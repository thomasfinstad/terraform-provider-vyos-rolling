...
- [vyos_protocols_bgp_address_family_ipv6_unicast_redistribute_kernel (Resource)](#vyos_protocols_bgp_address_family_ipv6_unicast_redistribute_kernel-resource)
  - [Schema](#schema)
    - [Optional](#optional)
      - [metric](#metric)
      - [route_map](#route_map)
...
```shell
terraform import vyos_protocols_bgp_address_family_ipv6_unicast_redistribute_kernel.example "protocols__bgp__address_family__ipv6_unicast__redistribute__kernel"
```
