...
```shell
terraform import vyos_vrf_name_protocols_bgp_address_family_ipv4_vpn_network.example "vrf__name__<name>__protocols__bgp__address-family__ipv4-vpn__network__<network>"
```
