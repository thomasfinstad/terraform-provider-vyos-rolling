...
```shell
terraform import vyos_vpn_l2tp_remote_access_client_ipv6_pool_prefix.example "vpn__l2tp__remote-access__client-ipv6-pool__<client-ipv6-pool>__prefix__<prefix>"
```
