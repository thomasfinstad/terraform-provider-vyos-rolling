...
- [vyos_interfaces_ethernet_vif (Resource)](#vyos_interfaces_ethernet_vif-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_interfaces_ethernet_vif.example "interfaces__ethernet__<ethernet>__vif__<vif>"
```
