...
```shell
terraform import vyos_vrf_name_protocols_bgp_address_family_ipv4_unicast_network.example "vrf__name__<name>__protocols__bgp__address_family__ipv4_unicast__network__<network>"
```
