...
- [vyos_protocols_isis_default_information_originate_ipv6_level_1 (Resource)](#vyos_protocols_isis_default_information_originate_ipv6_level_1-resource)
  - [Schema](#schema)
    - [Optional](#optional)
      - [always](#always)
      - [metric](#metric)
...
```shell
terraform import vyos_protocols_isis_default_information_originate_ipv6_level_1.example "protocols__isis__default-information__originate__ipv6__level-1"
```
