...
- [vyos_interfaces_wireless_vif_s_vif_c (Resource)](#vyos_interfaces_wireless_vif_s_vif_c-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_interfaces_wireless_vif_s_vif_c.example "interfaces__wireless__<wireless>__vif-s__<vif-s>__vif-c__<vif-c>"
```
