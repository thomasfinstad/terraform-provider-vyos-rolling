...
```shell
terraform import vyos_interfaces_pseudo_ethernet_vif_dhcpv6_options_pd.example "interfaces__pseudo-ethernet__<pseudo-ethernet>__vif__<vif>__dhcpv6-options__pd__<pd>"
```
