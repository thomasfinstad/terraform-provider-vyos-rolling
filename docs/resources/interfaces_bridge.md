...
- `aging` (Number) MAC address aging interval
    ...
    |Format      &emsp;|Description                                  |
    |--------------|-----------------------------------------------|
    |0           &emsp;|Disable MAC address learning (always flood)  |
    |10-1000000  &emsp;|MAC address aging time in seconds            |
...
- `forwarding_delay` (Number) Forwarding delay
    ...
    |Format  &emsp;|Description                                         |
    |----------|------------------------------------------------------|
    |0-200   &emsp;|Spanning Tree Protocol forwarding delay in seconds  |
- `hello_time` (Number) Hello packet advertisement interval

    |Format  &emsp;|Description                                                     |
    |----------|------------------------------------------------------------------|
    |1-10    &emsp;|Spanning Tree Protocol hello advertisement interval in seconds  |
