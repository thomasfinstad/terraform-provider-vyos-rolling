...
- [vyos_interfaces_wireless_vif (Resource)](#vyos_interfaces_wireless_vif-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_interfaces_wireless_vif.example "interfaces__wireless__<wireless>__vif__<vif>"
```
