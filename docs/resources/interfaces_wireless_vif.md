---
page_title: "vyos_interfaces_wireless_vif Resource - vyos"

subcategory: "Interfaces"

description: |- 
  interfaces⯯Wireless (WiFi/WLAN) Network Interface⯯Virtual Local Area Network (VLAN) ID
---

# vyos_interfaces_wireless_vif (Resource)
<center>
