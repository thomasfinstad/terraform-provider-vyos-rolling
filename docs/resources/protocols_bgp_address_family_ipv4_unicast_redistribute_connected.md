...
```shell
terraform import vyos_protocols_bgp_address_family_ipv4_unicast_redistribute_connected.example "protocols__bgp__address-family__ipv4-unicast__redistribute__connected"
```
