...
- [vyos_protocols_ospf_interface (Resource)](#vyos_protocols_ospf_interface-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_protocols_ospf_interface.example "protocols__ospf__interface__<interface>"
```
