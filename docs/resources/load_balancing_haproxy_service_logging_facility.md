---
page_title: "vyos_load_balancing_haproxy_service_logging_facility Resource - vyos"

subcategory: "Load Balancing"

description: |-
  load-balancing⯯Configure haproxy⯯Frontend service name⯯Logging parameters⯯Facility for logging
---

# vyos_load_balancing_haproxy_service_logging_facility (Resource)
<center>
...
- [vyos_load_balancing_haproxy_service_logging_facility (Resource)](#vyos_load_balancing_haproxy_service_logging_facility-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_load_balancing_haproxy_service_logging_facility.example "load-balancing__haproxy__service__<service>__logging__facility__<facility>"
```
