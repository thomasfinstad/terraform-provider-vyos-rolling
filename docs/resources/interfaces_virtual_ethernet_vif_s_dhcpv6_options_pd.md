---
page_title: "vyos_interfaces_virtual_ethernet_vif_s_dhcpv6_options_pd Resource - vyos"

subcategory: "Interfaces"

description: |- 
  interfaces⯯Virtual Ethernet (veth) Interface⯯QinQ TAG-S Virtual Local Area Network (VLAN) ID⯯DHCPv6 client settings/options⯯DHCPv6 prefix delegation interface statement
---

# vyos_interfaces_virtual_ethernet_vif_s_dhcpv6_options_pd (Resource)
<center>
