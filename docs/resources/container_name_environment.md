...
- [vyos_container_name_environment (Resource)](#vyos_container_name_environment-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_container_name_environment.example "container__name__<name>__environment__<environment>"
```
