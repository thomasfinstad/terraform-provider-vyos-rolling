...
```shell
terraform import vyos_protocols_bgp_address_family_ipv6_unicast_redistribute_connected.example "protocols__bgp__address-family__ipv6-unicast__redistribute__connected"
```
