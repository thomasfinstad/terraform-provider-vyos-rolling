...
```shell
terraform import vyos_protocols_bgp_address_family_ipv6_unicast_redistribute_connected.example "protocols__bgp__address_family__ipv6_unicast__redistribute__connected"
```
