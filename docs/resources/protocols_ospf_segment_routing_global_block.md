...
- [vyos_protocols_ospf_segment_routing_global_block (Resource)](#vyos_protocols_ospf_segment_routing_global_block-resource)
  - [Schema](#schema)
    - [Optional](#optional)
...
```shell
terraform import vyos_protocols_ospf_segment_routing_global_block.example "protocols__ospf__segment_routing__global_block"
```
