...
- [vyos_service_ipoe_server_client_ipv6_pool (Resource)](#vyos_service_ipoe_server_client_ipv6_pool-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_service_ipoe_server_client_ipv6_pool.example "service__ipoe-server__client-ipv6-pool__<client-ipv6-pool>"
```
