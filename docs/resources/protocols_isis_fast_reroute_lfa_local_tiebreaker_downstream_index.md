...
```shell
terraform import vyos_protocols_isis_fast_reroute_lfa_local_tiebreaker_downstream_index.example "protocols__isis__fast-reroute__lfa__local__tiebreaker__downstream__index__<index>"
```
