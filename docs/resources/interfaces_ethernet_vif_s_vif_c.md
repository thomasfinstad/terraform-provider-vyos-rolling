...
description: |-
  interfaces⯯Ethernet Interface⯯QinQ TAG-S Virtual Local Area Network (VLAN) ID⯯QinQ TAG-C Virtual Local Area Network (VLAN) ID
---
...
- [vyos_interfaces_ethernet_vif_s_vif_c (Resource)](#vyos_interfaces_ethernet_vif_s_vif_c-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_interfaces_ethernet_vif_s_vif_c.example "interfaces__ethernet__<ethernet>__vif-s__<vif-s>__vif-c__<vif-c>"
```
