...
- [vyos_protocols_bgp_address_family_ipv4_unicast_maximum_paths (Resource)](#vyos_protocols_bgp_address_family_ipv4_unicast_maximum_paths-resource)
  - [Schema](#schema)
    - [Optional](#optional)
      - [ebgp](#ebgp)
      - [ibgp](#ibgp)
...
```shell
terraform import vyos_protocols_bgp_address_family_ipv4_unicast_maximum_paths.example "protocols__bgp__address_family__ipv4_unicast__maximum_paths"
```
