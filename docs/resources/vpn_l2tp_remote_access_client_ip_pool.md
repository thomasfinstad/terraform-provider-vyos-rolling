---
page_title: "vyos_vpn_l2tp_remote_access_client_ip_pool Resource - vyos"

subcategory: "Vpn"

description: |-
  Virtual Private Network (VPN)⯯L2TP Virtual Private Network (VPN)⯯Remote access L2TP VPN⯯Client IP pool
---

# vyos_vpn_l2tp_remote_access_client_ip_pool (Resource)
<center>
...
- [vyos_vpn_l2tp_remote_access_client_ip_pool (Resource)](#vyos_vpn_l2tp_remote_access_client_ip_pool-resource)
  - [Schema](#schema)
    - [Required](#required)
