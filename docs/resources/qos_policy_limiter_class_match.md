...
- [vyos_qos_policy_limiter_class_match (Resource)](#vyos_qos_policy_limiter_class_match-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_qos_policy_limiter_class_match.example "qos__policy__limiter__<limiter>__class__<class>__match__<match>"
```
