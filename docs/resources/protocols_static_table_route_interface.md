...
description: |-
  protocols⯯Static Routing⯯Non-main Kernel Routing Table⯯Static IPv4 route⯯Next-hop IPv4 router interface
---
...
- [vyos_protocols_static_table_route_interface (Resource)](#vyos_protocols_static_table_route_interface-resource)
  - [Schema](#schema)
    - [Required](#required)
