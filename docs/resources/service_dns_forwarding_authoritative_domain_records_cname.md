...
```shell
terraform import vyos_service_dns_forwarding_authoritative_domain_records_cname.example "service__dns__forwarding__authoritative-domain__<authoritative-domain>__records__cname__<cname>"
```
