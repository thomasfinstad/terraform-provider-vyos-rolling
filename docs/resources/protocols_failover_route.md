...
- [vyos_protocols_failover_route (Resource)](#vyos_protocols_failover_route-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_protocols_failover_route.example "protocols__failover__route__<route>"
```
