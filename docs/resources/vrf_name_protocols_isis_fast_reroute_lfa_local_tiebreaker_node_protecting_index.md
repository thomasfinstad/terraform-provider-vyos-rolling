...
```shell
terraform import vyos_vrf_name_protocols_isis_fast_reroute_lfa_local_tiebreaker_node_protecting_index.example "vrf__name__<name>__protocols__isis__fast-reroute__lfa__local__tiebreaker__node-protecting__index__<index>"
```
