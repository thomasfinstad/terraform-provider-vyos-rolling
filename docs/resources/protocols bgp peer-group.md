...
page_title: "vyos_protocols bgp peer-group Resource - vyos"
subcategory: ""
description: |-
  Example resource
---

# vyos_protocols bgp peer-group (Resource)
...
Autonomous System Number (ASN) (see [below for nested schema](#nestedatt--local_as))
...
RS Client
Format: rs-server
Route Server (see [below for nested schema](#nestedatt--local_role))
