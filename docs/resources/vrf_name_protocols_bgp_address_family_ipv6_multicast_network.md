...
```shell
terraform import vyos_vrf_name_protocols_bgp_address_family_ipv6_multicast_network.example "vrf__name__<name>__protocols__bgp__address-family__ipv6-multicast__network__<network>"
```
