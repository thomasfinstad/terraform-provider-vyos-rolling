...
```shell
terraform import vyos_service_dns_forwarding_authoritative_domain_records_srv.example "service__dns__forwarding__authoritative_domain__<authoritative-domain>__records__srv__<srv>"
```
