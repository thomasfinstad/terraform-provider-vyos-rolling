...
- [vyos_system_syslog_host_facility (Resource)](#vyos_system_syslog_host_facility-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_system_syslog_host_facility.example "system__syslog__host__<host>__facility__<facility>"
```
