...
- [vyos_interfaces_bonding_vif_s (Resource)](#vyos_interfaces_bonding_vif_s-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_interfaces_bonding_vif_s.example "interfaces__bonding__<bonding>__vif-s__<vif-s>"
```
