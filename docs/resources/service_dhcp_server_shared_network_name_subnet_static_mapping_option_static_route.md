...
- [vyos_service_dhcp_server_shared_network_name_subnet_static_mapping_option_static_route (Resource)](#vyos_service_dhcp_server_shared_network_name_subnet_static_mapping_option_static_route-resource)
  - [Schema](#schema)
    - [Required](#required)
