...
- [vyos_protocols_bgp_address_family_ipv4_unicast_label_vpn (Resource)](#vyos_protocols_bgp_address_family_ipv4_unicast_label_vpn-resource)
  - [Schema](#schema)
    - [Optional](#optional)
      - [export](#export)
      - [timeouts](#timeouts)
...
```shell
terraform import vyos_protocols_bgp_address_family_ipv4_unicast_label_vpn.example "protocols__bgp__address_family__ipv4_unicast__label__vpn"
```
