...
- [vyos_protocols_isis_fast_reroute_lfa_local_priority_limit_critical (Resource)](#vyos_protocols_isis_fast_reroute_lfa_local_priority_limit_critical-resource)
  - [Schema](#schema)
    - [Optional](#optional)
      - [level_1](#level_1)
      - [level_2](#level_2)
...
```shell
terraform import vyos_protocols_isis_fast_reroute_lfa_local_priority_limit_critical.example "protocols__isis__fast-reroute__lfa__local__priority-limit__critical"
```
