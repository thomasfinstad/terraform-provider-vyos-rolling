...
description: |- 
  protocols⯯Border Gateway Protocol (BGP)⯯BGP address-family parameters⯯Multicast IPv4 BGP settings⯯Import BGP network/prefix into multicast IPv4 RIB
---
...
- `network` (String) Import BGP network/prefix into multicast IPv4 RIB
