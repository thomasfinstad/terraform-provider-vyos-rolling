...
- [vyos_interfaces_virtual_ethernet_dhcpv6_options_pd (Resource)](#vyos_interfaces_virtual_ethernet_dhcpv6_options_pd-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_interfaces_virtual_ethernet_dhcpv6_options_pd.example "interfaces__virtual_ethernet__<virtual-ethernet>__dhcpv6_options__pd__<pd>"
```
