...
- [vyos_protocols_static_route_next_hop (Resource)](#vyos_protocols_static_route_next_hop-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_protocols_static_route_next_hop.example "protocols__static__route__<route>__next_hop__<next-hop>"
```
