...
```shell
terraform import vyos_service_pppoe_server_client_ipv6_pool_prefix.example "service__pppoe_server__client_ipv6_pool__<client-ipv6-pool>__prefix__<prefix>"
```
