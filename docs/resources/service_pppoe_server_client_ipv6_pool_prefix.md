...
- [vyos_service_pppoe_server_client_ipv6_pool_prefix (Resource)](#vyos_service_pppoe_server_client_ipv6_pool_prefix-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_service_pppoe_server_client_ipv6_pool_prefix.example "service__pppoe-server__client-ipv6-pool__<client-ipv6-pool>__prefix__<prefix>"
```
