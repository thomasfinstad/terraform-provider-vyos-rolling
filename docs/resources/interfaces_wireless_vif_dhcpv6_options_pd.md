...
description: |- 
  interfaces⯯Wireless (WiFi/WLAN) Network Interface⯯Virtual Local Area Network (VLAN) ID⯯DHCPv6 client settings/options⯯DHCPv6 prefix delegation interface statement
---
