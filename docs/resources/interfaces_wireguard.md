...
- [vyos_interfaces_wireguard (Resource)](#vyos_interfaces_wireguard-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_interfaces_wireguard.example "interfaces__wireguard__<wireguard>"
```
