...
- [vyos_protocols_bgp_address_family_ipv6_multicast_distance (Resource)](#vyos_protocols_bgp_address_family_ipv6_multicast_distance-resource)
  - [Schema](#schema)
    - [Optional](#optional)
      - [external](#external)
      - [internal](#internal)
...
```shell
terraform import vyos_protocols_bgp_address_family_ipv6_multicast_distance.example "protocols__bgp__address_family__ipv6_multicast__distance"
```
