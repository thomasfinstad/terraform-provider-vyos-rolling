...
- [vyos_interfaces_bridge_vif (Resource)](#vyos_interfaces_bridge_vif-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_interfaces_bridge_vif.example "interfaces__bridge__<bridge>__vif__<vif>"
```
