...
description: |-
  ...
  Virtual Private Network (VPN)⯯Point to Point Tunneling Protocol (PPTP) Virtual Private Network (VPN)⯯Remote access PPTP VPN
---
...
- [vyos_vpn_pptp_remote_access (Resource)](#vyos_vpn_pptp_remote_access-resource)
  - [Schema](#schema)
    - [Optional](#optional)
