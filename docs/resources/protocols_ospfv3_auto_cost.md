---
page_title: "vyos_protocols_ospfv3_auto_cost Resource - vyos"

subcategory: "Protocols"

description: |-
  ~> This resource is global, having more than one resource of this type is likely to cause configuration drift / conflicts.
  protocols⯯Open Shortest Path First (OSPF) for IPv6⯯Calculate interface cost according to bandwidth
---

# vyos_protocols_ospfv3_auto_cost (Resource)
<center>
...
- [vyos_protocols_ospfv3_auto_cost (Resource)](#vyos_protocols_ospfv3_auto_cost-resource)
  - [Schema](#schema)
    - [Optional](#optional)
