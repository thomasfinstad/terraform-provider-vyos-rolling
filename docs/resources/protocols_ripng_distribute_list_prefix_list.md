...
- [vyos_protocols_ripng_distribute_list_prefix_list (Resource)](#vyos_protocols_ripng_distribute_list_prefix_list-resource)
  - [Schema](#schema)
    - [Optional](#optional)
      - [in](#in)
      - [out](#out)
...
```shell
terraform import vyos_protocols_ripng_distribute_list_prefix_list.example "protocols__ripng__distribute-list__prefix-list"
```
