...
- [vyos_firewall_ipv6_name_rule (Resource)](#vyos_firewall_ipv6_name_rule-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_firewall_ipv6_name_rule.example "firewall__ipv6__name__<name>__rule__<rule>"
```
