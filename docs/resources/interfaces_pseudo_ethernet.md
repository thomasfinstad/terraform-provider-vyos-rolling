---
page_title: "vyos_interfaces_pseudo_ethernet Resource - vyos"

subcategory: "Interfaces"

description: |- 
  interfaces⯯Pseudo Ethernet Interface (Macvlan)
---

# vyos_interfaces_pseudo_ethernet (Resource)
<center>
...
- `mode` (String) Receive mode (default: private)

    &emsp;|Format    &emsp;|Description                                        |
    |------------|-----------------------------------------------------|
    &emsp;|private   &emsp;|No communication with other pseudo-devices         |
    &emsp;|vepa      &emsp;|Virtual Ethernet Port Aggregator reflective relay  |
    &emsp;|bridge    &emsp;|Simple bridge between pseudo-devices               |
    &emsp;|passthru  &emsp;|Promicious mode passthrough of underlying device   |
