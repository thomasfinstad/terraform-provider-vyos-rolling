...
- [vyos_interfaces_virtual_ethernet_vif (Resource)](#vyos_interfaces_virtual_ethernet_vif-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_interfaces_virtual_ethernet_vif.example "interfaces__virtual-ethernet__<virtual-ethernet>__vif__<vif>"
```
