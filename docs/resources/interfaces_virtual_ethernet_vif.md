---
page_title: "vyos_interfaces_virtual_ethernet_vif Resource - vyos"

subcategory: "Interfaces"

description: |- 
  interfaces⯯Virtual Ethernet (veth) Interface⯯Virtual Local Area Network (VLAN) ID
---

# vyos_interfaces_virtual_ethernet_vif (Resource)
<center>
...
- `egress_qos` (String) VLAN egress QoS
    ...
    &emsp;|Format  &emsp;|Description                                  |
    |----------|-----------------------------------------------|
    &emsp;|txt     &emsp;|Format for qos mapping, e.g.: &#39;0:1 1:6 7:6&#39;  |
