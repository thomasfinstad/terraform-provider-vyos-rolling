...
- [vyos_vrf_name_protocols_static_route_next_hop (Resource)](#vyos_vrf_name_protocols_static_route_next_hop-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_vrf_name_protocols_static_route_next_hop.example "vrf__name__<name>__protocols__static__route__<route>__next_hop__<next-hop>"
```
