...
- [vyos_protocols_bgp_address_family_ipv4_unicast_redistribute_rip (Resource)](#vyos_protocols_bgp_address_family_ipv4_unicast_redistribute_rip-resource)
  - [Schema](#schema)
    - [Optional](#optional)
      - [metric](#metric)
      - [route_map](#route_map)
...
```shell
terraform import vyos_protocols_bgp_address_family_ipv4_unicast_redistribute_rip.example "protocols__bgp__address_family__ipv4_unicast__redistribute__rip"
```
