...
- [vyos_protocols_bgp_address_family_ipv4_unicast_sid_vpn (Resource)](#vyos_protocols_bgp_address_family_ipv4_unicast_sid_vpn-resource)
  - [Schema](#schema)
    - [Optional](#optional)
      - [export](#export)
      - [timeouts](#timeouts)
...
```shell
terraform import vyos_protocols_bgp_address_family_ipv4_unicast_sid_vpn.example "protocols__bgp__address-family__ipv4-unicast__sid__vpn"
```
