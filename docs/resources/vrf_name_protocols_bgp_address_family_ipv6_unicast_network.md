...
```shell
terraform import vyos_vrf_name_protocols_bgp_address_family_ipv6_unicast_network.example "vrf__name__<name>__protocols__bgp__address-family__ipv6-unicast__network__<network>"
```
