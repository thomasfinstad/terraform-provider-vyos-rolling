...
- [vyos_interfaces_wwan_dhcpv6_options_pd (Resource)](#vyos_interfaces_wwan_dhcpv6_options_pd-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_interfaces_wwan_dhcpv6_options_pd.example "interfaces__wwan__<wwan>__dhcpv6-options__pd__<pd>"
```
