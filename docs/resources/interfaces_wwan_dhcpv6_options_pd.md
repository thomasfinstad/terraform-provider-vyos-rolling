...
description: |- 
  interfaces⯯Wireless Modem (WWAN) Interface⯯DHCPv6 client settings/options⯯DHCPv6 prefix delegation interface statement
---
...
- `wwan` (String) Wireless Modem (WWAN) Interface
    ...
    &emsp;|Format  &emsp;|Description                                |
    |----------|---------------------------------------------|
    &emsp;|wwanN   &emsp;|Wireless Wide Area Network interface name  |
