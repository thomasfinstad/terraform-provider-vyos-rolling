...
- [vyos_interfaces_pseudo_ethernet_vif_s (Resource)](#vyos_interfaces_pseudo_ethernet_vif_s-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_interfaces_pseudo_ethernet_vif_s.example "interfaces__pseudo-ethernet__<pseudo-ethernet>__vif-s__<vif-s>"
```
