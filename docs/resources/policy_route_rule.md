...
description: |-
  Routing policy⯯Policy route rule set name for IPv4⯯Policy rule number
---
...
- [vyos_policy_route_rule (Resource)](#vyos_policy_route_rule-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_policy_route_rule.example "policy__route__<route>__rule__<rule>"
```
