...
- `duplex` (String) Duplex mode
    ...
    &emsp;|Format  &emsp;|Description       |
    |----------|--------------------|
    &emsp;|auto    &emsp;|Auto negotiation  |
    &emsp;|half    &emsp;|Half duplex       |
    &emsp;|full    &emsp;|Full duplex       |
...
- `speed` (String) Link speed
    ...
    |----------|--------------------|
    &emsp;|auto    &emsp;|Auto negotiation  |
    &emsp;|10      &emsp;|10 Mbit/sec       |
    &emsp;|100     &emsp;|100 Mbit/sec      |
    &emsp;|1000    &emsp;|1 Gbit/sec        |
    &emsp;|2500    &emsp;|2.5 Gbit/sec      |
    &emsp;|5000    &emsp;|5 Gbit/sec        |
    &emsp;|10000   &emsp;|10 Gbit/sec       |
    &emsp;|25000   &emsp;|25 Gbit/sec       |
    &emsp;|40000   &emsp;|40 Gbit/sec       |
    &emsp;|50000   &emsp;|50 Gbit/sec       |
    &emsp;|100000  &emsp;|100 Gbit/sec      |
...
- `rx` (Number) RX ring buffer
    ...
    &emsp;|Format    &emsp;|Description       |
    |------------|--------------------|
    &emsp;|80-16384  &emsp;|ring buffer size  |
