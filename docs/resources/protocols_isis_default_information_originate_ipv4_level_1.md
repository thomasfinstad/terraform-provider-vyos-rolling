...
```shell
terraform import vyos_protocols_isis_default_information_originate_ipv4_level_1.example "protocols__isis__default_information__originate__ipv4__level_1"
```
