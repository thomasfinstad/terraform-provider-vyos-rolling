...
- [vyos_policy_large_community_list (Resource)](#vyos_policy_large_community_list-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_policy_large_community_list.example "policy__large_community_list__<large-community-list>"
```
