...
- [vyos_service_pppoe_server_client_ip_pool (Resource)](#vyos_service_pppoe_server_client_ip_pool-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_service_pppoe_server_client_ip_pool.example "service__pppoe-server__client-ip-pool__<client-ip-pool>"
```
