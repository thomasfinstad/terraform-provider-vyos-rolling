...
- [vyos_interfaces_pppoe_dhcpv6_options_pd_interface (Resource)](#vyos_interfaces_pppoe_dhcpv6_options_pd_interface-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_interfaces_pppoe_dhcpv6_options_pd_interface.example "interfaces__pppoe__<pppoe>__dhcpv6_options__pd__<pd>__interface__<interface>"
```
