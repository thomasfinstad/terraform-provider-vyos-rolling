...
- [vyos_protocols_bgp_address_family_ipv4_unicast_export (Resource)](#vyos_protocols_bgp_address_family_ipv4_unicast_export-resource)
  - [Schema](#schema)
    - [Optional](#optional)
      - [timeouts](#timeouts)
      - [vpn](#vpn)
...
```shell
terraform import vyos_protocols_bgp_address_family_ipv4_unicast_export.example "protocols__bgp__address_family__ipv4_unicast__export"
```
