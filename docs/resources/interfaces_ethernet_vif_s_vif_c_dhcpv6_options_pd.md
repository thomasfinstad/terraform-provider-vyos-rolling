...
description: |-
  interfaces⯯Ethernet Interface⯯QinQ TAG-S Virtual Local Area Network (VLAN) ID⯯QinQ TAG-C Virtual Local Area Network (VLAN) ID⯯DHCPv6 client settings/options⯯DHCPv6 prefix delegation interface statement
---
...
- [vyos_interfaces_ethernet_vif_s_vif_c_dhcpv6_options_pd (Resource)](#vyos_interfaces_ethernet_vif_s_vif_c_dhcpv6_options_pd-resource)
  - [Schema](#schema)
    - [Required](#required)
