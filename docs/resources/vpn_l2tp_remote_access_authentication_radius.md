---
page_title: "vyos_vpn_l2tp_remote_access_authentication_radius Resource - vyos"

subcategory: "Vpn"

description: |-
  ~> This resource is global, having more than one resource of this type will cause configuration drift and possibly conflicts.
  Virtual Private Network (VPN)⯯L2TP Virtual Private Network (VPN)⯯Remote access L2TP VPN⯯Authentication for remote access L2TP VPN⯯RADIUS based user authentication
---

# vyos_vpn_l2tp_remote_access_authentication_radius (Resource)
<center>
...
- [vyos_vpn_l2tp_remote_access_authentication_radius (Resource)](#vyos_vpn_l2tp_remote_access_authentication_radius-resource)
  - [Schema](#schema)
    - [Optional](#optional)
