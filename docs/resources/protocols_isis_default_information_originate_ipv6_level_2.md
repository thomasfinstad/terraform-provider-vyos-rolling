...
description: |- 
  ...
  protocols⯯Intermediate System to Intermediate System (IS-IS)⯯Control distribution of default information⯯Distribute a default route⯯Distribute default route for IPv6⯯Distribute default route into level-2
---
