...
- [vyos_policy_extcommunity_list (Resource)](#vyos_policy_extcommunity_list-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_policy_extcommunity_list.example "policy__extcommunity_list__<extcommunity-list>"
```
