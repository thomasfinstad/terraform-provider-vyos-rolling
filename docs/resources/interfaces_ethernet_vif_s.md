...
- [vyos_interfaces_ethernet_vif_s (Resource)](#vyos_interfaces_ethernet_vif_s-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_interfaces_ethernet_vif_s.example "interfaces__ethernet__<ethernet>__vif_s__<vif-s>"
```
