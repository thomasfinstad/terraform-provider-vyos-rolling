...
- [vyos_interfaces_pseudo_ethernet_vif_s_dhcpv6_options_pd (Resource)](#vyos_interfaces_pseudo_ethernet_vif_s_dhcpv6_options_pd-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_interfaces_pseudo_ethernet_vif_s_dhcpv6_options_pd.example "interfaces__pseudo-ethernet__<pseudo-ethernet>__vif-s__<vif-s>__dhcpv6-options__pd__<pd>"
```
