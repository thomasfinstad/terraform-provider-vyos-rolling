---
page_title: "vyos_firewall_bridge_prerouting_filter_rule Resource - vyos"

subcategory: "Firewall"

description: |- 
  Firewall⯯Bridge firewall⯯Bridge prerouting firewall⯯Bridge firewall prerouting filter⯯Bridge firewall prerouting filter rule number
---

# vyos_firewall_bridge_prerouting_filter_rule (Resource)
<center>
...
- `rule_id` (Number) Bridge firewall prerouting filter rule number
