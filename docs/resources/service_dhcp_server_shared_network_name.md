...
- [vyos_service_dhcp_server_shared_network_name (Resource)](#vyos_service_dhcp_server_shared_network_name-resource)
  - [Schema](#schema)
    ...
    - [Nested Schema for `subnet.range`](#nested-schema-for-subnetrange)
    - [Nested Schema for `subnet.range.option`](#nested-schema-for-subnetrangeoption)
    - [Nested Schema for `subnet.range.option.vendor_option`](#nested-schema-for-subnetrangeoptionvendor_option)
    - [Nested Schema for `subnet.range.option.vendor_option.ubiquiti`](#nested-schema-for-subnetrangeoptionvendor_optionubiquiti)
...
- `option` (Attributes) DHCP option (see [below for nested schema](#nestedatt--subnet--range--option))
...
<a id="nestedatt--subnet--range--option"></a>
### Nested Schema for `subnet.range.option`
...
- `time_server` (List of String) IP address of time server
    ...
    |  ipv4    &emsp;|  Time server IPv4 address  |
- `time_zone` (String) Time zone to send to clients. Uses RFC4833 options 100 and 101
- `vendor_option` (Attributes) Vendor Specific Options (see [below for nested schema](#nestedatt--subnet--range--option--vendor_option))
- `wins_server` (List of String) IP address for Windows Internet Name Service (WINS) server
...
<a id="nestedatt--subnet--range--option--vendor_option"></a>
### Nested Schema for `subnet.range.option.vendor_option`

Optional:

- `ubiquiti` (Attributes) Ubiquiti specific parameters (see [below for nested schema](#nestedatt--subnet--range--option--vendor_option--ubiquiti))

<a id="nestedatt--subnet--range--option--vendor_option--ubiquiti"></a>
### Nested Schema for `subnet.range.option.vendor_option.ubiquiti`
...
```shell
terraform import vyos_service_dhcp_server_shared_network_name.example "service__dhcp-server__shared-network-name__<shared-network-name>"
```
