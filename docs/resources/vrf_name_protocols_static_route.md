...
- [vyos_vrf_name_protocols_static_route (Resource)](#vyos_vrf_name_protocols_static_route-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_vrf_name_protocols_static_route.example "vrf__name__<name>__protocols__static__route__<route>"
```
