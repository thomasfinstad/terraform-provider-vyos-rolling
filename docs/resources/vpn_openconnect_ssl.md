...
description: |-
  ...
  Virtual Private Network (VPN)⯯SSL VPN OpenConnect, AnyConnect compatible server⯯SSL Certificate, SSL Key and CA
---
...
- [vyos_vpn_openconnect_ssl (Resource)](#vyos_vpn_openconnect_ssl-resource)
  - [Schema](#schema)
    - [Optional](#optional)
...
```shell
terraform import vyos_vpn_openconnect_ssl.example "vpn__openconnect__ssl"
```
