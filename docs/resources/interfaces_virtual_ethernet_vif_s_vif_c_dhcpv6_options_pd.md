...
```shell
terraform import vyos_interfaces_virtual_ethernet_vif_s_vif_c_dhcpv6_options_pd.example "interfaces__virtual_ethernet__<virtual-ethernet>__vif_s__<vif-s>__vif_c__<vif-c>__dhcpv6_options__pd__<pd>"
```
