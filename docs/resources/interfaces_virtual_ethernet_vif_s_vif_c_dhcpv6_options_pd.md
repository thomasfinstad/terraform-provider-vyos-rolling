...
- [vyos_interfaces_virtual_ethernet_vif_s_vif_c_dhcpv6_options_pd (Resource)](#vyos_interfaces_virtual_ethernet_vif_s_vif_c_dhcpv6_options_pd-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_interfaces_virtual_ethernet_vif_s_vif_c_dhcpv6_options_pd.example "interfaces__virtual-ethernet__<virtual-ethernet>__vif-s__<vif-s>__vif-c__<vif-c>__dhcpv6-options__pd__<pd>"
```
