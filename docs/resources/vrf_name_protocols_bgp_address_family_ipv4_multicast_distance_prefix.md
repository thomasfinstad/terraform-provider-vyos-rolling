...
- [vyos_vrf_name_protocols_bgp_address_family_ipv4_multicast_distance_prefix (Resource)](#vyos_vrf_name_protocols_bgp_address_family_ipv4_multicast_distance_prefix-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_vrf_name_protocols_bgp_address_family_ipv4_multicast_distance_prefix.example "vrf__name__<name>__protocols__bgp__address_family__ipv4_multicast__distance__prefix__<prefix>"
```
