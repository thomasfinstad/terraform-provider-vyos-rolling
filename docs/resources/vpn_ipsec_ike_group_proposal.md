...
- [vyos_vpn_ipsec_ike_group_proposal (Resource)](#vyos_vpn_ipsec_ike_group_proposal-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_vpn_ipsec_ike_group_proposal.example "vpn__ipsec__ike_group__<ike-group>__proposal__<proposal>"
```
