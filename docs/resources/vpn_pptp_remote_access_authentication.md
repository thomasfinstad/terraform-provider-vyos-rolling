...
description: |-
  ...
  Virtual Private Network (VPN)⯯Point to Point Tunneling Protocol (PPTP) Virtual Private Network (VPN)⯯Remote access PPTP VPN⯯Authentication for remote access PPTP VPN
---
...
- [vyos_vpn_pptp_remote_access_authentication (Resource)](#vyos_vpn_pptp_remote_access_authentication-resource)
  - [Schema](#schema)
    - [Optional](#optional)
      - [mode](#mode)
      - [protocols](#protocols)
...
```shell
terraform import vyos_vpn_pptp_remote_access_authentication.example "vpn__pptp__remote-access__authentication"
```
