...
- [vyos_system_syslog_user_facility (Resource)](#vyos_system_syslog_user_facility-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_system_syslog_user_facility.example "system__syslog__user__<user>__facility__<facility>"
```
