...
- [vyos_protocols_isis_redistribute_ipv6_ospf6_level_2 (Resource)](#vyos_protocols_isis_redistribute_ipv6_ospf6_level_2-resource)
  - [Schema](#schema)
    - [Optional](#optional)
      - [metric](#metric)
      - [route_map](#route_map)
...
```shell
terraform import vyos_protocols_isis_redistribute_ipv6_ospf6_level_2.example "protocols__isis__redistribute__ipv6__ospf6__level-2"
```
