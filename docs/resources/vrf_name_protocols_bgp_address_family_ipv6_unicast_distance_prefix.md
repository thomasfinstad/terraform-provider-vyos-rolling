...
```shell
terraform import vyos_vrf_name_protocols_bgp_address_family_ipv6_unicast_distance_prefix.example "vrf__name__<name>__protocols__bgp__address_family__ipv6_unicast__distance__prefix__<prefix>"
```
