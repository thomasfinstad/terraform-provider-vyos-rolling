...
```shell
terraform import vyos_interfaces_macsec_dhcpv6_options_pd_interface.example "interfaces__macsec__<macsec>__dhcpv6_options__pd__<pd>__interface__<interface>"
```
