...
- [vyos_interfaces_wireless_dhcpv6_options_pd (Resource)](#vyos_interfaces_wireless_dhcpv6_options_pd-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_interfaces_wireless_dhcpv6_options_pd.example "interfaces__wireless__<wireless>__dhcpv6-options__pd__<pd>"
```
