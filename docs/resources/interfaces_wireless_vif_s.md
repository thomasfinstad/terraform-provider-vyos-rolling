...
- [vyos_interfaces_wireless_vif_s (Resource)](#vyos_interfaces_wireless_vif_s-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_interfaces_wireless_vif_s.example "interfaces__wireless__<wireless>__vif-s__<vif-s>"
```
