...
- [vyos_vrf_name_ip_protocol (Resource)](#vyos_vrf_name_ip_protocol-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_vrf_name_ip_protocol.example "vrf__name__<name>__ip__protocol__<protocol>"
```
