...
description: |-
  ...
  Virtual Private Network (VPN)⯯Secure Socket Tunneling Protocol (SSTP) server⯯Advanced protocol options
---
...
- [vyos_vpn_sstp_ppp_options (Resource)](#vyos_vpn_sstp_ppp_options-resource)
  - [Schema](#schema)
    - [Optional](#optional)
