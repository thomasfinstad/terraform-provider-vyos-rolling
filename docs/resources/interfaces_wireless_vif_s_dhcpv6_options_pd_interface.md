...
```shell
terraform import vyos_interfaces_wireless_vif_s_dhcpv6_options_pd_interface.example "interfaces__wireless__<wireless>__vif-s__<vif-s>__dhcpv6-options__pd__<pd>__interface__<interface>"
```
