...
- [vyos_interfaces_pseudo_ethernet_vif (Resource)](#vyos_interfaces_pseudo_ethernet_vif-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_interfaces_pseudo_ethernet_vif.example "interfaces__pseudo-ethernet__<pseudo-ethernet>__vif__<vif>"
```
