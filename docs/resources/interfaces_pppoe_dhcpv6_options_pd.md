...
- [vyos_interfaces_pppoe_dhcpv6_options_pd (Resource)](#vyos_interfaces_pppoe_dhcpv6_options_pd-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_interfaces_pppoe_dhcpv6_options_pd.example "interfaces__pppoe__<pppoe>__dhcpv6_options__pd__<pd>"
```
