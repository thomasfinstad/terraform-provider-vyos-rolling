...
- [vyos_protocols_bgp_neighbor_local_role (Resource)](#vyos_protocols_bgp_neighbor_local_role-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_protocols_bgp_neighbor_local_role.example "protocols__bgp__neighbor__<neighbor>__local-role__<local-role>"
```
