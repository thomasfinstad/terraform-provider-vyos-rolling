...
- [vyos_interfaces_bonding_vif (Resource)](#vyos_interfaces_bonding_vif-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_interfaces_bonding_vif.example "interfaces__bonding__<bonding>__vif__<vif>"
```
