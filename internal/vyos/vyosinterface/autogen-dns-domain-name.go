	...
	return interfacedefinition.InterfaceDefinition{
		...
		Node: []*interfacedefinition.Node{{
			...
			Children: []*interfacedefinition.Children{{
				...
				Node: []*interfacedefinition.Node{{
					XMLName: xml.Name{Local: "node"}, NodeNameAttr: "domain-search", OwnerAttr: "${vyos_conf_scripts_dir}/host_name.py",
					...
					XMLName: xml.Name{Local: "node"}, NodeNameAttr: "static-host-mapping", OwnerAttr: "${vyos_conf_scripts_dir}/host_name.py",
					Properties: []*interfacedefinition.Properties{{
						XMLName:  xml.Name{Local: "properties"},
					...
					Children: []*interfacedefinition.Children{{
						...
						TagNode: []*interfacedefinition.TagNode{{
							XMLName: xml.Name{Local: "tagNode"}, NodeNameAttr: "host-name",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
							...
							Children: []*interfacedefinition.Children{{
								XMLName: xml.Name{Local: "children"},
								LeafNode: []*interfacedefinition.LeafNode{{
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "alias",
									Properties: []*interfacedefinition.Properties{{
										XMLName: xml.Name{Local: "properties"},
									...
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "inet",
									Properties: []*interfacedefinition.Properties{{
										XMLName: xml.Name{Local: "properties"},
				...
				LeafNode: []*interfacedefinition.LeafNode{{
					XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "name-server", OwnerAttr: "${vyos_conf_scripts_dir}/host_name.py",
					Properties: []*interfacedefinition.Properties{{
						XMLName: xml.Name{Local: "properties"},
						...
						ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv4", Description: "Domain Name Server IPv4 address"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv6", Description: "Domain Name Server IPv6 address"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "txt", Description: "Use Domain Name Server from DHCP interface"}},
					...
					XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "host-name", OwnerAttr: "${vyos_conf_scripts_dir}/host_name.py",
					Properties: []*interfacedefinition.Properties{{
						XMLName: xml.Name{Local: "properties"},
					...
					XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "domain-name", OwnerAttr: "${vyos_conf_scripts_dir}/host_name.py",
					Properties: []*interfacedefinition.Properties{{
						XMLName: xml.Name{Local: "properties"},
