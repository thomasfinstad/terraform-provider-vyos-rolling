	...
	return interfacedefinition.InterfaceDefinition{
		...
		Node: []*interfacedefinition.Node{{
			...
			Children: []*interfacedefinition.Children{{
				...
				Node: []*interfacedefinition.Node{{
					XMLName: xml.Name{Local: "node"}, NodeNameAttr: "option", OwnerAttr: "${vyos_conf_scripts_dir}/system-option.py",
					...
					Children: []*interfacedefinition.Children{{
						XMLName: xml.Name{Local: "children"},
						Node: []*interfacedefinition.Node{{
							XMLName: xml.Name{Local: "node"}, NodeNameAttr: "http-client",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
							...
							XMLName: xml.Name{Local: "node"}, NodeNameAttr: "ssh-client",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
						...
						LeafNode: []*interfacedefinition.LeafNode{{
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "ctrl-alt-delete",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
								...
								ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "ignore", Description: "Ignore key sequence"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "reboot", Description: "Reboot system"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "poweroff", Description: "Poweroff system"}},
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "keyboard-layout",
							...
							Properties: []*interfacedefinition.Properties{{
								...
								ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "us", Description: "United States"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "uk", Description: "United Kingdom"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "fr", Description: "France"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "de", Description: "Germany"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "es", Description: "Spain"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "fi", Description: "Finland"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "jp106", Description: "Japan"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "no", Description: "Norway"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "dk", Description: "Denmark"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "dvorak", Description: "Dvorak"}},
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "performance",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
								...
								ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "throughput", Description: "Tune for maximum network throughput"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "latency", Description: "Tune for low network latency"}},
								CompletionHelp: []*interfacedefinition.CompletionHelp{{
									XMLName: xml.Name{Local: "completionHelp"},
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "reboot-on-panic",
							Properties: []*interfacedefinition.Properties{{
								XMLName:   xml.Name{Local: "properties"},
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "startup-beep",
							Properties: []*interfacedefinition.Properties{{
								XMLName:   xml.Name{Local: "properties"},
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "root-partition-auto-resize",
							Properties: []*interfacedefinition.Properties{{
								XMLName:   xml.Name{Local: "properties"},
