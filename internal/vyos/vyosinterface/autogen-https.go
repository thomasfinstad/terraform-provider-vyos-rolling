		...
		Node: []*interfacedefinition.Node{{
			...
			Children: []*interfacedefinition.Children{{
				...
				Node: []*interfacedefinition.Node{{
					...
					NodeNameAttr: "https",
					OwnerAttr:    "${vyos_conf_scripts_dir}/https.py",
					...
					Children: []*interfacedefinition.Children{{
						...
						Node: []*interfacedefinition.Node{{
							...
							NodeNameAttr: "api",
							OwnerAttr:    "${vyos_conf_scripts_dir}/http-api.py",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{
									Local: "properties",
								},
							...
							Children: []*interfacedefinition.Children{{
								...
								LeafNode: []*interfacedefinition.LeafNode{{
									...
									Properties: []*interfacedefinition.Properties{{
										...
										Hidden: []*interfacedefinition.Hidden{{
											XMLName: xml.Name{
												Local: "hidden",
											},
										}},
							...
							Children: []*interfacedefinition.Children{{
								...
								Node: []*interfacedefinition.Node{{
									...
									NodeNameAttr: "certbot",
									OwnerAttr:    "${vyos_conf_scripts_dir}/le_cert.py",
									Properties: []*interfacedefinition.Properties{{
										XMLName: xml.Name{
											Local: "properties",
										},
								...
								LeafNode: []*interfacedefinition.LeafNode{{
									...
									Properties: []*interfacedefinition.Properties{{
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{
											...
											Format:      "ipv4",
											Description: "HTTPS IPv4 address",
										}, {
											XMLName: xml.Name{
												Local: "valueHelp",
											},
											Format:      "ipv6",
											Description: "HTTPS IPv6 address",
										}, {
											XMLName: xml.Name{
												Local: "valueHelp",
											},
