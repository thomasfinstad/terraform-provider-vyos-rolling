		...
		Node: []*interfacedefinition.Node{{
			...
			Children: []*interfacedefinition.Children{{
				...
				TagNode: []*interfacedefinition.TagNode{{
					XMLName: xml.Name{Local: "tagNode"}, NodeNameAttr: "pseudo-ethernet", OwnerAttr: "${vyos_conf_scripts_dir}/interfaces-pseudo-ethernet.py",
					Properties: []*interfacedefinition.Properties{{
						...
						ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "pethN", Description: "Pseudo Ethernet interface name"}},
					...
					Children: []*interfacedefinition.Children{{
						...
						LeafNode: []*interfacedefinition.LeafNode{{
							...
							Properties: []*interfacedefinition.Properties{{
								...
								ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "interface", Description: "Physical interface used for traffic forwarding"}},
								CompletionHelp: []*interfacedefinition.CompletionHelp{{
									XMLName: xml.Name{Local: "completionHelp"},
							...
							Properties: []*interfacedefinition.Properties{{
								...
								ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "private", Description: "No communication with other pseudo-devices"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "vepa", Description: "Virtual Ethernet Port Aggregator reflective relay"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "bridge", Description: "Simple bridge between pseudo-devices"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "passthru", Description: "Promicious mode passthrough of underlying device"}},
