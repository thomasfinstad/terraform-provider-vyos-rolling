	...
	return interfacedefinition.InterfaceDefinition{
		...
		Node: []*interfacedefinition.Node{{
			...
			Children: []*interfacedefinition.Children{{
				...
				Node: []*interfacedefinition.Node{{
					XMLName: xml.Name{Local: "node"}, NodeNameAttr: "salt-minion", OwnerAttr: "${vyos_conf_scripts_dir}/salt-minion.py",
					...
					Children: []*interfacedefinition.Children{{
						...
						LeafNode: []*interfacedefinition.LeafNode{{
							...
							Properties: []*interfacedefinition.Properties{{
								...
								ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv4", Description: "Salt server IPv4 address"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv6", Description: "Salt server IPv6 address"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "hostname", Description: "Salt server FQDN address"}},
							...
							Properties: []*interfacedefinition.Properties{{
								...
								Constraint: []*interfacedefinition.Constraint{{
									XMLName:   xml.Name{Local: "constraint"},
									Validator: []*interfacedefinition.Validator{{XMLName: xml.Name{Local: "validator"}, NameAttr: "numeric", ArgumentAttr: "--range 1-1440"}},
								}},
								ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:1-1440", Description: "Update interval in minutes"}},
							}},
						}, {
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "master-key",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
