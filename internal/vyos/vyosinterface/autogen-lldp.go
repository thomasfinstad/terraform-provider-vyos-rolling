	...
	return interfacedefinition.InterfaceDefinition{
		...
		Node: []*interfacedefinition.Node{{
			...
			Children: []*interfacedefinition.Children{{
				...
				Node: []*interfacedefinition.Node{{
					XMLName: xml.Name{Local: "node"}, NodeNameAttr: "lldp", OwnerAttr: "${vyos_conf_scripts_dir}/lldp.py",
					...
					Children: []*interfacedefinition.Children{{
						XMLName: xml.Name{Local: "children"},
						Node: []*interfacedefinition.Node{{
							XMLName: xml.Name{Local: "node"}, NodeNameAttr: "legacy-protocols",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
							...
							Children: []*interfacedefinition.Children{{
								...
								LeafNode: []*interfacedefinition.LeafNode{{
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "cdp",
									Properties: []*interfacedefinition.Properties{{
										XMLName:   xml.Name{Local: "properties"},
									...
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "edp",
									Properties: []*interfacedefinition.Properties{{
										XMLName:   xml.Name{Local: "properties"},
									...
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "fdp",
									Properties: []*interfacedefinition.Properties{{
										XMLName:   xml.Name{Local: "properties"},
									...
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "sonmp",
									Properties: []*interfacedefinition.Properties{{
										XMLName:   xml.Name{Local: "properties"},
						...
						TagNode: []*interfacedefinition.TagNode{{
							...
							Properties: []*interfacedefinition.Properties{{
								...
								ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "all", Description: "Location data all interfaces"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "txt", Description: "Location data for a specific interface"}},
							...
							Children: []*interfacedefinition.Children{{
								XMLName: xml.Name{Local: "children"},
								Node: []*interfacedefinition.Node{{
									XMLName: xml.Name{Local: "node"}, NodeNameAttr: "location",
									Properties: []*interfacedefinition.Properties{{
										XMLName: xml.Name{Local: "properties"},
									...
									Children: []*interfacedefinition.Children{{
										XMLName: xml.Name{Local: "children"},
										Node: []*interfacedefinition.Node{{
											XMLName: xml.Name{Local: "node"}, NodeNameAttr: "coordinate-based",
											Properties: []*interfacedefinition.Properties{{
												XMLName: xml.Name{Local: "properties"},
											...
											Children: []*interfacedefinition.Children{{
												XMLName: xml.Name{Local: "children"},
												LeafNode: []*interfacedefinition.LeafNode{{
													XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "altitude",
													...
													Properties: []*interfacedefinition.Properties{{
														...
														ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "0", Description: "No altitude"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "[+-]<meters>", Description: "Altitude in meters"}},
														ConstraintErrorMessage: []string{"Altitude should be a positive or negative number"},
													}},
												}, {
													XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "datum",
													...
													Properties: []*interfacedefinition.Properties{{
														...
														ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "WGS84", Description: "WGS84"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "NAD83", Description: "NAD83"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "MLLW", Description: "NAD83/MLLW"}},
													...
													XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "latitude",
													Properties: []*interfacedefinition.Properties{{
														XMLName: xml.Name{Local: "properties"},
														...
														ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "<latitude>", Description: "Latitude (example \"37.524449N\")"}},
														ConstraintErrorMessage: []string{"Latitude should be a number followed by S or N"},
													}},
												}, {
													XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "longitude",
													Properties: []*interfacedefinition.Properties{{
														XMLName: xml.Name{Local: "properties"},
														...
														ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "<longitude>", Description: "Longitude (example \"122.267255W\")"}},
										...
										LeafNode: []*interfacedefinition.LeafNode{{
											XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "elin",
											Properties: []*interfacedefinition.Properties{{
												XMLName: xml.Name{Local: "properties"},
												...
												ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:0-9999999999", Description: "Emergency Call Service ELIN number (between 10-25 numbers)"}},
						...
						LeafNode: []*interfacedefinition.LeafNode{{
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "management-address",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
								...
								ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv4", Description: "IPv4 Management Address"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv6", Description: "IPv6 Management Address"}},
								CompletionHelp: []*interfacedefinition.CompletionHelp{{
									XMLName: xml.Name{Local: "completionHelp"},
