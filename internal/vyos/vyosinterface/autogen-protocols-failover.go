	...
	return interfacedefinition.InterfaceDefinition{
		...
		Node: []*interfacedefinition.Node{{
			...
			Children: []*interfacedefinition.Children{{
				...
				Node: []*interfacedefinition.Node{{
					XMLName: xml.Name{Local: "node"}, NodeNameAttr: "failover", OwnerAttr: "${vyos_conf_scripts_dir}/protocols_failover.py",
					...
					Children: []*interfacedefinition.Children{{
						...
						TagNode: []*interfacedefinition.TagNode{{
							...
							Properties: []*interfacedefinition.Properties{{
								...
								ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv4net", Description: "IPv4 failover route"}},
							}},
							Children: []*interfacedefinition.Children{{
								XMLName: xml.Name{Local: "children"},
								TagNode: []*interfacedefinition.TagNode{{
									...
									Children: []*interfacedefinition.Children{{
										XMLName: xml.Name{Local: "children"},
										Node: []*interfacedefinition.Node{{
											XMLName: xml.Name{Local: "node"}, NodeNameAttr: "check",
											Properties: []*interfacedefinition.Properties{{
												XMLName: xml.Name{Local: "properties"},
											...
											Children: []*interfacedefinition.Children{{
												...
												LeafNode: []*interfacedefinition.LeafNode{{
													...
													Properties: []*interfacedefinition.Properties{{
														...
														ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv4", Description: "Address to check"}},
													}},
												}, {
													...
													Properties: []*interfacedefinition.Properties{{
														...
														ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:1-300", Description: "Timeout in seconds between checks"}},
													}},
												}, {
													...
													Properties: []*interfacedefinition.Properties{{
														...
														ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "arp", Description: "Check target by ARP"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "icmp", Description: "Check target by ICMP"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "tcp", Description: "Check target by TCP"}},
										...
										LeafNode: []*interfacedefinition.LeafNode{{
											...
											Properties: []*interfacedefinition.Properties{{
												...
												ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:1-255", Description: "Route metric"}},
											}},
										}},
									}},
								}},
