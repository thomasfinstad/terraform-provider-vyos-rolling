	...
	return interfacedefinition.InterfaceDefinition{
		...
		Node: []*interfacedefinition.Node{{
			...
			Children: []*interfacedefinition.Children{{
				...
				Node: []*interfacedefinition.Node{{
					XMLName: xml.Name{Local: "node"}, NodeNameAttr: "broadcast-relay", OwnerAttr: "${vyos_conf_scripts_dir}/bcast_relay.py",
						...
						TagNode: []*interfacedefinition.TagNode{{
							...
							Properties: []*interfacedefinition.Properties{{
								...
								Constraint: []*interfacedefinition.Constraint{{
									...
									Validator: []*interfacedefinition.Validator{{XMLName: xml.Name{Local: "validator"}, NameAttr: "numeric", ArgumentAttr: "--range 1-99"}},
								}},
								ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:1-99", Description: "Broadcast relay instance ID"}},
							}},
							Children: []*interfacedefinition.Children{{
								XMLName: xml.Name{Local: "children"},
								LeafNode: []*interfacedefinition.LeafNode{{
									...
									Properties: []*interfacedefinition.Properties{{
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv4", Description: "Optional source address for forwarded packets"}},
									}},
								}, {
