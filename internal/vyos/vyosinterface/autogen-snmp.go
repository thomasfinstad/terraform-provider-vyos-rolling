	...
	return interfacedefinition.InterfaceDefinition{
		...
		Node: []*interfacedefinition.Node{{
			...
			Children: []*interfacedefinition.Children{{
				...
				Node: []*interfacedefinition.Node{{
					XMLName: xml.Name{Local: "node"}, NodeNameAttr: "snmp", OwnerAttr: "${vyos_conf_scripts_dir}/snmp.py",
					...
					Children: []*interfacedefinition.Children{{
						XMLName: xml.Name{Local: "children"},
						Node: []*interfacedefinition.Node{{
							XMLName: xml.Name{Local: "node"}, NodeNameAttr: "v3",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
							...
							Children: []*interfacedefinition.Children{{
								...
								TagNode: []*interfacedefinition.TagNode{{
									...
									Children: []*interfacedefinition.Children{{
										...
										LeafNode: []*interfacedefinition.LeafNode{{
											...
											Properties: []*interfacedefinition.Properties{{
												...
												ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "ro", Description: "Read-Only"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "rw", Description: "read write"}},
											...
											XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "seclevel",
											...
											Properties: []*interfacedefinition.Properties{{
												...
												ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "noauth", Description: "Messages not authenticated and not encrypted (noAuthNoPriv)"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "auth", Description: "Messages are authenticated but not encrypted (authNoPriv)"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "priv", Description: "Messages are authenticated and encrypted (authPriv)"}},
												CompletionHelp: []*interfacedefinition.CompletionHelp{{
													XMLName: xml.Name{Local: "completionHelp"},
											...
											XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "view",
											Properties: []*interfacedefinition.Properties{{
												XMLName: xml.Name{Local: "properties"},
									...
									XMLName: xml.Name{Local: "tagNode"}, NodeNameAttr: "trap-target",
									Properties: []*interfacedefinition.Properties{{
										XMLName: xml.Name{Local: "properties"},
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv4", Description: "IP address of trap target"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv6", Description: "IPv6 address of trap target"}},
									}},
									Children: []*interfacedefinition.Children{{
										XMLName: xml.Name{Local: "children"},
										Node: []*interfacedefinition.Node{{
											XMLName: xml.Name{Local: "node"}, NodeNameAttr: "auth",
											Properties: []*interfacedefinition.Properties{{
												XMLName: xml.Name{Local: "properties"},
											...
											Children: []*interfacedefinition.Children{{
												...
												LeafNode: []*interfacedefinition.LeafNode{{
													...
													Properties: []*interfacedefinition.Properties{{
														...
														ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "md5", Description: "Message Digest 5"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "sha", Description: "Secure Hash Algorithm"}},
														CompletionHelp: []*interfacedefinition.CompletionHelp{{
															XMLName: xml.Name{Local: "completionHelp"},
															List:    []string{"md5 sha"},
														}},
											...
											XMLName: xml.Name{Local: "node"}, NodeNameAttr: "privacy",
											Properties: []*interfacedefinition.Properties{{
												XMLName: xml.Name{Local: "properties"},
												Help:    []string{"Defines the privacy"},
											}},
											Children: []*interfacedefinition.Children{{
												...
												LeafNode: []*interfacedefinition.LeafNode{{
													...
													Properties: []*interfacedefinition.Properties{{
														...
														ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "des", Description: "Data Encryption Standard"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "aes", Description: "Advanced Encryption Standard"}},
														CompletionHelp: []*interfacedefinition.CompletionHelp{{
															XMLName: xml.Name{Local: "completionHelp"},
															List:    []string{"des aes"},
														}},
										...
										LeafNode: []*interfacedefinition.LeafNode{{
											...
											Properties: []*interfacedefinition.Properties{{
												...
												ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "udp", Description: "Listen protocol UDP"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "tcp", Description: "Listen protocol TCP"}},
												CompletionHelp: []*interfacedefinition.CompletionHelp{{
													XMLName: xml.Name{Local: "completionHelp"},
													List:    []string{"udp tcp"},
												}},
											...
											Properties: []*interfacedefinition.Properties{{
												...
												ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "inform", Description: "Use INFORM"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "trap", Description: "Use TRAP"}},
												CompletionHelp: []*interfacedefinition.CompletionHelp{{
													XMLName: xml.Name{Local: "completionHelp"},
									...
									XMLName: xml.Name{Local: "tagNode"}, NodeNameAttr: "view",
									Properties: []*interfacedefinition.Properties{{
										XMLName: xml.Name{Local: "properties"},
									...
									Children: []*interfacedefinition.Children{{
										XMLName: xml.Name{Local: "children"},
										TagNode: []*interfacedefinition.TagNode{{
											XMLName: xml.Name{Local: "tagNode"}, NodeNameAttr: "oid",
											Properties: []*interfacedefinition.Properties{{
												XMLName: xml.Name{Local: "properties"},
								...
								LeafNode: []*interfacedefinition.LeafNode{{
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "engineid",
									DefaultValue: []string{""},
									Properties: []*interfacedefinition.Properties{{
										XMLName: xml.Name{Local: "properties"},
							...
							XMLName: xml.Name{Local: "node"}, NodeNameAttr: "script-extensions",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
							...
							Children: []*interfacedefinition.Children{{
								XMLName: xml.Name{Local: "children"},
								TagNode: []*interfacedefinition.TagNode{{
									XMLName: xml.Name{Local: "tagNode"}, NodeNameAttr: "extension-name",
									Properties: []*interfacedefinition.Properties{{
										XMLName: xml.Name{Local: "properties"},
						...
						TagNode: []*interfacedefinition.TagNode{{
							XMLName: xml.Name{Local: "tagNode"}, NodeNameAttr: "community",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
							...
							Children: []*interfacedefinition.Children{{
								XMLName: xml.Name{Local: "children"},
								LeafNode: []*interfacedefinition.LeafNode{{
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "authorization",
									DefaultValue: []string{"ro"},
									Properties: []*interfacedefinition.Properties{{
										XMLName: xml.Name{Local: "properties"},
									...
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "client",
									Properties: []*interfacedefinition.Properties{{
										XMLName: xml.Name{Local: "properties"},
							...
							Properties: []*interfacedefinition.Properties{{
								...
								ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv4", Description: "IPv4 address to listen for incoming SNMP requests"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv6", Description: "IPv6 address to listen for incoming SNMP requests"}},
								CompletionHelp: []*interfacedefinition.CompletionHelp{{
									XMLName: xml.Name{Local: "completionHelp"},
							...
							Children: []*interfacedefinition.Children{{
								XMLName: xml.Name{Local: "children"},
								LeafNode: []*interfacedefinition.LeafNode{{
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "community",
									Properties: []*interfacedefinition.Properties{{
										XMLName: xml.Name{Local: "properties"},
						...
						LeafNode: []*interfacedefinition.LeafNode{{
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "contact",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "oid-enable",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
								...
								ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "ip-forward", Description: "Enable ipForward: .1.3.6.1.2.1.4.24"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "ip-route-table", Description: "Enable ipRouteTable: .1.3.6.1.2.1.4.21"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "ip-net-to-media-table", Description: "Enable ipNetToMediaTable: .1.3.6.1.2.1.4.22"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "ip-net-to-physical-phys-address", Description: "Enable ipNetToPhysicalPhysAddress: .1.3.6.1.2.1.4.35"}},
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "smux-peer",
							Properties: []*interfacedefinition.Properties{{
								XMLName:   xml.Name{Local: "properties"},
								Help:      []string{"Register a subtree for SMUX-based processing"},
								ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "txt", Description: "SNMP Object Identifier"}},
								Multi:     []*interfacedefinition.Multi{{XMLName: xml.Name{Local: "multi"}}},
							}},
						}, {
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "trap-source",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
