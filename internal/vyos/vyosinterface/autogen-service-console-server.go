...
func serviceconsoleserver() interfacedefinition.InterfaceDefinition {
	return interfacedefinition.InterfaceDefinition{
		...
		Node: []*interfacedefinition.Node{{
			...
			Children: []*interfacedefinition.Children{{
				...
				Node: []*interfacedefinition.Node{{
					XMLName: xml.Name{Local: "node"}, NodeNameAttr: "console-server", OwnerAttr: "${vyos_conf_scripts_dir}/service_console-server.py",
					...
					Children: []*interfacedefinition.Children{{
						...
						TagNode: []*interfacedefinition.TagNode{{
							...
							Properties: []*interfacedefinition.Properties{{
								...
								ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "ttySxxx", Description: "Regular serial interface"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "usbxbxpx", Description: "USB based serial interface"}},
							...
							Children: []*interfacedefinition.Children{{
								...
								LeafNode: []*interfacedefinition.LeafNode{{
									...
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "data-bits",
									...
									Properties: []*interfacedefinition.Properties{{
										...
										Constraint: []*interfacedefinition.Constraint{{
											XMLName:   xml.Name{Local: "constraint"},
											Validator: []*interfacedefinition.Validator{{XMLName: xml.Name{Local: "validator"}, NameAttr: "numeric", ArgumentAttr: "--range 7-8"}},
										}},
										CompletionHelp: []*interfacedefinition.CompletionHelp{{
											XMLName: xml.Name{Local: "completionHelp"},
											List:    []string{"7 8"},
									...
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "stop-bits",
									...
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "parity",
