						...
						TagNode: []*interfacedefinition.TagNode{{
							...
							Children: []*interfacedefinition.Children{{
								...
								TagNode: []*interfacedefinition.TagNode{{
									...
									Children: []*interfacedefinition.Children{{
										...
										TagNode: []*interfacedefinition.TagNode{{
											...
											Children: []*interfacedefinition.Children{{
												...
												LeafNode: []*interfacedefinition.LeafNode{{
													...
													NodeNameAttr: "static-mapping-parameters",
													Properties: []*interfacedefinition.Properties{{
														XMLName: xml.Name{
															Local: "properties",
														},
										...
										LeafNode: []*interfacedefinition.LeafNode{{
											...
											NodeNameAttr: "subnet-parameters",
											Properties: []*interfacedefinition.Properties{{
												XMLName: xml.Name{
													Local: "properties",
												},
								...
								LeafNode: []*interfacedefinition.LeafNode{{
									...
									NodeNameAttr: "shared-network-parameters",
									Properties: []*interfacedefinition.Properties{{
										XMLName: xml.Name{
											Local: "properties",
										},
