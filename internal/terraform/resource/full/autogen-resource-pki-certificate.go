...
func (r *pki_certificate) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m pki_certificateModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
...
func (r pki_certificate) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	r.ResourceName = req.ProviderTypeName + "_pki_certificate"
