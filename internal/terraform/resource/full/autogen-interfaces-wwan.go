...
var _ resource.Resource = &interfaces_wwan{}

// var _ resource.ResourceWithImportState = &interfaces_wwan{}

// interfaces_wwan defines the resource implementation.
type interfaces_wwan struct {
	client *http.Client
}

// interfaces wwanModel describes the resource data model.
type interfaces_wwanModel struct {
...
func (r *interfaces_wwan) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_interfaces wwan"
}

// interfaces_wwanResource method to return the example resource reference
func interfaces_wwanResource() resource.Resource {
	return &interfaces_wwan{}
}

// Schema method to define the schema for any resource configuration, plan, and state data.
func (r *interfaces_wwan) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *interfaces_wwan) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *interfaces_wwanModel
...
func (r *interfaces_wwan) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *interfaces_wwanModel
...
func (r *interfaces_wwan) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *interfaces_wwanModel
...
func (r *interfaces_wwan) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *interfaces_wwanModel
