...
func (r *service_lldp_interface) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m service_lldp_interfaceModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
