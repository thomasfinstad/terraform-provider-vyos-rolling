...
func (r *vpn_ipsec_esp_group) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m vpn_ipsec_esp_groupModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
	...
	values = map[string]attr.Value{
		...
		"lifetime":     m.Lifetime,
		"life_bytes":   m.Life_bytes,
		"life_packets": m.Life_packets,
		"mode":         m.Mode,
		"pfs":          m.Pfs,
...
func (r vpn_ipsec_esp_group) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	r.ResourceName = req.ProviderTypeName + "_vpn_ipsec_esp_group"
