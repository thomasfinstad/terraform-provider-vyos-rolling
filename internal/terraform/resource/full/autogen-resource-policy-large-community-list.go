...
func (r *policy_large_community_list) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m policy_large_community_listModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
...
func (r policy_large_community_list) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	r.ResourceName = req.ProviderTypeName + "_policy_large_community_list"
