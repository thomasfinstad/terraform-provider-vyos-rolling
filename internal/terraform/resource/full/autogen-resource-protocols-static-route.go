...
func (r *protocols_static_route) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
// protocols_static_routeModel describes the resource data model.
...
func (m protocols_static_routeModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
