...
func (r *vpn_sstp_client_ipvsix_pool_delegate) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m vpn_sstp_client_ipvsix_pool_delegateModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
