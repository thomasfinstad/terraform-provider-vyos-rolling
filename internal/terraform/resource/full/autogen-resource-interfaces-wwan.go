...
func (r *interfaces_wwan) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
// interfaces_wwanModel describes the resource data model.
...
func (m interfaces_wwanModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
