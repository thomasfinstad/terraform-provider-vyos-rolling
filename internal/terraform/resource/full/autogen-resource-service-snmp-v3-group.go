...
func (r *service_snmp_vthree_group) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m service_snmp_vthree_groupModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
...
func (r service_snmp_vthree_group) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	r.ResourceName = req.ProviderTypeName + "_service_snmp_v3_group"
