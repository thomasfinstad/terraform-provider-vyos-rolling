...
func (r *policy_route) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m policy_routeModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
