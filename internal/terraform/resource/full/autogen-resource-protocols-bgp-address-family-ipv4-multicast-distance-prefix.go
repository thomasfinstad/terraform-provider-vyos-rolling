...
func (r *protocols_bgp_address_family_ipvfour_multicast_distance_prefix) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m protocols_bgp_address_family_ipvfour_multicast_distance_prefixModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
...
func (r protocols_bgp_address_family_ipvfour_multicast_distance_prefix) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	r.ResourceName = req.ProviderTypeName + "_protocols_bgp_address_family_ipv4_multicast_distance_prefix"
