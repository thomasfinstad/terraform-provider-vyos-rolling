...
func (r *protocols_bgp_address_family_ipvsix_multicast_network) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m protocols_bgp_address_family_ipvsix_multicast_networkModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
