...
func (r *qos_policy_round_robin) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m qos_policy_round_robinModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
