...
func (r *firewall_name) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m firewall_nameModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
