...
func (r *service_webproxy_url_filtering_squidguard_rule) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m service_webproxy_url_filtering_squidguard_ruleModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
	...
	values = map[string]attr.Value{
		...
		// LeafNodes
		"allow_category":      m.Allow_category,
		"allow_ipaddr_url":    m.Allow_ipaddr_url,
		"block_category":      m.Block_category,
		"default_action":      m.Default_action,
		"enable_safe_search":  m.Enable_safe_search,
		"local_block_keyword": m.Local_block_keyword,
		"local_block_url":     m.Local_block_url,
		"local_block":         m.Local_block,
		"local_ok_url":        m.Local_ok_url,
		"local_ok":            m.Local_ok,
		"log":                 m.Log,
...
func (r service_webproxy_url_filtering_squidguard_rule) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	r.ResourceName = req.ProviderTypeName + "_service_webproxy_url_filtering_squidguard_rule"
