...
func (r *protocols_babel_interface) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m protocols_babel_interfaceModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
	...
	values = map[string]attr.Value{
		...
		"rxcost":            m.Rxcost,
		"rtt_decay":         m.Rtt_decay,
		"rtt_min":           m.Rtt_min,
		"rtt_max":           m.Rtt_max,
		"max_rtt_penalty":   m.Max_rtt_penalty,
		"enable_timestamps": m.Enable_timestamps,
		"channel":           m.Channel,
...
func (r protocols_babel_interface) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	r.ResourceName = req.ProviderTypeName + "_protocols_babel_interface"
