...
func (r *vpn_pptp_remote_access_authentication_radius_server) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m vpn_pptp_remote_access_authentication_radius_serverModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
