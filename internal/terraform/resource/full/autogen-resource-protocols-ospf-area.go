...
func (r *protocols_ospf_area) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
type protocols_ospf_areaModel struct {
	...
	// Nodes
	Area_type types.List `tfsdk:"area_type"`
}

func (m protocols_ospf_areaModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
...
func (r protocols_ospf_area) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	r.ResourceName = req.ProviderTypeName + "_protocols_ospf_area"
