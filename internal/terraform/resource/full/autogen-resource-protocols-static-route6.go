...
func (r *protocols_static_routesix) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m protocols_static_routesixModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
...
func (r protocols_static_routesix) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	r.ResourceName = req.ProviderTypeName + "_protocols_static_route6"
