...
func (r *load_balancing_wan_interface_health) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m load_balancing_wan_interface_healthModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
...
func (r load_balancing_wan_interface_health) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	r.ResourceName = req.ProviderTypeName + "_load_balancing_wan_interface_health"
