...
func (r *system_flow_accounting_sflow_server) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m system_flow_accounting_sflow_serverModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
...
func (r system_flow_accounting_sflow_server) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	r.ResourceName = req.ProviderTypeName + "_system_flow_accounting_sflow_server"
