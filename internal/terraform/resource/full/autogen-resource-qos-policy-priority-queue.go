...
var _ resource.Resource = &qos_policy_priority_queue{}

// var _ resource.ResourceWithImportState = &qos_policy_priority_queue{}

// qos_policy_priority_queue defines the resource implementation.
type qos_policy_priority_queue struct {
	ResourceName string
	client       *client.Client
}

func (r *qos_policy_priority_queue) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
// qos_policy_priority_queueModel describes the resource data model.
type qos_policy_priority_queueModel struct {
...
func (m qos_policy_priority_queueModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
...
func (r qos_policy_priority_queue) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	r.ResourceName = req.ProviderTypeName + "_qos_policy_priority_queue"
	resp.TypeName = r.ResourceName
}

// qos_policy_priority_queueResource method to return the example resource reference
func qos_policy_priority_queueResource() resource.Resource {
	return &qos_policy_priority_queue{}
}

// Schema method to define the schema for any resource configuration, plan, and state data.
func (r qos_policy_priority_queue) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r qos_policy_priority_queue) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r qos_policy_priority_queue) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *qos_policy_priority_queueModel
...
func (r qos_policy_priority_queue) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *qos_policy_priority_queueModel
...
func (r qos_policy_priority_queue) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *qos_policy_priority_queueModel
