...
func (r *protocols_ospf_neighbor) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m protocols_ospf_neighborModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
