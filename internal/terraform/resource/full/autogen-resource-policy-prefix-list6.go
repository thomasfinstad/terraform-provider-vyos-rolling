...
func (r *policy_prefix_listsix) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m policy_prefix_listsixModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
...
func (r policy_prefix_listsix) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	r.ResourceName = req.ProviderTypeName + "_policy_prefix_list6"
