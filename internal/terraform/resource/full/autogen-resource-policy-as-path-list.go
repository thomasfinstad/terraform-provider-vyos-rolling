...
func (r *policy_as_path_list) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m policy_as_path_listModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
