...
func (r *protocols_ospf_interface) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m protocols_ospf_interfaceModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
	...
	values = map[string]attr.Value{
		...
		// LeafNodes
		"area":                m.Area,
		"dead_interval":       m.Dead_interval,
		"hello_interval":      m.Hello_interval,
		"retransmit_interval": m.Retransmit_interval,
		"transmit_delay":      m.Transmit_delay,
		"cost":                m.Cost,
		"mtu_ignore":          m.Mtu_ignore,
		"priority":            m.Priority,
