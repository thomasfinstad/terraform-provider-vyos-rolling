...
func (r *service_webproxy_listen_address) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m service_webproxy_listen_addressModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
	...
	values = map[string]attr.Value{
		...
		// LeafNodes
		"port":                m.Port,
		"disable_transparent": m.Disable_transparent,
