...
func (r *protocols_static_multicast_route) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m protocols_static_multicast_routeModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
