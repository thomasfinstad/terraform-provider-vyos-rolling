...
func (r *service_webproxy_cache_peer) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m service_webproxy_cache_peerModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
...
func (r service_webproxy_cache_peer) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	r.ResourceName = req.ProviderTypeName + "_service_webproxy_cache_peer"
