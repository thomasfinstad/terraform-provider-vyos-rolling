...
var _ resource.Resource = &protocols_babel_interface{}

// var _ resource.ResourceWithImportState = &protocols_babel_interface{}

// protocols_babel_interface defines the resource implementation.
type protocols_babel_interface struct {
	client *http.Client
}

// protocols babel interfaceModel describes the resource data model.
type protocols_babel_interfaceModel struct {
	...
	Update_interval types.String `tfsdk:update_interval`

	Rxcost types.String `tfsdk:rxcost`

	Rtt_decay types.String `tfsdk:rtt_decay`

	Rtt_min types.String `tfsdk:rtt_min`

	Rtt_max types.String `tfsdk:rtt_max`
...
func (r *protocols_babel_interface) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_protocols babel interface"
}

// protocols_babel_interfaceResource method to return the example resource reference
func protocols_babel_interfaceResource() resource.Resource {
	return &protocols_babel_interface{}
}

// Schema method to define the schema for any resource configuration, plan, and state data.
func (r *protocols_babel_interface) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *protocols_babel_interface) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *protocols_babel_interfaceModel
...
func (r *protocols_babel_interface) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *protocols_babel_interfaceModel
...
func (r *protocols_babel_interface) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *protocols_babel_interfaceModel
...
func (r *protocols_babel_interface) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *protocols_babel_interfaceModel
