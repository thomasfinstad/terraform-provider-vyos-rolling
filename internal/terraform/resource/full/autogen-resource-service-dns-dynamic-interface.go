...
func (r *service_dns_dynamic_interface) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
type service_dns_dynamic_interfaceModel struct {
	...
	// LeafNodes
	Ipvsix_enable types.String `tfsdk:"ipv6_enable"`

	// TagNodes
	Rfctwoonethreesix types.Map `tfsdk:"rfc2136"`
	Service           types.Map `tfsdk:"service"`

	// Nodes
	Use_web types.List `tfsdk:"use_web"`
}

func (m service_dns_dynamic_interfaceModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
	...
	values = map[string]attr.Value{
		...
		// LeafNodes
		"ipv6_enable": m.Ipvsix_enable,

		// TagNodes
		"rfc2136": m.Rfctwoonethreesix,
		"service": m.Service,
...
func (r service_dns_dynamic_interface) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	r.ResourceName = req.ProviderTypeName + "_service_dns_dynamic_interface"
