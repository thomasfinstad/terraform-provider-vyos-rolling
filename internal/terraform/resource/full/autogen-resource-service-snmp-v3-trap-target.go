...
func (r *service_snmp_vthree_trap_target) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m service_snmp_vthree_trap_targetModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
