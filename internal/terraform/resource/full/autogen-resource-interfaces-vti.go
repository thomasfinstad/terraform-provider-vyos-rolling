...
func (r *interfaces_vti) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
// interfaces_vtiModel describes the resource data model.
...
func (m interfaces_vtiModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
...
func (r interfaces_vti) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	r.ResourceName = req.ProviderTypeName + "_interfaces_vti"
