...
func (r *firewall_interface) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m firewall_interfaceModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
