...
func (r *interfaces_bonding) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m interfaces_bondingModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
	...
	values = map[string]attr.Value{
		...
		"disable":             m.Disable,
		"vrf":                 m.Vrf,
		"hash_policy":         m.Hash_policy,
		"mac":                 m.Mac,
		"mii_mon_interval":    m.Mii_mon_interval,
		"min_links":           m.Min_links,
		"lacp_rate":           m.Lacp_rate,
		"mode":                m.Mode,
		"mtu":                 m.Mtu,
		"primary":             m.Primary,
		"redirect":            m.Redirect,
