...
func (r *service_snmp_script_extensions_extension_name) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m service_snmp_script_extensions_extension_nameModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
