...
// interfaces pseudo-ethernetModel describes the resource data model.
...
func (r *interfaces_pseudo_ethernet) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_interfaces pseudo-ethernet"
}
...
Format: private
No communication with other pseudo-devices
Format: vepa
Virtual Ethernet Port Aggregator reflective relay
Format: bridge
Simple bridge between pseudo-devices
Format: passthru
Promicious mode passthrough of underlying device
`,
				// DeprecationMessage:  "",
				// TODO Recreate some of vyos validators for use in leafnodes
				// Validators:          []validator.String(nil),
