...
func (r *protocols_ospf_access_list) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (m protocols_ospf_access_listModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
