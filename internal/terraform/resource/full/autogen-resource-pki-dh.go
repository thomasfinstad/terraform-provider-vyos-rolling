...
func (r *pki_dh) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
// pki_dhModel describes the resource data model.
...
func (m pki_dhModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
