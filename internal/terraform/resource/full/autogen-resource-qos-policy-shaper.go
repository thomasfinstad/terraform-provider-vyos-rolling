...
var _ resource.Resource = &qos_policy_shaper{}

// var _ resource.ResourceWithImportState = &qos_policy_shaper{}

// qos_policy_shaper defines the resource implementation.
type qos_policy_shaper struct {
	ResourceName string
	client       *client.Client
}

func (r *qos_policy_shaper) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
// qos_policy_shaperModel describes the resource data model.
type qos_policy_shaperModel struct {
...
func (m qos_policy_shaperModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
...
func (r qos_policy_shaper) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	r.ResourceName = req.ProviderTypeName + "_qos_policy_shaper"
	resp.TypeName = r.ResourceName
}

// qos_policy_shaperResource method to return the example resource reference
func qos_policy_shaperResource() resource.Resource {
	return &qos_policy_shaper{}
}

// Schema method to define the schema for any resource configuration, plan, and state data.
func (r qos_policy_shaper) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r qos_policy_shaper) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r qos_policy_shaper) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *qos_policy_shaperModel
...
func (r qos_policy_shaper) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *qos_policy_shaperModel
...
func (r qos_policy_shaper) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *qos_policy_shaperModel
