...
func (r *system_sflow_server) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
// system_sflow_serverModel describes the resource data model.
...
func (m system_sflow_serverModel) GetValues() (vyosPath []string, values map[string]attr.Value) {
