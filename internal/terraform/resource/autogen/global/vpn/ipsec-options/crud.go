...
func (r *vpnIPsecOptions) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *vpnIPsecOptions) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *vpnIPsecOptions) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *vpnIPsecOptions) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
