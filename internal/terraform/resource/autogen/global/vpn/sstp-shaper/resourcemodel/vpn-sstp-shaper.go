...
var _ helpers.VyosTopResourceDataModel = &VpnSstpShaper{}

// VpnSstpShaper describes the resource data model.
// This is a basenode!
...
type VpnSstpShaper struct {
	...
	// LeafNodes
	LeafVpnSstpShaperFwmark types.Number `tfsdk:"fwmark" vyos:"fwmark,omitempty"`
...
func (o *VpnSstpShaper) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *VpnSstpShaper) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *VpnSstpShaper) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *VpnSstpShaper) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"shaper",
	)
...
func (o *VpnSstpShaper) GetVyosParentPath() []string {
	return []string{
...
func (o *VpnSstpShaper) GetVyosNamedParentPath() []string {
	return []string{
...
func (o VpnSstpShaper) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
