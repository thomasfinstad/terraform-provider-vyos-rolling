...
type VpnPptpRemoteAccessAuthentication struct {
	...
	// Ignoring Node `VpnPptpRemoteAccessAuthenticationLocalUsers`.
...
`,
		...
		"protocols":
		/* tools/generate-terraform-resource-full/templates/resources/common/resource-model-schema-attrtype.gotmpl #resource-model-schema-attrtype-multi (protocols) */
