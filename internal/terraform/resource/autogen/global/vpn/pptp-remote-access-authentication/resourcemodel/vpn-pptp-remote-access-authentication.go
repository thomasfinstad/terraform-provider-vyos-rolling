...
var _ helpers.VyosTopResourceDataModel = &VpnPptpRemoteAccessAuthentication{}
...
type VpnPptpRemoteAccessAuthentication struct {
	...
	LeafVpnPptpRemoteAccessAuthenticationProtocols types.List   `tfsdk:"protocols" vyos:"protocols,omitempty"`

	// TagNodes

	// Nodes

	NodeVpnPptpRemoteAccessAuthenticationLocalUsers *VpnPptpRemoteAccessAuthenticationLocalUsers `tfsdk:"local_users" vyos:"local-users,omitempty"`
...
func (o *VpnPptpRemoteAccessAuthentication) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *VpnPptpRemoteAccessAuthentication) IsGlobalResource() bool {
	return (true)
}
...
func (o *VpnPptpRemoteAccessAuthentication) GetVyosParentPath() []string {
	return []string{
...
func (o *VpnPptpRemoteAccessAuthentication) GetVyosNamedParentPath() []string {
	return []string{
...
func (o VpnPptpRemoteAccessAuthentication) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
...
`,
		...
		"local_users": schema.SingleNestedAttribute{
			Attributes: VpnPptpRemoteAccessAuthenticationLocalUsers{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
