...
var _ helpers.VyosTopResourceDataModel = &VpnSstpAuthentication{}
...
func (o *VpnSstpAuthentication) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *VpnSstpAuthentication) IsGlobalResource() bool {
	return (true)
}
...
func (o *VpnSstpAuthentication) GetVyosParentPath() []string {
	return []string{
...
func (o *VpnSstpAuthentication) GetVyosNamedParentPath() []string {
	return []string{
...
func (o VpnSstpAuthentication) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
