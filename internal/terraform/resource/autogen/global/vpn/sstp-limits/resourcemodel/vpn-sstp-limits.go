...
var _ helpers.VyosTopResourceDataModel = &VpnSstpLimits{}

// VpnSstpLimits describes the resource data model.
// This is a basenode!
...
type VpnSstpLimits struct {
	...
	// LeafNodes
	LeafVpnSstpLimitsConnectionLimit types.String `tfsdk:"connection_limit" vyos:"connection-limit,omitempty"`
	LeafVpnSstpLimitsBurst           types.String `tfsdk:"burst" vyos:"burst,omitempty"`
	LeafVpnSstpLimitsTimeout         types.String `tfsdk:"timeout" vyos:"timeout,omitempty"`
...
func (o *VpnSstpLimits) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *VpnSstpLimits) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *VpnSstpLimits) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *VpnSstpLimits) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"limits",
	)
...
func (o *VpnSstpLimits) GetVyosParentPath() []string {
	return []string{
...
func (o *VpnSstpLimits) GetVyosNamedParentPath() []string {
	return []string{
...
func (o VpnSstpLimits) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
