...
type VpnPptpRemoteAccessLimits struct {
	...
	// LeafNodes
	LeafVpnPptpRemoteAccessLimitsConnectionLimit types.String `tfsdk:"connection_limit" vyos:"connection-limit,omitempty"`
...
func (o *VpnPptpRemoteAccessLimits) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *VpnPptpRemoteAccessLimits) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *VpnPptpRemoteAccessLimits) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *VpnPptpRemoteAccessLimits) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"limits",
	)
...
func (o VpnPptpRemoteAccessLimits) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
