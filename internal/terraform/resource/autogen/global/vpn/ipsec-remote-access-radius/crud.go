...
func (r *vpnIPsecRemoteAccessRadius) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *vpnIPsecRemoteAccessRadius) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *vpnIPsecRemoteAccessRadius) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *vpnIPsecRemoteAccessRadius) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
