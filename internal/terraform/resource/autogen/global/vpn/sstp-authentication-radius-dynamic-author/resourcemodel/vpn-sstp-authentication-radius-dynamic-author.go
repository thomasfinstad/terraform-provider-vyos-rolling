...
var _ helpers.VyosTopResourceDataModel = &VpnSstpAuthenticationRadiusDynamicAuthor{}
...
type VpnSstpAuthenticationRadiusDynamicAuthor struct {
	...
	LeafVpnSstpAuthenticationRadiusDynamicAuthorPort   types.Number `tfsdk:"port" vyos:"port,omitempty"`
	LeafVpnSstpAuthenticationRadiusDynamicAuthorKey    types.String `tfsdk:"key" vyos:"key,omitempty"`
...
func (o *VpnSstpAuthenticationRadiusDynamicAuthor) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *VpnSstpAuthenticationRadiusDynamicAuthor) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *VpnSstpAuthenticationRadiusDynamicAuthor) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *VpnSstpAuthenticationRadiusDynamicAuthor) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"dynamic-author",
	)
...
func (o *VpnSstpAuthenticationRadiusDynamicAuthor) GetVyosParentPath() []string {
	return []string{
...
func (o *VpnSstpAuthenticationRadiusDynamicAuthor) GetVyosNamedParentPath() []string {
	return []string{
...
func (o VpnSstpAuthenticationRadiusDynamicAuthor) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
