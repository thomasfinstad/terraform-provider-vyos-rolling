...
func (r *vpnSstpAuthenticationRadiusDynamicAuthor) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *vpnSstpAuthenticationRadiusDynamicAuthor) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *vpnSstpAuthenticationRadiusDynamicAuthor) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *vpnSstpAuthenticationRadiusDynamicAuthor) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
