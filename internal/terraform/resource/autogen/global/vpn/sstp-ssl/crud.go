...
func (r *vpnSstpSsl) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *vpnSstpSsl) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *vpnSstpSsl) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *vpnSstpSsl) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
