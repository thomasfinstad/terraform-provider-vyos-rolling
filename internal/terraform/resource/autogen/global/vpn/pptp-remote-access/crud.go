...
func (r *vpnPptpRemoteAccess) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *vpnPptpRemoteAccess) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *vpnPptpRemoteAccess) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *vpnPptpRemoteAccess) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
