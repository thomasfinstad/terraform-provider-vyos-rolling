...
func (r *vpnPptpRemoteAccessAuthenticationRateLimit) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *vpnPptpRemoteAccessAuthenticationRateLimit) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *vpnPptpRemoteAccessAuthenticationRateLimit) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *vpnPptpRemoteAccessAuthenticationRateLimit) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
