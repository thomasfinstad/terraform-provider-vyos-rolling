...
/* tools/generate-terraform-resource-full/templates/resources/common/schema.gotmpl #schema (extended-scripts) */
// Schema method to define the schema for any resource configuration, plan, and state data.
func (r vpnPptpRemoteAccessExtendedScrIPts) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
