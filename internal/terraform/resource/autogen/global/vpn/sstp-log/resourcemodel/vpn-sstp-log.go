...
var _ helpers.VyosTopResourceDataModel = &VpnSstpLog{}

// VpnSstpLog describes the resource data model.
// This is a basenode!
...
type VpnSstpLog struct {
	...
	// LeafNodes
	LeafVpnSstpLogLevel types.String `tfsdk:"level" vyos:"level,omitempty"`
...
func (o *VpnSstpLog) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *VpnSstpLog) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *VpnSstpLog) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *VpnSstpLog) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"log",
	)
...
func (o *VpnSstpLog) GetVyosParentPath() []string {
	return []string{
...
func (o *VpnSstpLog) GetVyosNamedParentPath() []string {
	return []string{
...
func (o VpnSstpLog) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
