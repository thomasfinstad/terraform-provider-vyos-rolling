...
var _ helpers.VyosTopResourceDataModel = &VpnOpenconnectAuthentication{}
...
func (o *VpnOpenconnectAuthentication) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *VpnOpenconnectAuthentication) IsGlobalResource() bool {
	return (true)
}
...
func (o *VpnOpenconnectAuthentication) GetVyosParentPath() []string {
	return []string{
...
func (o *VpnOpenconnectAuthentication) GetVyosNamedParentPath() []string {
	return []string{
...
func (o VpnOpenconnectAuthentication) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
...
`,
			Description: `Group that a client is allowed to select (from a list). Maps to RADIUS Class attribute.
