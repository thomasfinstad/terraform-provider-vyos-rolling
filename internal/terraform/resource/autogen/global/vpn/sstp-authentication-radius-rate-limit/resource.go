...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/global/vpn/sstp-authentication-radius-rate-limit/resourcemodel"
)
...
func (r *vpnSstpAuthenticationRadiusRateLimit) GetModel() helpers.VyosTopResourceDataModel {
	return r.model
}

// GetProviderConfig returns global provider data config
func (r *vpnSstpAuthenticationRadiusRateLimit) GetProviderConfig() data.ProviderData {
...
func (r *vpnSstpAuthenticationRadiusRateLimit) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
