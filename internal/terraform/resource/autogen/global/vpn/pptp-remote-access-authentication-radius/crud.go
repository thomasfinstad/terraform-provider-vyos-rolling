...
func (r *vpnPptpRemoteAccessAuthenticationRadius) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *vpnPptpRemoteAccessAuthenticationRadius) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *vpnPptpRemoteAccessAuthenticationRadius) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *vpnPptpRemoteAccessAuthenticationRadius) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
