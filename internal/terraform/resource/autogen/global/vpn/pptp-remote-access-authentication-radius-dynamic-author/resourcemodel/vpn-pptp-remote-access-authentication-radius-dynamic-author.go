...
/* tools/generate-terraform-resource-full/templates/resources/common/resource-model.gotmpl #resource-model (dynamic-author) */
// Validate compliance

var _ helpers.VyosTopResourceDataModel = &VpnPptpRemoteAccessAuthenticationRadiusDynamicAuthor{}

// VpnPptpRemoteAccessAuthenticationRadiusDynamicAuthor describes the resource data model.
// This is a basenode!
...
type VpnPptpRemoteAccessAuthenticationRadiusDynamicAuthor struct {
	...
	// LeafNodes
	LeafVpnPptpRemoteAccessAuthenticationRadiusDynamicAuthorServer types.String `tfsdk:"server" vyos:"server,omitempty"`
	LeafVpnPptpRemoteAccessAuthenticationRadiusDynamicAuthorPort   types.Number `tfsdk:"port" vyos:"port,omitempty"`
	LeafVpnPptpRemoteAccessAuthenticationRadiusDynamicAuthorKey    types.String `tfsdk:"key" vyos:"key,omitempty"`
...
func (o *VpnPptpRemoteAccessAuthenticationRadiusDynamicAuthor) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *VpnPptpRemoteAccessAuthenticationRadiusDynamicAuthor) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *VpnPptpRemoteAccessAuthenticationRadiusDynamicAuthor) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *VpnPptpRemoteAccessAuthenticationRadiusDynamicAuthor) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"dynamic-author",
	)
...
func (o *VpnPptpRemoteAccessAuthenticationRadiusDynamicAuthor) GetVyosParentPath() []string {
	return []string{
...
func (o *VpnPptpRemoteAccessAuthenticationRadiusDynamicAuthor) GetVyosNamedParentPath() []string {
	return []string{
...
func (o VpnPptpRemoteAccessAuthenticationRadiusDynamicAuthor) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
