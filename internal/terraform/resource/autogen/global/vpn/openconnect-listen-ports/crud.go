// Package globalvpnopenconnectlistenports code generated by /workspaces/terraform-provider-vyos/tools/build-terraform-resource-full/main.go. DO NOT EDIT.
...
func (r *vpnOpenconnectListenPorts) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *vpnOpenconnectListenPorts) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *vpnOpenconnectListenPorts) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *vpnOpenconnectListenPorts) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
