...
// Validate compliance
var _ helpers.VyosTopResourceDataModel = &LoadBalancingReverseProxyGlobalParameters{}

// LoadBalancingReverseProxyGlobalParameters describes the resource data model.
type LoadBalancingReverseProxyGlobalParameters struct {
	...
	// LeafNodes
	LeafLoadBalancingReverseProxyGlobalParametersMaxConnections types.Number `tfsdk:"max_connections" vyos:"max-connections,omitempty"`
	LeafLoadBalancingReverseProxyGlobalParametersSslBindCIPhers types.List   `tfsdk:"ssl_bind_ciphers" vyos:"ssl-bind-ciphers,omitempty"`
	LeafLoadBalancingReverseProxyGlobalParametersTLSVersionMin  types.String `tfsdk:"tls_version_min" vyos:"tls-version-min,omitempty"`

	// TagNodes (Bools that show if child resources have been configured)

	// Nodes (Bools that show if child resources have been configured)
	ExistsNodeLoadBalancingReverseProxyGlobalParametersLogging bool `tfsdk:"-" vyos:"logging,child"`
}

// SetID configures the resource ID
func (o *LoadBalancingReverseProxyGlobalParameters) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *LoadBalancingReverseProxyGlobalParameters) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *LoadBalancingReverseProxyGlobalParameters) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *LoadBalancingReverseProxyGlobalParameters) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"global-parameters",
	)
...
func (o *LoadBalancingReverseProxyGlobalParameters) GetVyosParentPath() []string {
	return []string{
		"load-balancing",
...
func (o *LoadBalancingReverseProxyGlobalParameters) GetVyosNamedParentPath() []string {
	return []string{}
}

// ResourceSchemaAttributes generates the schema attributes for the resource at this level
func (o LoadBalancingReverseProxyGlobalParameters) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
