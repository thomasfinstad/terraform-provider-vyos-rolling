...
func (r *firewallStatePolicyInvalID) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *firewallStatePolicyInvalID) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *firewallStatePolicyInvalID) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *firewallStatePolicyInvalID) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
