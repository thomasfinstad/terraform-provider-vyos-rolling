...
func (r *firewallStatePolicyEstablished) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *firewallStatePolicyEstablished) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *firewallStatePolicyEstablished) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *firewallStatePolicyEstablished) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
