...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/global/firewall/global-options-state-policy-related/resourcemodel"
)

/* tools/generate-terraform-resource-full/templates/resources/global/resource-node-based-full.gotmpl #resource-node-based-full (related) */
...
func (r *firewallGlobalOptionsStatePolicyRelated) GetProviderConfig() data.ProviderData {
...
func (r *firewallGlobalOptionsStatePolicyRelated) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
