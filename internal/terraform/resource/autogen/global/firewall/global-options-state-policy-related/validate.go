...
/* tools/generate-terraform-resource-full/templates/resources/common/validate.gotmpl #validate (related) */
...
var (
	...
	_ resource.ResourceWithImportState = &firewallGlobalOptionsStatePolicyRelated{}
)
