...
var _ helpers.VyosTopResourceDataModel = &FirewallIPvsixPreroutingRaw{}

// FirewallIPvsixPreroutingRaw describes the resource data model.
// This is a basenode!
...
type FirewallIPvsixPreroutingRaw struct {
	...
	// LeafNodes
	LeafFirewallIPvsixPreroutingRawDefaultAction     types.String `tfsdk:"default_action" vyos:"default-action,omitempty"`
	LeafFirewallIPvsixPreroutingRawDescrIPtion       types.String `tfsdk:"description" vyos:"description,omitempty"`
	LeafFirewallIPvsixPreroutingRawDefaultJumpTarget types.String `tfsdk:"default_jump_target" vyos:"default-jump-target,omitempty"`

	// TagNodes

	ExistsTagFirewallIPvsixPreroutingRawRule bool `tfsdk:"-" vyos:"rule,child"`

	// Nodes
}

// SetID configures the resource ID
func (o *FirewallIPvsixPreroutingRaw) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *FirewallIPvsixPreroutingRaw) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *FirewallIPvsixPreroutingRaw) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *FirewallIPvsixPreroutingRaw) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"raw",
	)
...
func (o *FirewallIPvsixPreroutingRaw) GetVyosParentPath() []string {
	return []string{
...
func (o *FirewallIPvsixPreroutingRaw) GetVyosNamedParentPath() []string {
	return []string{
...
func (o FirewallIPvsixPreroutingRaw) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
