...
var _ helpers.VyosTopResourceDataModel = &ProtocolsIsisRedistributeIPvsixOspfsixLevelTwo{}

// ProtocolsIsisRedistributeIPvsixOspfsixLevelTwo describes the resource data model.
// This is a basenode!
...
type ProtocolsIsisRedistributeIPvsixOspfsixLevelTwo struct {
	...
	// LeafNodes
	LeafProtocolsIsisRedistributeIPvsixOspfsixLevelTwoMetric   types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsIsisRedistributeIPvsixOspfsixLevelTwoRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsIsisRedistributeIPvsixOspfsixLevelTwo) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsIsisRedistributeIPvsixOspfsixLevelTwo) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsIsisRedistributeIPvsixOspfsixLevelTwo) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsIsisRedistributeIPvsixOspfsixLevelTwo) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"level-2",
	)
...
func (o *ProtocolsIsisRedistributeIPvsixOspfsixLevelTwo) GetVyosParentPath() []string {
	return []string{
		/* tools/generate-terraform-resource-full/templates/resources/common/resource-model-parent-vyos-path-hack.gotmpl #resource-model-parent-vyos-path-hack (ospf6) */
...
func (o *ProtocolsIsisRedistributeIPvsixOspfsixLevelTwo) GetVyosNamedParentPath() []string {
	return []string{
		/* tools/generate-terraform-resource-full/templates/resources/common/resource-model-parent-vyos-path-hack.gotmpl #resource-model-parent-vyos-path-hack-for-non-global (ospf6) */
...
func (o ProtocolsIsisRedistributeIPvsixOspfsixLevelTwo) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
