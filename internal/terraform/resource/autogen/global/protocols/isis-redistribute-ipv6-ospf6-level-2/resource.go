...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/global/protocols/isis-redistribute-ipv6-ospf6-level-2/resourcemodel"
)
...
func (r *protocolsIsisRedistributeIPvsixOspfsixLevelTwo) GetModel() helpers.VyosTopResourceDataModel {
	return r.model
}

// GetProviderConfig returns global provider data config
func (r *protocolsIsisRedistributeIPvsixOspfsixLevelTwo) GetProviderConfig() data.ProviderData {
...
func (r *protocolsIsisRedistributeIPvsixOspfsixLevelTwo) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
