...
var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpAddressFamilyIPvfourFlowspecLocalInstall{}
...
func (o *ProtocolsBgpAddressFamilyIPvfourFlowspecLocalInstall) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsBgpAddressFamilyIPvfourFlowspecLocalInstall) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpAddressFamilyIPvfourFlowspecLocalInstall) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsBgpAddressFamilyIPvfourFlowspecLocalInstall) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"local-install",
	)
...
func (o *ProtocolsBgpAddressFamilyIPvfourFlowspecLocalInstall) GetVyosParentPath() []string {
	return []string{
		/* tools/generate-terraform-resource-full/templates/resources/common/resource-model-parent-vyos-path-hack.gotmpl #resource-model-parent-vyos-path-hack (ipv4-flowspec) */
...
func (o *ProtocolsBgpAddressFamilyIPvfourFlowspecLocalInstall) GetVyosNamedParentPath() []string {
	return []string{
		/* tools/generate-terraform-resource-full/templates/resources/common/resource-model-parent-vyos-path-hack.gotmpl #resource-model-parent-vyos-path-hack-for-non-global (ipv4-flowspec) */
...
func (o ProtocolsBgpAddressFamilyIPvfourFlowspecLocalInstall) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
