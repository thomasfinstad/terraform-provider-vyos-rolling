...
/* tools/generate-terraform-resource-full/templates/resources/common/resource-model.gotmpl #resource-model (rp) */
// Validate compliance

var _ helpers.VyosTopResourceDataModel = &ProtocolsPimRp{}
...
func (o *ProtocolsPimRp) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsPimRp) IsGlobalResource() bool {
	return (true)
}
...
func (o *ProtocolsPimRp) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsPimRp) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsPimRp) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
