...
var _ helpers.VyosTopResourceDataModel = &ProtocolsIsisRedistributeIPvsixConnectedLevelTwo{}

// ProtocolsIsisRedistributeIPvsixConnectedLevelTwo describes the resource data model.
// This is a basenode!
...
type ProtocolsIsisRedistributeIPvsixConnectedLevelTwo struct {
	...
	// LeafNodes
	LeafProtocolsIsisRedistributeIPvsixConnectedLevelTwoMetric   types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsIsisRedistributeIPvsixConnectedLevelTwoRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsIsisRedistributeIPvsixConnectedLevelTwo) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsIsisRedistributeIPvsixConnectedLevelTwo) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsIsisRedistributeIPvsixConnectedLevelTwo) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsIsisRedistributeIPvsixConnectedLevelTwo) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"level-2",
	)
...
func (o *ProtocolsIsisRedistributeIPvsixConnectedLevelTwo) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsIsisRedistributeIPvsixConnectedLevelTwo) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsIsisRedistributeIPvsixConnectedLevelTwo) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
