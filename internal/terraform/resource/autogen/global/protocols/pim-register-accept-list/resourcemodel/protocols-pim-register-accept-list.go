...
/* tools/generate-terraform-resource-full/templates/resources/common/resource-model.gotmpl #resource-model (register-accept-list) */
// Validate compliance

var _ helpers.VyosTopResourceDataModel = &ProtocolsPimRegisterAcceptList{}

// ProtocolsPimRegisterAcceptList describes the resource data model.
// This is a basenode!
...
type ProtocolsPimRegisterAcceptList struct {
	...
	// LeafNodes
	LeafProtocolsPimRegisterAcceptListPrefixList types.String `tfsdk:"prefix_list" vyos:"prefix-list,omitempty"`
...
func (o *ProtocolsPimRegisterAcceptList) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsPimRegisterAcceptList) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsPimRegisterAcceptList) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsPimRegisterAcceptList) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
...
func (o *ProtocolsPimRegisterAcceptList) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsPimRegisterAcceptList) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsPimRegisterAcceptList) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
