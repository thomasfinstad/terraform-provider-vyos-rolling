...
var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpAddressFamilyIPvsixUnicastSIDVpn{}

// ProtocolsBgpAddressFamilyIPvsixUnicastSIDVpn describes the resource data model.
// This is a basenode!
...
type ProtocolsBgpAddressFamilyIPvsixUnicastSIDVpn struct {
	...
	// LeafNodes
	LeafProtocolsBgpAddressFamilyIPvsixUnicastSIDVpnExport types.String `tfsdk:"export" vyos:"export,omitempty"`
...
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastSIDVpn) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastSIDVpn) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastSIDVpn) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastSIDVpn) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"vpn",
	)
...
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastSIDVpn) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastSIDVpn) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsBgpAddressFamilyIPvsixUnicastSIDVpn) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
