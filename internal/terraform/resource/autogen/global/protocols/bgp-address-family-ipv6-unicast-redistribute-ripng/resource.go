...
func (r *protocolsBgpAddressFamilyIPvsixUnicastRedistributeRIPng) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
