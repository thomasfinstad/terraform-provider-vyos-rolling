...
func (r *protocolsBgpAddressFamilyIPvsixUnicastRedistributeRIPng) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsBgpAddressFamilyIPvsixUnicastRedistributeRIPng) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsBgpAddressFamilyIPvsixUnicastRedistributeRIPng) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsBgpAddressFamilyIPvsixUnicastRedistributeRIPng) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
