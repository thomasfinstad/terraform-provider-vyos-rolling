...
var _ helpers.VyosTopResourceDataModel = &ProtocolsRIPRedistributeBgp{}
...
func (o *ProtocolsRIPRedistributeBgp) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsRIPRedistributeBgp) IsGlobalResource() bool {
	return (true)
}
...
func (o *ProtocolsRIPRedistributeBgp) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsRIPRedistributeBgp) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsRIPRedistributeBgp) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
