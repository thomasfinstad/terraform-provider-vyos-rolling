...
var _ helpers.VyosTopResourceDataModel = &ProtocolsIsisRedistributeIPvfourBabelLevelOne{}

// ProtocolsIsisRedistributeIPvfourBabelLevelOne describes the resource data model.
// This is a basenode!
...
type ProtocolsIsisRedistributeIPvfourBabelLevelOne struct {
	...
	// LeafNodes
	LeafProtocolsIsisRedistributeIPvfourBabelLevelOneMetric   types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsIsisRedistributeIPvfourBabelLevelOneRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsIsisRedistributeIPvfourBabelLevelOne) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsIsisRedistributeIPvfourBabelLevelOne) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsIsisRedistributeIPvfourBabelLevelOne) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsIsisRedistributeIPvfourBabelLevelOne) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"level-1",
	)
...
func (o *ProtocolsIsisRedistributeIPvfourBabelLevelOne) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsIsisRedistributeIPvfourBabelLevelOne) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsIsisRedistributeIPvfourBabelLevelOne) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
