...
func (r *protocolsIsisRedistributeIPvfourKernelLevelOne) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsIsisRedistributeIPvfourKernelLevelOne) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsIsisRedistributeIPvfourKernelLevelOne) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsIsisRedistributeIPvfourKernelLevelOne) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
