...
var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpAddressFamilyIPvfourUnicastLabelVpn{}

// ProtocolsBgpAddressFamilyIPvfourUnicastLabelVpn describes the resource data model.
// This is a basenode!
// Top level basenode type: `Node`
type ProtocolsBgpAddressFamilyIPvfourUnicastLabelVpn struct {
	ID       types.String   `tfsdk:"id" vyos:"-,tfsdk-id"`
	Timeouts timeouts.Value `tfsdk:"timeouts" vyos:"-,timeout"`

	// LeafNodes
	LeafProtocolsBgpAddressFamilyIPvfourUnicastLabelVpnExport types.String `tfsdk:"export" vyos:"export,omitempty"`

	// TagNodes

	// Nodes

	ExistsNodeProtocolsBgpAddressFamilyIPvfourUnicastLabelVpnAllocationMode bool `tfsdk:"-" vyos:"allocation-mode,child"`
}

// SetID configures the resource ID
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastLabelVpn) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastLabelVpn) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastLabelVpn) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastLabelVpn) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"vpn",
	)
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastLabelVpn) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastLabelVpn) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsBgpAddressFamilyIPvfourUnicastLabelVpn) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
