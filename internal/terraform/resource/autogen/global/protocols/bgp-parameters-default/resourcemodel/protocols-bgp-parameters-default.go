...
var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpParametersDefault{}
...
func (o *ProtocolsBgpParametersDefault) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpParametersDefault) IsGlobalResource() bool {
	return (true)
}
...
func (o *ProtocolsBgpParametersDefault) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsBgpParametersDefault) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsBgpParametersDefault) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
