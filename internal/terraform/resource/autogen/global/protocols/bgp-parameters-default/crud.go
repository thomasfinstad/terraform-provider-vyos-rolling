...
func (r *protocolsBgpParametersDefault) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsBgpParametersDefault) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsBgpParametersDefault) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsBgpParametersDefault) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
