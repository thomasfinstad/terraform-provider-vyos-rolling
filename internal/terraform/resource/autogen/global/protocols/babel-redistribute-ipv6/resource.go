...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/global/protocols/babel-redistribute-ipv6/resourcemodel"
)
...
func (r *protocolsBabelRedistributeIPvsix) GetModel() helpers.VyosTopResourceDataModel {
	return r.model
}

// GetProviderConfig returns global provider data config
func (r *protocolsBabelRedistributeIPvsix) GetProviderConfig() data.ProviderData {
...
func (r *protocolsBabelRedistributeIPvsix) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
