...
var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpAddressFamilyIPvfourUnicastRedistributeConnected{}

// ProtocolsBgpAddressFamilyIPvfourUnicastRedistributeConnected describes the resource data model.
// This is a basenode!
...
type ProtocolsBgpAddressFamilyIPvfourUnicastRedistributeConnected struct {
	...
	// LeafNodes
	LeafProtocolsBgpAddressFamilyIPvfourUnicastRedistributeConnectedMetric   types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsBgpAddressFamilyIPvfourUnicastRedistributeConnectedRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRedistributeConnected) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRedistributeConnected) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRedistributeConnected) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRedistributeConnected) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"connected",
	)
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRedistributeConnected) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRedistributeConnected) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsBgpAddressFamilyIPvfourUnicastRedistributeConnected) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
