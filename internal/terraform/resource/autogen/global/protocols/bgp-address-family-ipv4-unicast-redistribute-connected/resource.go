...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/global/protocols/bgp-address-family-ipv4-unicast-redistribute-connected/resourcemodel"
)
...
func (r *protocolsBgpAddressFamilyIPvfourUnicastRedistributeConnected) GetModel() helpers.VyosTopResourceDataModel {
	return r.model
}

// GetProviderConfig returns global provider data config
func (r *protocolsBgpAddressFamilyIPvfourUnicastRedistributeConnected) GetProviderConfig() data.ProviderData {
...
func (r *protocolsBgpAddressFamilyIPvfourUnicastRedistributeConnected) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
