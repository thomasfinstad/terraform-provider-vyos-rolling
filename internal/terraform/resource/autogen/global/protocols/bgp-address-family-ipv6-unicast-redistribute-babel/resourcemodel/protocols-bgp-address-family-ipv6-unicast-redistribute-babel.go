...
var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpAddressFamilyIPvsixUnicastRedistributeBabel{}

// ProtocolsBgpAddressFamilyIPvsixUnicastRedistributeBabel describes the resource data model.
// This is a basenode!
...
type ProtocolsBgpAddressFamilyIPvsixUnicastRedistributeBabel struct {
	...
	// LeafNodes
	LeafProtocolsBgpAddressFamilyIPvsixUnicastRedistributeBabelMetric   types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsBgpAddressFamilyIPvsixUnicastRedistributeBabelRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastRedistributeBabel) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastRedistributeBabel) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastRedistributeBabel) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastRedistributeBabel) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"babel",
	)
...
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastRedistributeBabel) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastRedistributeBabel) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsBgpAddressFamilyIPvsixUnicastRedistributeBabel) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
