...
var _ helpers.VyosTopResourceDataModel = &ProtocolsOspfvthreeRedistributeIsis{}

// ProtocolsOspfvthreeRedistributeIsis describes the resource data model.
// This is a basenode!
...
type ProtocolsOspfvthreeRedistributeIsis struct {
	...
	// LeafNodes
	LeafProtocolsOspfvthreeRedistributeIsisMetric     types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsOspfvthreeRedistributeIsisMetricType types.Number `tfsdk:"metric_type" vyos:"metric-type,omitempty"`
	LeafProtocolsOspfvthreeRedistributeIsisRouteMap   types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsOspfvthreeRedistributeIsis) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsOspfvthreeRedistributeIsis) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsOspfvthreeRedistributeIsis) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsOspfvthreeRedistributeIsis) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"isis",
	)
...
func (o *ProtocolsOspfvthreeRedistributeIsis) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsOspfvthreeRedistributeIsis) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsOspfvthreeRedistributeIsis) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
