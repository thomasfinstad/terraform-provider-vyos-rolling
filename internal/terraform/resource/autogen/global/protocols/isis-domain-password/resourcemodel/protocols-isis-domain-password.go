...
var _ helpers.VyosTopResourceDataModel = &ProtocolsIsisDomainPassword{}
...
func (o *ProtocolsIsisDomainPassword) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsIsisDomainPassword) IsGlobalResource() bool {
	return (true)
}
...
func (o *ProtocolsIsisDomainPassword) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsIsisDomainPassword) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsIsisDomainPassword) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
