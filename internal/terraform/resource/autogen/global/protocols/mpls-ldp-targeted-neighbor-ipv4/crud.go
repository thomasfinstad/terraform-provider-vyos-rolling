...
func (r *protocolsMplsLdpTargetedNeighborIPvfour) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsMplsLdpTargetedNeighborIPvfour) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsMplsLdpTargetedNeighborIPvfour) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsMplsLdpTargetedNeighborIPvfour) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
