...
var _ helpers.VyosTopResourceDataModel = &ProtocolsIsisSegmentRoutingGlobalBlock{}
...
func (o *ProtocolsIsisSegmentRoutingGlobalBlock) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsIsisSegmentRoutingGlobalBlock) IsGlobalResource() bool {
	return (true)
}
...
func (o *ProtocolsIsisSegmentRoutingGlobalBlock) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsIsisSegmentRoutingGlobalBlock) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsIsisSegmentRoutingGlobalBlock) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
