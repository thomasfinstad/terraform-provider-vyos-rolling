...
var _ helpers.VyosTopResourceDataModel = &ProtocolsOspfvthreeRedistributeConnected{}

// ProtocolsOspfvthreeRedistributeConnected describes the resource data model.
// This is a basenode!
// Top level basenode type: `Node`
type ProtocolsOspfvthreeRedistributeConnected struct {
	ID       types.String   `tfsdk:"id" vyos:"-,tfsdk-id"`
	Timeouts timeouts.Value `tfsdk:"timeouts" vyos:"-,timeout"`

	// LeafNodes
	LeafProtocolsOspfvthreeRedistributeConnectedMetric     types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsOspfvthreeRedistributeConnectedMetricType types.Number `tfsdk:"metric_type" vyos:"metric-type,omitempty"`
	LeafProtocolsOspfvthreeRedistributeConnectedRouteMap   types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsOspfvthreeRedistributeConnected) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsOspfvthreeRedistributeConnected) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsOspfvthreeRedistributeConnected) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsOspfvthreeRedistributeConnected) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"connected",
	)
...
func (o *ProtocolsOspfvthreeRedistributeConnected) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsOspfvthreeRedistributeConnected) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsOspfvthreeRedistributeConnected) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
