...
var _ helpers.VyosTopResourceDataModel = &ProtocolsIsisRedistributeIPvsixBabelLevelTwo{}

// ProtocolsIsisRedistributeIPvsixBabelLevelTwo describes the resource data model.
// This is a basenode!
...
type ProtocolsIsisRedistributeIPvsixBabelLevelTwo struct {
	...
	// LeafNodes
	LeafProtocolsIsisRedistributeIPvsixBabelLevelTwoMetric   types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsIsisRedistributeIPvsixBabelLevelTwoRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsIsisRedistributeIPvsixBabelLevelTwo) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsIsisRedistributeIPvsixBabelLevelTwo) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsIsisRedistributeIPvsixBabelLevelTwo) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsIsisRedistributeIPvsixBabelLevelTwo) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"level-2",
	)
...
func (o *ProtocolsIsisRedistributeIPvsixBabelLevelTwo) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsIsisRedistributeIPvsixBabelLevelTwo) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsIsisRedistributeIPvsixBabelLevelTwo) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
