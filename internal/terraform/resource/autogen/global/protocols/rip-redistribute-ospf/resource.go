...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/global/protocols/rip-redistribute-ospf/resourcemodel"
)
...
func (r *protocolsRIPRedistributeOspf) GetModel() helpers.VyosTopResourceDataModel {
	return r.model
}

// GetProviderConfig returns global provider data config
func (r *protocolsRIPRedistributeOspf) GetProviderConfig() data.ProviderData {
...
func (r *protocolsRIPRedistributeOspf) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
