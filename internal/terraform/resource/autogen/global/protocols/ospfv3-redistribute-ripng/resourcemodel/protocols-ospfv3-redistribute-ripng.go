...
var _ helpers.VyosTopResourceDataModel = &ProtocolsOspfvthreeRedistributeRIPng{}

// ProtocolsOspfvthreeRedistributeRIPng describes the resource data model.
// This is a basenode!
...
type ProtocolsOspfvthreeRedistributeRIPng struct {
	...
	// LeafNodes
	LeafProtocolsOspfvthreeRedistributeRIPngMetric     types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsOspfvthreeRedistributeRIPngMetricType types.Number `tfsdk:"metric_type" vyos:"metric-type,omitempty"`
	LeafProtocolsOspfvthreeRedistributeRIPngRouteMap   types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsOspfvthreeRedistributeRIPng) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsOspfvthreeRedistributeRIPng) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsOspfvthreeRedistributeRIPng) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsOspfvthreeRedistributeRIPng) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"ripng",
	)
...
func (o *ProtocolsOspfvthreeRedistributeRIPng) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsOspfvthreeRedistributeRIPng) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsOspfvthreeRedistributeRIPng) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
