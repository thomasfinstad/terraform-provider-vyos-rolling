...
var _ helpers.VyosTopResourceDataModel = &ProtocolsRIPRedistributeStatic{}

// ProtocolsRIPRedistributeStatic describes the resource data model.
// This is a basenode!
...
type ProtocolsRIPRedistributeStatic struct {
	...
	// LeafNodes
	LeafProtocolsRIPRedistributeStaticMetric   types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsRIPRedistributeStaticRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsRIPRedistributeStatic) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsRIPRedistributeStatic) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsRIPRedistributeStatic) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsRIPRedistributeStatic) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"static",
	)
...
func (o *ProtocolsRIPRedistributeStatic) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsRIPRedistributeStatic) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsRIPRedistributeStatic) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
