...
func (r *protocolsRIPRedistributeConnected) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsRIPRedistributeConnected) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsRIPRedistributeConnected) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsRIPRedistributeConnected) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
