...
func (r *protocolsBgpAddressFamilyIPvsixFlowspecLocalInstall) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsBgpAddressFamilyIPvsixFlowspecLocalInstall) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsBgpAddressFamilyIPvsixFlowspecLocalInstall) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsBgpAddressFamilyIPvsixFlowspecLocalInstall) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
