...
func (r *protocolsBgpAddressFamilyIPvsixFlowspecLocalInstall) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
