...
var _ helpers.VyosTopResourceDataModel = &ProtocolsIsisRedistributeIPvsixKernelLevelOne{}

// ProtocolsIsisRedistributeIPvsixKernelLevelOne describes the resource data model.
// This is a basenode!
...
type ProtocolsIsisRedistributeIPvsixKernelLevelOne struct {
	...
	// LeafNodes
	LeafProtocolsIsisRedistributeIPvsixKernelLevelOneMetric   types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsIsisRedistributeIPvsixKernelLevelOneRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsIsisRedistributeIPvsixKernelLevelOne) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsIsisRedistributeIPvsixKernelLevelOne) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsIsisRedistributeIPvsixKernelLevelOne) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsIsisRedistributeIPvsixKernelLevelOne) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"level-1",
	)
...
func (o *ProtocolsIsisRedistributeIPvsixKernelLevelOne) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsIsisRedistributeIPvsixKernelLevelOne) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsIsisRedistributeIPvsixKernelLevelOne) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
