...
var _ helpers.VyosTopResourceDataModel = &ProtocolsRIPRedistributeBabel{}
...
type ProtocolsRIPRedistributeBabel struct {
	...
	LeafProtocolsRIPRedistributeBabelRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsRIPRedistributeBabel) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsRIPRedistributeBabel) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsRIPRedistributeBabel) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsRIPRedistributeBabel) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"babel",
	)
...
func (o *ProtocolsRIPRedistributeBabel) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsRIPRedistributeBabel) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsRIPRedistributeBabel) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
