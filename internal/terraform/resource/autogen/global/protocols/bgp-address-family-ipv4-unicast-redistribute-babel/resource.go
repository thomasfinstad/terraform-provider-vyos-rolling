...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/global/protocols/bgp-address-family-ipv4-unicast-redistribute-babel/resourcemodel"
)
...
func (r *protocolsBgpAddressFamilyIPvfourUnicastRedistributeBabel) GetModel() helpers.VyosTopResourceDataModel {
	return r.model
}

// GetProviderConfig returns global provider data config
func (r *protocolsBgpAddressFamilyIPvfourUnicastRedistributeBabel) GetProviderConfig() data.ProviderData {
...
func (r *protocolsBgpAddressFamilyIPvfourUnicastRedistributeBabel) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
