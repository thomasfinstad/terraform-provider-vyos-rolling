...
/* tools/generate-terraform-resource-full/templates/resources/common/resource-model.gotmpl #resource-model (global-block) */
// Validate compliance

var _ helpers.VyosTopResourceDataModel = &ProtocolsOspfSegmentRoutingGlobalBlock{}
...
type ProtocolsOspfSegmentRoutingGlobalBlock struct {
	...
	LeafProtocolsOspfSegmentRoutingGlobalBlockHighLabelValue types.Number `tfsdk:"high_label_value" vyos:"high-label-value,omitempty"`
...
func (o *ProtocolsOspfSegmentRoutingGlobalBlock) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsOspfSegmentRoutingGlobalBlock) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsOspfSegmentRoutingGlobalBlock) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsOspfSegmentRoutingGlobalBlock) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"global-block",
	)
...
func (o *ProtocolsOspfSegmentRoutingGlobalBlock) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsOspfSegmentRoutingGlobalBlock) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsOspfSegmentRoutingGlobalBlock) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
