// Package globalprotocolsospfsegmentroutingglobalblock code generated by /workspaces/terraform-provider-vyos/tools/build-terraform-resource-full/main.go. DO NOT EDIT.
...
func (r *protocolsOspfSegmentRoutingGlobalBlock) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsOspfSegmentRoutingGlobalBlock) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsOspfSegmentRoutingGlobalBlock) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsOspfSegmentRoutingGlobalBlock) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
