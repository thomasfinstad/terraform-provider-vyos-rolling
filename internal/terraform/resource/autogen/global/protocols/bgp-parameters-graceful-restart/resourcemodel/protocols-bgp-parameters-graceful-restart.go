...
var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpParametersGracefulRestart{}
...
func (o *ProtocolsBgpParametersGracefulRestart) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpParametersGracefulRestart) IsGlobalResource() bool {
	return (true)
}
...
func (o *ProtocolsBgpParametersGracefulRestart) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsBgpParametersGracefulRestart) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsBgpParametersGracefulRestart) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
	return map[string]schema.Attribute{
		...
		/* tools/generate-terraform-resource-full/templates/resources/common/resource-model-schema-attrtype.gotmpl #resource-model-schema-attrtype (stalepath-time) */
