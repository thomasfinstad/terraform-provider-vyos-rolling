...
var _ helpers.VyosTopResourceDataModel = &ProtocolsOspfDistance{}
...
func (o *ProtocolsOspfDistance) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsOspfDistance) IsGlobalResource() bool {
	return (true)
}
...
func (o *ProtocolsOspfDistance) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsOspfDistance) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsOspfDistance) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
