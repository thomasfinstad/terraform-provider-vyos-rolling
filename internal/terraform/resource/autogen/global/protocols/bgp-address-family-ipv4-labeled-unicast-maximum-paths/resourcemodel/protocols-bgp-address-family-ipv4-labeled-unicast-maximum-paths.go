...
var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpAddressFamilyIPvfourLabeledUnicastMaximumPaths{}

// ProtocolsBgpAddressFamilyIPvfourLabeledUnicastMaximumPaths describes the resource data model.
// This is a basenode!
...
type ProtocolsBgpAddressFamilyIPvfourLabeledUnicastMaximumPaths struct {
	...
	// LeafNodes
	LeafProtocolsBgpAddressFamilyIPvfourLabeledUnicastMaximumPathsEbgp types.Number `tfsdk:"ebgp" vyos:"ebgp,omitempty"`
	LeafProtocolsBgpAddressFamilyIPvfourLabeledUnicastMaximumPathsIbgp types.Number `tfsdk:"ibgp" vyos:"ibgp,omitempty"`
...
func (o *ProtocolsBgpAddressFamilyIPvfourLabeledUnicastMaximumPaths) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsBgpAddressFamilyIPvfourLabeledUnicastMaximumPaths) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpAddressFamilyIPvfourLabeledUnicastMaximumPaths) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsBgpAddressFamilyIPvfourLabeledUnicastMaximumPaths) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"maximum-paths",
	)
...
func (o *ProtocolsBgpAddressFamilyIPvfourLabeledUnicastMaximumPaths) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsBgpAddressFamilyIPvfourLabeledUnicastMaximumPaths) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsBgpAddressFamilyIPvfourLabeledUnicastMaximumPaths) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
