...
var _ helpers.VyosTopResourceDataModel = &ProtocolsIsisRedistributeIPvsixBgpLevelOne{}

// ProtocolsIsisRedistributeIPvsixBgpLevelOne describes the resource data model.
// This is a basenode!
...
type ProtocolsIsisRedistributeIPvsixBgpLevelOne struct {
	...
	// LeafNodes
	LeafProtocolsIsisRedistributeIPvsixBgpLevelOneMetric   types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsIsisRedistributeIPvsixBgpLevelOneRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsIsisRedistributeIPvsixBgpLevelOne) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsIsisRedistributeIPvsixBgpLevelOne) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsIsisRedistributeIPvsixBgpLevelOne) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsIsisRedistributeIPvsixBgpLevelOne) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"level-1",
	)
...
func (o *ProtocolsIsisRedistributeIPvsixBgpLevelOne) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsIsisRedistributeIPvsixBgpLevelOne) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsIsisRedistributeIPvsixBgpLevelOne) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
