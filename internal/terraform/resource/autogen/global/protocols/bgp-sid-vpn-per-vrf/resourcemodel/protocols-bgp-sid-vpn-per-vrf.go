...
/* tools/generate-terraform-resource-full/templates/resources/common/resource-model.gotmpl #resource-model (per-vrf) */
// Validate compliance

var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpSIDVpnPerVrf{}

// ProtocolsBgpSIDVpnPerVrf describes the resource data model.
// This is a basenode!
...
type ProtocolsBgpSIDVpnPerVrf struct {
	...
	// LeafNodes
	LeafProtocolsBgpSIDVpnPerVrfExport types.String `tfsdk:"export" vyos:"export,omitempty"`
...
func (o *ProtocolsBgpSIDVpnPerVrf) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsBgpSIDVpnPerVrf) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpSIDVpnPerVrf) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsBgpSIDVpnPerVrf) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"per-vrf",
	)
...
func (o *ProtocolsBgpSIDVpnPerVrf) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsBgpSIDVpnPerVrf) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsBgpSIDVpnPerVrf) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
