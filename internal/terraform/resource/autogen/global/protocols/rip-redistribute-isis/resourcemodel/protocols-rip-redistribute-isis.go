...
var _ helpers.VyosTopResourceDataModel = &ProtocolsRIPRedistributeIsis{}
...
type ProtocolsRIPRedistributeIsis struct {
	...
	LeafProtocolsRIPRedistributeIsisRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsRIPRedistributeIsis) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsRIPRedistributeIsis) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsRIPRedistributeIsis) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsRIPRedistributeIsis) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"isis",
	)
...
func (o *ProtocolsRIPRedistributeIsis) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsRIPRedistributeIsis) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsRIPRedistributeIsis) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
