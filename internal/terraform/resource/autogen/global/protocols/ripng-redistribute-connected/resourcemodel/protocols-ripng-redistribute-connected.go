...
var _ helpers.VyosTopResourceDataModel = &ProtocolsRIPngRedistributeConnected{}

// ProtocolsRIPngRedistributeConnected describes the resource data model.
// This is a basenode!
...
type ProtocolsRIPngRedistributeConnected struct {
	...
	// LeafNodes
	LeafProtocolsRIPngRedistributeConnectedMetric   types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsRIPngRedistributeConnectedRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsRIPngRedistributeConnected) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsRIPngRedistributeConnected) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsRIPngRedistributeConnected) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsRIPngRedistributeConnected) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"connected",
	)
...
func (o *ProtocolsRIPngRedistributeConnected) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsRIPngRedistributeConnected) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsRIPngRedistributeConnected) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
