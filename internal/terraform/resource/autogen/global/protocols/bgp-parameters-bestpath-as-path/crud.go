...
func (r *protocolsBgpParametersBestpathAsPath) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsBgpParametersBestpathAsPath) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsBgpParametersBestpathAsPath) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsBgpParametersBestpathAsPath) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
