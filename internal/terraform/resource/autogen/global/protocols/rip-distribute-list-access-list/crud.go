...
func (r *protocolsRIPDistributeListAccessList) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsRIPDistributeListAccessList) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsRIPDistributeListAccessList) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsRIPDistributeListAccessList) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
