...
var _ helpers.VyosTopResourceDataModel = &ProtocolsIsisRedistributeIPvfourKernelLevelTwo{}
...
func (o *ProtocolsIsisRedistributeIPvfourKernelLevelTwo) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsIsisRedistributeIPvfourKernelLevelTwo) IsGlobalResource() bool {
	return (true)
}
...
func (o *ProtocolsIsisRedistributeIPvfourKernelLevelTwo) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsIsisRedistributeIPvfourKernelLevelTwo) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsIsisRedistributeIPvfourKernelLevelTwo) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
