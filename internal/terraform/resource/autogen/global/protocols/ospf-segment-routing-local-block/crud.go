...
func (r *protocolsOspfSegmentRoutingLocalBlock) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsOspfSegmentRoutingLocalBlock) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsOspfSegmentRoutingLocalBlock) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsOspfSegmentRoutingLocalBlock) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
