...
/* tools/generate-terraform-resource-full/templates/resources/common/resource-model.gotmpl #resource-model (unicast) */
// Validate compliance

var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpAddressFamilyLtwovpnEvpnAdvertiseIPvsixUnicast{}
...
func (o *ProtocolsBgpAddressFamilyLtwovpnEvpnAdvertiseIPvsixUnicast) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpAddressFamilyLtwovpnEvpnAdvertiseIPvsixUnicast) IsGlobalResource() bool {
	return (true)
}
...
func (o *ProtocolsBgpAddressFamilyLtwovpnEvpnAdvertiseIPvsixUnicast) GetVyosParentPath() []string {
	return []string{
		...
		/* tools/generate-terraform-resource-full/templates/resources/common/resource-model-parent-vyos-path-hack.gotmpl #resource-model-parent-vyos-path-hack (advertise) */
...
func (o *ProtocolsBgpAddressFamilyLtwovpnEvpnAdvertiseIPvsixUnicast) GetVyosNamedParentPath() []string {
	return []string{
		...
		/* tools/generate-terraform-resource-full/templates/resources/common/resource-model-parent-vyos-path-hack.gotmpl #resource-model-parent-vyos-path-hack-for-non-global (advertise) */
...
func (o ProtocolsBgpAddressFamilyLtwovpnEvpnAdvertiseIPvsixUnicast) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
