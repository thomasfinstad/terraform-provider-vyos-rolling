...
func (r *protocolsBgpAddressFamilyLtwovpnEvpnAdvertiseIPvsixUnicast) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsBgpAddressFamilyLtwovpnEvpnAdvertiseIPvsixUnicast) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsBgpAddressFamilyLtwovpnEvpnAdvertiseIPvsixUnicast) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsBgpAddressFamilyLtwovpnEvpnAdvertiseIPvsixUnicast) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
