...
var _ helpers.VyosTopResourceDataModel = &ProtocolsOspfvthreeRedistributeBgp{}

// ProtocolsOspfvthreeRedistributeBgp describes the resource data model.
// This is a basenode!
...
type ProtocolsOspfvthreeRedistributeBgp struct {
	...
	// LeafNodes
	LeafProtocolsOspfvthreeRedistributeBgpMetric     types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsOspfvthreeRedistributeBgpMetricType types.Number `tfsdk:"metric_type" vyos:"metric-type,omitempty"`
	LeafProtocolsOspfvthreeRedistributeBgpRouteMap   types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsOspfvthreeRedistributeBgp) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsOspfvthreeRedistributeBgp) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsOspfvthreeRedistributeBgp) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsOspfvthreeRedistributeBgp) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"bgp",
	)
...
func (o *ProtocolsOspfvthreeRedistributeBgp) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsOspfvthreeRedistributeBgp) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsOspfvthreeRedistributeBgp) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
