...
func (r *protocolsRIPngRedistributeBgp) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsRIPngRedistributeBgp) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsRIPngRedistributeBgp) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsRIPngRedistributeBgp) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
