...
func (r *protocolsOspfLogAdjacencyChanges) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsOspfLogAdjacencyChanges) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsOspfLogAdjacencyChanges) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsOspfLogAdjacencyChanges) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
