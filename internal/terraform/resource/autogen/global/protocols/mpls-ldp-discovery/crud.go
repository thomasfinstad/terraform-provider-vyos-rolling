...
func (r *protocolsMplsLdpDiscovery) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsMplsLdpDiscovery) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsMplsLdpDiscovery) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsMplsLdpDiscovery) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
