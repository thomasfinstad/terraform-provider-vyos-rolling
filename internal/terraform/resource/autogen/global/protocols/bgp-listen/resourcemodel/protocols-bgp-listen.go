...
var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpListen{}
...
func (o *ProtocolsBgpListen) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpListen) IsGlobalResource() bool {
	return (true)
}
...
func (o *ProtocolsBgpListen) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsBgpListen) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsBgpListen) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
