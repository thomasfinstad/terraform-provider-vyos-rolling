...
func (r *protocolsIsisSegmentRoutingLocalBlock) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsIsisSegmentRoutingLocalBlock) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsIsisSegmentRoutingLocalBlock) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsIsisSegmentRoutingLocalBlock) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
