...
var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpAddressFamilyIPvfourUnicastSIDVpn{}

// ProtocolsBgpAddressFamilyIPvfourUnicastSIDVpn describes the resource data model.
// This is a basenode!
...
type ProtocolsBgpAddressFamilyIPvfourUnicastSIDVpn struct {
	...
	// LeafNodes
	LeafProtocolsBgpAddressFamilyIPvfourUnicastSIDVpnExport types.String `tfsdk:"export" vyos:"export,omitempty"`
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastSIDVpn) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastSIDVpn) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastSIDVpn) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastSIDVpn) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"vpn",
	)
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastSIDVpn) GetVyosParentPath() []string {
	return []string{
		/* tools/generate-terraform-resource-full/templates/resources/common/resource-model-parent-vyos-path-hack.gotmpl #resource-model-parent-vyos-path-hack (sid) */
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastSIDVpn) GetVyosNamedParentPath() []string {
	return []string{
		/* tools/generate-terraform-resource-full/templates/resources/common/resource-model-parent-vyos-path-hack.gotmpl #resource-model-parent-vyos-path-hack-for-non-global (sid) */
...
func (o ProtocolsBgpAddressFamilyIPvfourUnicastSIDVpn) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
