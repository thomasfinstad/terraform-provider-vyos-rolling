...
var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpAddressFamilyIPvfourUnicastNexthopVpn{}

// ProtocolsBgpAddressFamilyIPvfourUnicastNexthopVpn describes the resource data model.
// This is a basenode!
...
type ProtocolsBgpAddressFamilyIPvfourUnicastNexthopVpn struct {
	...
	// LeafNodes
	LeafProtocolsBgpAddressFamilyIPvfourUnicastNexthopVpnExport types.String `tfsdk:"export" vyos:"export,omitempty"`
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastNexthopVpn) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastNexthopVpn) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastNexthopVpn) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastNexthopVpn) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"vpn",
	)
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastNexthopVpn) GetVyosParentPath() []string {
	return []string{
		/* tools/generate-terraform-resource-full/templates/resources/common/resource-model-parent-vyos-path-hack.gotmpl #resource-model-parent-vyos-path-hack (nexthop) */
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastNexthopVpn) GetVyosNamedParentPath() []string {
	return []string{
		/* tools/generate-terraform-resource-full/templates/resources/common/resource-model-parent-vyos-path-hack.gotmpl #resource-model-parent-vyos-path-hack-for-non-global (nexthop) */
...
func (o ProtocolsBgpAddressFamilyIPvfourUnicastNexthopVpn) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
