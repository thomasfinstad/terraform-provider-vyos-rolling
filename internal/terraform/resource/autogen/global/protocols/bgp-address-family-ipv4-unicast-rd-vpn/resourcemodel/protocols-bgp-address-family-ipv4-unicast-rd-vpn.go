...
var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpAddressFamilyIPvfourUnicastRdVpn{}
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRdVpn) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRdVpn) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRdVpn) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRdVpn) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"vpn",
	)
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRdVpn) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRdVpn) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsBgpAddressFamilyIPvfourUnicastRdVpn) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
