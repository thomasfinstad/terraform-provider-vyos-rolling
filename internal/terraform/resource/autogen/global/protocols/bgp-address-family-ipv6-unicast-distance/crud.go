...
func (r *protocolsBgpAddressFamilyIPvsixUnicastDistance) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsBgpAddressFamilyIPvsixUnicastDistance) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsBgpAddressFamilyIPvsixUnicastDistance) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsBgpAddressFamilyIPvsixUnicastDistance) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
