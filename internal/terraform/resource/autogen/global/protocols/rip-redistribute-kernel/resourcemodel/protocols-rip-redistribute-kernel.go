...
var _ helpers.VyosTopResourceDataModel = &ProtocolsRIPRedistributeKernel{}

// ProtocolsRIPRedistributeKernel describes the resource data model.
// This is a basenode!
...
type ProtocolsRIPRedistributeKernel struct {
	...
	// LeafNodes
	LeafProtocolsRIPRedistributeKernelMetric   types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsRIPRedistributeKernelRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsRIPRedistributeKernel) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsRIPRedistributeKernel) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsRIPRedistributeKernel) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsRIPRedistributeKernel) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"kernel",
	)
...
func (o *ProtocolsRIPRedistributeKernel) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsRIPRedistributeKernel) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsRIPRedistributeKernel) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
