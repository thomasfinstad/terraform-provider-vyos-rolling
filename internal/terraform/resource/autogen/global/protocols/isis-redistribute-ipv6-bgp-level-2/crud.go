...
func (r *protocolsIsisRedistributeIPvsixBgpLevelTwo) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsIsisRedistributeIPvsixBgpLevelTwo) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsIsisRedistributeIPvsixBgpLevelTwo) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsIsisRedistributeIPvsixBgpLevelTwo) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
