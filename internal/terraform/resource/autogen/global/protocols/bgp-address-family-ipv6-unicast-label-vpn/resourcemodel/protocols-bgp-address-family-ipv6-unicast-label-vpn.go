...
var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpAddressFamilyIPvsixUnicastLabelVpn{}
...
type ProtocolsBgpAddressFamilyIPvsixUnicastLabelVpn struct {
	...
	ExistsNodeProtocolsBgpAddressFamilyIPvsixUnicastLabelVpnAllocationMode bool `tfsdk:"-" vyos:"allocation-mode,child"`
}
...
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastLabelVpn) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastLabelVpn) IsGlobalResource() bool {
	return (true)
}
...
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastLabelVpn) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastLabelVpn) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsBgpAddressFamilyIPvsixUnicastLabelVpn) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
