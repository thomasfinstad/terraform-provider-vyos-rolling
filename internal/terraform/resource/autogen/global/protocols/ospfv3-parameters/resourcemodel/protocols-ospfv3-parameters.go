...
var _ helpers.VyosTopResourceDataModel = &ProtocolsOspfvthreeParameters{}

// ProtocolsOspfvthreeParameters describes the resource data model.
// This is a basenode!
...
type ProtocolsOspfvthreeParameters struct {
	...
	// LeafNodes
	LeafProtocolsOspfvthreeParametersRouterID types.String `tfsdk:"router_id" vyos:"router-id,omitempty"`
...
func (o *ProtocolsOspfvthreeParameters) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsOspfvthreeParameters) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsOspfvthreeParameters) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsOspfvthreeParameters) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"parameters",
	)
...
func (o *ProtocolsOspfvthreeParameters) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsOspfvthreeParameters) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsOspfvthreeParameters) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
