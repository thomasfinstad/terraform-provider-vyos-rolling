// Package globalprotocolsriptimers code generated by /workspaces/terraform-provider-vyos/tools/build-terraform-resource-full/main.go. DO NOT EDIT.
...
func (r *protocolsRIPTimers) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsRIPTimers) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsRIPTimers) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsRIPTimers) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
