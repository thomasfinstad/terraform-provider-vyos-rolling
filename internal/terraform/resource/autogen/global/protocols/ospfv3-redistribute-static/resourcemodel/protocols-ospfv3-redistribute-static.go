...
var _ helpers.VyosTopResourceDataModel = &ProtocolsOspfvthreeRedistributeStatic{}

// ProtocolsOspfvthreeRedistributeStatic describes the resource data model.
// This is a basenode!
...
type ProtocolsOspfvthreeRedistributeStatic struct {
	...
	// LeafNodes
	LeafProtocolsOspfvthreeRedistributeStaticMetric     types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsOspfvthreeRedistributeStaticMetricType types.Number `tfsdk:"metric_type" vyos:"metric-type,omitempty"`
	LeafProtocolsOspfvthreeRedistributeStaticRouteMap   types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsOspfvthreeRedistributeStatic) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsOspfvthreeRedistributeStatic) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsOspfvthreeRedistributeStatic) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsOspfvthreeRedistributeStatic) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"static",
	)
...
func (o *ProtocolsOspfvthreeRedistributeStatic) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsOspfvthreeRedistributeStatic) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsOspfvthreeRedistributeStatic) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
