...
var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpAddressFamilyIPvsixUnicastRouteTargetVpn{}
...
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastRouteTargetVpn) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastRouteTargetVpn) IsGlobalResource() bool {
	return (true)
}
...
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastRouteTargetVpn) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastRouteTargetVpn) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsBgpAddressFamilyIPvsixUnicastRouteTargetVpn) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
