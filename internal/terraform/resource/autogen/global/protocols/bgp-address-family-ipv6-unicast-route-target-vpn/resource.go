...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/global/protocols/bgp-address-family-ipv6-unicast-route-target-vpn/resourcemodel"
)
...
func (r *protocolsBgpAddressFamilyIPvsixUnicastRouteTargetVpn) GetModel() helpers.VyosTopResourceDataModel {
	return r.model
}

// GetProviderConfig returns global provider data config
func (r *protocolsBgpAddressFamilyIPvsixUnicastRouteTargetVpn) GetProviderConfig() data.ProviderData {
...
func (r *protocolsBgpAddressFamilyIPvsixUnicastRouteTargetVpn) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
