...
var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpAddressFamilyLtwovpnEvpnEadEsRouteTarget{}

// ProtocolsBgpAddressFamilyLtwovpnEvpnEadEsRouteTarget describes the resource data model.
// This is a basenode!
...
type ProtocolsBgpAddressFamilyLtwovpnEvpnEadEsRouteTarget struct {
	...
	// LeafNodes
	LeafProtocolsBgpAddressFamilyLtwovpnEvpnEadEsRouteTargetExport types.List `tfsdk:"export" vyos:"export,omitempty"`
...
func (o *ProtocolsBgpAddressFamilyLtwovpnEvpnEadEsRouteTarget) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsBgpAddressFamilyLtwovpnEvpnEadEsRouteTarget) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpAddressFamilyLtwovpnEvpnEadEsRouteTarget) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsBgpAddressFamilyLtwovpnEvpnEadEsRouteTarget) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"ead-es-route-target",
	)
...
func (o *ProtocolsBgpAddressFamilyLtwovpnEvpnEadEsRouteTarget) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsBgpAddressFamilyLtwovpnEvpnEadEsRouteTarget) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsBgpAddressFamilyLtwovpnEvpnEadEsRouteTarget) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
