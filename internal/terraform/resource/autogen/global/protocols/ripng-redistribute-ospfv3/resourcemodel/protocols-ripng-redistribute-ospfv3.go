...
var _ helpers.VyosTopResourceDataModel = &ProtocolsRIPngRedistributeOspfvthree{}

// ProtocolsRIPngRedistributeOspfvthree describes the resource data model.
// This is a basenode!
...
type ProtocolsRIPngRedistributeOspfvthree struct {
	...
	// LeafNodes
	LeafProtocolsRIPngRedistributeOspfvthreeMetric   types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsRIPngRedistributeOspfvthreeRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsRIPngRedistributeOspfvthree) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsRIPngRedistributeOspfvthree) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsRIPngRedistributeOspfvthree) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsRIPngRedistributeOspfvthree) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"ospfv3",
	)
...
func (o *ProtocolsRIPngRedistributeOspfvthree) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsRIPngRedistributeOspfvthree) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsRIPngRedistributeOspfvthree) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
