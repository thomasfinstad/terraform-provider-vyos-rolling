...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/global/protocols/ospf-redistribute-connected/resourcemodel"
)
...
func (r *protocolsOspfRedistributeConnected) GetModel() helpers.VyosTopResourceDataModel {
	return r.model
}

// GetProviderConfig returns global provider data config
func (r *protocolsOspfRedistributeConnected) GetProviderConfig() data.ProviderData {
...
func (r *protocolsOspfRedistributeConnected) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
