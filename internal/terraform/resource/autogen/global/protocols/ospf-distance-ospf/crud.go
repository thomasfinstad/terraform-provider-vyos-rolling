// Package globalprotocolsospfdistanceospf code generated by /workspaces/terraform-provider-vyos/tools/build-terraform-resource-full/main.go. DO NOT EDIT.
...
func (r *protocolsOspfDistanceOspf) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsOspfDistanceOspf) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsOspfDistanceOspf) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsOspfDistanceOspf) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
