...
func (r *protocolsBabelDistributeListIPvfourAccessList) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsBabelDistributeListIPvfourAccessList) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsBabelDistributeListIPvfourAccessList) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsBabelDistributeListIPvfourAccessList) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
