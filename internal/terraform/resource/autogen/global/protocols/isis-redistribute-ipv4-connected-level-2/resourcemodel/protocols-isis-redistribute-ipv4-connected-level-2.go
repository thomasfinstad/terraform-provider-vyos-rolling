...
var _ helpers.VyosTopResourceDataModel = &ProtocolsIsisRedistributeIPvfourConnectedLevelTwo{}

// ProtocolsIsisRedistributeIPvfourConnectedLevelTwo describes the resource data model.
// This is a basenode!
...
type ProtocolsIsisRedistributeIPvfourConnectedLevelTwo struct {
	...
	// LeafNodes
	LeafProtocolsIsisRedistributeIPvfourConnectedLevelTwoMetric   types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsIsisRedistributeIPvfourConnectedLevelTwoRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsIsisRedistributeIPvfourConnectedLevelTwo) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsIsisRedistributeIPvfourConnectedLevelTwo) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsIsisRedistributeIPvfourConnectedLevelTwo) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsIsisRedistributeIPvfourConnectedLevelTwo) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"level-2",
	)
...
func (o *ProtocolsIsisRedistributeIPvfourConnectedLevelTwo) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsIsisRedistributeIPvfourConnectedLevelTwo) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsIsisRedistributeIPvfourConnectedLevelTwo) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
