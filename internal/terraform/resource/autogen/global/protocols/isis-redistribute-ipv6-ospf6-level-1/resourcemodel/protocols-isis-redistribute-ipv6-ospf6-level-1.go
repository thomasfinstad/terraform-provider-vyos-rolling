...
var _ helpers.VyosTopResourceDataModel = &ProtocolsIsisRedistributeIPvsixOspfsixLevelOne{}
...
type ProtocolsIsisRedistributeIPvsixOspfsixLevelOne struct {
	...
	LeafProtocolsIsisRedistributeIPvsixOspfsixLevelOneRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsIsisRedistributeIPvsixOspfsixLevelOne) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsIsisRedistributeIPvsixOspfsixLevelOne) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsIsisRedistributeIPvsixOspfsixLevelOne) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsIsisRedistributeIPvsixOspfsixLevelOne) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"level-1",
	)
...
func (o *ProtocolsIsisRedistributeIPvsixOspfsixLevelOne) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsIsisRedistributeIPvsixOspfsixLevelOne) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsIsisRedistributeIPvsixOspfsixLevelOne) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
