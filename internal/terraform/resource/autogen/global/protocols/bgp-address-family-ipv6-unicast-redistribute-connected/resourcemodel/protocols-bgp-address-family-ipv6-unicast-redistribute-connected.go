...
/* tools/generate-terraform-resource-full/templates/resources/common/resource-model.gotmpl #resource-model (connected) */
// Validate compliance

var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpAddressFamilyIPvsixUnicastRedistributeConnected{}

// ProtocolsBgpAddressFamilyIPvsixUnicastRedistributeConnected describes the resource data model.
// This is a basenode!
...
type ProtocolsBgpAddressFamilyIPvsixUnicastRedistributeConnected struct {
	...
	// LeafNodes
	LeafProtocolsBgpAddressFamilyIPvsixUnicastRedistributeConnectedMetric   types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsBgpAddressFamilyIPvsixUnicastRedistributeConnectedRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastRedistributeConnected) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastRedistributeConnected) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastRedistributeConnected) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastRedistributeConnected) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"connected",
	)
...
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastRedistributeConnected) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsBgpAddressFamilyIPvsixUnicastRedistributeConnected) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsBgpAddressFamilyIPvsixUnicastRedistributeConnected) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
