...
func (r *protocolsBgpAddressFamilyIPvsixUnicastRedistributeConnected) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsBgpAddressFamilyIPvsixUnicastRedistributeConnected) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsBgpAddressFamilyIPvsixUnicastRedistributeConnected) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsBgpAddressFamilyIPvsixUnicastRedistributeConnected) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
