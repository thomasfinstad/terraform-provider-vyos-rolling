...
func (r *protocolsBgpParametersBestpathMed) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsBgpParametersBestpathMed) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsBgpParametersBestpathMed) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsBgpParametersBestpathMed) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
