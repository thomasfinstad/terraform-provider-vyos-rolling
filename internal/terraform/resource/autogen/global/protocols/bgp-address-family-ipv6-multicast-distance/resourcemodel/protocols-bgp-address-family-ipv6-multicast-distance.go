...
type ProtocolsBgpAddressFamilyIPvsixMulticastDistance struct {
	...
	ExistsTagProtocolsBgpAddressFamilyIPvsixMulticastDistancePrefix bool `tfsdk:"-" vyos:"prefix,ignore,child"`
...
func (o ProtocolsBgpAddressFamilyIPvsixMulticastDistance) ResourceSchemaAttributes() map[string]schema.Attribute {
