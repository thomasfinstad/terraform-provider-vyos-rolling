...
var _ helpers.VyosTopResourceDataModel = &ProtocolsOspfRefresh{}
...
func (o *ProtocolsOspfRefresh) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsOspfRefresh) IsGlobalResource() bool {
	return (true)
}
...
func (o *ProtocolsOspfRefresh) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsOspfRefresh) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsOspfRefresh) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
	return map[string]schema.Attribute{
		...
		/* tools/generate-terraform-resource-full/templates/resources/common/resource-model-schema-attrtype.gotmpl #resource-model-schema-attrtype (timers) */
