...
func (r *protocolsOspfRefresh) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsOspfRefresh) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsOspfRefresh) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsOspfRefresh) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
