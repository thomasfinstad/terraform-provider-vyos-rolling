...
func (r *protocolsMplsLdpExportIPvsix) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsMplsLdpExportIPvsix) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsMplsLdpExportIPvsix) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsMplsLdpExportIPvsix) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
