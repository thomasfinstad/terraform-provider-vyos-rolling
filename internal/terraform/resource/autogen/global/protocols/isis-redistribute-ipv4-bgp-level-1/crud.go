...
func (r *protocolsIsisRedistributeIPvfourBgpLevelOne) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsIsisRedistributeIPvfourBgpLevelOne) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsIsisRedistributeIPvfourBgpLevelOne) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsIsisRedistributeIPvfourBgpLevelOne) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
