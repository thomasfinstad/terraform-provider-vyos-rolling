...
func (r *protocolsOspfTimersThroTTLeSpf) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *protocolsOspfTimersThroTTLeSpf) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *protocolsOspfTimersThroTTLeSpf) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *protocolsOspfTimersThroTTLeSpf) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
