...
var _ helpers.VyosTopResourceDataModel = &ProtocolsIsisRedistributeIPvfourBabelLevelTwo{}
...
func (o *ProtocolsIsisRedistributeIPvfourBabelLevelTwo) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsIsisRedistributeIPvfourBabelLevelTwo) IsGlobalResource() bool {
	return (true)
}
...
func (o *ProtocolsIsisRedistributeIPvfourBabelLevelTwo) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsIsisRedistributeIPvfourBabelLevelTwo) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsIsisRedistributeIPvfourBabelLevelTwo) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
