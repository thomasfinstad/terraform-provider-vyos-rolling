...
var _ helpers.VyosTopResourceDataModel = &ProtocolsIsisRedistributeIPvfourRIPLevelTwo{}
...
func (o *ProtocolsIsisRedistributeIPvfourRIPLevelTwo) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsIsisRedistributeIPvfourRIPLevelTwo) IsGlobalResource() bool {
	return (true)
}
...
func (o *ProtocolsIsisRedistributeIPvfourRIPLevelTwo) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsIsisRedistributeIPvfourRIPLevelTwo) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsIsisRedistributeIPvfourRIPLevelTwo) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
