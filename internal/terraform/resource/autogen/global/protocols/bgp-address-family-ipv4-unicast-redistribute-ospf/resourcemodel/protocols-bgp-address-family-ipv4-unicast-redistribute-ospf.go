...
var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpAddressFamilyIPvfourUnicastRedistributeOspf{}

// ProtocolsBgpAddressFamilyIPvfourUnicastRedistributeOspf describes the resource data model.
// This is a basenode!
...
type ProtocolsBgpAddressFamilyIPvfourUnicastRedistributeOspf struct {
	...
	// LeafNodes
	LeafProtocolsBgpAddressFamilyIPvfourUnicastRedistributeOspfMetric   types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsBgpAddressFamilyIPvfourUnicastRedistributeOspfRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRedistributeOspf) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRedistributeOspf) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRedistributeOspf) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRedistributeOspf) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"ospf",
	)
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRedistributeOspf) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRedistributeOspf) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsBgpAddressFamilyIPvfourUnicastRedistributeOspf) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
