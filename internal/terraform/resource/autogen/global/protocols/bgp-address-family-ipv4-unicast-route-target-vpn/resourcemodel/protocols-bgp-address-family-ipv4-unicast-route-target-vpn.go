...
var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpAddressFamilyIPvfourUnicastRouteTargetVpn{}
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRouteTargetVpn) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRouteTargetVpn) IsGlobalResource() bool {
	return (true)
}
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRouteTargetVpn) GetVyosParentPath() []string {
	return []string{
		/* tools/generate-terraform-resource-full/templates/resources/common/resource-model-parent-vyos-path-hack.gotmpl #resource-model-parent-vyos-path-hack (route-target) */
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRouteTargetVpn) GetVyosNamedParentPath() []string {
	return []string{
		/* tools/generate-terraform-resource-full/templates/resources/common/resource-model-parent-vyos-path-hack.gotmpl #resource-model-parent-vyos-path-hack-for-non-global (route-target) */
...
func (o ProtocolsBgpAddressFamilyIPvfourUnicastRouteTargetVpn) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
