...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/global/protocols/bgp-address-family-ipv4-unicast-redistribute-isis/resourcemodel"
)
...
func (r *protocolsBgpAddressFamilyIPvfourUnicastRedistributeIsis) GetModel() helpers.VyosTopResourceDataModel {
	return r.model
}

// GetProviderConfig returns global provider data config
func (r *protocolsBgpAddressFamilyIPvfourUnicastRedistributeIsis) GetProviderConfig() data.ProviderData {
...
func (r *protocolsBgpAddressFamilyIPvfourUnicastRedistributeIsis) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
