...
var _ helpers.VyosTopResourceDataModel = &SystemSyslogGlobalMarker{}
...
func (o *SystemSyslogGlobalMarker) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *SystemSyslogGlobalMarker) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *SystemSyslogGlobalMarker) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *SystemSyslogGlobalMarker) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"marker",
	)
...
func (o *SystemSyslogGlobalMarker) GetVyosParentPath() []string {
	return []string{
...
func (o *SystemSyslogGlobalMarker) GetVyosNamedParentPath() []string {
	return []string{
...
func (o SystemSyslogGlobalMarker) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
	return map[string]schema.Attribute{
		...
		schema.StringAttribute{
			Optional: true,
			MarkdownDescription: `time interval how often a mark message is being sent in seconds

`,
			Description: `time interval how often a mark message is being sent in seconds
