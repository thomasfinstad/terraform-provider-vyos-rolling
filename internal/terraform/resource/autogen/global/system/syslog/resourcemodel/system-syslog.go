...
type SystemSyslog struct {
	...
	// LeafNodes
	LeafSystemSyslogVrf types.String `tfsdk:"vrf" vyos:"vrf,omitempty"`

	// TagNodes (Bools that show if child resources have been configured)
	ExistsTagSystemSyslogUser bool `tfsdk:"-" vyos:"user,child"`
	ExistsTagSystemSyslogHost bool `tfsdk:"-" vyos:"host,child"`
	ExistsTagSystemSyslogFile bool `tfsdk:"-" vyos:"file,child"`

	// Nodes (Bools that show if child resources have been configured)
	ExistsNodeSystemSyslogGlobal  bool `tfsdk:"-" vyos:"global,child"`
	ExistsNodeSystemSyslogConsole bool `tfsdk:"-" vyos:"console,child"`
}
