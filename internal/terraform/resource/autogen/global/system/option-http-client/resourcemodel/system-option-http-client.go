...
/* tools/generate-terraform-resource-full/templates/resources/common/resource-model.gotmpl #resource-model (http-client) */
// Validate compliance

var _ helpers.VyosTopResourceDataModel = &SystemOptionHTTPClient{}
...
type SystemOptionHTTPClient struct {
	...
	LeafSystemOptionHTTPClientSourceAddress   types.String `tfsdk:"source_address" vyos:"source-address,omitempty"`
...
func (o *SystemOptionHTTPClient) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *SystemOptionHTTPClient) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *SystemOptionHTTPClient) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *SystemOptionHTTPClient) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"http-client",
	)
...
func (o *SystemOptionHTTPClient) GetVyosParentPath() []string {
	return []string{
...
func (o *SystemOptionHTTPClient) GetVyosNamedParentPath() []string {
	return []string{
...
func (o SystemOptionHTTPClient) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
