...
func (r *systemConntrackModules) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *systemConntrackModules) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *systemConntrackModules) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *systemConntrackModules) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
