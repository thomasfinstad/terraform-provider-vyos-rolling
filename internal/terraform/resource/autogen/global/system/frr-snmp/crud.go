// Package globalsystemfrrsnmp code generated by /workspaces/terraform-provider-vyos/tools/build-terraform-resource-full/main.go. DO NOT EDIT.
...
func (r *systemFrrSnmp) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *systemFrrSnmp) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *systemFrrSnmp) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *systemFrrSnmp) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
