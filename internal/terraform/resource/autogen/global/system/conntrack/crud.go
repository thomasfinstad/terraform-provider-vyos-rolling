...
func (r *systemConntrack) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *systemConntrack) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *systemConntrack) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *systemConntrack) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
