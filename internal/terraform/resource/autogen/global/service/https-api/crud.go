...
func (r *serviceHTTPSAPI) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *serviceHTTPSAPI) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *serviceHTTPSAPI) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *serviceHTTPSAPI) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
