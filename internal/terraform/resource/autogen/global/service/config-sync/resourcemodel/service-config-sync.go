...
/* tools/generate-terraform-resource-full/templates/resources/common/resource-model.gotmpl #resource-model (config-sync) */
// Validate compliance
...
func (o *ServiceConfigSync) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ServiceConfigSync) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ServiceConfigSync) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ServiceConfigSync) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"config-sync",
	)
...
func (o ServiceConfigSync) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
