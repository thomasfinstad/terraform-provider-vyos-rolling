...
/* tools/generate-terraform-resource-full/templates/resources/common/schema.gotmpl #schema (node-exporter) */
// Schema method to define the schema for any resource configuration, plan, and state data.
func (r serviceMonitoringPrometheusNodeExporter) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
