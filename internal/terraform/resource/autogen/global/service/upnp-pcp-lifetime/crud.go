...
func (r *serviceUpnpPcpLifetime) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *serviceUpnpPcpLifetime) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *serviceUpnpPcpLifetime) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *serviceUpnpPcpLifetime) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
