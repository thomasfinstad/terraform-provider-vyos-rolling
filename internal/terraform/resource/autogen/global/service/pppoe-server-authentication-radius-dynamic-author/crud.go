...
func (r *servicePppoeServerAuthenticationRadiusDynamicAuthor) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *servicePppoeServerAuthenticationRadiusDynamicAuthor) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *servicePppoeServerAuthenticationRadiusDynamicAuthor) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *servicePppoeServerAuthenticationRadiusDynamicAuthor) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
