...
var _ helpers.VyosTopResourceDataModel = &ServicePppoeServerAuthenticationRadiusDynamicAuthor{}

// ServicePppoeServerAuthenticationRadiusDynamicAuthor describes the resource data model.
// This is a basenode!
...
type ServicePppoeServerAuthenticationRadiusDynamicAuthor struct {
	...
	// LeafNodes
	LeafServicePppoeServerAuthenticationRadiusDynamicAuthorServer types.String `tfsdk:"server" vyos:"server,omitempty"`
	LeafServicePppoeServerAuthenticationRadiusDynamicAuthorPort   types.Number `tfsdk:"port" vyos:"port,omitempty"`
	LeafServicePppoeServerAuthenticationRadiusDynamicAuthorKey    types.String `tfsdk:"key" vyos:"key,omitempty"`
...
func (o *ServicePppoeServerAuthenticationRadiusDynamicAuthor) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ServicePppoeServerAuthenticationRadiusDynamicAuthor) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ServicePppoeServerAuthenticationRadiusDynamicAuthor) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ServicePppoeServerAuthenticationRadiusDynamicAuthor) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"dynamic-author",
	)
...
func (o *ServicePppoeServerAuthenticationRadiusDynamicAuthor) GetVyosParentPath() []string {
	return []string{
...
func (o *ServicePppoeServerAuthenticationRadiusDynamicAuthor) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ServicePppoeServerAuthenticationRadiusDynamicAuthor) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
