...
func (r *serviceBroadcastRelay) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *serviceBroadcastRelay) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *serviceBroadcastRelay) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *serviceBroadcastRelay) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
