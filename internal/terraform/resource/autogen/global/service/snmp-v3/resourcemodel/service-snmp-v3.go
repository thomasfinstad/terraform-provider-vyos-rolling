...
/* tools/generate-terraform-resource-full/templates/resources/common/resource-model.gotmpl #resource-model (v3) */
// Validate compliance
...
func (o *ServiceSnmpVthree) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ServiceSnmpVthree) IsGlobalResource() bool {
	return (true)
}
...
func (o ServiceSnmpVthree) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
	return map[string]schema.Attribute{
		...
		/* tools/generate-terraform-resource-full/templates/resources/common/resource-model-schema-attrtype.gotmpl #resource-model-schema-attrtype (engineid) */
		schema.StringAttribute{
			Optional: true,
			MarkdownDescription: `Specifies the EngineID that uniquely identify an agent (e.g. 000000000000000000000002)

`,
			Description: `Specifies the EngineID that uniquely identify an agent (e.g. 000000000000000000000002)
