...
func (r *servicePppoeServerSnmp) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *servicePppoeServerSnmp) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *servicePppoeServerSnmp) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *servicePppoeServerSnmp) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
