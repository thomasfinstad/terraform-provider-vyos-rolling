// Package globalserviceidsddosprotectionthresholdgeneral code generated by /workspaces/terraform-provider-vyos/tools/build-terraform-resource-full/main.go. DO NOT EDIT.
...
func (r *serviceIDsDdosProtectionThresholdGeneral) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *serviceIDsDdosProtectionThresholdGeneral) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *serviceIDsDdosProtectionThresholdGeneral) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *serviceIDsDdosProtectionThresholdGeneral) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
