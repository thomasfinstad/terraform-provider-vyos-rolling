...
func (r *serviceHTTPSCertificatesCertbot) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *serviceHTTPSCertificatesCertbot) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *serviceHTTPSCertificatesCertbot) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *serviceHTTPSCertificatesCertbot) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
