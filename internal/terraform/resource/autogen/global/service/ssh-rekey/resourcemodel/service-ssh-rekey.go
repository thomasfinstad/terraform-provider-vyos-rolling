...
/* tools/generate-terraform-resource-full/templates/resources/common/resource-model.gotmpl #resource-model (rekey) */
// Validate compliance

var _ helpers.VyosTopResourceDataModel = &ServiceTCPRekey{}
...
func (o *ServiceTCPRekey) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ServiceTCPRekey) IsGlobalResource() bool {
	return (true)
}
...
func (o *ServiceTCPRekey) GetVyosParentPath() []string {
	return []string{
...
func (o *ServiceTCPRekey) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ServiceTCPRekey) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
    ...
    |  1-65535  |  Megabytes    |
`,
			Description: `Threshold data in megabytes
