...
var _ helpers.VyosTopResourceDataModel = &ServiceStunnelLog{}

// ServiceStunnelLog describes the resource data model.
// This is a basenode!
...
type ServiceStunnelLog struct {
	...
	// LeafNodes
	LeafServiceStunnelLogLevel types.String `tfsdk:"level" vyos:"level,omitempty"`
...
func (o *ServiceStunnelLog) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ServiceStunnelLog) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ServiceStunnelLog) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ServiceStunnelLog) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"log",
	)
...
func (o *ServiceStunnelLog) GetVyosParentPath() []string {
	return []string{
...
func (o *ServiceStunnelLog) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ServiceStunnelLog) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
