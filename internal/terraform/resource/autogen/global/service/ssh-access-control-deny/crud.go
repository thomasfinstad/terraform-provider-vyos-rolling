...
func (r *serviceTCPAccessControlDeny) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *serviceTCPAccessControlDeny) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *serviceTCPAccessControlDeny) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *serviceTCPAccessControlDeny) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
