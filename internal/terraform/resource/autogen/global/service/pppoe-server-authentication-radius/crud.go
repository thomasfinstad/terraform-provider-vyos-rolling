...
func (r *servicePppoeServerAuthenticationRadius) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *servicePppoeServerAuthenticationRadius) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *servicePppoeServerAuthenticationRadius) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *servicePppoeServerAuthenticationRadius) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
