...
/* tools/generate-terraform-resource-full/templates/resources/common/schema.gotmpl #schema (zabbix-agent) */
// Schema method to define the schema for any resource configuration, plan, and state data.
func (r serviceMonitoringZabbixAgent) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
