...
func (r *serviceConntrackSyncFailoverMechanismVrrp) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *serviceConntrackSyncFailoverMechanismVrrp) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *serviceConntrackSyncFailoverMechanismVrrp) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *serviceConntrackSyncFailoverMechanismVrrp) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
