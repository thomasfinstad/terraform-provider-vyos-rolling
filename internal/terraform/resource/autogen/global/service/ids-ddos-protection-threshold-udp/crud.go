// Package globalserviceidsddosprotectionthresholdudp code generated by /workspaces/terraform-provider-vyos/tools/build-terraform-resource-full/main.go. DO NOT EDIT.
...
func (r *serviceIDsDdosProtectionThresholdUDP) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *serviceIDsDdosProtectionThresholdUDP) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *serviceIDsDdosProtectionThresholdUDP) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *serviceIDsDdosProtectionThresholdUDP) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
