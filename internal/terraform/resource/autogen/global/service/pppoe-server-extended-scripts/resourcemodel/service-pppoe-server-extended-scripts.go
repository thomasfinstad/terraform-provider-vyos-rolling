...
var _ helpers.VyosTopResourceDataModel = &ServicePppoeServerExtendedScrIPts{}
...
func (o *ServicePppoeServerExtendedScrIPts) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ServicePppoeServerExtendedScrIPts) IsGlobalResource() bool {
	return (true)
}
...
func (o *ServicePppoeServerExtendedScrIPts) GetVyosParentPath() []string {
	return []string{
...
func (o *ServicePppoeServerExtendedScrIPts) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ServicePppoeServerExtendedScrIPts) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
