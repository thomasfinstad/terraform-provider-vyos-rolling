// Package globalservicepppoeserverextendedscripts code generated by /workspaces/terraform-provider-vyos/tools/build-terraform-resource-full/main.go. DO NOT EDIT.
...
func (r *servicePppoeServerExtendedScrIPts) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *servicePppoeServerExtendedScrIPts) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *servicePppoeServerExtendedScrIPts) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *servicePppoeServerExtendedScrIPts) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
