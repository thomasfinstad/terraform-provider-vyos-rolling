...
func (r *serviceHTTPSAPIRestrict) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *serviceHTTPSAPIRestrict) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *serviceHTTPSAPIRestrict) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *serviceHTTPSAPIRestrict) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
