// Package globalservicemonitoringtelegrafazuredataexplorerauthentication code generated by /workspaces/terraform-provider-vyos/tools/build-terraform-resource-full/main.go. DO NOT EDIT.
...
func (r *serviceMonitoringTelegrafAzureDataExplorerAuthentication) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *serviceMonitoringTelegrafAzureDataExplorerAuthentication) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *serviceMonitoringTelegrafAzureDataExplorerAuthentication) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *serviceMonitoringTelegrafAzureDataExplorerAuthentication) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
