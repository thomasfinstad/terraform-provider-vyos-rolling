...
func (r *serviceIDsDdosProtectionThresholdIcmp) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *serviceIDsDdosProtectionThresholdIcmp) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *serviceIDsDdosProtectionThresholdIcmp) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *serviceIDsDdosProtectionThresholdIcmp) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
