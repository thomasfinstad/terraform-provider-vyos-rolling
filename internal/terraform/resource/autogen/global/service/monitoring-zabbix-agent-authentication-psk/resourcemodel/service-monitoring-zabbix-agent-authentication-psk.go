...
var _ helpers.VyosTopResourceDataModel = &ServiceMonitoringZabbixAgentAuthenticationPsk{}

// ServiceMonitoringZabbixAgentAuthenticationPsk describes the resource data model.
// This is a basenode!
...
type ServiceMonitoringZabbixAgentAuthenticationPsk struct {
	...
	// LeafNodes
	LeafServiceMonitoringZabbixAgentAuthenticationPskID     types.String `tfsdk:"id_param" vyos:"id,omitempty"`
	LeafServiceMonitoringZabbixAgentAuthenticationPskSecret types.String `tfsdk:"secret" vyos:"secret,omitempty"`
...
func (o *ServiceMonitoringZabbixAgentAuthenticationPsk) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ServiceMonitoringZabbixAgentAuthenticationPsk) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ServiceMonitoringZabbixAgentAuthenticationPsk) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ServiceMonitoringZabbixAgentAuthenticationPsk) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"psk",
	)
...
func (o *ServiceMonitoringZabbixAgentAuthenticationPsk) GetVyosParentPath() []string {
	return []string{
...
func (o *ServiceMonitoringZabbixAgentAuthenticationPsk) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ServiceMonitoringZabbixAgentAuthenticationPsk) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
