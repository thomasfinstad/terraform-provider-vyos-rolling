...
func (r *serviceMonitoringTelegraf) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *serviceMonitoringTelegraf) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *serviceMonitoringTelegraf) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *serviceMonitoringTelegraf) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
