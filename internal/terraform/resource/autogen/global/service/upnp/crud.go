...
func (r *serviceUpnp) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *serviceUpnp) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *serviceUpnp) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *serviceUpnp) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
