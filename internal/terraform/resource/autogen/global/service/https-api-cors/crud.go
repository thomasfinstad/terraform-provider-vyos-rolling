...
func (r *serviceHTTPSAPICors) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *serviceHTTPSAPICors) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *serviceHTTPSAPICors) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *serviceHTTPSAPICors) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
