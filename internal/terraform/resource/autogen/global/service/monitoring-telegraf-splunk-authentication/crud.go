...
func (r *serviceMonitoringTelegrafSplunkAuthentication) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *serviceMonitoringTelegrafSplunkAuthentication) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *serviceMonitoringTelegrafSplunkAuthentication) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *serviceMonitoringTelegrafSplunkAuthentication) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
