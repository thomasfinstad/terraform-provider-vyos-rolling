...
type InterfacesWwanAuthentication struct {
	// LeafNodes
	LeafInterfacesWwanAuthenticationUsername types.String `tfsdk:"username" json:"username,omitempty"`
	LeafInterfacesWwanAuthenticationPassword types.String `tfsdk:"password" json:"password,omitempty"`
