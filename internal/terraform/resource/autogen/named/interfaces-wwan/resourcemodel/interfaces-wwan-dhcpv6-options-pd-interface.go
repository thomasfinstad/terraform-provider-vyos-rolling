...
type InterfacesWwanDhcpvsixOptionsPdInterface struct {
	// LeafNodes
	InterfacesWwanDhcpvsixOptionsPdInterfaceAddress customtypes.CustomStringValue `tfsdk:"address" json:"address,omitempty"`
	InterfacesWwanDhcpvsixOptionsPdInterfaceSLAID   customtypes.CustomStringValue `tfsdk:"sla_id" json:"sla-id,omitempty"`
...
func (o InterfacesWwanDhcpvsixOptionsPdInterface) ResourceAttributes() map[string]schema.Attribute {
