...
type QosPolicyShaperClassMatchIPDestination struct {
	// LeafNodes
	LeafQosPolicyShaperClassMatchIPDestinationAddress types.String `tfsdk:"address" json:"address,omitempty"`
	LeafQosPolicyShaperClassMatchIPDestinationPort    types.String `tfsdk:"port" json:"port,omitempty"`
