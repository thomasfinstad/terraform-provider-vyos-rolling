...
type QosPolicyShaperClassMatchIPvsix struct {
	// LeafNodes
	QosPolicyShaperClassMatchIPvsixDscp      customtypes.CustomStringValue `tfsdk:"dscp" json:"dscp,omitempty"`
	QosPolicyShaperClassMatchIPvsixMaxLength customtypes.CustomStringValue `tfsdk:"max_length" json:"max-length,omitempty"`
	QosPolicyShaperClassMatchIPvsixProtocol  customtypes.CustomStringValue `tfsdk:"protocol" json:"protocol,omitempty"`

	// TagNodes

	// Nodes
	QosPolicyShaperClassMatchIPvsixDestination types.Object `tfsdk:"destination" json:"destination,omitempty"`
	QosPolicyShaperClassMatchIPvsixSource      types.Object `tfsdk:"source" json:"source,omitempty"`
	QosPolicyShaperClassMatchIPvsixTCP         types.Object `tfsdk:"tcp" json:"tcp,omitempty"`
}

// ResourceAttributes generates the attributes for the resource at this level
func (o QosPolicyShaperClassMatchIPvsix) ResourceAttributes() map[string]schema.Attribute {
...
`,
		...
		"destination": schema.SingleNestedAttribute{
			Attributes: QosPolicyShaperClassMatchIPvsixDestination{}.ResourceAttributes(),
			Optional:   true,
...
`,
		...
		"source": schema.SingleNestedAttribute{
			Attributes: QosPolicyShaperClassMatchIPvsixSource{}.ResourceAttributes(),
			Optional:   true,
...
`,
		...
		"tcp": schema.SingleNestedAttribute{
			Attributes: QosPolicyShaperClassMatchIPvsixTCP{}.ResourceAttributes(),
			Optional:   true,
