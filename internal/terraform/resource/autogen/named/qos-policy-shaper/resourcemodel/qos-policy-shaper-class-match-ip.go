...
type QosPolicyShaperClassMatchIP struct {
	// LeafNodes
	LeafQosPolicyShaperClassMatchIPDscp      types.String `tfsdk:"dscp" json:"dscp,omitempty"`
	LeafQosPolicyShaperClassMatchIPMaxLength types.String `tfsdk:"max_length" json:"max-length,omitempty"`
	LeafQosPolicyShaperClassMatchIPProtocol  types.String `tfsdk:"protocol" json:"protocol,omitempty"`

	// TagNodes

	// Nodes
	NodeQosPolicyShaperClassMatchIPDestination *QosPolicyShaperClassMatchIPDestination `tfsdk:"destination" json:"destination,omitempty"`
	NodeQosPolicyShaperClassMatchIPSource      *QosPolicyShaperClassMatchIPSource      `tfsdk:"source" json:"source,omitempty"`
	NodeQosPolicyShaperClassMatchIPTCP         *QosPolicyShaperClassMatchIPTCP         `tfsdk:"tcp" json:"tcp,omitempty"`
}
