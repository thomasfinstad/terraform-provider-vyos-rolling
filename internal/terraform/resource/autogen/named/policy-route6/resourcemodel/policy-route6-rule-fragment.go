...
type PolicyRoutesixRuleFragment struct {
	// LeafNodes
	LeafPolicyRoutesixRuleFragmentMatchFrag    types.String `tfsdk:"match_frag" json:"match-frag,omitempty"`
	LeafPolicyRoutesixRuleFragmentMatchNonFrag types.String `tfsdk:"match_non_frag" json:"match-non-frag,omitempty"`
