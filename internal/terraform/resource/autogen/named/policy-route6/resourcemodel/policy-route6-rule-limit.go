...
type PolicyRoutesixRuleLimit struct {
	// LeafNodes
	LeafPolicyRoutesixRuleLimitBurst types.String `tfsdk:"burst" json:"burst,omitempty"`
	LeafPolicyRoutesixRuleLimitRate  types.String `tfsdk:"rate" json:"rate,omitempty"`
