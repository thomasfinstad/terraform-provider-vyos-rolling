...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/interfaces/wireless-vif-s-vif-c-dhcpv6-options-pd/resourcemodel"
)
...
func (r *interfacesWirelessVifSVifCDhcpvsixOptionsPd) GetProviderConfig() data.ProviderData {
...
func (r *interfacesWirelessVifSVifCDhcpvsixOptionsPd) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
