...
type InterfacesEthernetVifSVifCIPvsixAddress struct {
	// LeafNodes
	LeafInterfacesEthernetVifSVifCIPvsixAddressAutoconf           types.String `tfsdk:"autoconf" vyos:"autoconf,omitempty"`
	LeafInterfacesEthernetVifSVifCIPvsixAddressEuisixfour         types.String `tfsdk:"eui64" vyos:"eui64,omitempty"`
	LeafInterfacesEthernetVifSVifCIPvsixAddressNoDefaultLinkLocal types.String `tfsdk:"no_default_link_local" vyos:"no-default-link-local,omitempty"`
