...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/interfaces/wireless-dhcpv6-options-pd/resourcemodel"
)
...
func (r *interfacesWirelessDhcpvsixOptionsPd) GetProviderConfig() data.ProviderData {
...
func (r *interfacesWirelessDhcpvsixOptionsPd) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
