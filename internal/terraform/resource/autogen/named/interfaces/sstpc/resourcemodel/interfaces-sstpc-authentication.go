...
var _ helpers.VyosResourceDataModel = &InterfacesSstpcAuthentication{}
...
func (o InterfacesSstpcAuthentication) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
