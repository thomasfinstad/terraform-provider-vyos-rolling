...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/interfaces/wwan-dhcpv6-options-pd/resourcemodel"
)
...
func (r *interfacesWwanDhcpvsixOptionsPd) GetProviderConfig() data.ProviderData {
...
func (r *interfacesWwanDhcpvsixOptionsPd) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
