...
func (r *interfacesBondingVifSVifCDhcpvsixOptionsPd) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *interfacesBondingVifSVifCDhcpvsixOptionsPd) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *interfacesBondingVifSVifCDhcpvsixOptionsPd) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *interfacesBondingVifSVifCDhcpvsixOptionsPd) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
