...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/interfaces/wireless-vif-s-vif-c/resourcemodel"
)
...
func (r *interfacesWirelessVifSVifC) GetProviderConfig() data.ProviderData {
...
func (r *interfacesWirelessVifSVifC) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
