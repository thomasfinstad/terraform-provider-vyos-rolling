...
type InterfacesWwanIPvsixAddress struct {
	// LeafNodes
	LeafInterfacesWwanIPvsixAddressAutoconf           types.String `tfsdk:"autoconf" vyos:"autoconf,omitempty"`
	LeafInterfacesWwanIPvsixAddressEuisixfour         types.String `tfsdk:"eui64" vyos:"eui64,omitempty"`
	LeafInterfacesWwanIPvsixAddressNoDefaultLinkLocal types.String `tfsdk:"no_default_link_local" vyos:"no-default-link-local,omitempty"`
