...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/interfaces/ethernet-vif-s-dhcpv6-options-pd/resourcemodel"
)
...
func (r *interfacesEthernetVifSDhcpvsixOptionsPd) GetModel() helpers.VyosTopResourceDataModel {
	return r.model
}

// GetProviderConfig returns global provider data config
func (r *interfacesEthernetVifSDhcpvsixOptionsPd) GetProviderConfig() data.ProviderData {
...
func (r *interfacesEthernetVifSDhcpvsixOptionsPd) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
