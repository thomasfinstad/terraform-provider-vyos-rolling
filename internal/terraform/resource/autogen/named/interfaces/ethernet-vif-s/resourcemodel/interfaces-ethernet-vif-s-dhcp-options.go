...
type InterfacesEthernetVifSDhcpOptions struct {
	...
	LeafInterfacesEthernetVifSDhcpOptionsMtu                  types.String `tfsdk:"mtu" vyos:"mtu,omitempty"`
	LeafInterfacesEthernetVifSDhcpOptionsVendorClassID        types.String `tfsdk:"vendor_class_id" vyos:"vendor-class-id,omitempty"`
	LeafInterfacesEthernetVifSDhcpOptionsNoDefaultRoute       types.String `tfsdk:"no_default_route" vyos:"no-default-route,omitempty"`
	LeafInterfacesEthernetVifSDhcpOptionsDefaultRouteDistance types.String `tfsdk:"default_route_distance" vyos:"default-route-distance,omitempty"`
	LeafInterfacesEthernetVifSDhcpOptionsReject               types.String `tfsdk:"reject" vyos:"reject,omitempty"`
