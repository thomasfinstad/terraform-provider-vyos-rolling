...
type InterfacesBrIDgeIPvsixAddress struct {
	// LeafNodes
	LeafInterfacesBrIDgeIPvsixAddressAutoconf           types.String `tfsdk:"autoconf" vyos:"autoconf,omitempty"`
	LeafInterfacesBrIDgeIPvsixAddressEuisixfour         types.String `tfsdk:"eui64" vyos:"eui64,omitempty"`
	LeafInterfacesBrIDgeIPvsixAddressNoDefaultLinkLocal types.String `tfsdk:"no_default_link_local" vyos:"no-default-link-local,omitempty"`
