...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos/internal/terraform/resource/autogen/named/interfaces/pppoe-dhcpv6-options-pd/resourcemodel"
)
...
func (r *interfacesPppoeDhcpvsixOptionsPd) GetName() string {
