...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/interfaces/tunnel/resourcemodel"
)
...
func (r *interfacesTunnel) GetProviderConfig() data.ProviderData {
...
func (r *interfacesTunnel) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
