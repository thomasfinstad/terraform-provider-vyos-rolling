...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos/internal/terraform/resource/autogen/named/interfaces/ethernet-vif/resourcemodel"
)
...
func (r *interfacesEthernetVif) GetName() string {
