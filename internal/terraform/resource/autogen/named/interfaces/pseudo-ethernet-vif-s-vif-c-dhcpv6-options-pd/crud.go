...
func (r interfacesPseudoEthernetVifSVifCDhcpvsixOptionsPd) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	data := r.model
...
func (r interfacesPseudoEthernetVifSVifCDhcpvsixOptionsPd) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	data := r.model
...
func (r interfacesPseudoEthernetVifSVifCDhcpvsixOptionsPd) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	data := r.model
...
func (r interfacesPseudoEthernetVifSVifCDhcpvsixOptionsPd) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	data := r.model
