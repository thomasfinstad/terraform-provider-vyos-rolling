...
func (r interfacesPseudoEthernetVifDhcpvsixOptionsPdInterface) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	data := r.model
...
func (r interfacesPseudoEthernetVifDhcpvsixOptionsPdInterface) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	data := r.model
...
func (r interfacesPseudoEthernetVifDhcpvsixOptionsPdInterface) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	data := r.model
...
func (r interfacesPseudoEthernetVifDhcpvsixOptionsPdInterface) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	data := r.model
