...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/interfaces/bonding-dhcpv6-options-pd/resourcemodel"
)
...
func (r *interfacesBondingDhcpvsixOptionsPd) GetProviderConfig() data.ProviderData {
...
func (r *interfacesBondingDhcpvsixOptionsPd) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
