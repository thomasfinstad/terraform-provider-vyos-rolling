...
func (r interfacesWirelessVifSVifCDhcpvsixOptionsPdInterface) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	data := r.model
...
func (r interfacesWirelessVifSVifCDhcpvsixOptionsPdInterface) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	data := r.model
...
func (r interfacesWirelessVifSVifCDhcpvsixOptionsPdInterface) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	data := r.model
...
func (r interfacesWirelessVifSVifCDhcpvsixOptionsPdInterface) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	data := r.model
