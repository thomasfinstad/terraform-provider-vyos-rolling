...
type InterfacesVxlanParametersIPvsix struct {
	// LeafNodes
	InterfacesVxlanParametersIPvsixFlowlabel customtypes.CustomStringValue `tfsdk:"flowlabel" json:"flowlabel,omitempty"`
...
func (o InterfacesVxlanParametersIPvsix) ResourceAttributes() map[string]schema.Attribute {
