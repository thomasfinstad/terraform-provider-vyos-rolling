...
type VpnSstpClientIPvsixPoolPrefix struct {
	// LeafNodes
	VpnSstpClientIPvsixPoolPrefixMask customtypes.CustomStringValue `tfsdk:"mask" json:"mask,omitempty"`
...
func (o VpnSstpClientIPvsixPoolPrefix) ResourceAttributes() map[string]schema.Attribute {
