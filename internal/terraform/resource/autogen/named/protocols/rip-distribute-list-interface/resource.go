...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/protocols/rip-distribute-list-interface/resourcemodel"
)
...
func (r *protocolsRIPDistributeListInterface) GetProviderConfig() data.ProviderData {
...
func (r *protocolsRIPDistributeListInterface) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
