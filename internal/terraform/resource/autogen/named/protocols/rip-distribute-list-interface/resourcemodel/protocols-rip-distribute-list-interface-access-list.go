...
var _ helpers.VyosResourceDataModel = &ProtocolsRIPDistributeListInterfaceAccessList{}
...
func (o ProtocolsRIPDistributeListInterfaceAccessList) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
