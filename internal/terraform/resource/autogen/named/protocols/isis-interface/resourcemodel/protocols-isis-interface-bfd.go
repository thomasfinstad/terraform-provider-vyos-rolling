...
var _ helpers.VyosResourceDataModel = &ProtocolsIsisInterfaceBfd{}
...
func (o ProtocolsIsisInterfaceBfd) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
