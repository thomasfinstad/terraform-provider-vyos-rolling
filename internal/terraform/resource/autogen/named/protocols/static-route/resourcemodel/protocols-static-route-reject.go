...
var _ helpers.VyosResourceDataModel = &ProtocolsStaticRouteReject{}
...
func (o ProtocolsStaticRouteReject) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
