...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/protocols/igmp-proxy-interface/resourcemodel"
)
...
func (r *protocolsIgmpProxyInterface) GetProviderConfig() data.ProviderData {
...
func (r *protocolsIgmpProxyInterface) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
