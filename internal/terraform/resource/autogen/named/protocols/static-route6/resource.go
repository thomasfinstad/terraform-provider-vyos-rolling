...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos/internal/terraform/resource/autogen/named/protocols/static-route6/resourcemodel"
)
...
func (r *protocolsStaticRoutesix) GetName() string {
