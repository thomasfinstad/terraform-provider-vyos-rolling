...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/protocols/ospf-interface-authentication-md5-key-id/resourcemodel"
)
...
func (r *protocolsOspfInterfaceAuthenticationMdfiveKeyID) GetProviderConfig() data.ProviderData {
...
func (r *protocolsOspfInterfaceAuthenticationMdfiveKeyID) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
