...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/protocols/rip-interface-authentication-md5/resourcemodel"
)

/* tools/generate-terraform-resource-full/templates/resources/named/resource-tagnode-based-full.gotmpl #resource-tagnode-based-full (md5) */
...
func (r *protocolsRIPInterfaceAuthenticationMdfive) GetProviderConfig() data.ProviderData {
...
func (r *protocolsRIPInterfaceAuthenticationMdfive) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
