...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/protocols/mpls-ldp-neighbor/resourcemodel"
)
...
func (r *protocolsMplsLdpNeighbor) GetModel() helpers.VyosTopResourceDataModel {
	return r.model
}

// GetProviderConfig returns global provider data config
func (r *protocolsMplsLdpNeighbor) GetProviderConfig() data.ProviderData {
...
func (r *protocolsMplsLdpNeighbor) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
