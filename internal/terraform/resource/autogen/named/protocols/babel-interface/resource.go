...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/protocols/babel-interface/resourcemodel"
)
...
func (r *protocolsBabelInterface) GetProviderConfig() data.ProviderData {
...
func (r *protocolsBabelInterface) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
