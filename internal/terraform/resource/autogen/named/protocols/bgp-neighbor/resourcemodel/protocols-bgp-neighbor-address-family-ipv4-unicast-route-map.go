...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpNeighborAddressFamilyIPvfourUnicastRouteMap{}
...
func (o ProtocolsBgpNeighborAddressFamilyIPvfourUnicastRouteMap) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
