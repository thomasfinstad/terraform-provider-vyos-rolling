...
type ProtocolsBgpNeighborAddressFamilyIPvfourUnicastNexthopSelf struct {
	// LeafNodes
	LeafProtocolsBgpNeighborAddressFamilyIPvfourUnicastNexthopSelfForce types.String `tfsdk:"force" vyos:"force,omitempty"`
...
func (o *ProtocolsBgpNeighborAddressFamilyIPvfourUnicastNexthopSelf) MarshalJSON() ([]byte, error) {
	...
	if !o.LeafProtocolsBgpNeighborAddressFamilyIPvfourUnicastNexthopSelfForce.IsNull() && !o.LeafProtocolsBgpNeighborAddressFamilyIPvfourUnicastNexthopSelfForce.IsUnknown() {
		jsonData["force"] = o.LeafProtocolsBgpNeighborAddressFamilyIPvfourUnicastNexthopSelfForce.ValueString()
	}
...
func (o *ProtocolsBgpNeighborAddressFamilyIPvfourUnicastNexthopSelf) UnmarshalJSON(jsonStr []byte) error {
	jsonData := make(map[string]interface{})
