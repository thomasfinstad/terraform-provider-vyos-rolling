...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpNeighborAddressFamilyIPvsixUnicastPrefixList{}
...
type ProtocolsBgpNeighborAddressFamilyIPvsixUnicastPrefixList struct {
	// LeafNodes
	LeafProtocolsBgpNeighborAddressFamilyIPvsixUnicastPrefixListExport types.String `tfsdk:"export" vyos:"export,omitempty"`
	LeafProtocolsBgpNeighborAddressFamilyIPvsixUnicastPrefixListImport types.String `tfsdk:"import" vyos:"import,omitempty"`
...
func (o ProtocolsBgpNeighborAddressFamilyIPvsixUnicastPrefixList) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
