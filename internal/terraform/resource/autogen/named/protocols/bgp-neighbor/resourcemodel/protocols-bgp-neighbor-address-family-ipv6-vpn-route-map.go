...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpNeighborAddressFamilyIPvsixVpnRouteMap{}
...
func (o ProtocolsBgpNeighborAddressFamilyIPvsixVpnRouteMap) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
