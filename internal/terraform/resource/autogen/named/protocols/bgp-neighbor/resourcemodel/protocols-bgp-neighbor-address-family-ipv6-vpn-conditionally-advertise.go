...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpNeighborAddressFamilyIPvsixVpnConditionallyAdvertise{}
...
type ProtocolsBgpNeighborAddressFamilyIPvsixVpnConditionallyAdvertise struct {
	// LeafNodes
	LeafProtocolsBgpNeighborAddressFamilyIPvsixVpnConditionallyAdvertiseAdvertiseMap types.String `tfsdk:"advertise_map" vyos:"advertise-map,omitempty"`
	LeafProtocolsBgpNeighborAddressFamilyIPvsixVpnConditionallyAdvertiseExistMap     types.String `tfsdk:"exist_map" vyos:"exist-map,omitempty"`
	LeafProtocolsBgpNeighborAddressFamilyIPvsixVpnConditionallyAdvertiseNonExistMap  types.String `tfsdk:"non_exist_map" vyos:"non-exist-map,omitempty"`
...
func (o ProtocolsBgpNeighborAddressFamilyIPvsixVpnConditionallyAdvertise) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
