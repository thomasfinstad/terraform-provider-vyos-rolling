...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastDistributeList{}
...
func (o ProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastDistributeList) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
