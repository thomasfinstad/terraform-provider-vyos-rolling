...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpNeighborAddressFamilyIPvsixMulticastDistributeList{}
...
func (o ProtocolsBgpNeighborAddressFamilyIPvsixMulticastDistributeList) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
