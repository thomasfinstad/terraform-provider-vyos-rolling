...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpNeighborAddressFamilyIPvsixVpnDistributeList{}
...
type ProtocolsBgpNeighborAddressFamilyIPvsixVpnDistributeList struct {
	// LeafNodes
	LeafProtocolsBgpNeighborAddressFamilyIPvsixVpnDistributeListExport types.Number `tfsdk:"export" vyos:"export,omitempty"`
	LeafProtocolsBgpNeighborAddressFamilyIPvsixVpnDistributeListImport types.Number `tfsdk:"import" vyos:"import,omitempty"`
...
func (o ProtocolsBgpNeighborAddressFamilyIPvsixVpnDistributeList) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
