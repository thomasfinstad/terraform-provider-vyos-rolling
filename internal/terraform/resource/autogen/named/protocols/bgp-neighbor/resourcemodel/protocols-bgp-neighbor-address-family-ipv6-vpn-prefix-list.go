...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpNeighborAddressFamilyIPvsixVpnPrefixList{}
...
func (o ProtocolsBgpNeighborAddressFamilyIPvsixVpnPrefixList) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
