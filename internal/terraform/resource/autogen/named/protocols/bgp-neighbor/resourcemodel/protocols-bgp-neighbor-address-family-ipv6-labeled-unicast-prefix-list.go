...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastPrefixList{}
...
func (o ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastPrefixList) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
