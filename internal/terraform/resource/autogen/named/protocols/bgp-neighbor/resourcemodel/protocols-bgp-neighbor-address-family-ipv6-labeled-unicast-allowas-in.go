...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAllowasIn{}
...
type ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAllowasIn struct {
	// LeafNodes
	LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAllowasInNumber types.Number `tfsdk:"number" vyos:"number,omitempty"`
...
func (o ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAllowasIn) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
