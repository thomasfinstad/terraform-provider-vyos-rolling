...
type ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAllowasIn struct {
	// LeafNodes
	LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAllowasInNumber types.String `tfsdk:"number" vyos:"number,omitempty"`
...
func (o *ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAllowasIn) MarshalJSON() ([]byte, error) {
	...
	if !o.LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAllowasInNumber.IsNull() && !o.LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAllowasInNumber.IsUnknown() {
		jsonData["number"] = o.LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAllowasInNumber.ValueString()
	}
...
func (o *ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAllowasIn) UnmarshalJSON(jsonStr []byte) error {
	jsonData := make(map[string]interface{})
