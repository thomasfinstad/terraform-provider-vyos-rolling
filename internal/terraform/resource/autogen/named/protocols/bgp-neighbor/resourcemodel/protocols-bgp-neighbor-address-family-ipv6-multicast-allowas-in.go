...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpNeighborAddressFamilyIPvsixMulticastAllowasIn{}
...
func (o ProtocolsBgpNeighborAddressFamilyIPvsixMulticastAllowasIn) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
