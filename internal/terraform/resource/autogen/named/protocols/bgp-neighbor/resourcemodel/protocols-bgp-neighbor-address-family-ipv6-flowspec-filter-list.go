...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpNeighborAddressFamilyIPvsixFlowspecFilterList{}
...
func (o ProtocolsBgpNeighborAddressFamilyIPvsixFlowspecFilterList) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
