...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpNeighborAddressFamilyIPvsixFlowspecPrefixList{}
...
func (o ProtocolsBgpNeighborAddressFamilyIPvsixFlowspecPrefixList) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
