...
type ProtocolsBgpNeighborAddressFamilyIPvsixVpnAttributeUnchanged struct {
	// LeafNodes
	LeafProtocolsBgpNeighborAddressFamilyIPvsixVpnAttributeUnchangedAsPath  types.String `tfsdk:"as_path" vyos:"as-path,omitempty"`
	LeafProtocolsBgpNeighborAddressFamilyIPvsixVpnAttributeUnchangedMed     types.String `tfsdk:"med" vyos:"med,omitempty"`
	LeafProtocolsBgpNeighborAddressFamilyIPvsixVpnAttributeUnchangedNextHop types.String `tfsdk:"next_hop" vyos:"next-hop,omitempty"`
