...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpNeighborAddressFamilyIPvfourMulticastCapabilityOrf{}
...
func (o ProtocolsBgpNeighborAddressFamilyIPvfourMulticastCapabilityOrf) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
	return map[string]schema.Attribute{
		...
		"prefix_list": schema.SingleNestedAttribute{
			Attributes: ProtocolsBgpNeighborAddressFamilyIPvfourMulticastCapabilityOrfPrefixList{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
