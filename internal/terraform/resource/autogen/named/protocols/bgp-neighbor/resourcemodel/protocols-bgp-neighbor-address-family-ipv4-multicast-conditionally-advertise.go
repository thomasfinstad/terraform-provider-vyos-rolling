...
func (o ProtocolsBgpNeighborAddressFamilyIPvfourMulticastConditionallyAdvertise) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
