...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastAllowasIn{}
...
func (o ProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastAllowasIn) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
