...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpNeighborAddressFamilyIPvfourFlowspecFilterList{}
...
func (o ProtocolsBgpNeighborAddressFamilyIPvfourFlowspecFilterList) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
