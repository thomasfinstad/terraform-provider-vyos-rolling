...
type ProtocolsBgpNeighborAddressFamilyIPvfourVpnNexthopSelf struct {
	// LeafNodes
	LeafProtocolsBgpNeighborAddressFamilyIPvfourVpnNexthopSelfForce types.String `tfsdk:"force" vyos:"force,omitempty"`
...
func (o *ProtocolsBgpNeighborAddressFamilyIPvfourVpnNexthopSelf) MarshalJSON() ([]byte, error) {
	...
	if !o.LeafProtocolsBgpNeighborAddressFamilyIPvfourVpnNexthopSelfForce.IsNull() && !o.LeafProtocolsBgpNeighborAddressFamilyIPvfourVpnNexthopSelfForce.IsUnknown() {
		jsonData["force"] = o.LeafProtocolsBgpNeighborAddressFamilyIPvfourVpnNexthopSelfForce.ValueString()
	}
...
func (o *ProtocolsBgpNeighborAddressFamilyIPvfourVpnNexthopSelf) UnmarshalJSON(jsonStr []byte) error {
	jsonData := make(map[string]interface{})
