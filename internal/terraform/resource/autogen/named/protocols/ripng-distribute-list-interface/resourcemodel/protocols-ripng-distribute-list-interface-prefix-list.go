...
var _ helpers.VyosResourceDataModel = &ProtocolsRIPngDistributeListInterfacePrefixList{}
...
func (o ProtocolsRIPngDistributeListInterfacePrefixList) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
