...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/protocols/bgp-address-family-ipv4-multicast-aggregate-address/resourcemodel"
)
...
func (r *protocolsBgpAddressFamilyIPvfourMulticastAggregateAddress) GetProviderConfig() data.ProviderData {
...
func (r *protocolsBgpAddressFamilyIPvfourMulticastAggregateAddress) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
