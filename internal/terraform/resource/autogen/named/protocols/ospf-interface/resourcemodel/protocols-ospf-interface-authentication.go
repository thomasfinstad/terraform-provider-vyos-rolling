...
var _ helpers.VyosResourceDataModel = &ProtocolsOspfInterfaceAuthentication{}
...
func (o ProtocolsOspfInterfaceAuthentication) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
...
`,
		...
		"md5": schema.SingleNestedAttribute{
			Attributes: ProtocolsOspfInterfaceAuthenticationMdfive{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
