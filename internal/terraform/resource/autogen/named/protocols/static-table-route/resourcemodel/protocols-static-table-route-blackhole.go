...
var _ helpers.VyosResourceDataModel = &ProtocolsStaticTableRouteBlackhole{}
...
func (o ProtocolsStaticTableRouteBlackhole) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
