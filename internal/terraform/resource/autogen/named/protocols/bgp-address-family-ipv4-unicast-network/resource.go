...
func (r *protocolsBgpAddressFamilyIPvfourUnicastNetwork) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
