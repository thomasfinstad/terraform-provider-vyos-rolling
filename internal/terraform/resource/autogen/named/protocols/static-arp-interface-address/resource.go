...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/protocols/static-arp-interface-address/resourcemodel"
)
...
func (r *protocolsStaticArpInterfaceAddress) GetProviderConfig() data.ProviderData {
...
func (r *protocolsStaticArpInterfaceAddress) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
