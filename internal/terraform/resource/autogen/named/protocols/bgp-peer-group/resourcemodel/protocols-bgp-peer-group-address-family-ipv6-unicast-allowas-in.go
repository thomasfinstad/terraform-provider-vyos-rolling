...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastAllowasIn{}
...
func (o ProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastAllowasIn) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
