...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastPrefixList{}
...
type ProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastPrefixList struct {
	// LeafNodes
	LeafProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastPrefixListExport types.String `tfsdk:"export" vyos:"export,omitempty"`
	LeafProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastPrefixListImport types.String `tfsdk:"import" vyos:"import,omitempty"`
...
func (o ProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastPrefixList) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
