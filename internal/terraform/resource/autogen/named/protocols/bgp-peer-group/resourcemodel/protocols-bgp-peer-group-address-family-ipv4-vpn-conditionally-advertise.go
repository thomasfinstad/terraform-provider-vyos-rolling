...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpPeerGroupAddressFamilyIPvfourVpnConditionallyAdvertise{}

// ProtocolsBgpPeerGroupAddressFamilyIPvfourVpnConditionallyAdvertise describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type ProtocolsBgpPeerGroupAddressFamilyIPvfourVpnConditionallyAdvertise struct {
	// LeafNodes
	LeafProtocolsBgpPeerGroupAddressFamilyIPvfourVpnConditionallyAdvertiseAdvertiseMap types.String `tfsdk:"advertise_map" vyos:"advertise-map,omitempty"`
	LeafProtocolsBgpPeerGroupAddressFamilyIPvfourVpnConditionallyAdvertiseExistMap     types.String `tfsdk:"exist_map" vyos:"exist-map,omitempty"`
	LeafProtocolsBgpPeerGroupAddressFamilyIPvfourVpnConditionallyAdvertiseNonExistMap  types.String `tfsdk:"non_exist_map" vyos:"non-exist-map,omitempty"`
...
func (o ProtocolsBgpPeerGroupAddressFamilyIPvfourVpnConditionallyAdvertise) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
