...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpPeerGroupAddressFamilyIPvsixLabeledUnicastFilterList{}

// ProtocolsBgpPeerGroupAddressFamilyIPvsixLabeledUnicastFilterList describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type ProtocolsBgpPeerGroupAddressFamilyIPvsixLabeledUnicastFilterList struct {
	// LeafNodes
	LeafProtocolsBgpPeerGroupAddressFamilyIPvsixLabeledUnicastFilterListExport types.String `tfsdk:"export" vyos:"export,omitempty"`
	LeafProtocolsBgpPeerGroupAddressFamilyIPvsixLabeledUnicastFilterListImport types.String `tfsdk:"import" vyos:"import,omitempty"`
...
func (o ProtocolsBgpPeerGroupAddressFamilyIPvsixLabeledUnicastFilterList) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
