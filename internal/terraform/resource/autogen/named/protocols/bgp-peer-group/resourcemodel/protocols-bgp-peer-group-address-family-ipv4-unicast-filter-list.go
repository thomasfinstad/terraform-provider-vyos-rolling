...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastFilterList{}
...
func (o ProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastFilterList) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
