...
type ProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastSoftReconfiguration struct {
	// LeafNodes
	LeafProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastSoftReconfigurationInbound types.String `tfsdk:"inbound" vyos:"inbound,omitempty"`
...
func (o *ProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastSoftReconfiguration) MarshalJSON() ([]byte, error) {
	...
	if !o.LeafProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastSoftReconfigurationInbound.IsNull() && !o.LeafProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastSoftReconfigurationInbound.IsUnknown() {
		jsonData["inbound"] = o.LeafProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastSoftReconfigurationInbound.ValueString()
	}
...
func (o *ProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastSoftReconfiguration) UnmarshalJSON(jsonStr []byte) error {
	jsonData := make(map[string]interface{})
