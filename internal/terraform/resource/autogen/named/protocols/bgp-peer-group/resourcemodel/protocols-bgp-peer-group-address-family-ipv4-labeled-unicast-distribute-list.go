...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpPeerGroupAddressFamilyIPvfourLabeledUnicastDistributeList{}

// ProtocolsBgpPeerGroupAddressFamilyIPvfourLabeledUnicastDistributeList describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type ProtocolsBgpPeerGroupAddressFamilyIPvfourLabeledUnicastDistributeList struct {
	// LeafNodes
	LeafProtocolsBgpPeerGroupAddressFamilyIPvfourLabeledUnicastDistributeListExport types.Number `tfsdk:"export" vyos:"export,omitempty"`
	LeafProtocolsBgpPeerGroupAddressFamilyIPvfourLabeledUnicastDistributeListImport types.Number `tfsdk:"import" vyos:"import,omitempty"`
...
func (o ProtocolsBgpPeerGroupAddressFamilyIPvfourLabeledUnicastDistributeList) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
