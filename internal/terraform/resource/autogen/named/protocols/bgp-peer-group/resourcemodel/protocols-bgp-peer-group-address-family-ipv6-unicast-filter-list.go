...
type ProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastFilterList struct {
	// LeafNodes
	LeafProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastFilterListExport types.String `tfsdk:"export" vyos:"export,omitempty"`
	LeafProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastFilterListImport types.String `tfsdk:"import" vyos:"import,omitempty"`
