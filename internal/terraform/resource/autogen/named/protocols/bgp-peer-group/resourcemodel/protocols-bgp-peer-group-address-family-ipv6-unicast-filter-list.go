...
var _ helpers.VyosResourceDataModel = &ProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastFilterList{}
...
func (o ProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastFilterList) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
