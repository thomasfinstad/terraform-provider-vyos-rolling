...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos/internal/terraform/resource/autogen/named/protocols/static-route6-next-hop/resourcemodel"
)
...
func (r *protocolsStaticRoutesixNextHop) GetName() string {
