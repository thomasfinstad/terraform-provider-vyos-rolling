...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/protocols/nhrp-tunnel-dynamic-map/resourcemodel"
)
...
func (r *protocolsNhrpTunnelDynamicMap) GetModel() helpers.VyosTopResourceDataModel {
	return r.model
}

// GetProviderConfig returns global provider data config
func (r *protocolsNhrpTunnelDynamicMap) GetProviderConfig() data.ProviderData {
...
func (r *protocolsNhrpTunnelDynamicMap) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
