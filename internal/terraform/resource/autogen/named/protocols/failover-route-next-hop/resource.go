...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/protocols/failover-route-next-hop/resourcemodel"
)
...
func (r *protocolsFailoverRouteNextHop) GetProviderConfig() data.ProviderData {
...
func (r *protocolsFailoverRouteNextHop) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
