...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/vrf/name-protocols-static-route6-next-hop-bfd-multi-hop-source/resourcemodel"
)
...
func (r *vrfNameProtocolsStaticRoutesixNextHopBfdMultiHopSource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
