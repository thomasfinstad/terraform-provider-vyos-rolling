...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/vrf/name-protocols-ospf-redistribute-table/resourcemodel"
)
...
func (r *vrfNameProtocolsOspfRedistributeTable) GetProviderConfig() data.ProviderData {
...
func (r *vrfNameProtocolsOspfRedistributeTable) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
