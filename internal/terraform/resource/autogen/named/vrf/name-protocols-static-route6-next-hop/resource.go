...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/vrf/name-protocols-static-route6-next-hop/resourcemodel"
)
...
func (r *vrfNameProtocolsStaticRoutesixNextHop) GetProviderConfig() data.ProviderData {
...
func (r *vrfNameProtocolsStaticRoutesixNextHop) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
