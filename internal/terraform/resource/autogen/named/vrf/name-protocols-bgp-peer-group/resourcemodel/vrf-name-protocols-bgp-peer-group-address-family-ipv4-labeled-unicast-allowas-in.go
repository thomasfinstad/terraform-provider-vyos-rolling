...
func (o VrfNameProtocolsBgpPeerGroupAddressFamilyIPvfourLabeledUnicastAllowasIn) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
