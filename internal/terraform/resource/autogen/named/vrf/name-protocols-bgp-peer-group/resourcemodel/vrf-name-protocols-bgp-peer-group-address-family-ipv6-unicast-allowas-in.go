...
type VrfNameProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastAllowasIn struct {
	// LeafNodes
	LeafVrfNameProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastAllowasInNumber types.String `tfsdk:"number" vyos:"number,omitempty"`
...
func (o *VrfNameProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastAllowasIn) MarshalJSON() ([]byte, error) {
	...
	if !o.LeafVrfNameProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastAllowasInNumber.IsNull() && !o.LeafVrfNameProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastAllowasInNumber.IsUnknown() {
		jsonData["number"] = o.LeafVrfNameProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastAllowasInNumber.ValueString()
	}
...
func (o *VrfNameProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastAllowasIn) UnmarshalJSON(jsonStr []byte) error {
	jsonData := make(map[string]interface{})
