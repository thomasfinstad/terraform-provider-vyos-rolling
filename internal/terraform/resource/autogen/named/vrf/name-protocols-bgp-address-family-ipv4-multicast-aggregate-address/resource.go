...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/vrf/name-protocols-bgp-address-family-ipv4-multicast-aggregate-address/resourcemodel"
)
...
func (r *vrfNameProtocolsBgpAddressFamilyIPvfourMulticastAggregateAddress) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
