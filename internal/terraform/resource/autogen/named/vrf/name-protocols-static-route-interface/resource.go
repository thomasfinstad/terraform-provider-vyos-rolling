...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/vrf/name-protocols-static-route-interface/resourcemodel"
)
...
func (r *vrfNameProtocolsStaticRouteInterface) GetProviderConfig() data.ProviderData {
...
func (r *vrfNameProtocolsStaticRouteInterface) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
