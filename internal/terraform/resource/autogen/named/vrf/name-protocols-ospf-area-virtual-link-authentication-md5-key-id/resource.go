...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/vrf/name-protocols-ospf-area-virtual-link-authentication-md5-key-id/resourcemodel"
)
...
func (r *vrfNameProtocolsOspfAreaVirtualLinkAuthenticationMdfiveKeyID) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
