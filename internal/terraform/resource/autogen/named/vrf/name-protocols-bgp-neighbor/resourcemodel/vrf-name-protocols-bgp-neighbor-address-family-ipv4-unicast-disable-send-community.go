...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastDisableSendCommunity struct {
	// LeafNodes
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastDisableSendCommunityExtended types.String `tfsdk:"extended" vyos:"extended,omitempty"`
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastDisableSendCommunityStandard types.String `tfsdk:"standard" vyos:"standard,omitempty"`
...
func (o *VrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastDisableSendCommunity) MarshalJSON() ([]byte, error) {
	...
	if !o.LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastDisableSendCommunityExtended.IsNull() && !o.LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastDisableSendCommunityExtended.IsUnknown() {
		jsonData["extended"] = o.LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastDisableSendCommunityExtended.ValueString()
	}
	...
	if !o.LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastDisableSendCommunityStandard.IsNull() && !o.LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastDisableSendCommunityStandard.IsUnknown() {
		jsonData["standard"] = o.LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastDisableSendCommunityStandard.ValueString()
	}
...
func (o *VrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastDisableSendCommunity) UnmarshalJSON(jsonStr []byte) error {
	jsonData := make(map[string]interface{})
