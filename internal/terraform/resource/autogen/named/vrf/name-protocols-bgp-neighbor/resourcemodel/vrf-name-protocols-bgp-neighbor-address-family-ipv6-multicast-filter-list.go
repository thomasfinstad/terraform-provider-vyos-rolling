...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvsixMulticastFilterList struct {
	// LeafNodes
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvsixMulticastFilterListExport types.String `tfsdk:"export" vyos:"export,omitempty"`
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvsixMulticastFilterListImport types.String `tfsdk:"import" vyos:"import,omitempty"`
