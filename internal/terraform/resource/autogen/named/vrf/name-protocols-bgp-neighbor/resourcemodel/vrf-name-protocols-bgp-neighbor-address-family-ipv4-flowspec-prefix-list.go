...
var _ helpers.VyosResourceDataModel = &VrfNameProtocolsBgpNeighborAddressFamilyIPvfourFlowspecPrefixList{}
...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvfourFlowspecPrefixList struct {
	// LeafNodes
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourFlowspecPrefixListExport types.String `tfsdk:"export" vyos:"export,omitempty"`
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourFlowspecPrefixListImport types.String `tfsdk:"import" vyos:"import,omitempty"`
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvfourFlowspecPrefixList) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
