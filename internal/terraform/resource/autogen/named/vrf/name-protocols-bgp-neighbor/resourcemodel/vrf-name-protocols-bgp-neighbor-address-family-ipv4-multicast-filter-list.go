...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvfourMulticastFilterList struct {
	// LeafNodes
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourMulticastFilterListExport types.String `tfsdk:"export" vyos:"export,omitempty"`
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourMulticastFilterListImport types.String `tfsdk:"import" vyos:"import,omitempty"`
