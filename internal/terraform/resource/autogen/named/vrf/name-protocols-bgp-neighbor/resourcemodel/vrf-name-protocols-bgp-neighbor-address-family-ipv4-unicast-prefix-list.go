...
var _ helpers.VyosResourceDataModel = &VrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastPrefixList{}
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastPrefixList) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
