...
var _ helpers.VyosResourceDataModel = &VrfNameProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAllowasIn{}
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAllowasIn) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
