...
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastConditionallyAdvertise) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
