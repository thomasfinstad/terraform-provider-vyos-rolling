...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvsixFlowspecFilterList struct {
	// LeafNodes
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvsixFlowspecFilterListExport types.String `tfsdk:"export" vyos:"export,omitempty"`
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvsixFlowspecFilterListImport types.String `tfsdk:"import" vyos:"import,omitempty"`
