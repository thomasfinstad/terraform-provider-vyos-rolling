...
var _ helpers.VyosResourceDataModel = &VrfNameProtocolsBgpNeighborAddressFamilyIPvfourMulticastPrefixList{}
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvfourMulticastPrefixList) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
