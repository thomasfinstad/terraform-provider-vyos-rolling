...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastNexthopSelf struct {
	// LeafNodes
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastNexthopSelfForce types.String `tfsdk:"force" vyos:"force,omitempty"`
...
func (o *VrfNameProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastNexthopSelf) MarshalJSON() ([]byte, error) {
	...
	if !o.LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastNexthopSelfForce.IsNull() && !o.LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastNexthopSelfForce.IsUnknown() {
		jsonData["force"] = o.LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastNexthopSelfForce.ValueString()
	}
...
func (o *VrfNameProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastNexthopSelf) UnmarshalJSON(jsonStr []byte) error {
	jsonData := make(map[string]interface{})
