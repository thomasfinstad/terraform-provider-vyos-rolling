...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/vrf/name-protocols-bgp-address-family-ipv6-unicast-aggregate-address/resourcemodel"
)
...
func (r *vrfNameProtocolsBgpAddressFamilyIPvsixUnicastAggregateAddress) GetProviderConfig() data.ProviderData {
...
func (r *vrfNameProtocolsBgpAddressFamilyIPvsixUnicastAggregateAddress) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
