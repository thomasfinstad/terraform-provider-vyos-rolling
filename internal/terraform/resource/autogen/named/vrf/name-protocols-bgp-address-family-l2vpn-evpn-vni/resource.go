...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/vrf/name-protocols-bgp-address-family-l2vpn-evpn-vni/resourcemodel"
)
...
func (r *vrfNameProtocolsBgpAddressFamilyLtwovpnEvpnVni) GetProviderConfig() data.ProviderData {
...
func (r *vrfNameProtocolsBgpAddressFamilyLtwovpnEvpnVni) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
