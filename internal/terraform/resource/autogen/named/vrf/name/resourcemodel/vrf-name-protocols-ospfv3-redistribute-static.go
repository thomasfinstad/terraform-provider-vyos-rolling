...
var _ helpers.VyosResourceDataModel = &VrfNameProtocolsOspfvthreeRedistributeStatic{}
...
type VrfNameProtocolsOspfvthreeRedistributeStatic struct {
	// LeafNodes
	LeafVrfNameProtocolsOspfvthreeRedistributeStaticMetric     types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafVrfNameProtocolsOspfvthreeRedistributeStaticMetricType types.Number `tfsdk:"metric_type" vyos:"metric-type,omitempty"`
	LeafVrfNameProtocolsOspfvthreeRedistributeStaticRouteMap   types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o VrfNameProtocolsOspfvthreeRedistributeStatic) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
