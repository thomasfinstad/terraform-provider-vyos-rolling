...
var _ helpers.VyosResourceDataModel = &VrfNameProtocolsIsisRedistributeIPvsixConnectedLevelOne{}
...
func (o VrfNameProtocolsIsisRedistributeIPvsixConnectedLevelOne) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
