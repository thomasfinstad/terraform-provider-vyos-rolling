...
var _ helpers.VyosResourceDataModel = &VrfNameProtocolsIsisRedistributeIPvfourBabelLevelOne{}
...
type VrfNameProtocolsIsisRedistributeIPvfourBabelLevelOne struct {
	// LeafNodes
	LeafVrfNameProtocolsIsisRedistributeIPvfourBabelLevelOneMetric   types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
...
func (o VrfNameProtocolsIsisRedistributeIPvfourBabelLevelOne) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
