...
var _ helpers.VyosResourceDataModel = &VrfNameProtocolsIsisRedistributeIPvsixStaticLevelOne{}
...
func (o VrfNameProtocolsIsisRedistributeIPvsixStaticLevelOne) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
