...
var _ helpers.VyosResourceDataModel = &VrfNameProtocolsOspfRedistributeBgp{}
...
func (o VrfNameProtocolsOspfRedistributeBgp) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
