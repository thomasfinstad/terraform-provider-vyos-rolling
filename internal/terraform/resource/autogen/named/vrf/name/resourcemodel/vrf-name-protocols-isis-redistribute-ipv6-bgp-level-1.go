...
type VrfNameProtocolsIsisRedistributeIPvsixBgpLevelOne struct {
	// LeafNodes
	LeafVrfNameProtocolsIsisRedistributeIPvsixBgpLevelOneMetric   types.String `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafVrfNameProtocolsIsisRedistributeIPvsixBgpLevelOneRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
