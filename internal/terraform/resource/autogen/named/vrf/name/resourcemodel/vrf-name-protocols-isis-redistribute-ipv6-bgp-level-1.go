...
var _ helpers.VyosResourceDataModel = &VrfNameProtocolsIsisRedistributeIPvsixBgpLevelOne{}
...
type VrfNameProtocolsIsisRedistributeIPvsixBgpLevelOne struct {
	// LeafNodes
	LeafVrfNameProtocolsIsisRedistributeIPvsixBgpLevelOneMetric   types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
...
func (o VrfNameProtocolsIsisRedistributeIPvsixBgpLevelOne) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
