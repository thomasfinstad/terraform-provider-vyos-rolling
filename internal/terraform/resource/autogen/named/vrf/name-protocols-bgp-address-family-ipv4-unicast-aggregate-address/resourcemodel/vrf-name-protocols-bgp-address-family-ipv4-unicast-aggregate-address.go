...
type VrfNameProtocolsBgpAddressFamilyIPvfourUnicastAggregateAddress struct {
	...
	// LeafNodes
	LeafVrfNameProtocolsBgpAddressFamilyIPvfourUnicastAggregateAddressAsSet       types.String `tfsdk:"as_set" vyos:"as-set,omitempty"`
	...
	LeafVrfNameProtocolsBgpAddressFamilyIPvfourUnicastAggregateAddressSummaryOnly types.String `tfsdk:"summary_only" vyos:"summary-only,omitempty"`
