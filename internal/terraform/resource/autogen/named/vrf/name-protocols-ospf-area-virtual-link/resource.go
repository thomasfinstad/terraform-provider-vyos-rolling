...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/vrf/name-protocols-ospf-area-virtual-link/resourcemodel"
)
...
func (r *vrfNameProtocolsOspfAreaVirtualLink) GetModel() helpers.VyosTopResourceDataModel {
	return r.model
}

// GetProviderConfig returns global provider data config
func (r *vrfNameProtocolsOspfAreaVirtualLink) GetProviderConfig() data.ProviderData {
...
func (r *vrfNameProtocolsOspfAreaVirtualLink) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
