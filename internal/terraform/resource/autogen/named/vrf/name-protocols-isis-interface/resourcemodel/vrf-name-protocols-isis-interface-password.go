...
var _ helpers.VyosResourceDataModel = &VrfNameProtocolsIsisInterfacePassword{}
...
func (o VrfNameProtocolsIsisInterfacePassword) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
