...
func (r *vrfNameProtocolsBgpAddressFamilyIPvsixMulticastAggregateAddress) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
