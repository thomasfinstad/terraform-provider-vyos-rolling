...
type InterfacesBrIDgeDhcpvsixOptionsPd struct {
	// LeafNodes
	LeafInterfacesBrIDgeDhcpvsixOptionsPdLength types.String `tfsdk:"length" json:"length,omitempty"`

	// TagNodes
	TagInterfacesBrIDgeDhcpvsixOptionsPdInterface *map[string]InterfacesBrIDgeDhcpvsixOptionsPdInterface `tfsdk:"interface" json:"interface,omitempty"`
...
func (o *InterfacesBrIDgeDhcpvsixOptionsPd) MarshalJSON() ([]byte, error) {
	...
	if !reflect.ValueOf(o.TagInterfacesBrIDgeDhcpvsixOptionsPdInterface).IsZero() {
		subJSONStr, err := json.Marshal(o.TagInterfacesBrIDgeDhcpvsixOptionsPdInterface)
		if err != nil {
			return nil, err
		}
...
func (o *InterfacesBrIDgeDhcpvsixOptionsPd) UnmarshalJSON(jsonStr []byte) error {
	...
	if value, ok := jsonData["interface"]; ok {
		...
		o.TagInterfacesBrIDgeDhcpvsixOptionsPdInterface = &map[string]InterfacesBrIDgeDhcpvsixOptionsPdInterface{}

		err = json.Unmarshal(subJSONStr, o.TagInterfacesBrIDgeDhcpvsixOptionsPdInterface)
		if err != nil {
			return err
		}
	}
