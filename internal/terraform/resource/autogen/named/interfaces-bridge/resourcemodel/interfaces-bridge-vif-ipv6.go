...
type InterfacesBrIDgeVifIPvsix struct {
	// LeafNodes
	LeafInterfacesBrIDgeVifIPvsixAdjustMss              types.String `tfsdk:"adjust_mss" json:"adjust-mss,omitempty"`
	LeafInterfacesBrIDgeVifIPvsixDisableForwarding      types.String `tfsdk:"disable_forwarding" json:"disable-forwarding,omitempty"`
	LeafInterfacesBrIDgeVifIPvsixDupAddrDetectTransmits types.String `tfsdk:"dup_addr_detect_transmits" json:"dup-addr-detect-transmits,omitempty"`

	// TagNodes

	// Nodes
	NodeInterfacesBrIDgeVifIPvsixAddress *InterfacesBrIDgeVifIPvsixAddress `tfsdk:"address" json:"address,omitempty"`
}
