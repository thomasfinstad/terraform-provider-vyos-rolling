...
type InterfacesBrIDgeMirror struct {
	// LeafNodes
	InterfacesBrIDgeMirrorIngress customtypes.CustomStringValue `tfsdk:"ingress" json:"ingress,omitempty"`
	InterfacesBrIDgeMirrorEgress  customtypes.CustomStringValue `tfsdk:"egress" json:"egress,omitempty"`
...
func (o InterfacesBrIDgeMirror) ResourceAttributes() map[string]schema.Attribute {
