...
type InterfacesBrIDgeVifDhcpvsixOptionsPdInterface struct {
	// LeafNodes
	InterfacesBrIDgeVifDhcpvsixOptionsPdInterfaceAddress customtypes.CustomStringValue `tfsdk:"address" json:"address,omitempty"`
	InterfacesBrIDgeVifDhcpvsixOptionsPdInterfaceSLAID   customtypes.CustomStringValue `tfsdk:"sla_id" json:"sla-id,omitempty"`
...
func (o InterfacesBrIDgeVifDhcpvsixOptionsPdInterface) ResourceAttributes() map[string]schema.Attribute {
