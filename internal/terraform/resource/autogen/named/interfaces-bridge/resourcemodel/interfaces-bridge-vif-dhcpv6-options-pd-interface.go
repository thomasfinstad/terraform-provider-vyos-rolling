...
type InterfacesBrIDgeVifDhcpvsixOptionsPdInterface struct {
	// LeafNodes
	LeafInterfacesBrIDgeVifDhcpvsixOptionsPdInterfaceAddress types.String `tfsdk:"address" json:"address,omitempty"`
	LeafInterfacesBrIDgeVifDhcpvsixOptionsPdInterfaceSLAID   types.String `tfsdk:"sla_id" json:"sla-id,omitempty"`
