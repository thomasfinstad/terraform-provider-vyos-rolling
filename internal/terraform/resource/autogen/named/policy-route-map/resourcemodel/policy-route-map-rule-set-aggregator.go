...
type PolicyRouteMapRuleSetAggregator struct {
	// LeafNodes
	LeafPolicyRouteMapRuleSetAggregatorAs types.String `tfsdk:"as" json:"as,omitempty"`
	LeafPolicyRouteMapRuleSetAggregatorIP types.String `tfsdk:"ip" json:"ip,omitempty"`
