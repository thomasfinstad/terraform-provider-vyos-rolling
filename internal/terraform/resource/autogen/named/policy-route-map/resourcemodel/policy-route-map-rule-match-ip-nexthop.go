...
type PolicyRouteMapRuleMatchIPNexthop struct {
	// LeafNodes
	LeafPolicyRouteMapRuleMatchIPNexthopAddress    types.String `tfsdk:"address" json:"address,omitempty"`
	LeafPolicyRouteMapRuleMatchIPNexthopAccessList types.String `tfsdk:"access_list" json:"access-list,omitempty"`
	LeafPolicyRouteMapRuleMatchIPNexthopPrefixLen  types.String `tfsdk:"prefix_len" json:"prefix-len,omitempty"`
	LeafPolicyRouteMapRuleMatchIPNexthopPrefixList types.String `tfsdk:"prefix_list" json:"prefix-list,omitempty"`
	LeafPolicyRouteMapRuleMatchIPNexthopType       types.String `tfsdk:"type" json:"type,omitempty"`
