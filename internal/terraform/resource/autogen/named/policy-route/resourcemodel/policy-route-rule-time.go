...
type PolicyRouteRuleTime struct {
	// LeafNodes
	LeafPolicyRouteRuleTimeMonthdays types.String `tfsdk:"monthdays" json:"monthdays,omitempty"`
	LeafPolicyRouteRuleTimeStartdate types.String `tfsdk:"startdate" json:"startdate,omitempty"`
	LeafPolicyRouteRuleTimeStarttime types.String `tfsdk:"starttime" json:"starttime,omitempty"`
	LeafPolicyRouteRuleTimeStopdate  types.String `tfsdk:"stopdate" json:"stopdate,omitempty"`
	LeafPolicyRouteRuleTimeStoptime  types.String `tfsdk:"stoptime" json:"stoptime,omitempty"`
	LeafPolicyRouteRuleTimeUtc       types.String `tfsdk:"utc" json:"utc,omitempty"`
	LeafPolicyRouteRuleTimeWeekdays  types.String `tfsdk:"weekdays" json:"weekdays,omitempty"`
