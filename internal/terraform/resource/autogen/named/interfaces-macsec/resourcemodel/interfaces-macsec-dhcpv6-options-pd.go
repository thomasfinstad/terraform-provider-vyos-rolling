...
type InterfacesMacsecDhcpvsixOptionsPd struct {
	// LeafNodes
	LeafInterfacesMacsecDhcpvsixOptionsPdLength types.String `tfsdk:"length" json:"length,omitempty"`

	// TagNodes
	TagInterfacesMacsecDhcpvsixOptionsPdInterface *map[string]InterfacesMacsecDhcpvsixOptionsPdInterface `tfsdk:"interface" json:"interface,omitempty"`
...
func (o *InterfacesMacsecDhcpvsixOptionsPd) MarshalJSON() ([]byte, error) {
	...
	if !reflect.ValueOf(o.TagInterfacesMacsecDhcpvsixOptionsPdInterface).IsZero() {
		subJSONStr, err := json.Marshal(o.TagInterfacesMacsecDhcpvsixOptionsPdInterface)
		if err != nil {
			return nil, err
		}
...
func (o *InterfacesMacsecDhcpvsixOptionsPd) UnmarshalJSON(jsonStr []byte) error {
	...
	if value, ok := jsonData["interface"]; ok {
		...
		o.TagInterfacesMacsecDhcpvsixOptionsPdInterface = &map[string]InterfacesMacsecDhcpvsixOptionsPdInterface{}

		err = json.Unmarshal(subJSONStr, o.TagInterfacesMacsecDhcpvsixOptionsPdInterface)
		if err != nil {
			return err
		}
	}
