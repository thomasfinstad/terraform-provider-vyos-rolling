...
type InterfacesMacsecMirror struct {
	// LeafNodes
	InterfacesMacsecMirrorIngress customtypes.CustomStringValue `tfsdk:"ingress" json:"ingress,omitempty"`
	InterfacesMacsecMirrorEgress  customtypes.CustomStringValue `tfsdk:"egress" json:"egress,omitempty"`
...
func (o InterfacesMacsecMirror) ResourceAttributes() map[string]schema.Attribute {
