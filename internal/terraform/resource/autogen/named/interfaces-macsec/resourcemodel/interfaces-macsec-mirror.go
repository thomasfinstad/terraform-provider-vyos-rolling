...
type InterfacesMacsecMirror struct {
	// LeafNodes
	LeafInterfacesMacsecMirrorIngress types.String `tfsdk:"ingress" json:"ingress,omitempty"`
	LeafInterfacesMacsecMirrorEgress  types.String `tfsdk:"egress" json:"egress,omitempty"`
