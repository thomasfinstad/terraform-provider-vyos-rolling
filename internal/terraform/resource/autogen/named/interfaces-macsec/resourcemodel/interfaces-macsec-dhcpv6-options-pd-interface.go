...
type InterfacesMacsecDhcpvsixOptionsPdInterface struct {
	// LeafNodes
	LeafInterfacesMacsecDhcpvsixOptionsPdInterfaceAddress types.String `tfsdk:"address"`
	LeafInterfacesMacsecDhcpvsixOptionsPdInterfaceSLAID   types.String `tfsdk:"sla_id"`
...
func (o *InterfacesMacsecDhcpvsixOptionsPdInterface) TerraformToVyos(ctx context.Context, diags *diag.Diagnostics) map[string]interface{} {
	tflog.Error(ctx, "TerraformToVyos", map[string]interface{}{"Path": []string{"interfaces", "macsec", "dhcpv6-options", "pd", "interface"}})
	...
	if !(o.LeafInterfacesMacsecDhcpvsixOptionsPdInterfaceAddress.IsNull() || o.LeafInterfacesMacsecDhcpvsixOptionsPdInterfaceAddress.IsUnknown()) {
		vyosData["address"] = o.LeafInterfacesMacsecDhcpvsixOptionsPdInterfaceAddress.ValueString()
	}
	if !(o.LeafInterfacesMacsecDhcpvsixOptionsPdInterfaceSLAID.IsNull() || o.LeafInterfacesMacsecDhcpvsixOptionsPdInterfaceSLAID.IsUnknown()) {
		vyosData["sla-id"] = o.LeafInterfacesMacsecDhcpvsixOptionsPdInterfaceSLAID.ValueString()
	}
...
func (o *InterfacesMacsecDhcpvsixOptionsPdInterface) VyosToTerraform(ctx context.Context, diags *diag.Diagnostics, vyosData map[string]interface{}) {
	tflog.Error(ctx, "VyosToTerraform begin", map[string]interface{}{"Path": []string{"interfaces", "macsec", "dhcpv6-options", "pd", "interface"}})
	...
	tflog.Error(ctx, "VyosToTerraform end", map[string]interface{}{"Path": []string{"interfaces", "macsec", "dhcpv6-options", "pd", "interface"}})
}

// AttributeTypes generates the attribute types for the resource at this level
func (o InterfacesMacsecDhcpvsixOptionsPdInterface) AttributeTypes() map[string]attr.Type {
