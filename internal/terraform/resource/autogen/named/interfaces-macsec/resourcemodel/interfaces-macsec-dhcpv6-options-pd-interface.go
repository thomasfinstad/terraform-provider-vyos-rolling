...
type InterfacesMacsecDhcpvsixOptionsPdInterface struct {
	// LeafNodes
	InterfacesMacsecDhcpvsixOptionsPdInterfaceAddress customtypes.CustomStringValue `tfsdk:"address" json:"address,omitempty"`
	InterfacesMacsecDhcpvsixOptionsPdInterfaceSLAID   customtypes.CustomStringValue `tfsdk:"sla_id" json:"sla-id,omitempty"`
...
func (o InterfacesMacsecDhcpvsixOptionsPdInterface) ResourceAttributes() map[string]schema.Attribute {
