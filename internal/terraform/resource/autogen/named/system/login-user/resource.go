...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/system/login-user/resourcemodel"
)
...
func (r *systemLoginUser) GetProviderConfig() data.ProviderData {
...
func (r *systemLoginUser) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
