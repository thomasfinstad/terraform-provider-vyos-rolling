...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos/internal/terraform/resource/autogen/named/system/sflow-server/resourcemodel"
)
...
func (r *systemSflowServer) GetName() string {
