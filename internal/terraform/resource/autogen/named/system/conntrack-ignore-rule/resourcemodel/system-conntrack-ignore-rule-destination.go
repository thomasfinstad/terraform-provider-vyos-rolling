...
type SystemConntrackIgnoreRuleDestination struct {
	// LeafNodes
	LeafSystemConntrackIgnoreRuleDestinationAddress types.String `tfsdk:"address" vyos:"address,omitempty"`
	LeafSystemConntrackIgnoreRuleDestinationPort    types.String `tfsdk:"port" vyos:"port,omitempty"`
