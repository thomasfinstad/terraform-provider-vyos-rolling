...
type SystemConntrackIgnoreRuleSource struct {
	// LeafNodes
	LeafSystemConntrackIgnoreRuleSourceAddress types.String `tfsdk:"address" vyos:"address,omitempty"`
	LeafSystemConntrackIgnoreRuleSourcePort    types.String `tfsdk:"port" vyos:"port,omitempty"`
...
func (o *SystemConntrackIgnoreRuleSource) UnmarshalJSON(_ []byte) error {
	return nil
}
