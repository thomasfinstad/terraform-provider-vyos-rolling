...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/system/flow-accounting-sflow-server/resourcemodel"
)
...
func (r *systemFlowAccountingSflowServer) GetProviderConfig() data.ProviderData {
...
func (r *systemFlowAccountingSflowServer) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
