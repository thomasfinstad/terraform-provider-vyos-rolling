...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/system/login-radius-server/resourcemodel"
)
...
func (r *systemLoginRadiusServer) GetProviderConfig() data.ProviderData {
...
func (r *systemLoginRadiusServer) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
