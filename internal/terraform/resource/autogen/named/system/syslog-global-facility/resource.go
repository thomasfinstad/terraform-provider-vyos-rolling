...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/system/syslog-global-facility/resourcemodel"
)
...
func (r *systemSyslogGlobalFacility) GetModel() helpers.VyosTopResourceDataModel {
	return r.model
}

// GetProviderConfig returns global provider data config
func (r *systemSyslogGlobalFacility) GetProviderConfig() data.ProviderData {
...
func (r *systemSyslogGlobalFacility) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
