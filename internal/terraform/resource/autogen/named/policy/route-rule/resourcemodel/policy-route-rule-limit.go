...
var _ helpers.VyosResourceDataModel = &PolicyRouteRuleLimit{}
...
func (o PolicyRouteRuleLimit) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
