...
var _ helpers.VyosResourceDataModel = &PolicyRouteRuleSourceGroup{}
...
func (o PolicyRouteRuleSourceGroup) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
