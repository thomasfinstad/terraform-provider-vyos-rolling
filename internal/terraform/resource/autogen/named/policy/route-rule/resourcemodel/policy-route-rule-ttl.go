...
var _ helpers.VyosResourceDataModel = &PolicyRouteRuleTTL{}
...
func (o PolicyRouteRuleTTL) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
