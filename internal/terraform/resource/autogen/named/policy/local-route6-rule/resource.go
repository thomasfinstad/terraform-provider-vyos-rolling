...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/policy/local-route6-rule/resourcemodel"
)
...
func (r *policyLocalRoutesixRule) GetProviderConfig() data.ProviderData {
...
func (r *policyLocalRoutesixRule) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
