...
var _ helpers.VyosResourceDataModel = &PolicyRoutesixRuleTCP{}
...
type PolicyRoutesixRuleTCP struct {
	// LeafNodes
	LeafPolicyRoutesixRuleTCPMss types.String `tfsdk:"mss" vyos:"mss,omitempty"`

	// TagNodes

	// Nodes

	NodePolicyRoutesixRuleTCPFlags *PolicyRoutesixRuleTCPFlags `tfsdk:"flags" vyos:"flags,omitempty"`
}

// ResourceSchemaAttributes generates the schema attributes for the resource at this level
func (o PolicyRoutesixRuleTCP) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
...
`,
		...
		"flags": schema.SingleNestedAttribute{
			Attributes: PolicyRoutesixRuleTCPFlags{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
