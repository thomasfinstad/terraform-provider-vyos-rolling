...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/policy/route6/resourcemodel"
)
...
func (r *policyRoutesix) GetProviderConfig() data.ProviderData {
...
func (r *policyRoutesix) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
