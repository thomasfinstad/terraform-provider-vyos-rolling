...
/* tools/generate-terraform-resource-full/templates/resources/common/resource-model.gotmpl #resource-model (route-source) */
// Validate compliance
...
func (o PolicyRouteMapRuleMatchIPRouteSource) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
