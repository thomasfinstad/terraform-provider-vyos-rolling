...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/policy/route-map-rule/resourcemodel"
)
...
func (r *policyRouteMapRule) GetProviderConfig() data.ProviderData {
