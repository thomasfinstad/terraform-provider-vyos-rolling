...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/policy/community-list-rule/resourcemodel"
)
...
func (r *policyCommunityListRule) GetProviderConfig() data.ProviderData {
...
func (r *policyCommunityListRule) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
