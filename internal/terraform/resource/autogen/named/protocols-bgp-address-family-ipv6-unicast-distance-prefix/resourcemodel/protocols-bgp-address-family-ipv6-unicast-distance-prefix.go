...
type ProtocolsBgpAddressFamilyIPvsixUnicastDistancePrefix struct {
	// LeafNodes
	ProtocolsBgpAddressFamilyIPvsixUnicastDistancePrefixDistance customtypes.CustomStringValue `tfsdk:"distance" json:"distance,omitempty"`
...
func (o ProtocolsBgpAddressFamilyIPvsixUnicastDistancePrefix) ResourceAttributes() map[string]schema.Attribute {
