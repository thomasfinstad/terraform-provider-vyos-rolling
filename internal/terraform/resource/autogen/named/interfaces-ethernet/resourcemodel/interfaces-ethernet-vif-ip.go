...
type InterfacesEthernetVifIP struct {
	// LeafNodes
	LeafInterfacesEthernetVifIPAdjustMss               types.String `tfsdk:"adjust_mss"`
	LeafInterfacesEthernetVifIPArpCacheTimeout         types.String `tfsdk:"arp_cache_timeout"`
	LeafInterfacesEthernetVifIPDisableArpFilter        types.String `tfsdk:"disable_arp_filter"`
	LeafInterfacesEthernetVifIPDisableForwarding       types.String `tfsdk:"disable_forwarding"`
	LeafInterfacesEthernetVifIPEnableDirectedBroadcast types.String `tfsdk:"enable_directed_broadcast"`
	LeafInterfacesEthernetVifIPEnableArpAccept         types.String `tfsdk:"enable_arp_accept"`
	LeafInterfacesEthernetVifIPEnableArpAnnounce       types.String `tfsdk:"enable_arp_announce"`
	LeafInterfacesEthernetVifIPEnableArpIgnore         types.String `tfsdk:"enable_arp_ignore"`
	LeafInterfacesEthernetVifIPEnableProxyArp          types.String `tfsdk:"enable_proxy_arp"`
	LeafInterfacesEthernetVifIPProxyArpPvlan           types.String `tfsdk:"proxy_arp_pvlan"`
	LeafInterfacesEthernetVifIPSourceValIDation        types.String `tfsdk:"source_validation"`
...
func (o *InterfacesEthernetVifIP) TerraformToVyos(ctx context.Context, diags *diag.Diagnostics) map[string]interface{} {
	tflog.Error(ctx, "TerraformToVyos", map[string]interface{}{"Path": []string{"interfaces", "ethernet", "vif", "ip"}})

	vyosData := make(map[string]interface{})

	// Leafs
	if !(o.LeafInterfacesEthernetVifIPAdjustMss.IsNull() || o.LeafInterfacesEthernetVifIPAdjustMss.IsUnknown()) {
		vyosData["adjust-mss"] = o.LeafInterfacesEthernetVifIPAdjustMss.ValueString()
	}
	if !(o.LeafInterfacesEthernetVifIPArpCacheTimeout.IsNull() || o.LeafInterfacesEthernetVifIPArpCacheTimeout.IsUnknown()) {
		vyosData["arp-cache-timeout"] = o.LeafInterfacesEthernetVifIPArpCacheTimeout.ValueString()
	}
	if !(o.LeafInterfacesEthernetVifIPDisableArpFilter.IsNull() || o.LeafInterfacesEthernetVifIPDisableArpFilter.IsUnknown()) {
		vyosData["disable-arp-filter"] = o.LeafInterfacesEthernetVifIPDisableArpFilter.ValueString()
	}
	if !(o.LeafInterfacesEthernetVifIPDisableForwarding.IsNull() || o.LeafInterfacesEthernetVifIPDisableForwarding.IsUnknown()) {
		vyosData["disable-forwarding"] = o.LeafInterfacesEthernetVifIPDisableForwarding.ValueString()
	}
...
func (o *InterfacesEthernetVifIP) VyosToTerraform(ctx context.Context, diags *diag.Diagnostics, vyosData map[string]interface{}) {
	tflog.Error(ctx, "VyosToTerraform begin", map[string]interface{}{"Path": []string{"interfaces", "ethernet", "vif", "ip"}})
	...
	tflog.Error(ctx, "VyosToTerraform end", map[string]interface{}{"Path": []string{"interfaces", "ethernet", "vif", "ip"}})
}

// AttributeTypes generates the attribute types for the resource at this level
func (o InterfacesEthernetVifIP) AttributeTypes() map[string]attr.Type {
