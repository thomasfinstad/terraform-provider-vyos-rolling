...
type InterfacesEthernetVifMirror struct {
	// LeafNodes
	InterfacesEthernetVifMirrorIngress customtypes.CustomStringValue `tfsdk:"ingress" json:"ingress,omitempty"`
	InterfacesEthernetVifMirrorEgress  customtypes.CustomStringValue `tfsdk:"egress" json:"egress,omitempty"`
...
func (o InterfacesEthernetVifMirror) ResourceAttributes() map[string]schema.Attribute {
