...
type InterfacesEthernetVifSVifCIPvsixAddress struct {
	// LeafNodes
	LeafInterfacesEthernetVifSVifCIPvsixAddressAutoconf           types.String `tfsdk:"autoconf" json:"autoconf,omitempty"`
	LeafInterfacesEthernetVifSVifCIPvsixAddressEuisixfour         types.String `tfsdk:"eui64" json:"eui64,omitempty"`
	LeafInterfacesEthernetVifSVifCIPvsixAddressNoDefaultLinkLocal types.String `tfsdk:"no_default_link_local" json:"no-default-link-local,omitempty"`
...
func (o *InterfacesEthernetVifSVifCIPvsixAddress) MarshalJSON() ([]byte, error) {
	...
	if !o.LeafInterfacesEthernetVifSVifCIPvsixAddressAutoconf.IsNull() && !o.LeafInterfacesEthernetVifSVifCIPvsixAddressAutoconf.IsUnknown() {
		jsonData["autoconf"] = o.LeafInterfacesEthernetVifSVifCIPvsixAddressAutoconf.ValueString()
	}
	...
	if !o.LeafInterfacesEthernetVifSVifCIPvsixAddressEuisixfour.IsNull() && !o.LeafInterfacesEthernetVifSVifCIPvsixAddressEuisixfour.IsUnknown() {
		jsonData["eui64"] = o.LeafInterfacesEthernetVifSVifCIPvsixAddressEuisixfour.ValueString()
	}
	...
	if !o.LeafInterfacesEthernetVifSVifCIPvsixAddressNoDefaultLinkLocal.IsNull() && !o.LeafInterfacesEthernetVifSVifCIPvsixAddressNoDefaultLinkLocal.IsUnknown() {
		jsonData["no-default-link-local"] = o.LeafInterfacesEthernetVifSVifCIPvsixAddressNoDefaultLinkLocal.ValueString()
	}
...
func (o *InterfacesEthernetVifSVifCIPvsixAddress) UnmarshalJSON(jsonStr []byte) error {
	jsonData := make(map[string]interface{})
