...
type InterfacesEthernetVifIPvsixAddress struct {
	// LeafNodes
	InterfacesEthernetVifIPvsixAddressAutoconf           customtypes.CustomStringValue `tfsdk:"autoconf" json:"autoconf,omitempty"`
	InterfacesEthernetVifIPvsixAddressEuisixfour         customtypes.CustomStringValue `tfsdk:"eui64" json:"eui64,omitempty"`
	InterfacesEthernetVifIPvsixAddressNoDefaultLinkLocal customtypes.CustomStringValue `tfsdk:"no_default_link_local" json:"no-default-link-local,omitempty"`
...
func (o InterfacesEthernetVifIPvsixAddress) ResourceAttributes() map[string]schema.Attribute {
