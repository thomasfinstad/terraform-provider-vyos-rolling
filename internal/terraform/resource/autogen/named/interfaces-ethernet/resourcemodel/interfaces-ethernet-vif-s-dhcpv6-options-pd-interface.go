...
type InterfacesEthernetVifSDhcpvsixOptionsPdInterface struct {
	// LeafNodes
	InterfacesEthernetVifSDhcpvsixOptionsPdInterfaceAddress customtypes.CustomStringValue `tfsdk:"address" json:"address,omitempty"`
	InterfacesEthernetVifSDhcpvsixOptionsPdInterfaceSLAID   customtypes.CustomStringValue `tfsdk:"sla_id" json:"sla-id,omitempty"`
...
func (o InterfacesEthernetVifSDhcpvsixOptionsPdInterface) ResourceAttributes() map[string]schema.Attribute {
