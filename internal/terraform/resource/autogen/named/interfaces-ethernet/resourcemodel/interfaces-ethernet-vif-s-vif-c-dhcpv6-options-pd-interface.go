...
type InterfacesEthernetVifSVifCDhcpvsixOptionsPdInterface struct {
	// LeafNodes
	LeafInterfacesEthernetVifSVifCDhcpvsixOptionsPdInterfaceAddress types.String `tfsdk:"address" json:"address,omitempty"`
	LeafInterfacesEthernetVifSVifCDhcpvsixOptionsPdInterfaceSLAID   types.String `tfsdk:"sla_id" json:"sla-id,omitempty"`
