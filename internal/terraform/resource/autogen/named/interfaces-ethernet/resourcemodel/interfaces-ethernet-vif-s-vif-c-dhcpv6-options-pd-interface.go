...
type InterfacesEthernetVifSVifCDhcpvsixOptionsPdInterface struct {
	// LeafNodes
	InterfacesEthernetVifSVifCDhcpvsixOptionsPdInterfaceAddress customtypes.CustomStringValue `tfsdk:"address" json:"address,omitempty"`
	InterfacesEthernetVifSVifCDhcpvsixOptionsPdInterfaceSLAID   customtypes.CustomStringValue `tfsdk:"sla_id" json:"sla-id,omitempty"`
...
func (o InterfacesEthernetVifSVifCDhcpvsixOptionsPdInterface) ResourceAttributes() map[string]schema.Attribute {
