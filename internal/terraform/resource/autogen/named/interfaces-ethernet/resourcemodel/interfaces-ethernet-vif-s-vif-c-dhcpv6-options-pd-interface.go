...
type InterfacesEthernetVifSVifCDhcpvsixOptionsPdInterface struct {
	// LeafNodes
	LeafInterfacesEthernetVifSVifCDhcpvsixOptionsPdInterfaceAddress types.String `tfsdk:"address"`
	LeafInterfacesEthernetVifSVifCDhcpvsixOptionsPdInterfaceSLAID   types.String `tfsdk:"sla_id"`
...
func (o *InterfacesEthernetVifSVifCDhcpvsixOptionsPdInterface) TerraformToVyos(ctx context.Context, diags *diag.Diagnostics) map[string]interface{} {
	tflog.Error(ctx, "TerraformToVyos", map[string]interface{}{"Path": []string{"interfaces", "ethernet", "vif-s", "vif-c", "dhcpv6-options", "pd", "interface"}})
	...
	if !(o.LeafInterfacesEthernetVifSVifCDhcpvsixOptionsPdInterfaceAddress.IsNull() || o.LeafInterfacesEthernetVifSVifCDhcpvsixOptionsPdInterfaceAddress.IsUnknown()) {
		vyosData["address"] = o.LeafInterfacesEthernetVifSVifCDhcpvsixOptionsPdInterfaceAddress.ValueString()
	}
	if !(o.LeafInterfacesEthernetVifSVifCDhcpvsixOptionsPdInterfaceSLAID.IsNull() || o.LeafInterfacesEthernetVifSVifCDhcpvsixOptionsPdInterfaceSLAID.IsUnknown()) {
		vyosData["sla-id"] = o.LeafInterfacesEthernetVifSVifCDhcpvsixOptionsPdInterfaceSLAID.ValueString()
	}
...
func (o *InterfacesEthernetVifSVifCDhcpvsixOptionsPdInterface) VyosToTerraform(ctx context.Context, diags *diag.Diagnostics, vyosData map[string]interface{}) {
	tflog.Error(ctx, "VyosToTerraform begin", map[string]interface{}{"Path": []string{"interfaces", "ethernet", "vif-s", "vif-c", "dhcpv6-options", "pd", "interface"}})
	...
	tflog.Error(ctx, "VyosToTerraform end", map[string]interface{}{"Path": []string{"interfaces", "ethernet", "vif-s", "vif-c", "dhcpv6-options", "pd", "interface"}})
}

// AttributeTypes generates the attribute types for the resource at this level
func (o InterfacesEthernetVifSVifCDhcpvsixOptionsPdInterface) AttributeTypes() map[string]attr.Type {
