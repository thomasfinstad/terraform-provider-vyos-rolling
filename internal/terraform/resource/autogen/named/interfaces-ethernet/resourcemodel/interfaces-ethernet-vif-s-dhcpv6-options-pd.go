...
type InterfacesEthernetVifSDhcpvsixOptionsPd struct {
	// LeafNodes
	LeafInterfacesEthernetVifSDhcpvsixOptionsPdLength types.String `tfsdk:"length" json:"length,omitempty"`

	// TagNodes
	TagInterfacesEthernetVifSDhcpvsixOptionsPdInterface *map[string]InterfacesEthernetVifSDhcpvsixOptionsPdInterface `tfsdk:"interface" json:"interface,omitempty"`
...
func (o *InterfacesEthernetVifSDhcpvsixOptionsPd) MarshalJSON() ([]byte, error) {
	...
	if !reflect.ValueOf(o.TagInterfacesEthernetVifSDhcpvsixOptionsPdInterface).IsZero() {
		subJSONStr, err := json.Marshal(o.TagInterfacesEthernetVifSDhcpvsixOptionsPdInterface)
		if err != nil {
			return nil, err
		}
...
func (o *InterfacesEthernetVifSDhcpvsixOptionsPd) UnmarshalJSON(jsonStr []byte) error {
	...
	if value, ok := jsonData["interface"]; ok {
		...
		o.TagInterfacesEthernetVifSDhcpvsixOptionsPdInterface = &map[string]InterfacesEthernetVifSDhcpvsixOptionsPdInterface{}

		err = json.Unmarshal(subJSONStr, o.TagInterfacesEthernetVifSDhcpvsixOptionsPdInterface)
		if err != nil {
			return err
		}
	}
