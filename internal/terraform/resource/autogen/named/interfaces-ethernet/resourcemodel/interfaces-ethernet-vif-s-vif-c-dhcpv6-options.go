...
type InterfacesEthernetVifSVifCDhcpvsixOptions struct {
	// LeafNodes
	LeafInterfacesEthernetVifSVifCDhcpvsixOptionsDuID           types.String `tfsdk:"duid" json:"duid,omitempty"`
	LeafInterfacesEthernetVifSVifCDhcpvsixOptionsParametersOnly types.String `tfsdk:"parameters_only" json:"parameters-only,omitempty"`
	LeafInterfacesEthernetVifSVifCDhcpvsixOptionsRAPIDCommit    types.String `tfsdk:"rapid_commit" json:"rapid-commit,omitempty"`
	LeafInterfacesEthernetVifSVifCDhcpvsixOptionsTemporary      types.String `tfsdk:"temporary" json:"temporary,omitempty"`

	// TagNodes
	TagInterfacesEthernetVifSVifCDhcpvsixOptionsPd *map[string]InterfacesEthernetVifSVifCDhcpvsixOptionsPd `tfsdk:"pd" json:"pd,omitempty"`
...
func (o *InterfacesEthernetVifSVifCDhcpvsixOptions) MarshalJSON() ([]byte, error) {
	...
	if !reflect.ValueOf(o.TagInterfacesEthernetVifSVifCDhcpvsixOptionsPd).IsZero() {
		subJSONStr, err := json.Marshal(o.TagInterfacesEthernetVifSVifCDhcpvsixOptionsPd)
		if err != nil {
			return nil, err
		}
...
func (o *InterfacesEthernetVifSVifCDhcpvsixOptions) UnmarshalJSON(jsonStr []byte) error {
	...
	if value, ok := jsonData["pd"]; ok {
		...
		o.TagInterfacesEthernetVifSVifCDhcpvsixOptionsPd = &map[string]InterfacesEthernetVifSVifCDhcpvsixOptionsPd{}

		err = json.Unmarshal(subJSONStr, o.TagInterfacesEthernetVifSVifCDhcpvsixOptionsPd)
		if err != nil {
			return err
		}
	}
