...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/load-balancing/wan-rule/resourcemodel"
)
...
func (r *loadBalancingWanRule) GetProviderConfig() data.ProviderData {
...
func (r *loadBalancingWanRule) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
