...
var _ helpers.VyosResourceDataModel = &LoadBalancingWanRuleSource{}
...
func (o LoadBalancingWanRuleSource) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
