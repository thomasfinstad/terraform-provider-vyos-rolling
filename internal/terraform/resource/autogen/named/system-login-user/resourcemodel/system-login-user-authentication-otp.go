...
type SystemLoginUserAuthenticationOtp struct {
	// LeafNodes
	LeafSystemLoginUserAuthenticationOtpRateLimit  types.String `tfsdk:"rate_limit" json:"rate-limit,omitempty"`
	LeafSystemLoginUserAuthenticationOtpRateTime   types.String `tfsdk:"rate_time" json:"rate-time,omitempty"`
	LeafSystemLoginUserAuthenticationOtpWindowSize types.String `tfsdk:"window_size" json:"window-size,omitempty"`
	LeafSystemLoginUserAuthenticationOtpKey        types.String `tfsdk:"key" json:"key,omitempty"`
