...
type ProtocolsIsisSegmentRoutingPrefixIndex struct {
	// LeafNodes
	ProtocolsIsisSegmentRoutingPrefixIndexValue        customtypes.CustomStringValue `tfsdk:"value" json:"value,omitempty"`
	ProtocolsIsisSegmentRoutingPrefixIndexExplicitNull customtypes.CustomStringValue `tfsdk:"explicit_null" json:"explicit-null,omitempty"`
	ProtocolsIsisSegmentRoutingPrefixIndexNoPhpFlag    customtypes.CustomStringValue `tfsdk:"no_php_flag" json:"no-php-flag,omitempty"`
...
func (o ProtocolsIsisSegmentRoutingPrefixIndex) ResourceAttributes() map[string]schema.Attribute {
