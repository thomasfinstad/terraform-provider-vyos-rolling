...
type InterfacesBondingMirror struct {
	// LeafNodes
	InterfacesBondingMirrorIngress customtypes.CustomStringValue `tfsdk:"ingress" json:"ingress,omitempty"`
	InterfacesBondingMirrorEgress  customtypes.CustomStringValue `tfsdk:"egress" json:"egress,omitempty"`
...
func (o InterfacesBondingMirror) ResourceAttributes() map[string]schema.Attribute {
