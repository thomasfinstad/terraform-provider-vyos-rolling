...
type InterfacesBondingVifSDhcpvsixOptionsPdInterface struct {
	// LeafNodes
	LeafInterfacesBondingVifSDhcpvsixOptionsPdInterfaceAddress types.String `tfsdk:"address"`
	LeafInterfacesBondingVifSDhcpvsixOptionsPdInterfaceSLAID   types.String `tfsdk:"sla_id"`
...
func (o *InterfacesBondingVifSDhcpvsixOptionsPdInterface) TerraformToVyos(ctx context.Context, diags *diag.Diagnostics) map[string]interface{} {
	tflog.Error(ctx, "TerraformToVyos", map[string]interface{}{"Path": []string{"interfaces", "bonding", "vif-s", "dhcpv6-options", "pd", "interface"}})
	...
	if !(o.LeafInterfacesBondingVifSDhcpvsixOptionsPdInterfaceAddress.IsNull() || o.LeafInterfacesBondingVifSDhcpvsixOptionsPdInterfaceAddress.IsUnknown()) {
		vyosData["address"] = o.LeafInterfacesBondingVifSDhcpvsixOptionsPdInterfaceAddress.ValueString()
	}
	if !(o.LeafInterfacesBondingVifSDhcpvsixOptionsPdInterfaceSLAID.IsNull() || o.LeafInterfacesBondingVifSDhcpvsixOptionsPdInterfaceSLAID.IsUnknown()) {
		vyosData["sla-id"] = o.LeafInterfacesBondingVifSDhcpvsixOptionsPdInterfaceSLAID.ValueString()
	}
...
func (o *InterfacesBondingVifSDhcpvsixOptionsPdInterface) VyosToTerraform(ctx context.Context, diags *diag.Diagnostics, vyosData map[string]interface{}) {
	tflog.Error(ctx, "VyosToTerraform begin", map[string]interface{}{"Path": []string{"interfaces", "bonding", "vif-s", "dhcpv6-options", "pd", "interface"}})
	...
	tflog.Error(ctx, "VyosToTerraform end", map[string]interface{}{"Path": []string{"interfaces", "bonding", "vif-s", "dhcpv6-options", "pd", "interface"}})
}

// AttributeTypes generates the attribute types for the resource at this level
func (o InterfacesBondingVifSDhcpvsixOptionsPdInterface) AttributeTypes() map[string]attr.Type {
