...
type InterfacesBondingVifSDhcpvsixOptionsPdInterface struct {
	// LeafNodes
	InterfacesBondingVifSDhcpvsixOptionsPdInterfaceAddress customtypes.CustomStringValue `tfsdk:"address" json:"address,omitempty"`
	InterfacesBondingVifSDhcpvsixOptionsPdInterfaceSLAID   customtypes.CustomStringValue `tfsdk:"sla_id" json:"sla-id,omitempty"`
...
func (o InterfacesBondingVifSDhcpvsixOptionsPdInterface) ResourceAttributes() map[string]schema.Attribute {
