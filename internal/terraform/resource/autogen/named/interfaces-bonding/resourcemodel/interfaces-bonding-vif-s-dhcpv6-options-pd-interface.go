...
type InterfacesBondingVifSDhcpvsixOptionsPdInterface struct {
	// LeafNodes
	LeafInterfacesBondingVifSDhcpvsixOptionsPdInterfaceAddress types.String `tfsdk:"address" json:"address,omitempty"`
	LeafInterfacesBondingVifSDhcpvsixOptionsPdInterfaceSLAID   types.String `tfsdk:"sla_id" json:"sla-id,omitempty"`
