...
type InterfacesBondingVifSIPvsixAddress struct {
	// LeafNodes
	InterfacesBondingVifSIPvsixAddressAutoconf           customtypes.CustomStringValue `tfsdk:"autoconf" json:"autoconf,omitempty"`
	InterfacesBondingVifSIPvsixAddressEuisixfour         customtypes.CustomStringValue `tfsdk:"eui64" json:"eui64,omitempty"`
	InterfacesBondingVifSIPvsixAddressNoDefaultLinkLocal customtypes.CustomStringValue `tfsdk:"no_default_link_local" json:"no-default-link-local,omitempty"`
...
func (o InterfacesBondingVifSIPvsixAddress) ResourceAttributes() map[string]schema.Attribute {
