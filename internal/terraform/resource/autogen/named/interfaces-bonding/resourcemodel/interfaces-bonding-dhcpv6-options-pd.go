...
type InterfacesBondingDhcpvsixOptionsPd struct {
	// LeafNodes
	LeafInterfacesBondingDhcpvsixOptionsPdLength types.String `tfsdk:"length" json:"length,omitempty"`

	// TagNodes
	TagInterfacesBondingDhcpvsixOptionsPdInterface *map[string]InterfacesBondingDhcpvsixOptionsPdInterface `tfsdk:"interface" json:"interface,omitempty"`
...
func (o *InterfacesBondingDhcpvsixOptionsPd) MarshalJSON() ([]byte, error) {
	...
	if !reflect.ValueOf(o.TagInterfacesBondingDhcpvsixOptionsPdInterface).IsZero() {
		subJSONStr, err := json.Marshal(o.TagInterfacesBondingDhcpvsixOptionsPdInterface)
		if err != nil {
			return nil, err
		}
...
func (o *InterfacesBondingDhcpvsixOptionsPd) UnmarshalJSON(jsonStr []byte) error {
	...
	if value, ok := jsonData["interface"]; ok {
		...
		o.TagInterfacesBondingDhcpvsixOptionsPdInterface = &map[string]InterfacesBondingDhcpvsixOptionsPdInterface{}

		err = json.Unmarshal(subJSONStr, o.TagInterfacesBondingDhcpvsixOptionsPdInterface)
		if err != nil {
			return err
		}
	}
