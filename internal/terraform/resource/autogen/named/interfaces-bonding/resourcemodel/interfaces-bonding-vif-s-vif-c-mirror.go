...
type InterfacesBondingVifSVifCMirror struct {
	// LeafNodes
	InterfacesBondingVifSVifCMirrorIngress customtypes.CustomStringValue `tfsdk:"ingress" json:"ingress,omitempty"`
	InterfacesBondingVifSVifCMirrorEgress  customtypes.CustomStringValue `tfsdk:"egress" json:"egress,omitempty"`
...
func (o InterfacesBondingVifSVifCMirror) ResourceAttributes() map[string]schema.Attribute {
