...
type InterfacesBondingVifSVifCDhcpvsixOptionsPdInterface struct {
	// LeafNodes
	InterfacesBondingVifSVifCDhcpvsixOptionsPdInterfaceAddress customtypes.CustomStringValue `tfsdk:"address" json:"address,omitempty"`
	InterfacesBondingVifSVifCDhcpvsixOptionsPdInterfaceSLAID   customtypes.CustomStringValue `tfsdk:"sla_id" json:"sla-id,omitempty"`
...
func (o InterfacesBondingVifSVifCDhcpvsixOptionsPdInterface) ResourceAttributes() map[string]schema.Attribute {
