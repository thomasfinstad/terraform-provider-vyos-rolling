...
type InterfacesBondingVifSMirror struct {
	// LeafNodes
	InterfacesBondingVifSMirrorIngress customtypes.CustomStringValue `tfsdk:"ingress" json:"ingress,omitempty"`
	InterfacesBondingVifSMirrorEgress  customtypes.CustomStringValue `tfsdk:"egress" json:"egress,omitempty"`
...
func (o InterfacesBondingVifSMirror) ResourceAttributes() map[string]schema.Attribute {
