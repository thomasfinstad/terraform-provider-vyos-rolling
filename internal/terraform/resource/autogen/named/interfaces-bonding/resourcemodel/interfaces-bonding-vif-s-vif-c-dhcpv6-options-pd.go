...
type InterfacesBondingVifSVifCDhcpvsixOptionsPd struct {
	// LeafNodes
	LeafInterfacesBondingVifSVifCDhcpvsixOptionsPdLength types.String `tfsdk:"length" json:"length,omitempty"`

	// TagNodes
	TagInterfacesBondingVifSVifCDhcpvsixOptionsPdInterface *map[string]InterfacesBondingVifSVifCDhcpvsixOptionsPdInterface `tfsdk:"interface" json:"interface,omitempty"`
...
func (o *InterfacesBondingVifSVifCDhcpvsixOptionsPd) MarshalJSON() ([]byte, error) {
	...
	if !reflect.ValueOf(o.TagInterfacesBondingVifSVifCDhcpvsixOptionsPdInterface).IsZero() {
		subJSONStr, err := json.Marshal(o.TagInterfacesBondingVifSVifCDhcpvsixOptionsPdInterface)
		if err != nil {
			return nil, err
		}
...
func (o *InterfacesBondingVifSVifCDhcpvsixOptionsPd) UnmarshalJSON(jsonStr []byte) error {
	...
	if value, ok := jsonData["interface"]; ok {
		...
		o.TagInterfacesBondingVifSVifCDhcpvsixOptionsPdInterface = &map[string]InterfacesBondingVifSVifCDhcpvsixOptionsPdInterface{}

		err = json.Unmarshal(subJSONStr, o.TagInterfacesBondingVifSVifCDhcpvsixOptionsPdInterface)
		if err != nil {
			return err
		}
	}
