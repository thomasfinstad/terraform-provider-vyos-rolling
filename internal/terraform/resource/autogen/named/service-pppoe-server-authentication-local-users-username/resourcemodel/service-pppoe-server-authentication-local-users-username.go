...
type ServicePppoeServerAuthenticationLocalUsersUsername struct {
	...
	// LeafNodes
	LeafServicePppoeServerAuthenticationLocalUsersUsernameDisable  types.String `tfsdk:"disable" json:"disable,omitempty"`
	LeafServicePppoeServerAuthenticationLocalUsersUsernamePassword types.String `tfsdk:"password" json:"password,omitempty"`
	LeafServicePppoeServerAuthenticationLocalUsersUsernameStaticIP types.String `tfsdk:"static_ip" json:"static-ip,omitempty"`

	// TagNodes

	// Nodes
	NodeServicePppoeServerAuthenticationLocalUsersUsernameRateLimit *ServicePppoeServerAuthenticationLocalUsersUsernameRateLimit `tfsdk:"rate_limit" json:"rate-limit,omitempty"`
}
