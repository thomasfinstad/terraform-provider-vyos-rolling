...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/vpn/ipsec-profile/resourcemodel"
)
...
func (r *vpnIPsecProfile) GetProviderConfig() data.ProviderData {
...
func (r *vpnIPsecProfile) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
