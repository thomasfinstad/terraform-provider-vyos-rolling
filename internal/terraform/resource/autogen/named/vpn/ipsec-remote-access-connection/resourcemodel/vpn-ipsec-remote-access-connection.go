...
type VpnIPsecRemoteAccessConnection struct {
	...
	LeafVpnIPsecRemoteAccessConnectionDisable      types.String `tfsdk:"disable" vyos:"disable,omitempty"`
	...
	LeafVpnIPsecRemoteAccessConnectionTimeout      types.String `tfsdk:"timeout" vyos:"timeout,omitempty"`
	LeafVpnIPsecRemoteAccessConnectionPool         types.String `tfsdk:"pool" vyos:"pool,omitempty"`
