...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos/internal/terraform/resource/autogen/named/vpn/ipsec-remote-access-connection/resourcemodel"
)
...
func (r *vpnIPsecRemoteAccessConnection) GetName() string {
