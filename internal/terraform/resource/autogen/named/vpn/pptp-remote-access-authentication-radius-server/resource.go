...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/vpn/pptp-remote-access-authentication-radius-server/resourcemodel"
)
...
func (r *vpnPptpRemoteAccessAuthenticationRadiusServer) GetProviderConfig() data.ProviderData {
...
func (r *vpnPptpRemoteAccessAuthenticationRadiusServer) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
