...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/vpn/sstp-authentication-radius-server/resourcemodel"
)
...
func (r *vpnSstpAuthenticationRadiusServer) GetProviderConfig() data.ProviderData {
...
func (r *vpnSstpAuthenticationRadiusServer) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
