...
func (r *vpnLtwotpRemoteAccessAuthenticationLocalUsersUsername) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
