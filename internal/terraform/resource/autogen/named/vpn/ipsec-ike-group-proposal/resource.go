...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/vpn/ipsec-ike-group-proposal/resourcemodel"
)
...
func (r *vpnIPsecIkeGroupProposal) GetModel() helpers.VyosTopResourceDataModel {
	return r.model
}

// GetProviderConfig returns global provider data config
func (r *vpnIPsecIkeGroupProposal) GetProviderConfig() data.ProviderData {
...
func (r *vpnIPsecIkeGroupProposal) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
