...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos/internal/terraform/resource/autogen/named/vpn/ipsec-site-to-site-peer-tunnel/resourcemodel"
)
...
func (r *vpnIPsecSiteToSitePeerTunnel) GetName() string {
