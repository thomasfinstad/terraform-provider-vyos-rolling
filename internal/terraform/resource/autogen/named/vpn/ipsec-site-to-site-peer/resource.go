...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/vpn/ipsec-site-to-site-peer/resourcemodel"
)
...
func (r *vpnIPsecSiteToSitePeer) GetProviderConfig() data.ProviderData {
...
func (r *vpnIPsecSiteToSitePeer) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
