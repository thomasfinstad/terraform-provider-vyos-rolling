...
func (r *vpnOpenconnectAuthenticationLocalUsersUsername) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
