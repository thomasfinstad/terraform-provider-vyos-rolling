...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos/internal/terraform/resource/autogen/named/vpn/openconnect-authentication-local-users-username/resourcemodel"
)
