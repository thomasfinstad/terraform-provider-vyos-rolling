...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/vpn/openconnect-authentication-radius-server/resourcemodel"
)
...
func (r *vpnOpenconnectAuthenticationRadiusServer) GetModel() helpers.VyosTopResourceDataModel {
	return r.model
}

// GetProviderConfig returns global provider data config
func (r *vpnOpenconnectAuthenticationRadiusServer) GetProviderConfig() data.ProviderData {
...
func (r *vpnOpenconnectAuthenticationRadiusServer) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
