...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/vpn/sstp-authentication-local-users-username/resourcemodel"
)
...
func (r *vpnSstpAuthenticationLocalUsersUsername) GetProviderConfig() data.ProviderData {
...
func (r *vpnSstpAuthenticationLocalUsersUsername) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
