...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/vpn/ipsec-authentication-psk/resourcemodel"
)
...
func (r *vpnIPsecAuthenticationPsk) GetModel() helpers.VyosTopResourceDataModel {
	return r.model
}

// GetProviderConfig returns global provider data config
func (r *vpnIPsecAuthenticationPsk) GetProviderConfig() data.ProviderData {
...
func (r *vpnIPsecAuthenticationPsk) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
