...
type ProtocolsRIPDistributeListInterfaceAccessList struct {
	// LeafNodes
	LeafProtocolsRIPDistributeListInterfaceAccessListIn  types.String `tfsdk:"in" json:"in,omitempty"`
	LeafProtocolsRIPDistributeListInterfaceAccessListOut types.String `tfsdk:"out" json:"out,omitempty"`
