...
type ProtocolsRIPDistributeListInterfacePrefixList struct {
	// LeafNodes
	ProtocolsRIPDistributeListInterfacePrefixListIn  customtypes.CustomStringValue `tfsdk:"in" json:"in,omitempty"`
	ProtocolsRIPDistributeListInterfacePrefixListOut customtypes.CustomStringValue `tfsdk:"out" json:"out,omitempty"`
...
func (o ProtocolsRIPDistributeListInterfacePrefixList) ResourceAttributes() map[string]schema.Attribute {
