...
type ProtocolsRIPDistributeListInterfacePrefixList struct {
	// LeafNodes
	LeafProtocolsRIPDistributeListInterfacePrefixListIn  types.String `tfsdk:"in"`
	LeafProtocolsRIPDistributeListInterfacePrefixListOut types.String `tfsdk:"out"`
...
func (o *ProtocolsRIPDistributeListInterfacePrefixList) TerraformToVyos(ctx context.Context, diags *diag.Diagnostics) map[string]interface{} {
	tflog.Error(ctx, "TerraformToVyos", map[string]interface{}{"Path": []string{"protocols", "rip", "distribute-list", "interface", "prefix-list"}})
	...
	if !(o.LeafProtocolsRIPDistributeListInterfacePrefixListIn.IsNull() || o.LeafProtocolsRIPDistributeListInterfacePrefixListIn.IsUnknown()) {
		vyosData["in"] = o.LeafProtocolsRIPDistributeListInterfacePrefixListIn.ValueString()
	}
	if !(o.LeafProtocolsRIPDistributeListInterfacePrefixListOut.IsNull() || o.LeafProtocolsRIPDistributeListInterfacePrefixListOut.IsUnknown()) {
		vyosData["out"] = o.LeafProtocolsRIPDistributeListInterfacePrefixListOut.ValueString()
	}
...
func (o *ProtocolsRIPDistributeListInterfacePrefixList) VyosToTerraform(ctx context.Context, diags *diag.Diagnostics, vyosData map[string]interface{}) {
	tflog.Error(ctx, "VyosToTerraform begin", map[string]interface{}{"Path": []string{"protocols", "rip", "distribute-list", "interface", "prefix-list"}})
	...
	tflog.Error(ctx, "VyosToTerraform end", map[string]interface{}{"Path": []string{"protocols", "rip", "distribute-list", "interface", "prefix-list"}})
}

// AttributeTypes generates the attribute types for the resource at this level
func (o ProtocolsRIPDistributeListInterfacePrefixList) AttributeTypes() map[string]attr.Type {
