...
type ProtocolsBgpAddressFamilyIPvsixMulticastDistancePrefix struct {
	// LeafNodes
	ProtocolsBgpAddressFamilyIPvsixMulticastDistancePrefixDistance customtypes.CustomStringValue `tfsdk:"distance" json:"distance,omitempty"`
...
func (o ProtocolsBgpAddressFamilyIPvsixMulticastDistancePrefix) ResourceAttributes() map[string]schema.Attribute {
