...
type InterfacesPppoeMirror struct {
	// LeafNodes
	InterfacesPppoeMirrorIngress customtypes.CustomStringValue `tfsdk:"ingress" json:"ingress,omitempty"`
	InterfacesPppoeMirrorEgress  customtypes.CustomStringValue `tfsdk:"egress" json:"egress,omitempty"`
...
func (o InterfacesPppoeMirror) ResourceAttributes() map[string]schema.Attribute {
