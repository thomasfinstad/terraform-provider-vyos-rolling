...
var _ helpers.VyosResourceDataModel = &FirewallIPvfourOutputRawRuleRecent{}

// FirewallIPvfourOutputRawRuleRecent describes the resource data model.
type FirewallIPvfourOutputRawRuleRecent struct {
	// LeafNodes
	LeafFirewallIPvfourOutputRawRuleRecentCount types.Number `tfsdk:"count" vyos:"count,omitempty"`
	LeafFirewallIPvfourOutputRawRuleRecentTime  types.String `tfsdk:"time" vyos:"time,omitempty"`
...
func (o FirewallIPvfourOutputRawRuleRecent) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
