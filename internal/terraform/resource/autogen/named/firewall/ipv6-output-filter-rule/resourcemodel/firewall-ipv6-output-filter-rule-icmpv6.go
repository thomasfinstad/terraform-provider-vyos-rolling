...
var _ helpers.VyosResourceDataModel = &FirewallIPvsixOutputFilterRuleIcmpvsix{}

// FirewallIPvsixOutputFilterRuleIcmpvsix describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallIPvsixOutputFilterRuleIcmpvsix struct {
	// LeafNodes
	LeafFirewallIPvsixOutputFilterRuleIcmpvsixCode     types.Number `tfsdk:"code" vyos:"code,omitempty"`
	LeafFirewallIPvsixOutputFilterRuleIcmpvsixType     types.Number `tfsdk:"type" vyos:"type,omitempty"`
	LeafFirewallIPvsixOutputFilterRuleIcmpvsixTypeName types.String `tfsdk:"type_name" vyos:"type-name,omitempty"`
...
func (o FirewallIPvsixOutputFilterRuleIcmpvsix) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
