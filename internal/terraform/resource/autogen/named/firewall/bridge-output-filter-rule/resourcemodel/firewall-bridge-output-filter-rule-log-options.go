...
var _ helpers.VyosResourceDataModel = &FirewallBrIDgeOutputFilterRuleLogOptions{}

// FirewallBrIDgeOutputFilterRuleLogOptions describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallBrIDgeOutputFilterRuleLogOptions struct {
	// LeafNodes
	LeafFirewallBrIDgeOutputFilterRuleLogOptionsGroup          types.Number `tfsdk:"group" vyos:"group,omitempty"`
	LeafFirewallBrIDgeOutputFilterRuleLogOptionsSnapshotLength types.Number `tfsdk:"snapshot_length" vyos:"snapshot-length,omitempty"`
	LeafFirewallBrIDgeOutputFilterRuleLogOptionsQueueThreshold types.Number `tfsdk:"queue_threshold" vyos:"queue-threshold,omitempty"`
...
func (o FirewallBrIDgeOutputFilterRuleLogOptions) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
