...
var _ helpers.VyosResourceDataModel = &FirewallBrIDgeOutputFilterRuleTime{}

// FirewallBrIDgeOutputFilterRuleTime describes the resource data model.
type FirewallBrIDgeOutputFilterRuleTime struct {
	// LeafNodes
	LeafFirewallBrIDgeOutputFilterRuleTimeStartdate types.String `tfsdk:"startdate" vyos:"startdate,omitempty"`
	LeafFirewallBrIDgeOutputFilterRuleTimeStarttime types.String `tfsdk:"starttime" vyos:"starttime,omitempty"`
	LeafFirewallBrIDgeOutputFilterRuleTimeStopdate  types.String `tfsdk:"stopdate" vyos:"stopdate,omitempty"`
	LeafFirewallBrIDgeOutputFilterRuleTimeStoptime  types.String `tfsdk:"stoptime" vyos:"stoptime,omitempty"`
	LeafFirewallBrIDgeOutputFilterRuleTimeWeekdays  types.String `tfsdk:"weekdays" vyos:"weekdays,omitempty"`
...
func (o FirewallBrIDgeOutputFilterRuleTime) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
