...
var _ helpers.VyosResourceDataModel = &FirewallBrIDgeForwardFilterRuleIcmp{}

// FirewallBrIDgeForwardFilterRuleIcmp describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallBrIDgeForwardFilterRuleIcmp struct {
	// LeafNodes
	LeafFirewallBrIDgeForwardFilterRuleIcmpCode     types.Number `tfsdk:"code" vyos:"code,omitempty"`
	LeafFirewallBrIDgeForwardFilterRuleIcmpType     types.Number `tfsdk:"type" vyos:"type,omitempty"`
	LeafFirewallBrIDgeForwardFilterRuleIcmpTypeName types.String `tfsdk:"type_name" vyos:"type-name,omitempty"`
...
func (o FirewallBrIDgeForwardFilterRuleIcmp) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
