...
var _ helpers.VyosResourceDataModel = &FirewallBrIDgeForwardFilterRuleTime{}

// FirewallBrIDgeForwardFilterRuleTime describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallBrIDgeForwardFilterRuleTime struct {
	// LeafNodes
	LeafFirewallBrIDgeForwardFilterRuleTimeStartdate types.String `tfsdk:"startdate" vyos:"startdate,omitempty"`
	LeafFirewallBrIDgeForwardFilterRuleTimeStarttime types.String `tfsdk:"starttime" vyos:"starttime,omitempty"`
	LeafFirewallBrIDgeForwardFilterRuleTimeStopdate  types.String `tfsdk:"stopdate" vyos:"stopdate,omitempty"`
	LeafFirewallBrIDgeForwardFilterRuleTimeStoptime  types.String `tfsdk:"stoptime" vyos:"stoptime,omitempty"`
	LeafFirewallBrIDgeForwardFilterRuleTimeWeekdays  types.String `tfsdk:"weekdays" vyos:"weekdays,omitempty"`
...
func (o FirewallBrIDgeForwardFilterRuleTime) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
