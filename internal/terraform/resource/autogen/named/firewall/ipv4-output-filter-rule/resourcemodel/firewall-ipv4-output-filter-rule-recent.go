...
var _ helpers.VyosResourceDataModel = &FirewallIPvfourOutputFilterRuleRecent{}

// FirewallIPvfourOutputFilterRuleRecent describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallIPvfourOutputFilterRuleRecent struct {
	// LeafNodes
	LeafFirewallIPvfourOutputFilterRuleRecentCount types.Number `tfsdk:"count" vyos:"count,omitempty"`
	LeafFirewallIPvfourOutputFilterRuleRecentTime  types.String `tfsdk:"time" vyos:"time,omitempty"`
...
func (o FirewallIPvfourOutputFilterRuleRecent) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
