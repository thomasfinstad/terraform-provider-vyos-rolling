...
var _ helpers.VyosResourceDataModel = &FirewallIPvfourOutputFilterRuleIcmp{}
...
func (o FirewallIPvfourOutputFilterRuleIcmp) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
