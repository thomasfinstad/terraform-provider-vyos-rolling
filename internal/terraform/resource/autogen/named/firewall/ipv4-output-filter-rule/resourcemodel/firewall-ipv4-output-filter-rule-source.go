...
var _ helpers.VyosResourceDataModel = &FirewallIPvfourOutputFilterRuleSource{}

// FirewallIPvfourOutputFilterRuleSource describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallIPvfourOutputFilterRuleSource struct {
	// LeafNodes
	LeafFirewallIPvfourOutputFilterRuleSourceAddress     types.String `tfsdk:"address" vyos:"address,omitempty"`
	LeafFirewallIPvfourOutputFilterRuleSourceAddressMask types.String `tfsdk:"address_mask" vyos:"address-mask,omitempty"`
	LeafFirewallIPvfourOutputFilterRuleSourceFqdn        types.String `tfsdk:"fqdn" vyos:"fqdn,omitempty"`
	LeafFirewallIPvfourOutputFilterRuleSourceMacAddress  types.String `tfsdk:"mac_address" vyos:"mac-address,omitempty"`
	LeafFirewallIPvfourOutputFilterRuleSourcePort        types.String `tfsdk:"port" vyos:"port,omitempty"`

	// TagNodes

	// Nodes

	NodeFirewallIPvfourOutputFilterRuleSourceGeoIP *FirewallIPvfourOutputFilterRuleSourceGeoIP `tfsdk:"geoip" vyos:"geoip,omitempty"`

	NodeFirewallIPvfourOutputFilterRuleSourceGroup *FirewallIPvfourOutputFilterRuleSourceGroup `tfsdk:"group" vyos:"group,omitempty"`
}

// ResourceSchemaAttributes generates the schema attributes for the resource at this level
func (o FirewallIPvfourOutputFilterRuleSource) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
...
`,
		...
		"geoip": schema.SingleNestedAttribute{
			Attributes: FirewallIPvfourOutputFilterRuleSourceGeoIP{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
...
`,
		...
		"group": schema.SingleNestedAttribute{
			Attributes: FirewallIPvfourOutputFilterRuleSourceGroup{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
