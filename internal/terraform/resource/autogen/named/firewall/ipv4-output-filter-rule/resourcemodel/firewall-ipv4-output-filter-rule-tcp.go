...
var _ helpers.VyosResourceDataModel = &FirewallIPvfourOutputFilterRuleTCP{}

// FirewallIPvfourOutputFilterRuleTCP describes the resource data model.
type FirewallIPvfourOutputFilterRuleTCP struct {
	// LeafNodes
...
func (o FirewallIPvfourOutputFilterRuleTCP) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
...
`,
		...
		"flags": schema.SingleNestedAttribute{
			Attributes: FirewallIPvfourOutputFilterRuleTCPFlags{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
