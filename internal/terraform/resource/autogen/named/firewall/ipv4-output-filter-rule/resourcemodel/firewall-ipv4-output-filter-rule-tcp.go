...
func (o FirewallIPvfourOutputFilterRuleTCP) ResourceSchemaAttributes() map[string]schema.Attribute {
...
`,
		...
		"flags": schema.SingleNestedAttribute{
			Attributes: FirewallIPvfourOutputFilterRuleTCPFlags{}.ResourceSchemaAttributes(),
			Optional:   true,
