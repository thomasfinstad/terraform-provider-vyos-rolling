...
var _ helpers.VyosResourceDataModel = &FirewallIPvsixInputFilterRuleRecent{}

// FirewallIPvsixInputFilterRuleRecent describes the resource data model.
type FirewallIPvsixInputFilterRuleRecent struct {
	// LeafNodes
	LeafFirewallIPvsixInputFilterRuleRecentCount types.Number `tfsdk:"count" vyos:"count,omitempty"`
	LeafFirewallIPvsixInputFilterRuleRecentTime  types.String `tfsdk:"time" vyos:"time,omitempty"`
...
func (o FirewallIPvsixInputFilterRuleRecent) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
