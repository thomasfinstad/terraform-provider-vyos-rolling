...
var _ helpers.VyosResourceDataModel = &FirewallIPvsixInputFilterRuleIcmpvsix{}

// FirewallIPvsixInputFilterRuleIcmpvsix describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallIPvsixInputFilterRuleIcmpvsix struct {
	// LeafNodes
	LeafFirewallIPvsixInputFilterRuleIcmpvsixCode     types.Number `tfsdk:"code" vyos:"code,omitempty"`
	LeafFirewallIPvsixInputFilterRuleIcmpvsixType     types.Number `tfsdk:"type" vyos:"type,omitempty"`
	LeafFirewallIPvsixInputFilterRuleIcmpvsixTypeName types.String `tfsdk:"type_name" vyos:"type-name,omitempty"`
...
func (o FirewallIPvsixInputFilterRuleIcmpvsix) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
