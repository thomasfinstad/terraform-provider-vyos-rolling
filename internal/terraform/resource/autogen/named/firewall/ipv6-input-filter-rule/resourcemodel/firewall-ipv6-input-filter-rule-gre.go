...
var _ helpers.VyosResourceDataModel = &FirewallIPvsixInputFilterRuleGre{}

// FirewallIPvsixInputFilterRuleGre describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallIPvsixInputFilterRuleGre struct {
	// LeafNodes
	LeafFirewallIPvsixInputFilterRuleGreInnerProto types.String `tfsdk:"inner_proto" vyos:"inner-proto,omitempty"`
	LeafFirewallIPvsixInputFilterRuleGreKey        types.Number `tfsdk:"key" vyos:"key,omitempty"`
...
func (o FirewallIPvsixInputFilterRuleGre) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
...
`,
		...
		"flags": schema.SingleNestedAttribute{
			Attributes: FirewallIPvsixInputFilterRuleGreFlags{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
