...
type FirewallBrIDgeNameRuleDestination struct {
	...
	LeafFirewallBrIDgeNameRuleDestinationAddress     types.String `tfsdk:"address" vyos:"address,omitempty"`
	LeafFirewallBrIDgeNameRuleDestinationAddressMask types.String `tfsdk:"address_mask" vyos:"address-mask,omitempty"`
...
func (o FirewallBrIDgeNameRuleDestination) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
...
`,
		...
		"group": schema.SingleNestedAttribute{
			Attributes: FirewallBrIDgeNameRuleDestinationGroup{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
