...
type FirewallBrIDgeNameRuleTime struct {
	...
	LeafFirewallBrIDgeNameRuleTimeStarttime types.String `tfsdk:"starttime" vyos:"starttime,omitempty"`
	LeafFirewallBrIDgeNameRuleTimeStopdate  types.String `tfsdk:"stopdate" vyos:"stopdate,omitempty"`
...
func (o FirewallBrIDgeNameRuleTime) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
