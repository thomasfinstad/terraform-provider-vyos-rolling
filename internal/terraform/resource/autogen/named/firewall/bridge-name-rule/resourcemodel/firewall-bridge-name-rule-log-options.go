...
var _ helpers.VyosResourceDataModel = &FirewallBrIDgeNameRuleLogOptions{}

// FirewallBrIDgeNameRuleLogOptions describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallBrIDgeNameRuleLogOptions struct {
	// LeafNodes
	LeafFirewallBrIDgeNameRuleLogOptionsGroup          types.Number `tfsdk:"group" vyos:"group,omitempty"`
	LeafFirewallBrIDgeNameRuleLogOptionsSnapshotLength types.Number `tfsdk:"snapshot_length" vyos:"snapshot-length,omitempty"`
	LeafFirewallBrIDgeNameRuleLogOptionsQueueThreshold types.Number `tfsdk:"queue_threshold" vyos:"queue-threshold,omitempty"`
	LeafFirewallBrIDgeNameRuleLogOptionsLevel          types.String `tfsdk:"level" vyos:"level,omitempty"`
...
func (o FirewallBrIDgeNameRuleLogOptions) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
