...
var _ helpers.VyosResourceDataModel = &FirewallBrIDgeNameRuleIcmpvsix{}

// FirewallBrIDgeNameRuleIcmpvsix describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallBrIDgeNameRuleIcmpvsix struct {
	// LeafNodes
	LeafFirewallBrIDgeNameRuleIcmpvsixCode     types.Number `tfsdk:"code" vyos:"code,omitempty"`
	LeafFirewallBrIDgeNameRuleIcmpvsixType     types.Number `tfsdk:"type" vyos:"type,omitempty"`
	LeafFirewallBrIDgeNameRuleIcmpvsixTypeName types.String `tfsdk:"type_name" vyos:"type-name,omitempty"`
...
func (o FirewallBrIDgeNameRuleIcmpvsix) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
