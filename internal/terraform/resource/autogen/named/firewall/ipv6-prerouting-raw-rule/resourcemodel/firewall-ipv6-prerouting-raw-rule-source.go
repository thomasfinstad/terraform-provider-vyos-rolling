...
var _ helpers.VyosResourceDataModel = &FirewallIPvsixPreroutingRawRuleSource{}

// FirewallIPvsixPreroutingRawRuleSource describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallIPvsixPreroutingRawRuleSource struct {
	// LeafNodes
	LeafFirewallIPvsixPreroutingRawRuleSourceAddress     types.String `tfsdk:"address" vyos:"address,omitempty"`
	LeafFirewallIPvsixPreroutingRawRuleSourceAddressMask types.String `tfsdk:"address_mask" vyos:"address-mask,omitempty"`
	LeafFirewallIPvsixPreroutingRawRuleSourceFqdn        types.String `tfsdk:"fqdn" vyos:"fqdn,omitempty"`
	LeafFirewallIPvsixPreroutingRawRuleSourceMacAddress  types.String `tfsdk:"mac_address" vyos:"mac-address,omitempty"`
	LeafFirewallIPvsixPreroutingRawRuleSourcePort        types.String `tfsdk:"port" vyos:"port,omitempty"`

	// TagNodes

	// Nodes

	NodeFirewallIPvsixPreroutingRawRuleSourceGeoIP *FirewallIPvsixPreroutingRawRuleSourceGeoIP `tfsdk:"geoip" vyos:"geoip,omitempty"`

	NodeFirewallIPvsixPreroutingRawRuleSourceGroup *FirewallIPvsixPreroutingRawRuleSourceGroup `tfsdk:"group" vyos:"group,omitempty"`
}

// ResourceSchemaAttributes generates the schema attributes for the resource at this level
func (o FirewallIPvsixPreroutingRawRuleSource) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
...
`,
		...
		"geoip": schema.SingleNestedAttribute{
			Attributes: FirewallIPvsixPreroutingRawRuleSourceGeoIP{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
...
`,
		...
		"group": schema.SingleNestedAttribute{
			Attributes: FirewallIPvsixPreroutingRawRuleSourceGroup{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
