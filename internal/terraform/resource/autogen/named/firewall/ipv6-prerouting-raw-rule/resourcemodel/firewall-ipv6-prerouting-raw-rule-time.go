...
var _ helpers.VyosResourceDataModel = &FirewallIPvsixPreroutingRawRuleTime{}

// FirewallIPvsixPreroutingRawRuleTime describes the resource data model.
type FirewallIPvsixPreroutingRawRuleTime struct {
	// LeafNodes
	LeafFirewallIPvsixPreroutingRawRuleTimeStartdate types.String `tfsdk:"startdate" vyos:"startdate,omitempty"`
	LeafFirewallIPvsixPreroutingRawRuleTimeStarttime types.String `tfsdk:"starttime" vyos:"starttime,omitempty"`
	LeafFirewallIPvsixPreroutingRawRuleTimeStopdate  types.String `tfsdk:"stopdate" vyos:"stopdate,omitempty"`
	LeafFirewallIPvsixPreroutingRawRuleTimeStoptime  types.String `tfsdk:"stoptime" vyos:"stoptime,omitempty"`
	LeafFirewallIPvsixPreroutingRawRuleTimeWeekdays  types.String `tfsdk:"weekdays" vyos:"weekdays,omitempty"`
...
func (o FirewallIPvsixPreroutingRawRuleTime) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
