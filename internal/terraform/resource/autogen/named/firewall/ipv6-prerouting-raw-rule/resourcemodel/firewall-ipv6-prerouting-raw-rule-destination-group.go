...
var _ helpers.VyosResourceDataModel = &FirewallIPvsixPreroutingRawRuleDestinationGroup{}

// FirewallIPvsixPreroutingRawRuleDestinationGroup describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallIPvsixPreroutingRawRuleDestinationGroup struct {
	// LeafNodes
	LeafFirewallIPvsixPreroutingRawRuleDestinationGroupAddressGroup        types.String `tfsdk:"address_group" vyos:"address-group,omitempty"`
	LeafFirewallIPvsixPreroutingRawRuleDestinationGroupDomainGroup         types.String `tfsdk:"domain_group" vyos:"domain-group,omitempty"`
	LeafFirewallIPvsixPreroutingRawRuleDestinationGroupMacGroup            types.String `tfsdk:"mac_group" vyos:"mac-group,omitempty"`
	LeafFirewallIPvsixPreroutingRawRuleDestinationGroupNetworkGroup        types.String `tfsdk:"network_group" vyos:"network-group,omitempty"`
	LeafFirewallIPvsixPreroutingRawRuleDestinationGroupPortGroup           types.String `tfsdk:"port_group" vyos:"port-group,omitempty"`
	LeafFirewallIPvsixPreroutingRawRuleDestinationGroupDynamicAddressGroup types.String `tfsdk:"dynamic_address_group" vyos:"dynamic-address-group,omitempty"`
...
func (o FirewallIPvsixPreroutingRawRuleDestinationGroup) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
