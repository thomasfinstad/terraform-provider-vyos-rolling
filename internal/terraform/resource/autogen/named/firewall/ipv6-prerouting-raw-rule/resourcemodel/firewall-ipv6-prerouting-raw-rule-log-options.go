...
var _ helpers.VyosResourceDataModel = &FirewallIPvsixPreroutingRawRuleLogOptions{}

// FirewallIPvsixPreroutingRawRuleLogOptions describes the resource data model.
type FirewallIPvsixPreroutingRawRuleLogOptions struct {
	// LeafNodes
	LeafFirewallIPvsixPreroutingRawRuleLogOptionsGroup          types.Number `tfsdk:"group" vyos:"group,omitempty"`
	LeafFirewallIPvsixPreroutingRawRuleLogOptionsSnapshotLength types.Number `tfsdk:"snapshot_length" vyos:"snapshot-length,omitempty"`
	LeafFirewallIPvsixPreroutingRawRuleLogOptionsQueueThreshold types.Number `tfsdk:"queue_threshold" vyos:"queue-threshold,omitempty"`
	LeafFirewallIPvsixPreroutingRawRuleLogOptionsLevel          types.String `tfsdk:"level" vyos:"level,omitempty"`
...
func (o FirewallIPvsixPreroutingRawRuleLogOptions) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
