...
var _ helpers.VyosResourceDataModel = &FirewallIPvsixPreroutingRawRuleIcmpvsix{}

// FirewallIPvsixPreroutingRawRuleIcmpvsix describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallIPvsixPreroutingRawRuleIcmpvsix struct {
	// LeafNodes
	LeafFirewallIPvsixPreroutingRawRuleIcmpvsixCode     types.Number `tfsdk:"code" vyos:"code,omitempty"`
	LeafFirewallIPvsixPreroutingRawRuleIcmpvsixType     types.Number `tfsdk:"type" vyos:"type,omitempty"`
	LeafFirewallIPvsixPreroutingRawRuleIcmpvsixTypeName types.String `tfsdk:"type_name" vyos:"type-name,omitempty"`
...
func (o FirewallIPvsixPreroutingRawRuleIcmpvsix) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
