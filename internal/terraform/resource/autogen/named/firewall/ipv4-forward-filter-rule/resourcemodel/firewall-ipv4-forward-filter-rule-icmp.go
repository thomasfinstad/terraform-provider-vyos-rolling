...
var _ helpers.VyosResourceDataModel = &FirewallIPvfourForwardFilterRuleIcmp{}

// FirewallIPvfourForwardFilterRuleIcmp describes the resource data model.
type FirewallIPvfourForwardFilterRuleIcmp struct {
	// LeafNodes
	LeafFirewallIPvfourForwardFilterRuleIcmpCode     types.Number `tfsdk:"code" vyos:"code,omitempty"`
	LeafFirewallIPvfourForwardFilterRuleIcmpType     types.Number `tfsdk:"type" vyos:"type,omitempty"`
	LeafFirewallIPvfourForwardFilterRuleIcmpTypeName types.String `tfsdk:"type_name" vyos:"type-name,omitempty"`
...
func (o FirewallIPvfourForwardFilterRuleIcmp) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
