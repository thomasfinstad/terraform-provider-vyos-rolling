...
func (o FirewallIPvfourForwardFilterRuleGre) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
...
`,
		...
		"flags": schema.SingleNestedAttribute{
			Attributes: FirewallIPvfourForwardFilterRuleGreFlags{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
