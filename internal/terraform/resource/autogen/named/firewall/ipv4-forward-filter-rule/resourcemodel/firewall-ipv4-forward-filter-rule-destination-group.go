...
var _ helpers.VyosResourceDataModel = &FirewallIPvfourForwardFilterRuleDestinationGroup{}

// FirewallIPvfourForwardFilterRuleDestinationGroup describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallIPvfourForwardFilterRuleDestinationGroup struct {
	// LeafNodes
	LeafFirewallIPvfourForwardFilterRuleDestinationGroupAddressGroup        types.String `tfsdk:"address_group" vyos:"address-group,omitempty"`
	LeafFirewallIPvfourForwardFilterRuleDestinationGroupDomainGroup         types.String `tfsdk:"domain_group" vyos:"domain-group,omitempty"`
	LeafFirewallIPvfourForwardFilterRuleDestinationGroupMacGroup            types.String `tfsdk:"mac_group" vyos:"mac-group,omitempty"`
...
func (o FirewallIPvfourForwardFilterRuleDestinationGroup) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
