...
var _ helpers.VyosResourceDataModel = &FirewallIPvfourInputFilterRuleAddAddressToGroupDestinationAddress{}
...
func (o FirewallIPvfourInputFilterRuleAddAddressToGroupDestinationAddress) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
