...
type FirewallNameRuleState struct {
	// LeafNodes
	LeafFirewallNameRuleStateEstablished types.String `tfsdk:"established" vyos:"established,omitempty"`
	LeafFirewallNameRuleStateInvalID     types.String `tfsdk:"invalid" vyos:"invalid,omitempty"`
	LeafFirewallNameRuleStateNew         types.String `tfsdk:"new" vyos:"new,omitempty"`
	LeafFirewallNameRuleStateRelated     types.String `tfsdk:"related" vyos:"related,omitempty"`
...
func (o *FirewallNameRuleState) UnmarshalJSON(_ []byte) error {
	return nil
}
