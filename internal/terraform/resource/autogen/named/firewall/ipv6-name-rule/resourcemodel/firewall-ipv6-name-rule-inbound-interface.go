...
var _ helpers.VyosResourceDataModel = &FirewallIPvsixNameRuleInboundInterface{}
...
func (o FirewallIPvsixNameRuleInboundInterface) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
