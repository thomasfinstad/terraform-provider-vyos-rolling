...
type FirewallIPvsixNameRuleLogOptions struct {
	...
	LeafFirewallIPvsixNameRuleLogOptionsSnapshotLength types.Number `tfsdk:"snapshot_length" vyos:"snapshot-length,omitempty"`
...
func (o FirewallIPvsixNameRuleLogOptions) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
