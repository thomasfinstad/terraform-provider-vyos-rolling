...
var _ helpers.VyosResourceDataModel = &FirewallIPvsixNameRuleIcmpvsix{}
...
func (o FirewallIPvsixNameRuleIcmpvsix) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
