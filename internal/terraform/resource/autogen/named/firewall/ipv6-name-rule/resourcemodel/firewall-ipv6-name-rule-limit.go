...
var _ helpers.VyosResourceDataModel = &FirewallIPvsixNameRuleLimit{}
...
func (o FirewallIPvsixNameRuleLimit) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
