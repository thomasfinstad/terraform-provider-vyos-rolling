...
var _ helpers.VyosResourceDataModel = &FirewallBrIDgeInputFilterRuleIcmpvsix{}

// FirewallBrIDgeInputFilterRuleIcmpvsix describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallBrIDgeInputFilterRuleIcmpvsix struct {
	// LeafNodes
	LeafFirewallBrIDgeInputFilterRuleIcmpvsixCode     types.Number `tfsdk:"code" vyos:"code,omitempty"`
	LeafFirewallBrIDgeInputFilterRuleIcmpvsixType     types.Number `tfsdk:"type" vyos:"type,omitempty"`
	LeafFirewallBrIDgeInputFilterRuleIcmpvsixTypeName types.String `tfsdk:"type_name" vyos:"type-name,omitempty"`
...
func (o FirewallBrIDgeInputFilterRuleIcmpvsix) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
