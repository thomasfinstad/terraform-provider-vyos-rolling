...
var _ helpers.VyosResourceDataModel = &FirewallBrIDgeInputFilterRuleSource{}

// FirewallBrIDgeInputFilterRuleSource describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallBrIDgeInputFilterRuleSource struct {
	// LeafNodes
	LeafFirewallBrIDgeInputFilterRuleSourceMacAddress  types.String `tfsdk:"mac_address" vyos:"mac-address,omitempty"`
	LeafFirewallBrIDgeInputFilterRuleSourceAddress     types.String `tfsdk:"address" vyos:"address,omitempty"`
	LeafFirewallBrIDgeInputFilterRuleSourceAddressMask types.String `tfsdk:"address_mask" vyos:"address-mask,omitempty"`
	LeafFirewallBrIDgeInputFilterRuleSourcePort        types.String `tfsdk:"port" vyos:"port,omitempty"`

	// TagNodes

	// Nodes

	NodeFirewallBrIDgeInputFilterRuleSourceGroup *FirewallBrIDgeInputFilterRuleSourceGroup `tfsdk:"group" vyos:"group,omitempty"`
}

// ResourceSchemaAttributes generates the schema attributes for the resource at this level
func (o FirewallBrIDgeInputFilterRuleSource) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
...
`,
		...
		"group": schema.SingleNestedAttribute{
			Attributes: FirewallBrIDgeInputFilterRuleSourceGroup{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
