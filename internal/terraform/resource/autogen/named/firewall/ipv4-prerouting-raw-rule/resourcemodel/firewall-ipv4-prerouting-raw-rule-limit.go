...
var _ helpers.VyosResourceDataModel = &FirewallIPvfourPreroutingRawRuleLimit{}

// FirewallIPvfourPreroutingRawRuleLimit describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallIPvfourPreroutingRawRuleLimit struct {
	// LeafNodes
	LeafFirewallIPvfourPreroutingRawRuleLimitBurst types.Number `tfsdk:"burst" vyos:"burst,omitempty"`
	LeafFirewallIPvfourPreroutingRawRuleLimitRate  types.String `tfsdk:"rate" vyos:"rate,omitempty"`
...
func (o FirewallIPvfourPreroutingRawRuleLimit) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
