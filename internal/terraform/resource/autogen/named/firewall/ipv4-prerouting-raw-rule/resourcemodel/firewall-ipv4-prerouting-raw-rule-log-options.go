...
var _ helpers.VyosResourceDataModel = &FirewallIPvfourPreroutingRawRuleLogOptions{}

// FirewallIPvfourPreroutingRawRuleLogOptions describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallIPvfourPreroutingRawRuleLogOptions struct {
	// LeafNodes
	LeafFirewallIPvfourPreroutingRawRuleLogOptionsGroup          types.Number `tfsdk:"group" vyos:"group,omitempty"`
	LeafFirewallIPvfourPreroutingRawRuleLogOptionsSnapshotLength types.Number `tfsdk:"snapshot_length" vyos:"snapshot-length,omitempty"`
	LeafFirewallIPvfourPreroutingRawRuleLogOptionsQueueThreshold types.Number `tfsdk:"queue_threshold" vyos:"queue-threshold,omitempty"`
	LeafFirewallIPvfourPreroutingRawRuleLogOptionsLevel          types.String `tfsdk:"level" vyos:"level,omitempty"`
...
func (o FirewallIPvfourPreroutingRawRuleLogOptions) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
