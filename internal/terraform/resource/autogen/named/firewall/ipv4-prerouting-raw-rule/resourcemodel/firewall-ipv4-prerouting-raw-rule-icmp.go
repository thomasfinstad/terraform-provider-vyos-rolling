...
var _ helpers.VyosResourceDataModel = &FirewallIPvfourPreroutingRawRuleIcmp{}

// FirewallIPvfourPreroutingRawRuleIcmp describes the resource data model.
type FirewallIPvfourPreroutingRawRuleIcmp struct {
	// LeafNodes
	LeafFirewallIPvfourPreroutingRawRuleIcmpCode     types.Number `tfsdk:"code" vyos:"code,omitempty"`
	LeafFirewallIPvfourPreroutingRawRuleIcmpType     types.Number `tfsdk:"type" vyos:"type,omitempty"`
	LeafFirewallIPvfourPreroutingRawRuleIcmpTypeName types.String `tfsdk:"type_name" vyos:"type-name,omitempty"`
...
func (o FirewallIPvfourPreroutingRawRuleIcmp) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
