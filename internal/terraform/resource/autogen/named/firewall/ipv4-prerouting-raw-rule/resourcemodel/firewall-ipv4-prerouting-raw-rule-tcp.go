...
func (o FirewallIPvfourPreroutingRawRuleTCP) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
...
`,
		...
		"flags": schema.SingleNestedAttribute{
			Attributes: FirewallIPvfourPreroutingRawRuleTCPFlags{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
