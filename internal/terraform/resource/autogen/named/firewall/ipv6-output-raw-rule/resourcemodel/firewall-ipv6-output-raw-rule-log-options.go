...
var _ helpers.VyosResourceDataModel = &FirewallIPvsixOutputRawRuleLogOptions{}

// FirewallIPvsixOutputRawRuleLogOptions describes the resource data model.
type FirewallIPvsixOutputRawRuleLogOptions struct {
	// LeafNodes
	LeafFirewallIPvsixOutputRawRuleLogOptionsGroup          types.Number `tfsdk:"group" vyos:"group,omitempty"`
	LeafFirewallIPvsixOutputRawRuleLogOptionsSnapshotLength types.Number `tfsdk:"snapshot_length" vyos:"snapshot-length,omitempty"`
	LeafFirewallIPvsixOutputRawRuleLogOptionsQueueThreshold types.Number `tfsdk:"queue_threshold" vyos:"queue-threshold,omitempty"`
	LeafFirewallIPvsixOutputRawRuleLogOptionsLevel          types.String `tfsdk:"level" vyos:"level,omitempty"`
...
func (o FirewallIPvsixOutputRawRuleLogOptions) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
