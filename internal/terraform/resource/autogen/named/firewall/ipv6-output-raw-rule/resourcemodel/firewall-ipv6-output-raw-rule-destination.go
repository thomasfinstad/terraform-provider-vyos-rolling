...
var _ helpers.VyosResourceDataModel = &FirewallIPvsixOutputRawRuleDestination{}

// FirewallIPvsixOutputRawRuleDestination describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallIPvsixOutputRawRuleDestination struct {
	// LeafNodes
	LeafFirewallIPvsixOutputRawRuleDestinationAddress     types.String `tfsdk:"address" vyos:"address,omitempty"`
	LeafFirewallIPvsixOutputRawRuleDestinationAddressMask types.String `tfsdk:"address_mask" vyos:"address-mask,omitempty"`
	LeafFirewallIPvsixOutputRawRuleDestinationFqdn        types.String `tfsdk:"fqdn" vyos:"fqdn,omitempty"`
	LeafFirewallIPvsixOutputRawRuleDestinationMacAddress  types.String `tfsdk:"mac_address" vyos:"mac-address,omitempty"`
	LeafFirewallIPvsixOutputRawRuleDestinationPort        types.String `tfsdk:"port" vyos:"port,omitempty"`

	// TagNodes

	// Nodes

	NodeFirewallIPvsixOutputRawRuleDestinationGeoIP *FirewallIPvsixOutputRawRuleDestinationGeoIP `tfsdk:"geoip" vyos:"geoip,omitempty"`

	NodeFirewallIPvsixOutputRawRuleDestinationGroup *FirewallIPvsixOutputRawRuleDestinationGroup `tfsdk:"group" vyos:"group,omitempty"`
}

// ResourceSchemaAttributes generates the schema attributes for the resource at this level
func (o FirewallIPvsixOutputRawRuleDestination) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
...
`,
		...
		"geoip": schema.SingleNestedAttribute{
			Attributes: FirewallIPvsixOutputRawRuleDestinationGeoIP{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
...
`,
		...
		"group": schema.SingleNestedAttribute{
			Attributes: FirewallIPvsixOutputRawRuleDestinationGroup{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
