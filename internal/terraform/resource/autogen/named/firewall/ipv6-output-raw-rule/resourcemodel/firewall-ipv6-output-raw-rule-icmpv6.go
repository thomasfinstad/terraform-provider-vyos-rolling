...
var _ helpers.VyosResourceDataModel = &FirewallIPvsixOutputRawRuleIcmpvsix{}

// FirewallIPvsixOutputRawRuleIcmpvsix describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallIPvsixOutputRawRuleIcmpvsix struct {
	// LeafNodes
	LeafFirewallIPvsixOutputRawRuleIcmpvsixCode     types.Number `tfsdk:"code" vyos:"code,omitempty"`
	LeafFirewallIPvsixOutputRawRuleIcmpvsixType     types.Number `tfsdk:"type" vyos:"type,omitempty"`
	LeafFirewallIPvsixOutputRawRuleIcmpvsixTypeName types.String `tfsdk:"type_name" vyos:"type-name,omitempty"`
...
func (o FirewallIPvsixOutputRawRuleIcmpvsix) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
