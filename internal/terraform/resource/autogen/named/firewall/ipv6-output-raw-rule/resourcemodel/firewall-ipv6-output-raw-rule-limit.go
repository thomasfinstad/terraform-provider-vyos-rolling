...
var _ helpers.VyosResourceDataModel = &FirewallIPvsixOutputRawRuleLimit{}

// FirewallIPvsixOutputRawRuleLimit describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallIPvsixOutputRawRuleLimit struct {
	// LeafNodes
	LeafFirewallIPvsixOutputRawRuleLimitBurst types.Number `tfsdk:"burst" vyos:"burst,omitempty"`
	LeafFirewallIPvsixOutputRawRuleLimitRate  types.String `tfsdk:"rate" vyos:"rate,omitempty"`
...
func (o FirewallIPvsixOutputRawRuleLimit) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
