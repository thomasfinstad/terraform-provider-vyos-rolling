...
var _ helpers.VyosResourceDataModel = &FirewallBrIDgePreroutingFilterRuleTCP{}

// FirewallBrIDgePreroutingFilterRuleTCP describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallBrIDgePreroutingFilterRuleTCP struct {
	// LeafNodes
...
func (o FirewallBrIDgePreroutingFilterRuleTCP) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
...
`,
		...
		"flags": schema.SingleNestedAttribute{
			Attributes: FirewallBrIDgePreroutingFilterRuleTCPFlags{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
