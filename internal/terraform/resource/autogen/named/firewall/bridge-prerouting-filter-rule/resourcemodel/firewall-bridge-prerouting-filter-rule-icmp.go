...
var _ helpers.VyosResourceDataModel = &FirewallBrIDgePreroutingFilterRuleIcmp{}

// FirewallBrIDgePreroutingFilterRuleIcmp describes the resource data model.
type FirewallBrIDgePreroutingFilterRuleIcmp struct {
	// LeafNodes
	LeafFirewallBrIDgePreroutingFilterRuleIcmpCode     types.Number `tfsdk:"code" vyos:"code,omitempty"`
	LeafFirewallBrIDgePreroutingFilterRuleIcmpType     types.Number `tfsdk:"type" vyos:"type,omitempty"`
	LeafFirewallBrIDgePreroutingFilterRuleIcmpTypeName types.String `tfsdk:"type_name" vyos:"type-name,omitempty"`
...
func (o FirewallBrIDgePreroutingFilterRuleIcmp) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
