...
var _ helpers.VyosResourceDataModel = &FirewallIPvsixForwardFilterRuleLogOptions{}
...
func (o FirewallIPvsixForwardFilterRuleLogOptions) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
