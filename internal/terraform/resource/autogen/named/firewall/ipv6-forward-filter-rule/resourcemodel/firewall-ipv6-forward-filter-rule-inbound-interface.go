...
var _ helpers.VyosResourceDataModel = &FirewallIPvsixForwardFilterRuleInboundInterface{}
...
func (o FirewallIPvsixForwardFilterRuleInboundInterface) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
