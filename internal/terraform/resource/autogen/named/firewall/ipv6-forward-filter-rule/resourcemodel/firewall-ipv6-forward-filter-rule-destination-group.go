...
var _ helpers.VyosResourceDataModel = &FirewallIPvsixForwardFilterRuleDestinationGroup{}

// FirewallIPvsixForwardFilterRuleDestinationGroup describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallIPvsixForwardFilterRuleDestinationGroup struct {
	// LeafNodes
	LeafFirewallIPvsixForwardFilterRuleDestinationGroupAddressGroup        types.String `tfsdk:"address_group" vyos:"address-group,omitempty"`
	LeafFirewallIPvsixForwardFilterRuleDestinationGroupDomainGroup         types.String `tfsdk:"domain_group" vyos:"domain-group,omitempty"`
	LeafFirewallIPvsixForwardFilterRuleDestinationGroupMacGroup            types.String `tfsdk:"mac_group" vyos:"mac-group,omitempty"`
	LeafFirewallIPvsixForwardFilterRuleDestinationGroupNetworkGroup        types.String `tfsdk:"network_group" vyos:"network-group,omitempty"`
	LeafFirewallIPvsixForwardFilterRuleDestinationGroupPortGroup           types.String `tfsdk:"port_group" vyos:"port-group,omitempty"`
	LeafFirewallIPvsixForwardFilterRuleDestinationGroupDynamicAddressGroup types.String `tfsdk:"dynamic_address_group" vyos:"dynamic-address-group,omitempty"`
...
func (o FirewallIPvsixForwardFilterRuleDestinationGroup) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
