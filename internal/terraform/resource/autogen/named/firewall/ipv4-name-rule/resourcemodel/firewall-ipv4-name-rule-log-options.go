...
var _ helpers.VyosResourceDataModel = &FirewallIPvfourNameRuleLogOptions{}

// FirewallIPvfourNameRuleLogOptions describes the resource data model.
type FirewallIPvfourNameRuleLogOptions struct {
	// LeafNodes
	LeafFirewallIPvfourNameRuleLogOptionsGroup          types.Number `tfsdk:"group" vyos:"group,omitempty"`
	LeafFirewallIPvfourNameRuleLogOptionsSnapshotLength types.Number `tfsdk:"snapshot_length" vyos:"snapshot-length,omitempty"`
	LeafFirewallIPvfourNameRuleLogOptionsQueueThreshold types.Number `tfsdk:"queue_threshold" vyos:"queue-threshold,omitempty"`
	LeafFirewallIPvfourNameRuleLogOptionsLevel          types.String `tfsdk:"level" vyos:"level,omitempty"`
...
func (o FirewallIPvfourNameRuleLogOptions) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
