...
var _ helpers.VyosResourceDataModel = &FirewallIPvfourNameRuleDestinationGroup{}

// FirewallIPvfourNameRuleDestinationGroup describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type FirewallIPvfourNameRuleDestinationGroup struct {
	// LeafNodes
	LeafFirewallIPvfourNameRuleDestinationGroupAddressGroup        types.String `tfsdk:"address_group" vyos:"address-group,omitempty"`
	LeafFirewallIPvfourNameRuleDestinationGroupDomainGroup         types.String `tfsdk:"domain_group" vyos:"domain-group,omitempty"`
	LeafFirewallIPvfourNameRuleDestinationGroupMacGroup            types.String `tfsdk:"mac_group" vyos:"mac-group,omitempty"`
	LeafFirewallIPvfourNameRuleDestinationGroupNetworkGroup        types.String `tfsdk:"network_group" vyos:"network-group,omitempty"`
	LeafFirewallIPvfourNameRuleDestinationGroupPortGroup           types.String `tfsdk:"port_group" vyos:"port-group,omitempty"`
	LeafFirewallIPvfourNameRuleDestinationGroupDynamicAddressGroup types.String `tfsdk:"dynamic_address_group" vyos:"dynamic-address-group,omitempty"`
...
func (o FirewallIPvfourNameRuleDestinationGroup) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
