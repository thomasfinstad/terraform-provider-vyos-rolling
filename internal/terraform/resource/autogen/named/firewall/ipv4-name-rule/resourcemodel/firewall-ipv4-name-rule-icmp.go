...
var _ helpers.VyosResourceDataModel = &FirewallIPvfourNameRuleIcmp{}

// FirewallIPvfourNameRuleIcmp describes the resource data model.
type FirewallIPvfourNameRuleIcmp struct {
	// LeafNodes
	LeafFirewallIPvfourNameRuleIcmpCode     types.Number `tfsdk:"code" vyos:"code,omitempty"`
	LeafFirewallIPvfourNameRuleIcmpType     types.Number `tfsdk:"type" vyos:"type,omitempty"`
	LeafFirewallIPvfourNameRuleIcmpTypeName types.String `tfsdk:"type_name" vyos:"type-name,omitempty"`
...
func (o FirewallIPvfourNameRuleIcmp) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
