...
type ProtocolsRIPngDistributeListInterfaceAccessList struct {
	// LeafNodes
	ProtocolsRIPngDistributeListInterfaceAccessListIn  customtypes.CustomStringValue `tfsdk:"in" json:"in,omitempty"`
	ProtocolsRIPngDistributeListInterfaceAccessListOut customtypes.CustomStringValue `tfsdk:"out" json:"out,omitempty"`
...
func (o ProtocolsRIPngDistributeListInterfaceAccessList) ResourceAttributes() map[string]schema.Attribute {
