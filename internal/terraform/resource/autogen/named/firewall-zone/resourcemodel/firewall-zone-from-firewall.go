...
type FirewallZoneFromFirewall struct {
	// LeafNodes
	LeafFirewallZoneFromFirewallIPvsixName types.String `tfsdk:"ipv6_name" json:"ipv6-name,omitempty"`
	LeafFirewallZoneFromFirewallName       types.String `tfsdk:"name" json:"name,omitempty"`
