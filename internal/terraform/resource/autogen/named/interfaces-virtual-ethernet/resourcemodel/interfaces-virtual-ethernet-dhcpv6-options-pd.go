...
type InterfacesVirtualEthernetDhcpvsixOptionsPd struct {
	// LeafNodes
	LeafInterfacesVirtualEthernetDhcpvsixOptionsPdLength types.String `tfsdk:"length" json:"length,omitempty"`

	// TagNodes
	TagInterfacesVirtualEthernetDhcpvsixOptionsPdInterface *map[string]InterfacesVirtualEthernetDhcpvsixOptionsPdInterface `tfsdk:"interface" json:"interface,omitempty"`
...
func (o *InterfacesVirtualEthernetDhcpvsixOptionsPd) MarshalJSON() ([]byte, error) {
	...
	if !reflect.ValueOf(o.TagInterfacesVirtualEthernetDhcpvsixOptionsPdInterface).IsZero() {
		subJSONStr, err := json.Marshal(o.TagInterfacesVirtualEthernetDhcpvsixOptionsPdInterface)
		if err != nil {
			return nil, err
		}
...
func (o *InterfacesVirtualEthernetDhcpvsixOptionsPd) UnmarshalJSON(jsonStr []byte) error {
	...
	if value, ok := jsonData["interface"]; ok {
		...
		o.TagInterfacesVirtualEthernetDhcpvsixOptionsPdInterface = &map[string]InterfacesVirtualEthernetDhcpvsixOptionsPdInterface{}

		err = json.Unmarshal(subJSONStr, o.TagInterfacesVirtualEthernetDhcpvsixOptionsPdInterface)
		if err != nil {
			return err
		}
	}
