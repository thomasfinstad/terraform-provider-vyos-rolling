...
type InterfacesVirtualEthernetDhcpvsixOptionsPdInterface struct {
	// LeafNodes
	LeafInterfacesVirtualEthernetDhcpvsixOptionsPdInterfaceAddress types.String `tfsdk:"address"`
	LeafInterfacesVirtualEthernetDhcpvsixOptionsPdInterfaceSLAID   types.String `tfsdk:"sla_id"`
...
func (o *InterfacesVirtualEthernetDhcpvsixOptionsPdInterface) TerraformToVyos(ctx context.Context, diags *diag.Diagnostics) map[string]interface{} {
	tflog.Error(ctx, "TerraformToVyos", map[string]interface{}{"Path": []string{"interfaces", "virtual-ethernet", "dhcpv6-options", "pd", "interface"}})
	...
	if !(o.LeafInterfacesVirtualEthernetDhcpvsixOptionsPdInterfaceAddress.IsNull() || o.LeafInterfacesVirtualEthernetDhcpvsixOptionsPdInterfaceAddress.IsUnknown()) {
		vyosData["address"] = o.LeafInterfacesVirtualEthernetDhcpvsixOptionsPdInterfaceAddress.ValueString()
	}
	if !(o.LeafInterfacesVirtualEthernetDhcpvsixOptionsPdInterfaceSLAID.IsNull() || o.LeafInterfacesVirtualEthernetDhcpvsixOptionsPdInterfaceSLAID.IsUnknown()) {
		vyosData["sla-id"] = o.LeafInterfacesVirtualEthernetDhcpvsixOptionsPdInterfaceSLAID.ValueString()
	}
...
func (o *InterfacesVirtualEthernetDhcpvsixOptionsPdInterface) VyosToTerraform(ctx context.Context, diags *diag.Diagnostics, vyosData map[string]interface{}) {
	tflog.Error(ctx, "VyosToTerraform begin", map[string]interface{}{"Path": []string{"interfaces", "virtual-ethernet", "dhcpv6-options", "pd", "interface"}})
	...
	tflog.Error(ctx, "VyosToTerraform end", map[string]interface{}{"Path": []string{"interfaces", "virtual-ethernet", "dhcpv6-options", "pd", "interface"}})
}

// AttributeTypes generates the attribute types for the resource at this level
func (o InterfacesVirtualEthernetDhcpvsixOptionsPdInterface) AttributeTypes() map[string]attr.Type {
