...
type InterfacesVirtualEthernetDhcpvsixOptionsPdInterface struct {
	// LeafNodes
	InterfacesVirtualEthernetDhcpvsixOptionsPdInterfaceAddress customtypes.CustomStringValue `tfsdk:"address" json:"address,omitempty"`
	InterfacesVirtualEthernetDhcpvsixOptionsPdInterfaceSLAID   customtypes.CustomStringValue `tfsdk:"sla_id" json:"sla-id,omitempty"`
...
func (o InterfacesVirtualEthernetDhcpvsixOptionsPdInterface) ResourceAttributes() map[string]schema.Attribute {
