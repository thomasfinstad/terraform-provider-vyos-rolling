...
type LoadBalancingWanRuleSource struct {
	// LeafNodes
	LoadBalancingWanRuleSourceAddress customtypes.CustomStringValue `tfsdk:"address" json:"address,omitempty"`
	LoadBalancingWanRuleSourcePort    customtypes.CustomStringValue `tfsdk:"port" json:"port,omitempty"`
...
func (o LoadBalancingWanRuleSource) ResourceAttributes() map[string]schema.Attribute {
