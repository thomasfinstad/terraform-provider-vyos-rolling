...
type InterfacesOpenvpnMirror struct {
	// LeafNodes
	LeafInterfacesOpenvpnMirrorIngress types.String `tfsdk:"ingress" json:"ingress,omitempty"`
	LeafInterfacesOpenvpnMirrorEgress  types.String `tfsdk:"egress" json:"egress,omitempty"`
