...
type InterfacesOpenvpnIPvsixAddress struct {
	// LeafNodes
	InterfacesOpenvpnIPvsixAddressAutoconf           customtypes.CustomStringValue `tfsdk:"autoconf" json:"autoconf,omitempty"`
	InterfacesOpenvpnIPvsixAddressEuisixfour         customtypes.CustomStringValue `tfsdk:"eui64" json:"eui64,omitempty"`
	InterfacesOpenvpnIPvsixAddressNoDefaultLinkLocal customtypes.CustomStringValue `tfsdk:"no_default_link_local" json:"no-default-link-local,omitempty"`
...
func (o InterfacesOpenvpnIPvsixAddress) ResourceAttributes() map[string]schema.Attribute {
