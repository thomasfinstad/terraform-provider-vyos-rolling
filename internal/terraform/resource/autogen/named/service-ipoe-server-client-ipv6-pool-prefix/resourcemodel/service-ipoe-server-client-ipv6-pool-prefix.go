...
type ServiceIPoeServerClientIPvsixPoolPrefix struct {
	// LeafNodes
	ServiceIPoeServerClientIPvsixPoolPrefixMask customtypes.CustomStringValue `tfsdk:"mask" json:"mask,omitempty"`
...
func (o ServiceIPoeServerClientIPvsixPoolPrefix) ResourceAttributes() map[string]schema.Attribute {
