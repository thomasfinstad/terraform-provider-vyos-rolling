...
type ProtocolsOspfInterfaceAuthenticationMdfiveKeyID struct {
	// LeafNodes
	ProtocolsOspfInterfaceAuthenticationMdfiveKeyIDMdfiveKey customtypes.CustomStringValue `tfsdk:"md5_key" json:"md5-key,omitempty"`
...
func (o ProtocolsOspfInterfaceAuthenticationMdfiveKeyID) ResourceAttributes() map[string]schema.Attribute {
