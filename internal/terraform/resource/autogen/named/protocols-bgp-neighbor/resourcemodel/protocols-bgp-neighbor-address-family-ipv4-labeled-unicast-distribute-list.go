...
type ProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastDistributeList struct {
	// LeafNodes
	ProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastDistributeListExport customtypes.CustomStringValue `tfsdk:"export" json:"export,omitempty"`
	ProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastDistributeListImport customtypes.CustomStringValue `tfsdk:"import" json:"import,omitempty"`
...
func (o ProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastDistributeList) ResourceAttributes() map[string]schema.Attribute {
