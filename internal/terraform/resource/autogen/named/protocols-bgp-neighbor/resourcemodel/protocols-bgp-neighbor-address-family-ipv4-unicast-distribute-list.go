...
type ProtocolsBgpNeighborAddressFamilyIPvfourUnicastDistributeList struct {
	// LeafNodes
	LeafProtocolsBgpNeighborAddressFamilyIPvfourUnicastDistributeListExport types.String `tfsdk:"export" json:"export,omitempty"`
	LeafProtocolsBgpNeighborAddressFamilyIPvfourUnicastDistributeListImport types.String `tfsdk:"import" json:"import,omitempty"`
