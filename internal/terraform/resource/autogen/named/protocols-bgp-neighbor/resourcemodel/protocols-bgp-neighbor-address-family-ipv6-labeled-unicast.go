...
type ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicast struct {
	// LeafNodes
	LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAddpathTxAll         types.String `tfsdk:"addpath_tx_all" json:"addpath-tx-all,omitempty"`
	LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAddpathTxPerAs       types.String `tfsdk:"addpath_tx_per_as" json:"addpath-tx-per-as,omitempty"`
	LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAsOverrIDe           types.String `tfsdk:"as_override" json:"as-override,omitempty"`
	LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastMaximumPrefix        types.String `tfsdk:"maximum_prefix" json:"maximum-prefix,omitempty"`
	LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastMaximumPrefixOut     types.String `tfsdk:"maximum_prefix_out" json:"maximum-prefix-out,omitempty"`
	LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastRemovePrivateAs      types.String `tfsdk:"remove_private_as" json:"remove-private-as,omitempty"`
	LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastRouteReflectorClient types.String `tfsdk:"route_reflector_client" json:"route-reflector-client,omitempty"`
	LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastRouteServerClient    types.String `tfsdk:"route_server_client" json:"route-server-client,omitempty"`
	LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastUnsuppressMap        types.String `tfsdk:"unsuppress_map" json:"unsuppress-map,omitempty"`
	LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastWeight               types.String `tfsdk:"weight" json:"weight,omitempty"`

	// TagNodes

	// Nodes
	NodeProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastCapability             *ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastCapability             `tfsdk:"capability" json:"capability,omitempty"`
	NodeProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastNexthopLocal           *ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastNexthopLocal           `tfsdk:"nexthop_local" json:"nexthop-local,omitempty"`
	NodeProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastPrefixList             *ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastPrefixList             `tfsdk:"prefix_list" json:"prefix-list,omitempty"`
	NodeProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastConditionallyAdvertise *ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastConditionallyAdvertise `tfsdk:"conditionally_advertise" json:"conditionally-advertise,omitempty"`
	NodeProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAllowasIn              *ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAllowasIn              `tfsdk:"allowas_in" json:"allowas-in,omitempty"`
	NodeProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAttributeUnchanged     *ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAttributeUnchanged     `tfsdk:"attribute_unchanged" json:"attribute-unchanged,omitempty"`
	NodeProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastDisableSendCommunity   *ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastDisableSendCommunity   `tfsdk:"disable_send_community" json:"disable-send-community,omitempty"`
	NodeProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastDistributeList         *ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastDistributeList         `tfsdk:"distribute_list" json:"distribute-list,omitempty"`
	NodeProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastFilterList             *ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastFilterList             `tfsdk:"filter_list" json:"filter-list,omitempty"`
	NodeProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastNexthopSelf            *ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastNexthopSelf            `tfsdk:"nexthop_self" json:"nexthop-self,omitempty"`
	NodeProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastRouteMap               *ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastRouteMap               `tfsdk:"route_map" json:"route-map,omitempty"`
	NodeProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastSoftReconfiguration    *ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastSoftReconfiguration    `tfsdk:"soft_reconfiguration" json:"soft-reconfiguration,omitempty"`
	NodeProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastDefaultOriginate       *ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastDefaultOriginate       `tfsdk:"default_originate" json:"default-originate,omitempty"`
}
