...
type ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastNexthopSelf struct {
	// LeafNodes
	ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastNexthopSelfForce customtypes.CustomStringValue `tfsdk:"force" json:"force,omitempty"`
...
func (o ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastNexthopSelf) ResourceAttributes() map[string]schema.Attribute {
