...
type ProtocolsBgpNeighborAddressFamilyIPvsixMulticastRouteMap struct {
	// LeafNodes
	LeafProtocolsBgpNeighborAddressFamilyIPvsixMulticastRouteMapExport types.String `tfsdk:"export" json:"export,omitempty"`
	LeafProtocolsBgpNeighborAddressFamilyIPvsixMulticastRouteMapImport types.String `tfsdk:"import" json:"import,omitempty"`
