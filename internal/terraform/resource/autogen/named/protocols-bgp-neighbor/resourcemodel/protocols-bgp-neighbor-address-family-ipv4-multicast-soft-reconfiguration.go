...
type ProtocolsBgpNeighborAddressFamilyIPvfourMulticastSoftReconfiguration struct {
	// LeafNodes
	ProtocolsBgpNeighborAddressFamilyIPvfourMulticastSoftReconfigurationInbound customtypes.CustomStringValue `tfsdk:"inbound" json:"inbound,omitempty"`
...
func (o ProtocolsBgpNeighborAddressFamilyIPvfourMulticastSoftReconfiguration) ResourceAttributes() map[string]schema.Attribute {
