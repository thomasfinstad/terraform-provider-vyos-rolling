...
type ProtocolsBgpNeighborAddressFamilyIPvsixVpnDistributeList struct {
	// LeafNodes
	ProtocolsBgpNeighborAddressFamilyIPvsixVpnDistributeListExport customtypes.CustomStringValue `tfsdk:"export" json:"export,omitempty"`
	ProtocolsBgpNeighborAddressFamilyIPvsixVpnDistributeListImport customtypes.CustomStringValue `tfsdk:"import" json:"import,omitempty"`
...
func (o ProtocolsBgpNeighborAddressFamilyIPvsixVpnDistributeList) ResourceAttributes() map[string]schema.Attribute {
