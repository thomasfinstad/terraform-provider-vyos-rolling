...
type ProtocolsBgpNeighborAddressFamilyLtwovpnEvpnNexthopSelf struct {
	// LeafNodes
	ProtocolsBgpNeighborAddressFamilyLtwovpnEvpnNexthopSelfForce customtypes.CustomStringValue `tfsdk:"force" json:"force,omitempty"`
...
func (o ProtocolsBgpNeighborAddressFamilyLtwovpnEvpnNexthopSelf) ResourceAttributes() map[string]schema.Attribute {
