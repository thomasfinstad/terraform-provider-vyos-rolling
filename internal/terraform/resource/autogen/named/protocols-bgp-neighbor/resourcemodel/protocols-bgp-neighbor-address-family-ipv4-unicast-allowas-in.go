...
type ProtocolsBgpNeighborAddressFamilyIPvfourUnicastAllowasIn struct {
	// LeafNodes
	ProtocolsBgpNeighborAddressFamilyIPvfourUnicastAllowasInNumber customtypes.CustomStringValue `tfsdk:"number" json:"number,omitempty"`
...
func (o ProtocolsBgpNeighborAddressFamilyIPvfourUnicastAllowasIn) ResourceAttributes() map[string]schema.Attribute {
