...
type ProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastAllowasIn struct {
	// LeafNodes
	ProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastAllowasInNumber customtypes.CustomStringValue `tfsdk:"number" json:"number,omitempty"`
...
func (o ProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastAllowasIn) ResourceAttributes() map[string]schema.Attribute {
