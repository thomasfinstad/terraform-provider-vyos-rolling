...
type ProtocolsBgpNeighborAddressFamilyIPvfourVpnPrefixList struct {
	// LeafNodes
	LeafProtocolsBgpNeighborAddressFamilyIPvfourVpnPrefixListExport types.String `tfsdk:"export"`
	LeafProtocolsBgpNeighborAddressFamilyIPvfourVpnPrefixListImport types.String `tfsdk:"import"`
...
func (o *ProtocolsBgpNeighborAddressFamilyIPvfourVpnPrefixList) TerraformToVyos(ctx context.Context, diags *diag.Diagnostics) map[string]interface{} {
	tflog.Error(ctx, "TerraformToVyos", map[string]interface{}{"Path": []string{"protocols", "bgp", "neighbor", "address-family", "ipv4-vpn", "prefix-list"}})
	...
	if !(o.LeafProtocolsBgpNeighborAddressFamilyIPvfourVpnPrefixListExport.IsNull() || o.LeafProtocolsBgpNeighborAddressFamilyIPvfourVpnPrefixListExport.IsUnknown()) {
		vyosData["export"] = o.LeafProtocolsBgpNeighborAddressFamilyIPvfourVpnPrefixListExport.ValueString()
	}
	if !(o.LeafProtocolsBgpNeighborAddressFamilyIPvfourVpnPrefixListImport.IsNull() || o.LeafProtocolsBgpNeighborAddressFamilyIPvfourVpnPrefixListImport.IsUnknown()) {
		vyosData["import"] = o.LeafProtocolsBgpNeighborAddressFamilyIPvfourVpnPrefixListImport.ValueString()
	}
...
func (o *ProtocolsBgpNeighborAddressFamilyIPvfourVpnPrefixList) VyosToTerraform(ctx context.Context, diags *diag.Diagnostics, vyosData map[string]interface{}) {
	tflog.Error(ctx, "VyosToTerraform begin", map[string]interface{}{"Path": []string{"protocols", "bgp", "neighbor", "address-family", "ipv4-vpn", "prefix-list"}})
	...
	tflog.Error(ctx, "VyosToTerraform end", map[string]interface{}{"Path": []string{"protocols", "bgp", "neighbor", "address-family", "ipv4-vpn", "prefix-list"}})
}

// AttributeTypes generates the attribute types for the resource at this level
func (o ProtocolsBgpNeighborAddressFamilyIPvfourVpnPrefixList) AttributeTypes() map[string]attr.Type {
