...
type ProtocolsBgpNeighborInterface struct {
	// LeafNodes
	LeafProtocolsBgpNeighborInterfacePeerGroup       types.String `tfsdk:"peer_group" json:"peer-group,omitempty"`
	LeafProtocolsBgpNeighborInterfaceRemoteAs        types.String `tfsdk:"remote_as" json:"remote-as,omitempty"`
	LeafProtocolsBgpNeighborInterfaceSourceInterface types.String `tfsdk:"source_interface" json:"source-interface,omitempty"`

	// TagNodes

	// Nodes
	NodeProtocolsBgpNeighborInterfaceVsixonly *ProtocolsBgpNeighborInterfaceVsixonly `tfsdk:"v6only" json:"v6only,omitempty"`
}
