...
type ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastNexthopLocal struct {
	// LeafNodes
	ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastNexthopLocalUnchanged customtypes.CustomStringValue `tfsdk:"unchanged" json:"unchanged,omitempty"`
...
func (o ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastNexthopLocal) ResourceAttributes() map[string]schema.Attribute {
