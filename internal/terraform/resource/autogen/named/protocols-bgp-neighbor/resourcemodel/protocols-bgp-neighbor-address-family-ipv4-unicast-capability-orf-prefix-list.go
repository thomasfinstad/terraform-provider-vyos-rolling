...
type ProtocolsBgpNeighborAddressFamilyIPvfourUnicastCapabilityOrfPrefixList struct {
	// LeafNodes
	LeafProtocolsBgpNeighborAddressFamilyIPvfourUnicastCapabilityOrfPrefixListReceive types.String `tfsdk:"receive"`
	LeafProtocolsBgpNeighborAddressFamilyIPvfourUnicastCapabilityOrfPrefixListSend    types.String `tfsdk:"send"`
...
func (o *ProtocolsBgpNeighborAddressFamilyIPvfourUnicastCapabilityOrfPrefixList) TerraformToVyos(ctx context.Context, diags *diag.Diagnostics) map[string]interface{} {
	tflog.Error(ctx, "TerraformToVyos", map[string]interface{}{"Path": []string{"protocols", "bgp", "neighbor", "address-family", "ipv4-unicast", "capability", "orf", "prefix-list"}})
	...
	if !(o.LeafProtocolsBgpNeighborAddressFamilyIPvfourUnicastCapabilityOrfPrefixListReceive.IsNull() || o.LeafProtocolsBgpNeighborAddressFamilyIPvfourUnicastCapabilityOrfPrefixListReceive.IsUnknown()) {
		vyosData["receive"] = o.LeafProtocolsBgpNeighborAddressFamilyIPvfourUnicastCapabilityOrfPrefixListReceive.ValueString()
	}
	if !(o.LeafProtocolsBgpNeighborAddressFamilyIPvfourUnicastCapabilityOrfPrefixListSend.IsNull() || o.LeafProtocolsBgpNeighborAddressFamilyIPvfourUnicastCapabilityOrfPrefixListSend.IsUnknown()) {
		vyosData["send"] = o.LeafProtocolsBgpNeighborAddressFamilyIPvfourUnicastCapabilityOrfPrefixListSend.ValueString()
	}
...
func (o *ProtocolsBgpNeighborAddressFamilyIPvfourUnicastCapabilityOrfPrefixList) VyosToTerraform(ctx context.Context, diags *diag.Diagnostics, vyosData map[string]interface{}) {
	tflog.Error(ctx, "VyosToTerraform begin", map[string]interface{}{"Path": []string{"protocols", "bgp", "neighbor", "address-family", "ipv4-unicast", "capability", "orf", "prefix-list"}})
	...
	tflog.Error(ctx, "VyosToTerraform end", map[string]interface{}{"Path": []string{"protocols", "bgp", "neighbor", "address-family", "ipv4-unicast", "capability", "orf", "prefix-list"}})
}

// AttributeTypes generates the attribute types for the resource at this level
func (o ProtocolsBgpNeighborAddressFamilyIPvfourUnicastCapabilityOrfPrefixList) AttributeTypes() map[string]attr.Type {
