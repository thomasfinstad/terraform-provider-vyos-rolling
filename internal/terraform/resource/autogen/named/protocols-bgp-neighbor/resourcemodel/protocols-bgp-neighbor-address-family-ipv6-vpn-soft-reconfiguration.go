...
type ProtocolsBgpNeighborAddressFamilyIPvsixVpnSoftReconfiguration struct {
	// LeafNodes
	ProtocolsBgpNeighborAddressFamilyIPvsixVpnSoftReconfigurationInbound customtypes.CustomStringValue `tfsdk:"inbound" json:"inbound,omitempty"`
...
func (o ProtocolsBgpNeighborAddressFamilyIPvsixVpnSoftReconfiguration) ResourceAttributes() map[string]schema.Attribute {
