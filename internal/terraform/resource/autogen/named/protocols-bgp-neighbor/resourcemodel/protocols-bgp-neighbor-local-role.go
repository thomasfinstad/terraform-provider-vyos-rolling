...
type ProtocolsBgpNeighborLocalRole struct {
	// LeafNodes
	ProtocolsBgpNeighborLocalRoleStrict customtypes.CustomStringValue `tfsdk:"strict" json:"strict,omitempty"`
...
func (o ProtocolsBgpNeighborLocalRole) ResourceAttributes() map[string]schema.Attribute {
