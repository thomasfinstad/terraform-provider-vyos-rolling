...
type ProtocolsBgpNeighborAddressFamilyIPvfourVpnNexthopSelf struct {
	// LeafNodes
	ProtocolsBgpNeighborAddressFamilyIPvfourVpnNexthopSelfForce customtypes.CustomStringValue `tfsdk:"force" json:"force,omitempty"`
...
func (o ProtocolsBgpNeighborAddressFamilyIPvfourVpnNexthopSelf) ResourceAttributes() map[string]schema.Attribute {
