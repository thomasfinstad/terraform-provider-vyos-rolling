...
type ProtocolsBgpNeighborAddressFamilyIPvsixMulticastDistributeList struct {
	// LeafNodes
	ProtocolsBgpNeighborAddressFamilyIPvsixMulticastDistributeListExport customtypes.CustomStringValue `tfsdk:"export" json:"export,omitempty"`
	ProtocolsBgpNeighborAddressFamilyIPvsixMulticastDistributeListImport customtypes.CustomStringValue `tfsdk:"import" json:"import,omitempty"`
...
func (o ProtocolsBgpNeighborAddressFamilyIPvsixMulticastDistributeList) ResourceAttributes() map[string]schema.Attribute {
