...
type ProtocolsBgpNeighborAddressFamilyIPvsixMulticastAllowasIn struct {
	// LeafNodes
	ProtocolsBgpNeighborAddressFamilyIPvsixMulticastAllowasInNumber customtypes.CustomStringValue `tfsdk:"number" json:"number,omitempty"`
...
func (o ProtocolsBgpNeighborAddressFamilyIPvsixMulticastAllowasIn) ResourceAttributes() map[string]schema.Attribute {
