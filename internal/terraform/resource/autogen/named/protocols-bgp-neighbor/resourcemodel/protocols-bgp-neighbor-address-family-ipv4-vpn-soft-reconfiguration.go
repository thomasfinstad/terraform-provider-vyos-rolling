...
type ProtocolsBgpNeighborAddressFamilyIPvfourVpnSoftReconfiguration struct {
	// LeafNodes
	ProtocolsBgpNeighborAddressFamilyIPvfourVpnSoftReconfigurationInbound customtypes.CustomStringValue `tfsdk:"inbound" json:"inbound,omitempty"`
...
func (o ProtocolsBgpNeighborAddressFamilyIPvfourVpnSoftReconfiguration) ResourceAttributes() map[string]schema.Attribute {
