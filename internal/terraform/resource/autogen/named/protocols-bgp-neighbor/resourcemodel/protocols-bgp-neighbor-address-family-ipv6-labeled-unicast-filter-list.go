...
type ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastFilterList struct {
	// LeafNodes
	LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastFilterListExport types.String `tfsdk:"export"`
	LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastFilterListImport types.String `tfsdk:"import"`
...
func (o *ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastFilterList) TerraformToVyos(ctx context.Context, diags *diag.Diagnostics) map[string]interface{} {
	tflog.Error(ctx, "TerraformToVyos", map[string]interface{}{"Path": []string{"protocols", "bgp", "neighbor", "address-family", "ipv6-labeled-unicast", "filter-list"}})
	...
	if !(o.LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastFilterListExport.IsNull() || o.LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastFilterListExport.IsUnknown()) {
		vyosData["export"] = o.LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastFilterListExport.ValueString()
	}
	if !(o.LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastFilterListImport.IsNull() || o.LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastFilterListImport.IsUnknown()) {
		vyosData["import"] = o.LeafProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastFilterListImport.ValueString()
	}
...
func (o *ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastFilterList) VyosToTerraform(ctx context.Context, diags *diag.Diagnostics, vyosData map[string]interface{}) {
	tflog.Error(ctx, "VyosToTerraform begin", map[string]interface{}{"Path": []string{"protocols", "bgp", "neighbor", "address-family", "ipv6-labeled-unicast", "filter-list"}})
	...
	tflog.Error(ctx, "VyosToTerraform end", map[string]interface{}{"Path": []string{"protocols", "bgp", "neighbor", "address-family", "ipv6-labeled-unicast", "filter-list"}})
}

// AttributeTypes generates the attribute types for the resource at this level
func (o ProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastFilterList) AttributeTypes() map[string]attr.Type {
