...
type ProtocolsBgpNeighborAddressFamilyIPvfourVpnRouteMap struct {
	// LeafNodes
	LeafProtocolsBgpNeighborAddressFamilyIPvfourVpnRouteMapExport types.String `tfsdk:"export" json:"export,omitempty"`
	LeafProtocolsBgpNeighborAddressFamilyIPvfourVpnRouteMapImport types.String `tfsdk:"import" json:"import,omitempty"`
