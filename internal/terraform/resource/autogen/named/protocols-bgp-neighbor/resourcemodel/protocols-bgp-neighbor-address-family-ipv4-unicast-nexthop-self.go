...
type ProtocolsBgpNeighborAddressFamilyIPvfourUnicastNexthopSelf struct {
	// LeafNodes
	ProtocolsBgpNeighborAddressFamilyIPvfourUnicastNexthopSelfForce customtypes.CustomStringValue `tfsdk:"force" json:"force,omitempty"`
...
func (o ProtocolsBgpNeighborAddressFamilyIPvfourUnicastNexthopSelf) ResourceAttributes() map[string]schema.Attribute {
