...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/service/broadcast-relay-id/resourcemodel"
)
...
func (r *serviceBroadcastRelayID) GetModel() helpers.VyosTopResourceDataModel {
	return r.model
}

// GetProviderConfig returns global provider data config
func (r *serviceBroadcastRelayID) GetProviderConfig() data.ProviderData {
...
func (r *serviceBroadcastRelayID) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
