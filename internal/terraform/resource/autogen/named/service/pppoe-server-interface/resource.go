...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/service/pppoe-server-interface/resourcemodel"
)
...
func (r *servicePppoeServerInterface) GetProviderConfig() data.ProviderData {
...
func (r *servicePppoeServerInterface) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
