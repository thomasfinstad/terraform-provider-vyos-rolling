...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/service/router-advert-interface/resourcemodel"
)
...
func (r *serviceRouterAdvertInterface) GetModel() helpers.VyosTopResourceDataModel {
	return r.model
}

// GetProviderConfig returns global provider data config
func (r *serviceRouterAdvertInterface) GetProviderConfig() data.ProviderData {
...
func (r *serviceRouterAdvertInterface) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
