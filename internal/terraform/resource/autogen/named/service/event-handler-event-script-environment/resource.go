...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/service/event-handler-event-script-environment/resourcemodel"
)

/* tools/generate-terraform-resource-full/templates/resources/named/resource-tagnode-based-full.gotmpl #resource-tagnode-based-full (environment) */
...
func (r *serviceEventHandlerEventScrIPtEnvironment) GetProviderConfig() data.ProviderData {
...
func (r *serviceEventHandlerEventScrIPtEnvironment) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
