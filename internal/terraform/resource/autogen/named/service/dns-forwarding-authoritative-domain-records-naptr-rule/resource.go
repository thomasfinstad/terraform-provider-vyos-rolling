...
func (r *serviceDNSForwardingAuthoritativeDomainRecordsNaptrRule) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
