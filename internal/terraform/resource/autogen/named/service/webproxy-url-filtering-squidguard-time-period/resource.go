...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/service/webproxy-url-filtering-squidguard-time-period/resourcemodel"
)

/* tools/generate-terraform-resource-full/templates/resources/named/resource-tagnode-based-full.gotmpl #resource-tagnode-based-full (time-period) */
...
func (r *serviceWebproxyURLFilteringSquIDguardTimePeriod) GetModel() helpers.VyosTopResourceDataModel {
	return r.model
}

// GetProviderConfig returns global provider data config
func (r *serviceWebproxyURLFilteringSquIDguardTimePeriod) GetProviderConfig() data.ProviderData {
...
func (r *serviceWebproxyURLFilteringSquIDguardTimePeriod) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
