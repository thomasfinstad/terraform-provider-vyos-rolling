...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/service/dhcp-server-shared-network-name-subnet-range/resourcemodel"
)
...
func (r *serviceDhcpServerSharedNetworkNameSubnetRange) GetProviderConfig() data.ProviderData {
...
func (r *serviceDhcpServerSharedNetworkNameSubnetRange) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
