...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos/internal/terraform/resource/autogen/named/service/ipoe-server-client-ipv6-pool-delegate/resourcemodel"
)
...
func (r *serviceIPoeServerClientIPvsixPoolDelegate) GetName() string {
