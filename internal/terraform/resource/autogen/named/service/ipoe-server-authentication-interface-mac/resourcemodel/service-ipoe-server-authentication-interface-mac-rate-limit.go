...
var _ helpers.VyosResourceDataModel = &ServiceIPoeServerAuthenticationInterfaceMacRateLimit{}
...
func (o ServiceIPoeServerAuthenticationInterfaceMacRateLimit) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
