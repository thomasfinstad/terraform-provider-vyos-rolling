...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/service/ntp-server/resourcemodel"
)
...
func (r *serviceNtpServer) GetProviderConfig() data.ProviderData {
