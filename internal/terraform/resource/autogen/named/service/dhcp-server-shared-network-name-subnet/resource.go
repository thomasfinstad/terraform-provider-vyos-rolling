...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos/internal/terraform/resource/autogen/named/service/dhcp-server-shared-network-name-subnet/resourcemodel"
)
...
func (r *serviceDhcpServerSharedNetworkNameSubnet) GetName() string {
