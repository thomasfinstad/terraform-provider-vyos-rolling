...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/service/ipoe-server-interface/resourcemodel"
)
...
func (r *serviceIPoeServerInterface) GetProviderConfig() data.ProviderData {
...
func (r *serviceIPoeServerInterface) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
