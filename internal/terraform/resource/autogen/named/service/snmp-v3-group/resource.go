...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/service/snmp-v3-group/resourcemodel"
)
...
func (r *serviceSnmpVthreeGroup) GetProviderConfig() data.ProviderData {
...
func (r *serviceSnmpVthreeGroup) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
