...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/service/lldp-interface/resourcemodel"
)
...
func (r *serviceLldpInterface) GetProviderConfig() data.ProviderData {
...
func (r *serviceLldpInterface) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
