...
func (r *serviceDNSForwardingAuthoritativeDomainRecordsNaptr) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *serviceDNSForwardingAuthoritativeDomainRecordsNaptr) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *serviceDNSForwardingAuthoritativeDomainRecordsNaptr) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *serviceDNSForwardingAuthoritativeDomainRecordsNaptr) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
