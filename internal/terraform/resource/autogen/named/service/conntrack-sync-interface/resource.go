...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/service/conntrack-sync-interface/resourcemodel"
)
...
func (r *serviceConntrackSyncInterface) GetProviderConfig() data.ProviderData {
...
func (r *serviceConntrackSyncInterface) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
