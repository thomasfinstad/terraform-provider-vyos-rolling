...
var _ helpers.VyosResourceDataModel = &ServiceConsoleServerDeviceTCP{}
...
func (o ServiceConsoleServerDeviceTCP) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
