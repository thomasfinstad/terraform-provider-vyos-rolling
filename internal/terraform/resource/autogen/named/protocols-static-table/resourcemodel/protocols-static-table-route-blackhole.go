...
type ProtocolsStaticTableRouteBlackhole struct {
	// LeafNodes
	LeafProtocolsStaticTableRouteBlackholeDistance types.String `tfsdk:"distance" json:"distance,omitempty"`
	LeafProtocolsStaticTableRouteBlackholeTag      types.String `tfsdk:"tag" json:"tag,omitempty"`
