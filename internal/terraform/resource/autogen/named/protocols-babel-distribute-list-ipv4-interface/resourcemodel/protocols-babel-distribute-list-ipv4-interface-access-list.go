...
type ProtocolsBabelDistributeListIPvfourInterfaceAccessList struct {
	// LeafNodes
	LeafProtocolsBabelDistributeListIPvfourInterfaceAccessListIn  types.String `tfsdk:"in" json:"in,omitempty"`
	LeafProtocolsBabelDistributeListIPvfourInterfaceAccessListOut types.String `tfsdk:"out" json:"out,omitempty"`
