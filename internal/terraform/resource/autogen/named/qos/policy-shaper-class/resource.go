...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/qos/policy-shaper-class/resourcemodel"
)
...
func (r *qosPolicyShaperClass) GetProviderConfig() data.ProviderData {
...
func (r *qosPolicyShaperClass) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
