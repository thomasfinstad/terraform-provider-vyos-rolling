...
var _ helpers.VyosResourceDataModel = &QosTrafficMatchGroupMatchIPvsix{}

// QosTrafficMatchGroupMatchIPvsix describes the resource data model.
// This is not a basenode!
// Top level basenode type: `N/A`
type QosTrafficMatchGroupMatchIPvsix struct {
	// LeafNodes
	LeafQosTrafficMatchGroupMatchIPvsixDscp      types.String `tfsdk:"dscp" vyos:"dscp,omitempty"`
	LeafQosTrafficMatchGroupMatchIPvsixMaxLength types.Number `tfsdk:"max_length" vyos:"max-length,omitempty"`
	LeafQosTrafficMatchGroupMatchIPvsixProtocol  types.String `tfsdk:"protocol" vyos:"protocol,omitempty"`

	// TagNodes

	// Nodes

	NodeQosTrafficMatchGroupMatchIPvsixDestination *QosTrafficMatchGroupMatchIPvsixDestination `tfsdk:"destination" vyos:"destination,omitempty"`

	NodeQosTrafficMatchGroupMatchIPvsixSource *QosTrafficMatchGroupMatchIPvsixSource `tfsdk:"source" vyos:"source,omitempty"`

	NodeQosTrafficMatchGroupMatchIPvsixTCP *QosTrafficMatchGroupMatchIPvsixTCP `tfsdk:"tcp" vyos:"tcp,omitempty"`
}

// ResourceSchemaAttributes generates the schema attributes for the resource at this level
func (o QosTrafficMatchGroupMatchIPvsix) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
...
`,
		...
		"destination": schema.SingleNestedAttribute{
			Attributes: QosTrafficMatchGroupMatchIPvsixDestination{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
...
`,
		...
		"source": schema.SingleNestedAttribute{
			Attributes: QosTrafficMatchGroupMatchIPvsixSource{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
...
`,
		...
		"tcp": schema.SingleNestedAttribute{
			Attributes: QosTrafficMatchGroupMatchIPvsixTCP{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
