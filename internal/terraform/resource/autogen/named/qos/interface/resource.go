...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/qos/interface/resourcemodel"
)
...
func (r *qosInterface) GetProviderConfig() data.ProviderData {
...
func (r *qosInterface) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
