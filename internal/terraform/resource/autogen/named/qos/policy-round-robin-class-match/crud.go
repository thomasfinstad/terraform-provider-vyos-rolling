...
func (r *qosPolicyRoundRobinClassMatch) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *qosPolicyRoundRobinClassMatch) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r *qosPolicyRoundRobinClassMatch) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *qosPolicyRoundRobinClassMatch) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
