...
var _ helpers.VyosResourceDataModel = &QosPolicyShaperHfscClassUpperlimit{}
...
func (o QosPolicyShaperHfscClassUpperlimit) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
