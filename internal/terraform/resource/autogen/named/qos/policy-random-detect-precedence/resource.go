...
import (
	...
	// Extra Imports
	"github.com/thomasfinstad/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/qos/policy-random-detect-precedence/resourcemodel"
)

/* tools/generate-terraform-resource-full/templates/resources/named/resource-tagnode-based-full.gotmpl #resource-tagnode-based-full (precedence) */
...
func (r *qosPolicyRandomDetectPrecedence) GetProviderConfig() data.ProviderData {
...
func (r *qosPolicyRandomDetectPrecedence) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
