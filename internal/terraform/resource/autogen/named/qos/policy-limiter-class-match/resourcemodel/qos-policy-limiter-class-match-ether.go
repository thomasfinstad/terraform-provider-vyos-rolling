...
var _ helpers.VyosResourceDataModel = &QosPolicyLimiterClassMatchEther{}
...
func (o QosPolicyLimiterClassMatchEther) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
