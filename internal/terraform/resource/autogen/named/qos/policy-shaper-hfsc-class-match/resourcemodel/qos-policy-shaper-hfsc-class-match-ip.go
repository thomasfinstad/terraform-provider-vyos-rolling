...
var _ helpers.VyosResourceDataModel = &QosPolicyShaperHfscClassMatchIP{}
...
type QosPolicyShaperHfscClassMatchIP struct {
	...
	LeafQosPolicyShaperHfscClassMatchIPMaxLength types.Number `tfsdk:"max_length" vyos:"max-length,omitempty"`
...
func (o QosPolicyShaperHfscClassMatchIP) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
...
`,
		...
		"destination": schema.SingleNestedAttribute{
			Attributes: QosPolicyShaperHfscClassMatchIPDestination{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
...
`,
		...
		"source": schema.SingleNestedAttribute{
			Attributes: QosPolicyShaperHfscClassMatchIPSource{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
...
`,
		...
		"tcp": schema.SingleNestedAttribute{
			Attributes: QosPolicyShaperHfscClassMatchIPTCP{}.ResourceSchemaAttributes(ctx),
			Optional:   true,
