...
var _ helpers.VyosResourceDataModel = &QosPolicyShaperHfscClassMatchIPSource{}
...
func (o QosPolicyShaperHfscClassMatchIPSource) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
