...
type QosPolicyShaperHfscClassMatchIP struct {
	// LeafNodes
	LeafQosPolicyShaperHfscClassMatchIPDscp      types.String `tfsdk:"dscp" json:"dscp,omitempty"`
	LeafQosPolicyShaperHfscClassMatchIPMaxLength types.String `tfsdk:"max_length" json:"max-length,omitempty"`
	LeafQosPolicyShaperHfscClassMatchIPProtocol  types.String `tfsdk:"protocol" json:"protocol,omitempty"`

	// TagNodes

	// Nodes
	NodeQosPolicyShaperHfscClassMatchIPDestination *QosPolicyShaperHfscClassMatchIPDestination `tfsdk:"destination" json:"destination,omitempty"`
	NodeQosPolicyShaperHfscClassMatchIPSource      *QosPolicyShaperHfscClassMatchIPSource      `tfsdk:"source" json:"source,omitempty"`
	NodeQosPolicyShaperHfscClassMatchIPTCP         *QosPolicyShaperHfscClassMatchIPTCP         `tfsdk:"tcp" json:"tcp,omitempty"`
}
