...
type QosPolicyShaperHfscDefaultRealtime struct {
	// LeafNodes
	QosPolicyShaperHfscDefaultRealtimeD    customtypes.CustomStringValue `tfsdk:"d" json:"d,omitempty"`
	QosPolicyShaperHfscDefaultRealtimeMone customtypes.CustomStringValue `tfsdk:"m1" json:"m1,omitempty"`
	QosPolicyShaperHfscDefaultRealtimeMtwo customtypes.CustomStringValue `tfsdk:"m2" json:"m2,omitempty"`
...
func (o QosPolicyShaperHfscDefaultRealtime) ResourceAttributes() map[string]schema.Attribute {
