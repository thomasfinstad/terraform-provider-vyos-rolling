...
type QosPolicyShaperHfscClassMatchIPDestination struct {
	// LeafNodes
	LeafQosPolicyShaperHfscClassMatchIPDestinationAddress types.String `tfsdk:"address" json:"address,omitempty"`
	LeafQosPolicyShaperHfscClassMatchIPDestinationPort    types.String `tfsdk:"port" json:"port,omitempty"`
