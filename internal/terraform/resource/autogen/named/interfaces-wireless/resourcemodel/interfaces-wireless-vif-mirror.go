...
type InterfacesWirelessVifMirror struct {
	// LeafNodes
	LeafInterfacesWirelessVifMirrorIngress types.String `tfsdk:"ingress"`
	LeafInterfacesWirelessVifMirrorEgress  types.String `tfsdk:"egress"`
...
func (o *InterfacesWirelessVifMirror) TerraformToVyos(ctx context.Context, diags *diag.Diagnostics) map[string]interface{} {
	tflog.Error(ctx, "TerraformToVyos", map[string]interface{}{"Path": []string{"interfaces", "wireless", "vif", "mirror"}})

	vyosData := make(map[string]interface{})

	// Leafs
	if !(o.LeafInterfacesWirelessVifMirrorIngress.IsNull() || o.LeafInterfacesWirelessVifMirrorIngress.IsUnknown()) {
		vyosData["ingress"] = o.LeafInterfacesWirelessVifMirrorIngress.ValueString()
	}
	if !(o.LeafInterfacesWirelessVifMirrorEgress.IsNull() || o.LeafInterfacesWirelessVifMirrorEgress.IsUnknown()) {
		vyosData["egress"] = o.LeafInterfacesWirelessVifMirrorEgress.ValueString()
	}
...
func (o *InterfacesWirelessVifMirror) VyosToTerraform(ctx context.Context, diags *diag.Diagnostics, vyosData map[string]interface{}) {
	tflog.Error(ctx, "VyosToTerraform begin", map[string]interface{}{"Path": []string{"interfaces", "wireless", "vif", "mirror"}})
	...
	tflog.Error(ctx, "VyosToTerraform end", map[string]interface{}{"Path": []string{"interfaces", "wireless", "vif", "mirror"}})
}

// AttributeTypes generates the attribute types for the resource at this level
func (o InterfacesWirelessVifMirror) AttributeTypes() map[string]attr.Type {
