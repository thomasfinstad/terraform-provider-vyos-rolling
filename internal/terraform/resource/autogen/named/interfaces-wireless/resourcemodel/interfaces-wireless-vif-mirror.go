...
type InterfacesWirelessVifMirror struct {
	// LeafNodes
	InterfacesWirelessVifMirrorIngress customtypes.CustomStringValue `tfsdk:"ingress" json:"ingress,omitempty"`
	InterfacesWirelessVifMirrorEgress  customtypes.CustomStringValue `tfsdk:"egress" json:"egress,omitempty"`
...
func (o InterfacesWirelessVifMirror) ResourceAttributes() map[string]schema.Attribute {
