...
type InterfacesWirelessVifIPvsix struct {
	// LeafNodes
	LeafInterfacesWirelessVifIPvsixAdjustMss              types.String `tfsdk:"adjust_mss" json:"adjust-mss,omitempty"`
	LeafInterfacesWirelessVifIPvsixDisableForwarding      types.String `tfsdk:"disable_forwarding" json:"disable-forwarding,omitempty"`
	LeafInterfacesWirelessVifIPvsixDupAddrDetectTransmits types.String `tfsdk:"dup_addr_detect_transmits" json:"dup-addr-detect-transmits,omitempty"`

	// TagNodes

	// Nodes
	NodeInterfacesWirelessVifIPvsixAddress *InterfacesWirelessVifIPvsixAddress `tfsdk:"address" json:"address,omitempty"`
}
