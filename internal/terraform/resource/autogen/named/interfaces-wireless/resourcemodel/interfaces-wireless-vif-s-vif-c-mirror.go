...
type InterfacesWirelessVifSVifCMirror struct {
	// LeafNodes
	InterfacesWirelessVifSVifCMirrorIngress customtypes.CustomStringValue `tfsdk:"ingress" json:"ingress,omitempty"`
	InterfacesWirelessVifSVifCMirrorEgress  customtypes.CustomStringValue `tfsdk:"egress" json:"egress,omitempty"`
...
func (o InterfacesWirelessVifSVifCMirror) ResourceAttributes() map[string]schema.Attribute {
