...
type InterfacesWirelessVifSVifCDhcpvsixOptionsPdInterface struct {
	// LeafNodes
	InterfacesWirelessVifSVifCDhcpvsixOptionsPdInterfaceAddress customtypes.CustomStringValue `tfsdk:"address" json:"address,omitempty"`
	InterfacesWirelessVifSVifCDhcpvsixOptionsPdInterfaceSLAID   customtypes.CustomStringValue `tfsdk:"sla_id" json:"sla-id,omitempty"`
...
func (o InterfacesWirelessVifSVifCDhcpvsixOptionsPdInterface) ResourceAttributes() map[string]schema.Attribute {
