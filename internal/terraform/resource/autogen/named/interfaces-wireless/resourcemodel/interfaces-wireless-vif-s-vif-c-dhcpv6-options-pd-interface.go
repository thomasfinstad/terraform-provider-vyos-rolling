...
type InterfacesWirelessVifSVifCDhcpvsixOptionsPdInterface struct {
	// LeafNodes
	LeafInterfacesWirelessVifSVifCDhcpvsixOptionsPdInterfaceAddress types.String `tfsdk:"address" json:"address,omitempty"`
	LeafInterfacesWirelessVifSVifCDhcpvsixOptionsPdInterfaceSLAID   types.String `tfsdk:"sla_id" json:"sla-id,omitempty"`
