...
type InterfacesWirelessDhcpvsixOptionsPd struct {
	// LeafNodes
	LeafInterfacesWirelessDhcpvsixOptionsPdLength types.String `tfsdk:"length" json:"length,omitempty"`

	// TagNodes
	TagInterfacesWirelessDhcpvsixOptionsPdInterface *map[string]InterfacesWirelessDhcpvsixOptionsPdInterface `tfsdk:"interface" json:"interface,omitempty"`
...
func (o *InterfacesWirelessDhcpvsixOptionsPd) MarshalJSON() ([]byte, error) {
	...
	if !reflect.ValueOf(o.TagInterfacesWirelessDhcpvsixOptionsPdInterface).IsZero() {
		subJSONStr, err := json.Marshal(o.TagInterfacesWirelessDhcpvsixOptionsPdInterface)
		if err != nil {
			return nil, err
		}
...
func (o *InterfacesWirelessDhcpvsixOptionsPd) UnmarshalJSON(jsonStr []byte) error {
	...
	if value, ok := jsonData["interface"]; ok {
		...
		o.TagInterfacesWirelessDhcpvsixOptionsPdInterface = &map[string]InterfacesWirelessDhcpvsixOptionsPdInterface{}

		err = json.Unmarshal(subJSONStr, o.TagInterfacesWirelessDhcpvsixOptionsPdInterface)
		if err != nil {
			return err
		}
	}
