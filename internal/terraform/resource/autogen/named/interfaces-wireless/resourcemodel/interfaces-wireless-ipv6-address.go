...
type InterfacesWirelessIPvsixAddress struct {
	// LeafNodes
	InterfacesWirelessIPvsixAddressAutoconf           customtypes.CustomStringValue `tfsdk:"autoconf" json:"autoconf,omitempty"`
	InterfacesWirelessIPvsixAddressEuisixfour         customtypes.CustomStringValue `tfsdk:"eui64" json:"eui64,omitempty"`
	InterfacesWirelessIPvsixAddressNoDefaultLinkLocal customtypes.CustomStringValue `tfsdk:"no_default_link_local" json:"no-default-link-local,omitempty"`
...
func (o InterfacesWirelessIPvsixAddress) ResourceAttributes() map[string]schema.Attribute {
