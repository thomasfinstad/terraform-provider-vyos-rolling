...
type InterfacesWirelessVifSMirror struct {
	// LeafNodes
	InterfacesWirelessVifSMirrorIngress customtypes.CustomStringValue `tfsdk:"ingress" json:"ingress,omitempty"`
	InterfacesWirelessVifSMirrorEgress  customtypes.CustomStringValue `tfsdk:"egress" json:"egress,omitempty"`
...
func (o InterfacesWirelessVifSMirror) ResourceAttributes() map[string]schema.Attribute {
