...
type InterfacesWirelessCapabilitiesHtStbc struct {
	// LeafNodes
	LeafInterfacesWirelessCapabilitiesHtStbcRx types.String `tfsdk:"rx" json:"rx,omitempty"`
	LeafInterfacesWirelessCapabilitiesHtStbcTx types.String `tfsdk:"tx" json:"tx,omitempty"`
