...
type InterfacesPseudoEthernetVifIPvsixAddress struct {
	// LeafNodes
	InterfacesPseudoEthernetVifIPvsixAddressAutoconf           customtypes.CustomStringValue `tfsdk:"autoconf" json:"autoconf,omitempty"`
	InterfacesPseudoEthernetVifIPvsixAddressEuisixfour         customtypes.CustomStringValue `tfsdk:"eui64" json:"eui64,omitempty"`
	InterfacesPseudoEthernetVifIPvsixAddressNoDefaultLinkLocal customtypes.CustomStringValue `tfsdk:"no_default_link_local" json:"no-default-link-local,omitempty"`
...
func (o InterfacesPseudoEthernetVifIPvsixAddress) ResourceAttributes() map[string]schema.Attribute {
