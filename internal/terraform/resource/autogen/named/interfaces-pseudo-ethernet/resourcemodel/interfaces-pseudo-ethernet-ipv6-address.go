...
type InterfacesPseudoEthernetIPvsixAddress struct {
	// LeafNodes
	InterfacesPseudoEthernetIPvsixAddressAutoconf           customtypes.CustomStringValue `tfsdk:"autoconf" json:"autoconf,omitempty"`
	InterfacesPseudoEthernetIPvsixAddressEuisixfour         customtypes.CustomStringValue `tfsdk:"eui64" json:"eui64,omitempty"`
	InterfacesPseudoEthernetIPvsixAddressNoDefaultLinkLocal customtypes.CustomStringValue `tfsdk:"no_default_link_local" json:"no-default-link-local,omitempty"`
...
func (o InterfacesPseudoEthernetIPvsixAddress) ResourceAttributes() map[string]schema.Attribute {
