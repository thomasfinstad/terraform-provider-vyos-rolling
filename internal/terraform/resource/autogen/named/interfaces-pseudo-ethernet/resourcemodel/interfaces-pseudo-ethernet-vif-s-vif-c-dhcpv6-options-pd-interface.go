...
type InterfacesPseudoEthernetVifSVifCDhcpvsixOptionsPdInterface struct {
	// LeafNodes
	InterfacesPseudoEthernetVifSVifCDhcpvsixOptionsPdInterfaceAddress customtypes.CustomStringValue `tfsdk:"address" json:"address,omitempty"`
	InterfacesPseudoEthernetVifSVifCDhcpvsixOptionsPdInterfaceSLAID   customtypes.CustomStringValue `tfsdk:"sla_id" json:"sla-id,omitempty"`
...
func (o InterfacesPseudoEthernetVifSVifCDhcpvsixOptionsPdInterface) ResourceAttributes() map[string]schema.Attribute {
