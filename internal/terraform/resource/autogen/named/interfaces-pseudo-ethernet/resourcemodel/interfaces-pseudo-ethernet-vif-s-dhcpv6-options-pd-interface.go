...
type InterfacesPseudoEthernetVifSDhcpvsixOptionsPdInterface struct {
	// LeafNodes
	InterfacesPseudoEthernetVifSDhcpvsixOptionsPdInterfaceAddress customtypes.CustomStringValue `tfsdk:"address" json:"address,omitempty"`
	InterfacesPseudoEthernetVifSDhcpvsixOptionsPdInterfaceSLAID   customtypes.CustomStringValue `tfsdk:"sla_id" json:"sla-id,omitempty"`
...
func (o InterfacesPseudoEthernetVifSDhcpvsixOptionsPdInterface) ResourceAttributes() map[string]schema.Attribute {
