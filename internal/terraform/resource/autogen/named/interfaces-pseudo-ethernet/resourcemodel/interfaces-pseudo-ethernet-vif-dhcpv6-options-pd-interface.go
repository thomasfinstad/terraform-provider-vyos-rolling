...
type InterfacesPseudoEthernetVifDhcpvsixOptionsPdInterface struct {
	// LeafNodes
	InterfacesPseudoEthernetVifDhcpvsixOptionsPdInterfaceAddress customtypes.CustomStringValue `tfsdk:"address" json:"address,omitempty"`
	InterfacesPseudoEthernetVifDhcpvsixOptionsPdInterfaceSLAID   customtypes.CustomStringValue `tfsdk:"sla_id" json:"sla-id,omitempty"`
...
func (o InterfacesPseudoEthernetVifDhcpvsixOptionsPdInterface) ResourceAttributes() map[string]schema.Attribute {
