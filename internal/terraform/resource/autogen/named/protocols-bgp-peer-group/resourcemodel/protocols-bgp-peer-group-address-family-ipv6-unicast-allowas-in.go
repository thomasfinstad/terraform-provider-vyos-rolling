...
type ProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastAllowasIn struct {
	// LeafNodes
	ProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastAllowasInNumber customtypes.CustomStringValue `tfsdk:"number" json:"number,omitempty"`
...
func (o ProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastAllowasIn) ResourceAttributes() map[string]schema.Attribute {
