...
type ProtocolsBgpPeerGroupTTLSecURIty struct {
	// LeafNodes
	ProtocolsBgpPeerGroupTTLSecURItyHops customtypes.CustomStringValue `tfsdk:"hops" json:"hops,omitempty"`
...
func (o ProtocolsBgpPeerGroupTTLSecURIty) ResourceAttributes() map[string]schema.Attribute {
