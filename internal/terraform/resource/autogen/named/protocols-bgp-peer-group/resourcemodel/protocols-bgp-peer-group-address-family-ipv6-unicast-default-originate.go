...
type ProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastDefaultOriginate struct {
	// LeafNodes
	LeafProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastDefaultOriginateRouteMap types.String `tfsdk:"route_map" json:"route-map,omitempty"`
...
func (o *ProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastDefaultOriginate) MarshalJSON() ([]byte, error) {
	...
	if !o.LeafProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastDefaultOriginateRouteMap.IsNull() && !o.LeafProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastDefaultOriginateRouteMap.IsUnknown() {
		jsonData["route-map"] = o.LeafProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastDefaultOriginateRouteMap.ValueString()
	}
...
func (o *ProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastDefaultOriginate) UnmarshalJSON(jsonStr []byte) error {
	jsonData := make(map[string]interface{})
