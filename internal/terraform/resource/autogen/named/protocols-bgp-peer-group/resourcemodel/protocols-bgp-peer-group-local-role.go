...
type ProtocolsBgpPeerGroupLocalRole struct {
	// LeafNodes
	ProtocolsBgpPeerGroupLocalRoleStrict customtypes.CustomStringValue `tfsdk:"strict" json:"strict,omitempty"`
...
func (o ProtocolsBgpPeerGroupLocalRole) ResourceAttributes() map[string]schema.Attribute {
