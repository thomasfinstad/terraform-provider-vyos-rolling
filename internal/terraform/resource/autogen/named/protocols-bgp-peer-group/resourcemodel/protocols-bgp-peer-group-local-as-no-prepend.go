...
type ProtocolsBgpPeerGroupLocalAsNoPrepend struct {
	// LeafNodes
	ProtocolsBgpPeerGroupLocalAsNoPrependReplaceAs customtypes.CustomStringValue `tfsdk:"replace_as" json:"replace-as,omitempty"`
...
func (o ProtocolsBgpPeerGroupLocalAsNoPrepend) ResourceAttributes() map[string]schema.Attribute {
