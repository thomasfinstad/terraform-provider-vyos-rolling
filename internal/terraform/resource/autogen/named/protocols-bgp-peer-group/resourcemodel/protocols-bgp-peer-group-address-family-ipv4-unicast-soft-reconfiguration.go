...
type ProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastSoftReconfiguration struct {
	// LeafNodes
	ProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastSoftReconfigurationInbound customtypes.CustomStringValue `tfsdk:"inbound" json:"inbound,omitempty"`
...
func (o ProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastSoftReconfiguration) ResourceAttributes() map[string]schema.Attribute {
