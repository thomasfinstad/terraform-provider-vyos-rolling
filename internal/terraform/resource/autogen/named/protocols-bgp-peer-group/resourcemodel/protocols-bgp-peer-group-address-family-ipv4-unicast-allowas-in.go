...
type ProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastAllowasIn struct {
	// LeafNodes
	ProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastAllowasInNumber customtypes.CustomStringValue `tfsdk:"number" json:"number,omitempty"`
...
func (o ProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastAllowasIn) ResourceAttributes() map[string]schema.Attribute {
