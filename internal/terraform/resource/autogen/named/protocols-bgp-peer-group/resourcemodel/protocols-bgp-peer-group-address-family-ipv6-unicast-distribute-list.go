...
type ProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastDistributeList struct {
	// LeafNodes
	ProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastDistributeListExport customtypes.CustomStringValue `tfsdk:"export" json:"export,omitempty"`
	ProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastDistributeListImport customtypes.CustomStringValue `tfsdk:"import" json:"import,omitempty"`
...
func (o ProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastDistributeList) ResourceAttributes() map[string]schema.Attribute {
