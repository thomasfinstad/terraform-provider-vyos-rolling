...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastDistributeList struct {
	// LeafNodes
	VrfNameProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastDistributeListExport customtypes.CustomStringValue `tfsdk:"export" json:"export,omitempty"`
	VrfNameProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastDistributeListImport customtypes.CustomStringValue `tfsdk:"import" json:"import,omitempty"`
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastDistributeList) ResourceAttributes() map[string]schema.Attribute {
