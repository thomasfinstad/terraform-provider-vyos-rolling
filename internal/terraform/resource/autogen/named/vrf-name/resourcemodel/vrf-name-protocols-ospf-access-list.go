...
type VrfNameProtocolsOspfAccessList struct {
	// LeafNodes
	VrfNameProtocolsOspfAccessListExport customtypes.CustomStringValue `tfsdk:"export" json:"export,omitempty"`
...
func (o VrfNameProtocolsOspfAccessList) ResourceAttributes() map[string]schema.Attribute {
