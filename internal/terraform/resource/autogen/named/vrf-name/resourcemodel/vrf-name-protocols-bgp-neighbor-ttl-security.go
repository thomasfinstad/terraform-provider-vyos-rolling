...
type VrfNameProtocolsBgpNeighborTTLSecURIty struct {
	// LeafNodes
	VrfNameProtocolsBgpNeighborTTLSecURItyHops customtypes.CustomStringValue `tfsdk:"hops" json:"hops,omitempty"`
...
func (o VrfNameProtocolsBgpNeighborTTLSecURIty) ResourceAttributes() map[string]schema.Attribute {
