...
type VrfNameProtocolsOspfRedistributeTable struct {
	// LeafNodes
	LeafVrfNameProtocolsOspfRedistributeTableMetric     types.String `tfsdk:"metric" json:"metric,omitempty"`
	LeafVrfNameProtocolsOspfRedistributeTableMetricType types.String `tfsdk:"metric_type" json:"metric-type,omitempty"`
	LeafVrfNameProtocolsOspfRedistributeTableRouteMap   types.String `tfsdk:"route_map" json:"route-map,omitempty"`
