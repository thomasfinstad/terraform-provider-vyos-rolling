...
type VrfNameProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastNexthopLocal struct {
	// LeafNodes
	VrfNameProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastNexthopLocalUnchanged customtypes.CustomStringValue `tfsdk:"unchanged" json:"unchanged,omitempty"`
...
func (o VrfNameProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastNexthopLocal) ResourceAttributes() map[string]schema.Attribute {
