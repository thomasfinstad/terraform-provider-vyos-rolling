...
type VrfNameProtocolsBgpPeerGroupAddressFamilyLtwovpnEvpnNexthopSelf struct {
	// LeafNodes
	VrfNameProtocolsBgpPeerGroupAddressFamilyLtwovpnEvpnNexthopSelfForce customtypes.CustomStringValue `tfsdk:"force" json:"force,omitempty"`
...
func (o VrfNameProtocolsBgpPeerGroupAddressFamilyLtwovpnEvpnNexthopSelf) ResourceAttributes() map[string]schema.Attribute {
