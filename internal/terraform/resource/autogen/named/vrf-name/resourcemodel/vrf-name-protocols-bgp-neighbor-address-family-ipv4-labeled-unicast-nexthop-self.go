...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastNexthopSelf struct {
	// LeafNodes
	VrfNameProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastNexthopSelfForce customtypes.CustomStringValue `tfsdk:"force" json:"force,omitempty"`
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastNexthopSelf) ResourceAttributes() map[string]schema.Attribute {
