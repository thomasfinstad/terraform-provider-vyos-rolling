...
type VrfNameProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastDistributeList struct {
	// LeafNodes
	VrfNameProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastDistributeListExport customtypes.CustomStringValue `tfsdk:"export" json:"export,omitempty"`
	VrfNameProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastDistributeListImport customtypes.CustomStringValue `tfsdk:"import" json:"import,omitempty"`
...
func (o VrfNameProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastDistributeList) ResourceAttributes() map[string]schema.Attribute {
