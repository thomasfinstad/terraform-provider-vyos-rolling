...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastDistributeList struct {
	// LeafNodes
	VrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastDistributeListExport customtypes.CustomStringValue `tfsdk:"export" json:"export,omitempty"`
	VrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastDistributeListImport customtypes.CustomStringValue `tfsdk:"import" json:"import,omitempty"`
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastDistributeList) ResourceAttributes() map[string]schema.Attribute {
