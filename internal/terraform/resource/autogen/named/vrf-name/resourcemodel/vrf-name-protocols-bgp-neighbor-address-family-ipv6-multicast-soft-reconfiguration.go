...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvsixMulticastSoftReconfiguration struct {
	// LeafNodes
	VrfNameProtocolsBgpNeighborAddressFamilyIPvsixMulticastSoftReconfigurationInbound customtypes.CustomStringValue `tfsdk:"inbound" json:"inbound,omitempty"`
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvsixMulticastSoftReconfiguration) ResourceAttributes() map[string]schema.Attribute {
