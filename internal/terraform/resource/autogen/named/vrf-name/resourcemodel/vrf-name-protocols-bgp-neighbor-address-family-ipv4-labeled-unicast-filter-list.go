...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastFilterList struct {
	// LeafNodes
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastFilterListExport types.String `tfsdk:"export" json:"export,omitempty"`
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourLabeledUnicastFilterListImport types.String `tfsdk:"import" json:"import,omitempty"`
