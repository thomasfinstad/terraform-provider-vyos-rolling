...
type VrfNameProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastNexthopSelf struct {
	// LeafNodes
	VrfNameProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastNexthopSelfForce customtypes.CustomStringValue `tfsdk:"force" json:"force,omitempty"`
...
func (o VrfNameProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastNexthopSelf) ResourceAttributes() map[string]schema.Attribute {
