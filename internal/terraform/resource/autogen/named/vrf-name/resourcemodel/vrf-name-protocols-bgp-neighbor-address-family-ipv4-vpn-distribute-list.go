...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvfourVpnDistributeList struct {
	// LeafNodes
	VrfNameProtocolsBgpNeighborAddressFamilyIPvfourVpnDistributeListExport customtypes.CustomStringValue `tfsdk:"export" json:"export,omitempty"`
	VrfNameProtocolsBgpNeighborAddressFamilyIPvfourVpnDistributeListImport customtypes.CustomStringValue `tfsdk:"import" json:"import,omitempty"`
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvfourVpnDistributeList) ResourceAttributes() map[string]schema.Attribute {
