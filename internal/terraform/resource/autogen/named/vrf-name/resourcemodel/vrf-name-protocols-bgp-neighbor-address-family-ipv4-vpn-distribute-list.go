...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvfourVpnDistributeList struct {
	// LeafNodes
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourVpnDistributeListExport types.String `tfsdk:"export" json:"export,omitempty"`
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourVpnDistributeListImport types.String `tfsdk:"import" json:"import,omitempty"`
