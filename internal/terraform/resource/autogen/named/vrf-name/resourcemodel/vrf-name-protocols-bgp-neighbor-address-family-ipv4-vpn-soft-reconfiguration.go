...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvfourVpnSoftReconfiguration struct {
	// LeafNodes
	VrfNameProtocolsBgpNeighborAddressFamilyIPvfourVpnSoftReconfigurationInbound customtypes.CustomStringValue `tfsdk:"inbound" json:"inbound,omitempty"`
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvfourVpnSoftReconfiguration) ResourceAttributes() map[string]schema.Attribute {
