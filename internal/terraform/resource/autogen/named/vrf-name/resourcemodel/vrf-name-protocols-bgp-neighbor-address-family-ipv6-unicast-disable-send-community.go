...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvsixUnicastDisableSendCommunity struct {
	// LeafNodes
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvsixUnicastDisableSendCommunityExtended types.String `tfsdk:"extended" json:"extended,omitempty"`
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvsixUnicastDisableSendCommunityStandard types.String `tfsdk:"standard" json:"standard,omitempty"`
