...
type VrfNameProtocolsIsisRedistributeIPvsixStaticLevelOne struct {
	// LeafNodes
	LeafVrfNameProtocolsIsisRedistributeIPvsixStaticLevelOneMetric   types.String `tfsdk:"metric" json:"metric,omitempty"`
	LeafVrfNameProtocolsIsisRedistributeIPvsixStaticLevelOneRouteMap types.String `tfsdk:"route_map" json:"route-map,omitempty"`
