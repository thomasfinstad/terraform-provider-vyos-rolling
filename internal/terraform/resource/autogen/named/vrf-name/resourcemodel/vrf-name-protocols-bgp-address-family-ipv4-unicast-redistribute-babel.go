...
type VrfNameProtocolsBgpAddressFamilyIPvfourUnicastRedistributeBabel struct {
	// LeafNodes
	LeafVrfNameProtocolsBgpAddressFamilyIPvfourUnicastRedistributeBabelMetric   types.String `tfsdk:"metric" json:"metric,omitempty"`
	LeafVrfNameProtocolsBgpAddressFamilyIPvfourUnicastRedistributeBabelRouteMap types.String `tfsdk:"route_map" json:"route-map,omitempty"`
