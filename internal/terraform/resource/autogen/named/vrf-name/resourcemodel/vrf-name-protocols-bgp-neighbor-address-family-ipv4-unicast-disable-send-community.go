...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastDisableSendCommunity struct {
	// LeafNodes
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastDisableSendCommunityExtended types.String `tfsdk:"extended" json:"extended,omitempty"`
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastDisableSendCommunityStandard types.String `tfsdk:"standard" json:"standard,omitempty"`
