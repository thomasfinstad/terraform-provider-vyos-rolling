...
type VrfNameProtocolsBgpNeighborAddressFamilyLtwovpnEvpnAllowasIn struct {
	// LeafNodes
	VrfNameProtocolsBgpNeighborAddressFamilyLtwovpnEvpnAllowasInNumber customtypes.CustomStringValue `tfsdk:"number" json:"number,omitempty"`
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyLtwovpnEvpnAllowasIn) ResourceAttributes() map[string]schema.Attribute {
