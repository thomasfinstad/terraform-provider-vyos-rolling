...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastAllowasIn struct {
	// LeafNodes
	VrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastAllowasInNumber customtypes.CustomStringValue `tfsdk:"number" json:"number,omitempty"`
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvfourUnicastAllowasIn) ResourceAttributes() map[string]schema.Attribute {
