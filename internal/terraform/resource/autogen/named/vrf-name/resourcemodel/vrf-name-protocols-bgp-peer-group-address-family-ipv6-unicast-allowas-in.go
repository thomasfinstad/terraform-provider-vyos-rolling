...
type VrfNameProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastAllowasIn struct {
	// LeafNodes
	VrfNameProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastAllowasInNumber customtypes.CustomStringValue `tfsdk:"number" json:"number,omitempty"`
...
func (o VrfNameProtocolsBgpPeerGroupAddressFamilyIPvsixUnicastAllowasIn) ResourceAttributes() map[string]schema.Attribute {
