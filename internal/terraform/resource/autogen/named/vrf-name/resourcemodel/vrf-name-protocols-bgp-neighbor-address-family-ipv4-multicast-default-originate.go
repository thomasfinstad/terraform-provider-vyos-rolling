...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvfourMulticastDefaultOriginate struct {
	// LeafNodes
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourMulticastDefaultOriginateRouteMap types.String `tfsdk:"route_map" json:"route-map,omitempty"`
...
func (o *VrfNameProtocolsBgpNeighborAddressFamilyIPvfourMulticastDefaultOriginate) MarshalJSON() ([]byte, error) {
	...
	if !o.LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourMulticastDefaultOriginateRouteMap.IsNull() && !o.LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourMulticastDefaultOriginateRouteMap.IsUnknown() {
		jsonData["route-map"] = o.LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourMulticastDefaultOriginateRouteMap.ValueString()
	}
...
func (o *VrfNameProtocolsBgpNeighborAddressFamilyIPvfourMulticastDefaultOriginate) UnmarshalJSON(jsonStr []byte) error {
	jsonData := make(map[string]interface{})
