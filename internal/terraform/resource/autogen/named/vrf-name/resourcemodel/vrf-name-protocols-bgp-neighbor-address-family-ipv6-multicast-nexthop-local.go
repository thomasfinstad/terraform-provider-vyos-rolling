...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvsixMulticastNexthopLocal struct {
	// LeafNodes
	VrfNameProtocolsBgpNeighborAddressFamilyIPvsixMulticastNexthopLocalUnchanged customtypes.CustomStringValue `tfsdk:"unchanged" json:"unchanged,omitempty"`
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvsixMulticastNexthopLocal) ResourceAttributes() map[string]schema.Attribute {
