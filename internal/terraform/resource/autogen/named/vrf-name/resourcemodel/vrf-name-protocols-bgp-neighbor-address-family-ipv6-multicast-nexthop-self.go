...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvsixMulticastNexthopSelf struct {
	// LeafNodes
	VrfNameProtocolsBgpNeighborAddressFamilyIPvsixMulticastNexthopSelfForce customtypes.CustomStringValue `tfsdk:"force" json:"force,omitempty"`
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvsixMulticastNexthopSelf) ResourceAttributes() map[string]schema.Attribute {
