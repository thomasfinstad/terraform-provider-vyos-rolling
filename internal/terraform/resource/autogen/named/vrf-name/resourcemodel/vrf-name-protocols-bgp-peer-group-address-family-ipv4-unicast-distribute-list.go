...
type VrfNameProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastDistributeList struct {
	// LeafNodes
	VrfNameProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastDistributeListExport customtypes.CustomStringValue `tfsdk:"export" json:"export,omitempty"`
	VrfNameProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastDistributeListImport customtypes.CustomStringValue `tfsdk:"import" json:"import,omitempty"`
...
func (o VrfNameProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastDistributeList) ResourceAttributes() map[string]schema.Attribute {
