...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastSoftReconfiguration struct {
	// LeafNodes
	VrfNameProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastSoftReconfigurationInbound customtypes.CustomStringValue `tfsdk:"inbound" json:"inbound,omitempty"`
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastSoftReconfiguration) ResourceAttributes() map[string]schema.Attribute {
