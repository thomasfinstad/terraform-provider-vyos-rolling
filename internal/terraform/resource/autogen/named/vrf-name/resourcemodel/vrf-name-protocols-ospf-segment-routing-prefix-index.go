...
type VrfNameProtocolsOspfSegmentRoutingPrefixIndex struct {
	// LeafNodes
	VrfNameProtocolsOspfSegmentRoutingPrefixIndexValue        customtypes.CustomStringValue `tfsdk:"value" json:"value,omitempty"`
	VrfNameProtocolsOspfSegmentRoutingPrefixIndexExplicitNull customtypes.CustomStringValue `tfsdk:"explicit_null" json:"explicit-null,omitempty"`
	VrfNameProtocolsOspfSegmentRoutingPrefixIndexNoPhpFlag    customtypes.CustomStringValue `tfsdk:"no_php_flag" json:"no-php-flag,omitempty"`
...
func (o VrfNameProtocolsOspfSegmentRoutingPrefixIndex) ResourceAttributes() map[string]schema.Attribute {
