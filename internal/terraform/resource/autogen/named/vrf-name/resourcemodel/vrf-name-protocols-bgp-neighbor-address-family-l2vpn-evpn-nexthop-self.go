...
type VrfNameProtocolsBgpNeighborAddressFamilyLtwovpnEvpnNexthopSelf struct {
	// LeafNodes
	VrfNameProtocolsBgpNeighborAddressFamilyLtwovpnEvpnNexthopSelfForce customtypes.CustomStringValue `tfsdk:"force" json:"force,omitempty"`
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyLtwovpnEvpnNexthopSelf) ResourceAttributes() map[string]schema.Attribute {
