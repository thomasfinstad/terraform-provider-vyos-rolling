...
type VrfNameProtocolsBgpNeighborInterfaceVsixonly struct {
	// LeafNodes
	LeafVrfNameProtocolsBgpNeighborInterfaceVsixonlyPeerGroup types.String `tfsdk:"peer_group" json:"peer-group,omitempty"`
	LeafVrfNameProtocolsBgpNeighborInterfaceVsixonlyRemoteAs  types.String `tfsdk:"remote_as" json:"remote-as,omitempty"`
