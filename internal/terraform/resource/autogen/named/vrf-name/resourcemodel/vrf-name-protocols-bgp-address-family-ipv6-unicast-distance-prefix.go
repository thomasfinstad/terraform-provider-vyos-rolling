...
type VrfNameProtocolsBgpAddressFamilyIPvsixUnicastDistancePrefix struct {
	// LeafNodes
	VrfNameProtocolsBgpAddressFamilyIPvsixUnicastDistancePrefixDistance customtypes.CustomStringValue `tfsdk:"distance" json:"distance,omitempty"`
...
func (o VrfNameProtocolsBgpAddressFamilyIPvsixUnicastDistancePrefix) ResourceAttributes() map[string]schema.Attribute {
