...
type VrfNameProtocolsBgpPeerGroupAddressFamilyLtwovpnEvpnAllowasIn struct {
	// LeafNodes
	VrfNameProtocolsBgpPeerGroupAddressFamilyLtwovpnEvpnAllowasInNumber customtypes.CustomStringValue `tfsdk:"number" json:"number,omitempty"`
...
func (o VrfNameProtocolsBgpPeerGroupAddressFamilyLtwovpnEvpnAllowasIn) ResourceAttributes() map[string]schema.Attribute {
