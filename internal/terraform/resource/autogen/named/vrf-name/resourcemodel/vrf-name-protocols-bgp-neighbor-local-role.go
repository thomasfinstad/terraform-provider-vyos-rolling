...
type VrfNameProtocolsBgpNeighborLocalRole struct {
	// LeafNodes
	VrfNameProtocolsBgpNeighborLocalRoleStrict customtypes.CustomStringValue `tfsdk:"strict" json:"strict,omitempty"`
...
func (o VrfNameProtocolsBgpNeighborLocalRole) ResourceAttributes() map[string]schema.Attribute {
