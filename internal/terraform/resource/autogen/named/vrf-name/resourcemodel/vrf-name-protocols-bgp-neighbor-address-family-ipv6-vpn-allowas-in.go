...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvsixVpnAllowasIn struct {
	// LeafNodes
	VrfNameProtocolsBgpNeighborAddressFamilyIPvsixVpnAllowasInNumber customtypes.CustomStringValue `tfsdk:"number" json:"number,omitempty"`
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvsixVpnAllowasIn) ResourceAttributes() map[string]schema.Attribute {
