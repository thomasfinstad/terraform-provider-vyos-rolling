...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvfourMulticastSoftReconfiguration struct {
	// LeafNodes
	VrfNameProtocolsBgpNeighborAddressFamilyIPvfourMulticastSoftReconfigurationInbound customtypes.CustomStringValue `tfsdk:"inbound" json:"inbound,omitempty"`
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvfourMulticastSoftReconfiguration) ResourceAttributes() map[string]schema.Attribute {
