...
type VrfNameProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastDefaultOriginate struct {
	// LeafNodes
	LeafVrfNameProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastDefaultOriginateRouteMap types.String `tfsdk:"route_map" json:"route-map,omitempty"`
...
func (o *VrfNameProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastDefaultOriginate) MarshalJSON() ([]byte, error) {
	...
	if !o.LeafVrfNameProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastDefaultOriginateRouteMap.IsNull() && !o.LeafVrfNameProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastDefaultOriginateRouteMap.IsUnknown() {
		jsonData["route-map"] = o.LeafVrfNameProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastDefaultOriginateRouteMap.ValueString()
	}
...
func (o *VrfNameProtocolsBgpPeerGroupAddressFamilyIPvfourUnicastDefaultOriginate) UnmarshalJSON(jsonStr []byte) error {
	jsonData := make(map[string]interface{})
