...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvfourFlowspecPrefixList struct {
	// LeafNodes
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourFlowspecPrefixListExport types.String `tfsdk:"export"`
	LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourFlowspecPrefixListImport types.String `tfsdk:"import"`
...
func (o *VrfNameProtocolsBgpNeighborAddressFamilyIPvfourFlowspecPrefixList) TerraformToVyos(ctx context.Context, diags *diag.Diagnostics) map[string]interface{} {
	tflog.Error(ctx, "TerraformToVyos", map[string]interface{}{"Path": []string{"vrf", "name", "protocols", "bgp", "neighbor", "address-family", "ipv4-flowspec", "prefix-list"}})
	...
	if !(o.LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourFlowspecPrefixListExport.IsNull() || o.LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourFlowspecPrefixListExport.IsUnknown()) {
		vyosData["export"] = o.LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourFlowspecPrefixListExport.ValueString()
	}
	if !(o.LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourFlowspecPrefixListImport.IsNull() || o.LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourFlowspecPrefixListImport.IsUnknown()) {
		vyosData["import"] = o.LeafVrfNameProtocolsBgpNeighborAddressFamilyIPvfourFlowspecPrefixListImport.ValueString()
	}
...
func (o *VrfNameProtocolsBgpNeighborAddressFamilyIPvfourFlowspecPrefixList) VyosToTerraform(ctx context.Context, diags *diag.Diagnostics, vyosData map[string]interface{}) {
	tflog.Error(ctx, "VyosToTerraform begin", map[string]interface{}{"Path": []string{"vrf", "name", "protocols", "bgp", "neighbor", "address-family", "ipv4-flowspec", "prefix-list"}})
	...
	tflog.Error(ctx, "VyosToTerraform end", map[string]interface{}{"Path": []string{"vrf", "name", "protocols", "bgp", "neighbor", "address-family", "ipv4-flowspec", "prefix-list"}})
}

// AttributeTypes generates the attribute types for the resource at this level
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvfourFlowspecPrefixList) AttributeTypes() map[string]attr.Type {
