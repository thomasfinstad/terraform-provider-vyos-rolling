...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvsixVpnDistributeList struct {
	// LeafNodes
	VrfNameProtocolsBgpNeighborAddressFamilyIPvsixVpnDistributeListExport customtypes.CustomStringValue `tfsdk:"export" json:"export,omitempty"`
	VrfNameProtocolsBgpNeighborAddressFamilyIPvsixVpnDistributeListImport customtypes.CustomStringValue `tfsdk:"import" json:"import,omitempty"`
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvsixVpnDistributeList) ResourceAttributes() map[string]schema.Attribute {
