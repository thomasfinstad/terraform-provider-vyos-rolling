...
type VrfNameProtocolsBgpAddressFamilyIPvfourUnicastRouteTarget struct {
	...
	// Nodes
	NodeVrfNameProtocolsBgpAddressFamilyIPvfourUnicastRouteTargetVpn *VrfNameProtocolsBgpAddressFamilyIPvfourUnicastRouteTargetVpn `tfsdk:"vpn" json:"vpn,omitempty"`
}
