...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvsixVpnNexthopLocal struct {
	// LeafNodes
	VrfNameProtocolsBgpNeighborAddressFamilyIPvsixVpnNexthopLocalUnchanged customtypes.CustomStringValue `tfsdk:"unchanged" json:"unchanged,omitempty"`
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvsixVpnNexthopLocal) ResourceAttributes() map[string]schema.Attribute {
