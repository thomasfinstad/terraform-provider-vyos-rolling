...
type VrfNameProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAllowasIn struct {
	// LeafNodes
	VrfNameProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAllowasInNumber customtypes.CustomStringValue `tfsdk:"number" json:"number,omitempty"`
...
func (o VrfNameProtocolsBgpNeighborAddressFamilyIPvsixLabeledUnicastAllowasIn) ResourceAttributes() map[string]schema.Attribute {
