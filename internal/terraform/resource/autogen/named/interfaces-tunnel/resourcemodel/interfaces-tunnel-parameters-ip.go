...
type InterfacesTunnelParametersIP struct {
	// LeafNodes
	LeafInterfacesTunnelParametersIPNoPmtuDiscovery types.String `tfsdk:"no_pmtu_discovery" json:"no-pmtu-discovery,omitempty"`
	LeafInterfacesTunnelParametersIPIgnoreDf        types.String `tfsdk:"ignore_df" json:"ignore-df,omitempty"`
	LeafInterfacesTunnelParametersIPKey             types.String `tfsdk:"key" json:"key,omitempty"`
	LeafInterfacesTunnelParametersIPTos             types.String `tfsdk:"tos" json:"tos,omitempty"`
	LeafInterfacesTunnelParametersIPTTL             types.String `tfsdk:"ttl" json:"ttl,omitempty"`
