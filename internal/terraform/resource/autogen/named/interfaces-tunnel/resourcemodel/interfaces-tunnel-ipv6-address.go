...
type InterfacesTunnelIPvsixAddress struct {
	// LeafNodes
	LeafInterfacesTunnelIPvsixAddressAutoconf           types.String `tfsdk:"autoconf"`
	LeafInterfacesTunnelIPvsixAddressEuisixfour         types.String `tfsdk:"eui64"`
	LeafInterfacesTunnelIPvsixAddressNoDefaultLinkLocal types.String `tfsdk:"no_default_link_local"`
...
func (o *InterfacesTunnelIPvsixAddress) TerraformToVyos(ctx context.Context, diags *diag.Diagnostics) map[string]interface{} {
	tflog.Error(ctx, "TerraformToVyos", map[string]interface{}{"Path": []string{"interfaces", "tunnel", "ipv6", "address"}})

	vyosData := make(map[string]interface{})

	// Leafs
	if !(o.LeafInterfacesTunnelIPvsixAddressAutoconf.IsNull() || o.LeafInterfacesTunnelIPvsixAddressAutoconf.IsUnknown()) {
		vyosData["autoconf"] = o.LeafInterfacesTunnelIPvsixAddressAutoconf.ValueString()
	}
	if !(o.LeafInterfacesTunnelIPvsixAddressEuisixfour.IsNull() || o.LeafInterfacesTunnelIPvsixAddressEuisixfour.IsUnknown()) {
		vyosData["eui64"] = o.LeafInterfacesTunnelIPvsixAddressEuisixfour.ValueString()
	}
	if !(o.LeafInterfacesTunnelIPvsixAddressNoDefaultLinkLocal.IsNull() || o.LeafInterfacesTunnelIPvsixAddressNoDefaultLinkLocal.IsUnknown()) {
		vyosData["no-default-link-local"] = o.LeafInterfacesTunnelIPvsixAddressNoDefaultLinkLocal.ValueString()
	}
...
func (o *InterfacesTunnelIPvsixAddress) VyosToTerraform(ctx context.Context, diags *diag.Diagnostics, vyosData map[string]interface{}) {
	tflog.Error(ctx, "VyosToTerraform begin", map[string]interface{}{"Path": []string{"interfaces", "tunnel", "ipv6", "address"}})
	...
	tflog.Error(ctx, "VyosToTerraform end", map[string]interface{}{"Path": []string{"interfaces", "tunnel", "ipv6", "address"}})
}

// AttributeTypes generates the attribute types for the resource at this level
func (o InterfacesTunnelIPvsixAddress) AttributeTypes() map[string]attr.Type {
