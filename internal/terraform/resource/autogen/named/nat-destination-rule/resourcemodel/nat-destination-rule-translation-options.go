...
type NatDestinationRuleTranSLAtionOptions struct {
	// LeafNodes
	NatDestinationRuleTranSLAtionOptionsAddressMapping customtypes.CustomStringValue `tfsdk:"address_mapping" json:"address-mapping,omitempty"`
	NatDestinationRuleTranSLAtionOptionsPortMapping    customtypes.CustomStringValue `tfsdk:"port_mapping" json:"port-mapping,omitempty"`
...
func (o NatDestinationRuleTranSLAtionOptions) ResourceAttributes() map[string]schema.Attribute {
