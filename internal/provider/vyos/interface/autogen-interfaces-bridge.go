						...
						TagNode: []*interfacedefinition.TagNode{
							{
								XMLName: xml.Name{
									Local: `tagNode`},
								OwnerAttr: `${vyos_conf_scripts_dir}/interfaces-bridge.py`,
								Properties: []*interfacedefinition.Properties{
									{
										...
										ConstraintErrorMessage: []string{
											`Bridge interface must be named brN`},
										Priority: []string{
											`310`},
												...
												Properties: []*interfacedefinition.Properties{
													{
														XMLName: xml.Name{
															Local: `properties`},
														Help: []string{
															`Internet Group Management Protocol (IGMP) and Multicast Listener Discovery (MLD) settings`},
														KeepChildOrder: []*interfacedefinition.KeepChildOrder(nil)}},
												Children: []*interfacedefinition.Children{
													{
														XMLName: xml.Name{
																				...
																				Properties: []*interfacedefinition.Properties{
																					{
																						...
																						ConstraintErrorMessage: []string{
																							`not a valid VLAN ID value or range`},
																						Multi: []*interfacedefinition.Multi{
																							{
																								XMLName: xml.Name{
																									Local: `multi`}}},
																				...
																				Properties: []*interfacedefinition.Properties{
																					{
																						...
																						ConstraintErrorMessage: []string{
																							`Path cost value must be between 1 and 65535`},
																						KeepChildOrder: []*interfacedefinition.KeepChildOrder(nil)}}},
																			{
																				XMLName: xml.Name{
																					Local: `leafNode`},
																				...
																				Properties: []*interfacedefinition.Properties{
																					{
																						...
																						ConstraintErrorMessage: []string{
																							`Port priority value must be between 0 and 63`},
																						KeepChildOrder: []*interfacedefinition.KeepChildOrder(nil)}}},
																			{
																				XMLName: xml.Name{
																					Local: `leafNode`},
												...
												Properties: []*interfacedefinition.Properties{
													{
														...
														ConstraintErrorMessage: []string{
															`Forwarding delay must be between 0 and 200 seconds`},
														KeepChildOrder: []*interfacedefinition.KeepChildOrder(nil)}}},
											{
												XMLName: xml.Name{
													Local: `leafNode`},
												...
												Properties: []*interfacedefinition.Properties{
													{
														...
														ConstraintErrorMessage: []string{
															`Bridge Hello interval must be between 1 and 10 seconds`},
														KeepChildOrder: []*interfacedefinition.KeepChildOrder(nil)}}},
											{
												XMLName: xml.Name{
													Local: `leafNode`},
												...
												Properties: []*interfacedefinition.Properties{
													{
														...
														ConstraintErrorMessage: []string{
															`Bridge max aging value must be between 1 and 40 seconds`},
														KeepChildOrder: []*interfacedefinition.KeepChildOrder(nil)}}},
											{
												XMLName: xml.Name{
													Local: `leafNode`},
												...
												Properties: []*interfacedefinition.Properties{
													{
														...
														ConstraintErrorMessage: []string{
															`Bridge priority must be between 0 and 65535 (multiples of 4096)`},
														KeepChildOrder: []*interfacedefinition.KeepChildOrder(nil)}}},
											{
												XMLName: xml.Name{
													Local: `leafNode`},
