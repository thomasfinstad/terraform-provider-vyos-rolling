																				...
																				Properties: []*interfacedefinition.Properties{
																					{
																						XMLName: xml.Name{
																							Local: `properties`},
																						Help: []string{
																							`Authentication protocol for remote access peer PPTP VPN`},
																						ValueHelp: []*interfacedefinition.ValueHelp{
																							{
																								XMLName: xml.Name{
																									Local: `valueHelp`},
																				...
																				Properties: []*interfacedefinition.Properties{
																					{
																						XMLName: xml.Name{
																							Local: `properties`},
																						Help: []string{
																							`Specifies mppe negotioation preference. (default require mppe 128-bit stateless`},
																						Constraint: []*interfacedefinition.Constraint{
																							{
																								XMLName: xml.Name{
																									Local: `constraint`},
																						...
																						ValueHelp: []*interfacedefinition.ValueHelp{
																								...
																								Description: `deny mppe`},
																							{
																								XMLName: xml.Name{
																									Local: `valueHelp`},
																								Format: `prefer`,
																								Description: `ask client for mppe,
 if it rejects do not fail`},
																							{
																								XMLName: xml.Name{
																									Local: `valueHelp`},
																								Format: `require`,
																								Description: `ask client for mppe,
 if it rejects drop connection`}},
																						CompletionHelp: []*interfacedefinition.CompletionHelp{
																							{
																								XMLName: xml.Name{
																									Local: `completionHelp`},
