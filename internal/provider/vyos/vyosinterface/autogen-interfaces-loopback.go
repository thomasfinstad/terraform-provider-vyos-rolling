		...
		Node: []*interfacedefinition.Node{{
			...
			Children: []*interfacedefinition.Children{{
				...
				TagNode: []*interfacedefinition.TagNode{{
					XMLName: xml.Name{Local: "tagNode"}, NodeNameAttr: "loopback", OwnerAttr: "${vyos_conf_scripts_dir}/interfaces-loopback.py",
					Properties: []*interfacedefinition.Properties{{
						...
						ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "lo", Description: "Loopback interface"}},
