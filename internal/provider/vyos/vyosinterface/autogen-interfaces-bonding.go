		...
		Node: []*interfacedefinition.Node{{
			...
			Children: []*interfacedefinition.Children{{
				...
				TagNode: []*interfacedefinition.TagNode{{
					XMLName: xml.Name{Local: "tagNode"}, NodeNameAttr: "bonding", OwnerAttr: "${vyos_conf_scripts_dir}/interfaces-bonding.py",
					Properties: []*interfacedefinition.Properties{{
						...
						ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "bondN", Description: "Bonding interface name"}},
					...
					Children: []*interfacedefinition.Children{{
						XMLName: xml.Name{Local: "children"},
						Node: []*interfacedefinition.Node{{
							XMLName: xml.Name{Local: "node"}, NodeNameAttr: "arp-monitor",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
							...
							Children: []*interfacedefinition.Children{{
								...
								LeafNode: []*interfacedefinition.LeafNode{{
									...
									Properties: []*interfacedefinition.Properties{{
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "u32", Description: "Specifies the ARP link monitoring frequency in milliseconds"}},
									}},
								}, {
									...
									Properties: []*interfacedefinition.Properties{{
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv4", Description: "Specify IPv4 address of ARP requests when interval is enabled"}},
						...
						LeafNode: []*interfacedefinition.LeafNode{{
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "hash-policy",
							...
							Properties: []*interfacedefinition.Properties{{
								...
								ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "layer2", Description: "use MAC addresses to generate the hash"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "layer2+3", Description: "combine MAC address and IP address to make hash"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "layer3+4", Description: "combine IP address and port to make hash"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "encap2+3", Description: "combine encapsulated MAC address and IP address to make hash"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "encap3+4", Description: "combine encapsulated IP address and port to make hash"}},
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "mii-mon-interval",
							...
							Properties: []*interfacedefinition.Properties{{
								...
								Constraint: []*interfacedefinition.Constraint{{
									XMLName:   xml.Name{Local: "constraint"},
									Validator: []*interfacedefinition.Validator{{XMLName: xml.Name{Local: "validator"}, NameAttr: "numeric", ArgumentAttr: "--range 0-0 --range 50-1000"}},
								}},
								ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:0", Description: "Disable MII link monitoring"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:50-1000", Description: "MII link monitoring frequency in milliseconds"}},
							}},
						}, {
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "min-links",
							...
							Properties: []*interfacedefinition.Properties{{
								...
								Constraint: []*interfacedefinition.Constraint{{
									XMLName:   xml.Name{Local: "constraint"},
									Validator: []*interfacedefinition.Validator{{XMLName: xml.Name{Local: "validator"}, NameAttr: "numeric", ArgumentAttr: "--range 0-16"}},
								}},
								ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:0-16", Description: "Minimum number of member interfaces required up before enabling bond"}},
							}},
						}, {
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "lacp-rate",
							...
							Properties: []*interfacedefinition.Properties{{
								...
								ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "slow", Description: "Request partner to transmit LACPDUs every 30 seconds"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "fast", Description: "Request partner to transmit LACPDUs every 1 second"}},
								CompletionHelp: []*interfacedefinition.CompletionHelp{{
									XMLName: xml.Name{Local: "completionHelp"},
							...
							Properties: []*interfacedefinition.Properties{{
								...
								ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "802.3ad", Description: "IEEE 802.3ad Dynamic link aggregation"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "active-backup", Description: "Fault tolerant: only one slave in the bond is active"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "broadcast", Description: "Fault tolerant: transmits everything on all slave interfaces"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "round-robin", Description: "Load balance: transmit packets in sequential order"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "transmit-load-balance", Description: "Load balance: adapts based on transmit load and speed"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "adaptive-load-balance", Description: "Load balance: adapts based on transmit and receive plus ARP"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "xor-hash", Description: "Distribute based on MAC address"}},
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "primary",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "xdp",
							Properties: []*interfacedefinition.Properties{{
								XMLName:   xml.Name{Local: "properties"},
