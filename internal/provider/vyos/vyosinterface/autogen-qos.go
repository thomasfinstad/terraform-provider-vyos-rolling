...
func Qos() interfacedefinition.InterfaceDefinition {
 ...
 all traffic passes through a single queue`},
																				...
																				Properties: []*interfacedefinition.Properties{
																					{
																						XMLName: xml.Name{
																							Local: `properties`},
																						Help: []string{
																							`Flows are defined by the 5-tuple,
 and fairness is applied first over source addresses,
 then over individual flows`},
																						Valueless: []*interfacedefinition.Valueless{
																							{
																								XMLName: xml.Name{
																									Local: `valueless`}}},
																				...
																				Properties: []*interfacedefinition.Properties{
																					{
																						...
																						Help: []string{
																							`Flows are defined by the 5-tuple,
 and fairness is applied first over destination addresses,
 then over individual flows`},
																						Valueless: []*interfacedefinition.Valueless{
																							{
																								XMLName: xml.Name{
																		...
																		Constraint: []*interfacedefinition.Constraint{
																			{
																				XMLName: xml.Name{
																					Local: `constraint`},
																				Regex: []string{
																					`(\\d+(bit|kbit|mbit|gbit|tbit)?|(100|\\d(\\d)?)%)`},
																		...
																		ValueHelp: []*interfacedefinition.ValueHelp{
																			{
																				...
																				Description: `Queue size in packets`}},
																		ConstraintErrorMessage: []string{
																			`Queue limit must be in range 1 to 127`},
																		KeepChildOrder: []*interfacedefinition.KeepChildOrder(nil)}}}}}}},
											{
												XMLName: xml.Name{
													Local: `tagNode`},
...
256}`},
																				...
																				Properties: []*interfacedefinition.Properties{
																					{
																						...
																						ValueHelp: []*interfacedefinition.ValueHelp{
																								...
																								Description: `Bytes`},
																							{
																								...
																								Description: `Bytes with scaling suffix (kb,
 mb,
 gb)`}},
																						KeepChildOrder: []*interfacedefinition.KeepChildOrder(nil)}}},
																			{
 ...
 just continue with the next action in line`},
																							{
																								XMLName: xml.Name{
																									Local: `valueHelp`},
																								Format:      `drop`,
																												...
																												Properties: []*interfacedefinition.Properties{
																													{
																														...
																														ConstraintErrorMessage: []string{
																															`Maximum packet length is 65535`},
																														KeepChildOrder: []*interfacedefinition.KeepChildOrder(nil)}}},
																											{
																												XMLName: xml.Name{
																													Local: `leafNode`},
																						...
																						Constraint: []*interfacedefinition.Constraint{
																							{
																								XMLName: xml.Name{
																									Local: `constraint`},
																								Regex: []string{
																									`(drop-tail|fair-queue|fq-codel|priority|random-detect)`},
																								Validator: []*interfacedefinition.Validator(nil)}},
																						ValueHelp: []*interfacedefinition.ValueHelp{
																							{
																								XMLName: xml.Name{
																		...
																		Constraint: []*interfacedefinition.Constraint{
																			{
																				XMLName: xml.Name{
																					Local: `constraint`},
																				Regex: []string{
																					`(auto|\\d+(bit|kbit|mbit|gbit|tbit)?|(100|\\d(\\d)?)%)`},
																				Validator: []*interfacedefinition.Validator{
																					{
																						XMLName: xml.Name{
																							Local: `validator`},
														...
														CompletionHelp: []*interfacedefinition.CompletionHelp{
															{
																...
																Path: []string{
																	`qos policy cake`,
																	`qos policy drop-tail`,
																	`qos policy fair-queue`,
																	`qos policy fq-codel`,
																	`qos policy network-emulator`,
																	`qos policy priority-queue`,
																	`qos policy random-detect`,
																	`qos policy rate-control`,
																	`qos policy round-robin`,
																	`qos policy shaper`,
																	`qos policy shaper-hfsc`},
																Script: []string(nil)}},
														KeepChildOrder: []*interfacedefinition.KeepChildOrder(nil)}}}}}}}},
						LeafNode: []*interfacedefinition.LeafNode(nil)}}}}}
}
