		...
		Node: []*interfacedefinition.Node{{
			...
			Children: []*interfacedefinition.Children{{
				...
				TagNode: []*interfacedefinition.TagNode{{
					XMLName: xml.Name{Local: "tagNode"}, NodeNameAttr: "macsec", OwnerAttr: "${vyos_conf_scripts_dir}/interfaces-macsec.py",
					Properties: []*interfacedefinition.Properties{{
						...
						ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "macsecN", Description: "MACsec interface name"}},
					...
					Children: []*interfacedefinition.Children{{
						...
						Node: []*interfacedefinition.Node{{
							...
							Children: []*interfacedefinition.Children{{
								XMLName: xml.Name{Local: "children"},
								Node: []*interfacedefinition.Node{{
									XMLName: xml.Name{Local: "node"}, NodeNameAttr: "mka",
									Properties: []*interfacedefinition.Properties{{
										XMLName: xml.Name{Local: "properties"},
									...
									Children: []*interfacedefinition.Children{{
										XMLName: xml.Name{Local: "children"},
										LeafNode: []*interfacedefinition.LeafNode{{
											XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "cak",
											Properties: []*interfacedefinition.Properties{{
												XMLName: xml.Name{Local: "properties"},
												...
												ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "txt", Description: "16-byte (128-bit) hex-string (32 hex-digits) for gcm-aes-128 or 32-byte (256-bit) hex-string (64 hex-digits) for gcm-aes-256"}},
											}},
										}, {
											XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "ckn",
											Properties: []*interfacedefinition.Properties{{
												XMLName: xml.Name{Local: "properties"},
												...
												ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "txt", Description: "1..32-bytes (8..256 bit) hex-string (2..64 hex-digits)"}},
											}},
										}, {
											...
											Properties: []*interfacedefinition.Properties{{
												...
												ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:0-255", Description: "MACsec Key Agreement protocol (MKA) priority"}},
											}},
										}},
									}},
								}},
								LeafNode: []*interfacedefinition.LeafNode{{
									...
									Properties: []*interfacedefinition.Properties{{
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "gcm-aes-128", Description: "Galois/Counter Mode of AES cipher with 128-bit key"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "gcm-aes-256", Description: "Galois/Counter Mode of AES cipher with 256-bit key"}},
										CompletionHelp: []*interfacedefinition.CompletionHelp{{
											XMLName: xml.Name{Local: "completionHelp"},
									...
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "encrypt",
									Properties: []*interfacedefinition.Properties{{
										XMLName:   xml.Name{Local: "properties"},
									...
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "replay-window",
									Properties: []*interfacedefinition.Properties{{
										XMLName: xml.Name{Local: "properties"},
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:0", Description: "No replay window, strict check"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:1-4294967295", Description: "Number of packets that could be misordered"}},
									}},
								}},
							}},
						}},
