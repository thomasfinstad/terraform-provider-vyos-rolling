	...
	return interfacedefinition.InterfaceDefinition{
		...
		Node: []*interfacedefinition.Node{{
			...
			Children: []*interfacedefinition.Children{{
				...
				Node: []*interfacedefinition.Node{{
					XMLName: xml.Name{Local: "node"}, NodeNameAttr: "igmp-proxy", OwnerAttr: "${vyos_conf_scripts_dir}/igmp_proxy.py",
					...
					Children: []*interfacedefinition.Children{{
						...
						TagNode: []*interfacedefinition.TagNode{{
							...
							Children: []*interfacedefinition.Children{{
								...
								LeafNode: []*interfacedefinition.LeafNode{{
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "alt-subnet",
									Properties: []*interfacedefinition.Properties{{
										XMLName: xml.Name{Local: "properties"},
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv4net", Description: "IPv4 network"}},
									...
									Properties: []*interfacedefinition.Properties{{
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "upstream", Description: "Upstream interface (only 1 allowed)"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "downstream", Description: "Downstream interface(s)"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "disabled", Description: "Disabled interface"}},
										CompletionHelp: []*interfacedefinition.CompletionHelp{{
											XMLName: xml.Name{Local: "completionHelp"},
									...
									Properties: []*interfacedefinition.Properties{{
										...
										ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:1-255", Description: "TTL threshold for the interfaces"}},
										ConstraintErrorMessage: []string{"Threshold must be between 1 and 255"},
									}},
								}, {
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "whitelist",
									Properties: []*interfacedefinition.Properties{{
										XMLName: xml.Name{Local: "properties"},
						...
						LeafNode: []*interfacedefinition.LeafNode{{
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "disable-quickleave",
							Properties: []*interfacedefinition.Properties{{
								XMLName:   xml.Name{Local: "properties"},
