...
func container() interfacedefinition.InterfaceDefinition {
	return interfacedefinition.InterfaceDefinition{
		...
		Node: []*interfacedefinition.Node{{
			XMLName: xml.Name{Local: "node"}, NodeNameAttr: "container", OwnerAttr: "${vyos_conf_scripts_dir}/container.py",
			...
			Children: []*interfacedefinition.Children{{
				...
				TagNode: []*interfacedefinition.TagNode{{
					...
					Children: []*interfacedefinition.Children{{
						XMLName: xml.Name{Local: "children"},
						TagNode: []*interfacedefinition.TagNode{{
							XMLName: xml.Name{Local: "tagNode"}, NodeNameAttr: "device",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
							...
							Children: []*interfacedefinition.Children{{
								...
								LeafNode: []*interfacedefinition.LeafNode{{
									...
									Properties: []*interfacedefinition.Properties{{
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "txt", Description: "Source device"}},
									}},
								}, {
									...
									Properties: []*interfacedefinition.Properties{{
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "txt", Description: "Destination container device"}},
									}},
								}},
							}},
						}, {
							...
							Children: []*interfacedefinition.Children{{
								...
								LeafNode: []*interfacedefinition.LeafNode{{
									...
									Properties: []*interfacedefinition.Properties{{
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "txt", Description: "Set environment option value"}},
									}},
								}},
							}},
						}, {
							...
							XMLName: xml.Name{Local: "tagNode"}, NodeNameAttr: "port",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
							...
							Children: []*interfacedefinition.Children{{
								...
								LeafNode: []*interfacedefinition.LeafNode{{
									...
									Properties: []*interfacedefinition.Properties{{
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:1-65535", Description: "Source host port"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "start-end", Description: "Source host port range (e.g. 10025-10030)"}},
									}},
								}, {
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "destination",
									Properties: []*interfacedefinition.Properties{{
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:1-65535", Description: "Destination container port"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "start-end", Description: "Destination container port range (e.g. 10025-10030)"}},
									}},
								}, {
									...
									Properties: []*interfacedefinition.Properties{{
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "tcp", Description: "Use Transmission Control Protocol for given port"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "udp", Description: "Use User Datagram Protocol for given port"}},
										CompletionHelp: []*interfacedefinition.CompletionHelp{{
											XMLName: xml.Name{Local: "completionHelp"},
											List:    []string{"tcp udp"},
										}},
							...
							XMLName: xml.Name{Local: "tagNode"}, NodeNameAttr: "volume",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
							...
							Children: []*interfacedefinition.Children{{
								...
								LeafNode: []*interfacedefinition.LeafNode{{
									...
									Properties: []*interfacedefinition.Properties{{
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "txt", Description: "Source host directory"}},
									}},
								}, {
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "destination",
									Properties: []*interfacedefinition.Properties{{
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "txt", Description: "Destination container directory"}},
									}},
								}, {
									...
									Properties: []*interfacedefinition.Properties{{
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "ro", Description: "Volume mounted into the container as read-only"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "rw", Description: "Volume mounted into the container as read-write"}},
										CompletionHelp: []*interfacedefinition.CompletionHelp{{
											XMLName: xml.Name{Local: "completionHelp"},
											List:    []string{"ro rw"},
										}},
						...
						LeafNode: []*interfacedefinition.LeafNode{{
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "allow-host-networks",
							Properties: []*interfacedefinition.Properties{{
								XMLName:   xml.Name{Local: "properties"},
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "cap-add",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
								...
								ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "net-admin", Description: "Network operations (interface, firewall, routing tables)"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "net-bind-service", Description: "Bind a socket to privileged ports (port numbers less than 1024)"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "net-raw", Description: "Permission to create raw network sockets"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "setpcap", Description: "Capability sets (from bounded or inherited set)"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "sys-admin", Description: "Administation operations (quotactl, mount, sethostname, setdomainame)"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "sys-time", Description: "Permission to set system clock"}},
								CompletionHelp: []*interfacedefinition.CompletionHelp{{
									XMLName: xml.Name{Local: "completionHelp"},
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "entrypoint",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "image",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
								Help:    []string{"Image name in the hub-registry"},
							}},
						}, {
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "command",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "memory",
							...
							Properties: []*interfacedefinition.Properties{{
								...
								Constraint: []*interfacedefinition.Constraint{{
									XMLName:   xml.Name{Local: "constraint"},
									Validator: []*interfacedefinition.Validator{{XMLName: xml.Name{Local: "validator"}, NameAttr: "numeric", ArgumentAttr: "--range 0-16384"}},
								}},
								ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:0", Description: "Unlimited"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:1-16384", Description: "Container memory in megabytes (MB)"}},
								ConstraintErrorMessage: []string{"Container memory must be in range 0 to 16384 MB"},
							}},
						}, {
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "shared-memory",
							...
							Properties: []*interfacedefinition.Properties{{
								...
								Constraint: []*interfacedefinition.Constraint{{
									XMLName:   xml.Name{Local: "constraint"},
									Validator: []*interfacedefinition.Validator{{XMLName: xml.Name{Local: "validator"}, NameAttr: "numeric", ArgumentAttr: "--range 0-8192"}},
								}},
								ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:0", Description: "Unlimited"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:1-8192", Description: "Container memory in megabytes (MB)"}},
								ConstraintErrorMessage: []string{"Container memory must be in range 0 to 8192 MB"},
							}},
						}, {
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "restart",
							...
							Properties: []*interfacedefinition.Properties{{
								...
								ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "no", Description: "Do not restart containers on exit"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "on-failure", Description: "Restart containers when they exit with a non-zero exit code, retrying indefinitely"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "always", Description: "Restart containers when they exit, regardless of status, retrying indefinitely"}},
								CompletionHelp: []*interfacedefinition.CompletionHelp{{
									XMLName: xml.Name{Local: "completionHelp"},
					...
					Children: []*interfacedefinition.Children{{
						...
						LeafNode: []*interfacedefinition.LeafNode{{
							...
							Properties: []*interfacedefinition.Properties{{
								...
								ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv4net", Description: "IPv4 network prefix"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv6net", Description: "IPv6 network prefix"}},
								Multi:     []*interfacedefinition.Multi{{XMLName: xml.Name{Local: "multi"}}},
							}},
						}},
					}},
				}, {
					XMLName: xml.Name{Local: "tagNode"}, NodeNameAttr: "registry",
