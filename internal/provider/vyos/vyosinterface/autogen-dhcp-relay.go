	...
	return interfacedefinition.InterfaceDefinition{
		...
		Node: []*interfacedefinition.Node{{
			...
			Children: []*interfacedefinition.Children{{
				...
				Node: []*interfacedefinition.Node{{
					XMLName: xml.Name{Local: "node"}, NodeNameAttr: "dhcp-relay", OwnerAttr: "${vyos_conf_scripts_dir}/dhcp_relay.py",
					...
					Children: []*interfacedefinition.Children{{
						XMLName: xml.Name{Local: "children"},
						Node: []*interfacedefinition.Node{{
							XMLName: xml.Name{Local: "node"}, NodeNameAttr: "relay-options",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
							...
							Children: []*interfacedefinition.Children{{
								...
								LeafNode: []*interfacedefinition.LeafNode{{
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "hop-count",
									...
									Properties: []*interfacedefinition.Properties{{
										...
										ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:1-255", Description: "Hop count"}},
										ConstraintErrorMessage: []string{"hop-count must be a value between 1 and 255"},
									}},
								}, {
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "max-size",
									...
									Properties: []*interfacedefinition.Properties{{
										...
										Constraint: []*interfacedefinition.Constraint{{
											XMLName:   xml.Name{Local: "constraint"},
											Validator: []*interfacedefinition.Validator{{XMLName: xml.Name{Local: "validator"}, NameAttr: "numeric", ArgumentAttr: "--range 64-1400"}},
										}},
										ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:64-1400", Description: "Maximum packet size"}},
										ConstraintErrorMessage: []string{"max-size must be a value between 64 and 1400"},
									}},
								}, {
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "relay-agents-packets",
									...
									Properties: []*interfacedefinition.Properties{{
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "append", Description: "append own relay options to packet"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "replace", Description: "replace existing agent option field"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "forward", Description: "forward packet unchanged"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "discard", Description: "discard packet (default action if giaddr not set in packet)"}},
						...
						LeafNode: []*interfacedefinition.LeafNode{{
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "upstream-interface",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
