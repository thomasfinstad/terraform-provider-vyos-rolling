	...
	return interfacedefinition.InterfaceDefinition{
		...
		Node: []*interfacedefinition.Node{{
			...
			Children: []*interfacedefinition.Children{{
				...
				Node: []*interfacedefinition.Node{{
					XMLName: xml.Name{Local: "node"}, NodeNameAttr: "conntrack-sync", OwnerAttr: "${vyos_conf_scripts_dir}/conntrack_sync.py",
					...
					Children: []*interfacedefinition.Children{{
						XMLName: xml.Name{Local: "children"},
						Node: []*interfacedefinition.Node{{
							XMLName: xml.Name{Local: "node"}, NodeNameAttr: "failover-mechanism",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
								...
								Node: []*interfacedefinition.Node{{
									...
									Children: []*interfacedefinition.Children{{
										...
										LeafNode: []*interfacedefinition.LeafNode{{
											XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "sync-group",
											Properties: []*interfacedefinition.Properties{{
												XMLName: xml.Name{Local: "properties"},
							...
							Children: []*interfacedefinition.Children{{
								...
								LeafNode: []*interfacedefinition.LeafNode{{
									...
									Properties: []*interfacedefinition.Properties{{
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv4", Description: "IP address to listen for incoming connections"}},
									}},
								}, {
						...
						LeafNode: []*interfacedefinition.LeafNode{{
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "accept-protocol",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
								...
								ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "tcp", Description: "Sync Transmission Control Protocol entries"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "udp", Description: "Sync User Datagram Protocol entries"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "icmp", Description: "Sync Internet Control Message Protocol entries"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "icmp6", Description: "Sync IPv6 Internet Control Message Protocol entries"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "sctp", Description: "Sync Stream Control Transmission Protocol entries"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "dccp", Description: "Sync Datagram Congestion Control Protocol entries"}},
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "disable-external-cache",
							Properties: []*interfacedefinition.Properties{{
								XMLName:   xml.Name{Local: "properties"},
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "event-listen-queue-size",
							DefaultValue: []string{"8"},
							Properties: []*interfacedefinition.Properties{{
								XMLName:   xml.Name{Local: "properties"},
								Help:      []string{"Queue size for local conntrack events"},
								ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "u32", Description: "Queue size in MB"}},
							}},
						}, {
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "expect-sync",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "ignore-address",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
								Help:    []string{"IP addresses for which local conntrack entries will not be synced"},
								Constraint: []*interfacedefinition.Constraint{{
									XMLName:   xml.Name{Local: "constraint"},
									Validator: []*interfacedefinition.Validator{{XMLName: xml.Name{Local: "validator"}, NameAttr: "ipv4"}, {XMLName: xml.Name{Local: "validator"}, NameAttr: "ipv6"}},
								}},
								ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv4", Description: "IPv4 address to ignore"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv4net", Description: "IPv4 prefix to ignore"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv6", Description: "IPv6 address to ignore"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv6net", Description: "IPv6 prefix to ignore"}},
								Multi:     []*interfacedefinition.Multi{{XMLName: xml.Name{Local: "multi"}}},
							}},
						}, {
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "mcast-group",
							...
							Properties: []*interfacedefinition.Properties{{
								...
								Constraint: []*interfacedefinition.Constraint{{
									XMLName:   xml.Name{Local: "constraint"},
									Validator: []*interfacedefinition.Validator{{XMLName: xml.Name{Local: "validator"}, NameAttr: "ipv4-multicast"}},
								}},
							}},
						}, {
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "sync-queue-size",
