		...
		Node: []*interfacedefinition.Node{{
			...
			Children: []*interfacedefinition.Children{{
				...
				TagNode: []*interfacedefinition.TagNode{{
					XMLName: xml.Name{Local: "tagNode"}, NodeNameAttr: "vxlan", OwnerAttr: "${vyos_conf_scripts_dir}/interfaces-vxlan.py",
					Properties: []*interfacedefinition.Properties{{
						...
						ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "vxlanN", Description: "VXLAN interface name"}},
					...
					Children: []*interfacedefinition.Children{{
							...
							Children: []*interfacedefinition.Children{{
								...
								Node: []*interfacedefinition.Node{{
									...
									Children: []*interfacedefinition.Children{{
										XMLName: xml.Name{Local: "children"},
										LeafNode: []*interfacedefinition.LeafNode{{
											XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "df",
											...
											Properties: []*interfacedefinition.Properties{{
												...
												ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "set", Description: "Always set DF (don't fragment) bit"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "unset", Description: "Always unset DF (don't fragment) bit"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "inherit", Description: "Copy from the original IP header"}},
												CompletionHelp: []*interfacedefinition.CompletionHelp{{
													XMLName: xml.Name{Local: "completionHelp"},
								...
								LeafNode: []*interfacedefinition.LeafNode{{
									XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "nolearning",
									Properties: []*interfacedefinition.Properties{{
										XMLName:   xml.Name{Local: "properties"},
						...
						LeafNode: []*interfacedefinition.LeafNode{{
							...
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "gpe",
							Properties: []*interfacedefinition.Properties{{
								XMLName:   xml.Name{Local: "properties"},
							...
							Properties: []*interfacedefinition.Properties{{
								...
								Constraint: []*interfacedefinition.Constraint{{
									XMLName:   xml.Name{Local: "constraint"},
									Validator: []*interfacedefinition.Validator{{XMLName: xml.Name{Local: "validator"}, NameAttr: "ipv4-multicast"}, {XMLName: xml.Name{Local: "validator"}, NameAttr: "ipv6-multicast"}},
								}},
								ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv4", Description: "Multicast IPv4 group address"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "ipv6", Description: "Multicast IPv6 group address"}},
							...
							DefaultValue: []string{"1450"},
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
								Help:    []string{"Maximum Transmission Unit (MTU)"},
								Constraint: []*interfacedefinition.Constraint{{
									XMLName:   xml.Name{Local: "constraint"},
									Validator: []*interfacedefinition.Validator{{XMLName: xml.Name{Local: "validator"}, NameAttr: "numeric", ArgumentAttr: "--range 1200-16000"}},
								}},
								ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:1200-16000", Description: "Maximum Transmission Unit in byte"}},
								ConstraintErrorMessage: []string{"MTU must be between 1200 and 16000"},
							}},
						}, {
							XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "port",
							DefaultValue: []string{"8472"},
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
