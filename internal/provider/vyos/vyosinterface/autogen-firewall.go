														...
														Constraint: []*interfacedefinition.Constraint{
															{
																...
																Validator: []*interfacedefinition.Validator(nil)}},
														ConstraintErrorMessage: []string{
															`Name of domain-group can only contain alpha-numeric letters,
 hyphen,
 underscores and not start with numeric`},
														KeepChildOrder: []*interfacedefinition.KeepChildOrder(nil)}},
												Children: []*interfacedefinition.Children{
													{
														XMLName: xml.Name{
												...
												Properties: []*interfacedefinition.Properties{
													{
														...
														ConstraintErrorMessage: []string{
															`Firewall rule number must be between 1 and 999999`},
														KeepChildOrder: []*interfacedefinition.KeepChildOrder(nil)}},
												Children: []*interfacedefinition.Children{
													{
														XMLName: xml.Name{
																				...
																				Properties: []*interfacedefinition.Properties{
																					{
																						XMLName: xml.Name{
																							Local: `properties`},
																						Help: []string{
																							`GeoIP options - Data provided by DB-IP.com`},
																						KeepChildOrder: []*interfacedefinition.KeepChildOrder(nil)}},
																				Children: []*interfacedefinition.Children{
																					{
																						XMLName: xml.Name{
																						...
																						ValueHelp: []*interfacedefinition.ValueHelp{
																							{
																								XMLName: xml.Name{
																									Local: `valueHelp`},
																								Format: `txt`,
																								Description: `Name of day (Monday,
 Tuesday,
 Wednesday,
 Thursdays,
 Friday,
																		...
																		Constraint: []*interfacedefinition.Constraint{
																			{
																				XMLName: xml.Name{
																					Local: `constraint`},
																				Regex: []string{
																					`(accept|jump|reject|return|drop|queue)`},
																				Validator: []*interfacedefinition.Validator(nil)}},
																		ValueHelp: []*interfacedefinition.ValueHelp{
																			{
																				XMLName: xml.Name{
														...
														Constraint: []*interfacedefinition.Constraint{
															{
																XMLName: xml.Name{
																	Local: `constraint`},
																Regex: []string{
																	`(drop|jump|reject|return|accept)`},
																Validator: []*interfacedefinition.Validator(nil)}},
														ValueHelp: []*interfacedefinition.ValueHelp{
															{
																XMLName: xml.Name{
								...
								Properties: []*interfacedefinition.Properties{
									{
										XMLName: xml.Name{
											Local: `properties`},
										Help: []string{
											`Policy for source validation by reversed path,
 as specified in RFC3704`},
										Constraint: []*interfacedefinition.Constraint{
											{
												XMLName: xml.Name{
													Local: `constraint`},
