		...
		Node: []*interfacedefinition.Node{{
			...
			Children: []*interfacedefinition.Children{{
				...
				TagNode: []*interfacedefinition.TagNode{{
					XMLName: xml.Name{Local: "tagNode"}, NodeNameAttr: "input", OwnerAttr: "${vyos_conf_scripts_dir}/interfaces-input.py",
					Properties: []*interfacedefinition.Properties{{
						...
						ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "ifbN", Description: "Input interface name"}},
