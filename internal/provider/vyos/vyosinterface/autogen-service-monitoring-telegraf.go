	...
	return interfacedefinition.InterfaceDefinition{
		...
		Node: []*interfacedefinition.Node{{
			...
			Children: []*interfacedefinition.Children{{
				...
				Node: []*interfacedefinition.Node{{
					XMLName: xml.Name{Local: "node"}, NodeNameAttr: "monitoring",
					...
					Children: []*interfacedefinition.Children{{
						XMLName: xml.Name{Local: "children"},
						Node: []*interfacedefinition.Node{{
							XMLName: xml.Name{Local: "node"}, NodeNameAttr: "telegraf", OwnerAttr: "${vyos_conf_scripts_dir}/service_monitoring_telegraf.py",
							Properties: []*interfacedefinition.Properties{{
								XMLName: xml.Name{Local: "properties"},
							...
							Children: []*interfacedefinition.Children{{
								XMLName: xml.Name{Local: "children"},
								Node: []*interfacedefinition.Node{{
									XMLName: xml.Name{Local: "node"}, NodeNameAttr: "influxdb",
									Properties: []*interfacedefinition.Properties{{
										XMLName: xml.Name{Local: "properties"},
									...
									Children: []*interfacedefinition.Children{{
										...
										Node: []*interfacedefinition.Node{{
											...
											Children: []*interfacedefinition.Children{{
												...
												LeafNode: []*interfacedefinition.LeafNode{{
													...
													XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "token",
													Properties: []*interfacedefinition.Properties{{
														XMLName: xml.Name{Local: "properties"},
														...
														ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "txt", Description: "Authentication token"}},
										...
										LeafNode: []*interfacedefinition.LeafNode{{
											XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "bucket",
											...
											Properties: []*interfacedefinition.Properties{{
												...
												ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "url", Description: "Remote URL"}},
									...
									XMLName: xml.Name{Local: "node"}, NodeNameAttr: "azure-data-explorer",
									Properties: []*interfacedefinition.Properties{{
										XMLName: xml.Name{Local: "properties"},
									...
									Children: []*interfacedefinition.Children{{
										...
										Node: []*interfacedefinition.Node{{
											...
											Children: []*interfacedefinition.Children{{
												...
												LeafNode: []*interfacedefinition.LeafNode{{
													...
													XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "client-secret",
													Properties: []*interfacedefinition.Properties{{
														XMLName: xml.Name{Local: "properties"},
													...
													XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "tenant-id",
													Properties: []*interfacedefinition.Properties{{
														XMLName: xml.Name{Local: "properties"},
										...
										LeafNode: []*interfacedefinition.LeafNode{{
											XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "database",
											Properties: []*interfacedefinition.Properties{{
												XMLName: xml.Name{Local: "properties"},
												...
												ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "txt", Description: "Remote database name"}},
												ConstraintErrorMessage: []string{"Database is limited to alphanumerical characters and can contain hyphen and underscores"},
											}},
										}, {
											XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "group-metrics",
											...
											Properties: []*interfacedefinition.Properties{{
												...
												ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "single-table", Description: "Metrics stores in one table"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "table-per-metric", Description: "One table per gorups of metric by the metric name"}},
											...
											Properties: []*interfacedefinition.Properties{{
												...
												ValueHelp:              []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "txt", Description: "Table name"}},
									...
									XMLName: xml.Name{Local: "node"}, NodeNameAttr: "prometheus-client",
									Properties: []*interfacedefinition.Properties{{
										XMLName: xml.Name{Local: "properties"},
									...
									Children: []*interfacedefinition.Children{{
											...
											Children: []*interfacedefinition.Children{{
												...
												LeafNode: []*interfacedefinition.LeafNode{{
													...
													Properties: []*interfacedefinition.Properties{{
														...
														ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "txt", Description: "Authentication password"}},
													}},
												}},
											}},
										}},
										LeafNode: []*interfacedefinition.LeafNode{{
											...
											XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "metric-version",
											...
											Properties: []*interfacedefinition.Properties{{
												...
												ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "u32:1-2", Description: "Metric version (default: 2)"}},
											}},
										}, {
											XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "port",
									...
									XMLName: xml.Name{Local: "node"}, NodeNameAttr: "splunk",
									Properties: []*interfacedefinition.Properties{{
										XMLName: xml.Name{Local: "properties"},
										...
										Node: []*interfacedefinition.Node{{
											...
											Children: []*interfacedefinition.Children{{
												...
												LeafNode: []*interfacedefinition.LeafNode{{
													...
													XMLName: xml.Name{Local: "leafNode"}, NodeNameAttr: "insecure",
													Properties: []*interfacedefinition.Properties{{
														XMLName:   xml.Name{Local: "properties"},
								...
								LeafNode: []*interfacedefinition.LeafNode{{
									...
									Properties: []*interfacedefinition.Properties{{
										...
										ValueHelp: []*interfacedefinition.ValueHelp{{XMLName: xml.Name{Local: "valueHelp"}, Format: "all", Description: "All parameters"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "hardware-utilization", Description: "Hardware-utilization parameters (CPU, disk, memory)"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "logs", Description: "Logs parameters"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "network", Description: "Network parameters (net, netstat, nftables)"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "system", Description: "System parameters (system, processes, interrupts)"}, {XMLName: xml.Name{Local: "valueHelp"}, Format: "telegraf", Description: "Telegraf internal statistics"}},
										CompletionHelp: []*interfacedefinition.CompletionHelp{{
											XMLName: xml.Name{Local: "completionHelp"},
